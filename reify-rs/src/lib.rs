...
pub fn build_data_model() -> GraphBuffer {
  ...
  g.add_edge((CLASS_CAPTUREDSTMT, META_SUBCLASS, CLASS_STMT));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_CAPTURE_BEGIN, "clang::CapturedStmt::capture_begin"),
      add_named_node(&mut g, METHOD_CAPTURE_END, "clang::CapturedStmt::capture_end"),
      ...
      add_named_node(&mut g, METHOD_CAPTURE_INIT_BEGIN, "clang::CapturedStmt::capture_init_begin"),
      add_named_node(&mut g, METHOD_CAPTURE_INIT_END, "clang::CapturedStmt::capture_init_end"),
  ...
  g.add_edge((CLASS_BLOCKDECL, META_SUBCLASS, CLASS_DECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_PARAM_BEGIN, "clang::BlockDecl::param_begin"),
      add_named_node(&mut g, METHOD_PARAM_END, "clang::BlockDecl::param_end"),
      ...
      add_named_node(&mut g, METHOD_CAPTURE_BEGIN_1, "clang::BlockDecl::capture_begin"),
      add_named_node(&mut g, METHOD_CAPTURE_END_1, "clang::BlockDecl::capture_end"),
  ...
  g.add_edge((CLASS_VARTEMPLATEDECL, META_SUBCLASS, CLASS_REDECLARABLETEMPLATEDECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_SPEC_BEGIN_1, "clang::VarTemplateDecl::spec_begin"),
      add_named_node(&mut g, METHOD_SPEC_END_1, "clang::VarTemplateDecl::spec_end"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_FUNCTIONDECL, META_SUBCLASS, CLASS_DECLARATORDECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_PARAM_BEGIN_1, "clang::FunctionDecl::param_begin"),
      add_named_node(&mut g, METHOD_PARAM_END_1, "clang::FunctionDecl::param_end"),
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETINNERTYPE_1, "clang::ReferenceTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETVALUELOC, "clang::AtomicTypeLoc::getValueLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE, "clang::AtomicTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETKWLOC, "clang::AtomicTypeLoc::getKWLoc"),
      add_named_node(&mut g, METHOD_GETLPARENLOC_12, "clang::AtomicTypeLoc::getLParenLoc"),
      add_named_node(&mut g, METHOD_GETRPARENLOC_29, "clang::AtomicTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETPARENSRANGE, "clang::AtomicTypeLoc::getParensRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_2, "clang::AtomicTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_DECLTYPETYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETRPARENLOC_30, "clang::DecltypeTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_1, "clang::DecltypeTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_VECTORTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_2, "clang::VectorTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETELEMENTLOC, "clang::VectorTypeLoc::getElementLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_3, "clang::VectorTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_DEPENDENTADDRESSSPACETYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_3, "clang::DependentAddressSpaceTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_4, "clang::DependentAddressSpaceTypeLoc::getInnerType"),
  ...
  g.add_edge((CLASS_FUNCTIONTEMPLATEDECL, META_SUBCLASS, CLASS_REDECLARABLETEMPLATEDECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_SPEC_BEGIN_2, "clang::FunctionTemplateDecl::spec_begin"),
      add_named_node(&mut g, METHOD_SPEC_END_2, "clang::FunctionTemplateDecl::spec_end"),
  ...
  g.add_edge((CLASS_BUILTINTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETNAMELOC_3, "clang::BuiltinTypeLoc::getNameLoc"),
      ...
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATASIZE, "clang::BuiltinTypeLoc::getExtraLocalDataSize"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATAALIGNMENT, "clang::BuiltinTypeLoc::getExtraLocalDataAlignment"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_4, "clang::BuiltinTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_ARRAYTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETELEMENTLOC_1, "clang::ArrayTypeLoc::getElementLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_5, "clang::ArrayTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_5, "clang::ArrayTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_9, "clang::TagTypeLoc::getDecl"),
  ...
  g.add_edge((CLASS_TEMPLATESPECIALIZATIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_6, "clang::TemplateSpecializationTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATASIZE_1, "clang::TemplateSpecializationTypeLoc::getExtraLocalDataSize"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATAALIGNMENT_1, "clang::TemplateSpecializationTypeLoc::getExtraLocalDataAlignment"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_LAMBDAEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_CAPTURE_BEGIN_2, "clang::LambdaExpr::capture_begin"),
      add_named_node(&mut g, METHOD_CAPTURE_END_2, "clang::LambdaExpr::capture_end"),
      ...
      add_named_node(&mut g, METHOD_CAPTURE_INIT_BEGIN_1, "clang::LambdaExpr::capture_init_begin"),
      add_named_node(&mut g, METHOD_CAPTURE_INIT_END_1, "clang::LambdaExpr::capture_init_end"),
  ...
  g.add_edge((CLASS_CAPTUREDDECL, META_SUBCLASS, CLASS_DECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_PARAM_BEGIN_2, "clang::CapturedDecl::param_begin"),
      add_named_node(&mut g, METHOD_PARAM_END_2, "clang::CapturedDecl::param_end"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETINNERLOC, "clang::MacroQualifiedTypeLoc::getInnerLoc"),
      ...
      add_named_node(&mut g, METHOD_GETINNERTYPE_6, "clang::MacroQualifiedTypeLoc::getInnerType"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_7, "clang::MacroQualifiedTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_ATTRIBUTEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_8, "clang::AttributedTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_7, "clang::AttributedTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_MATRIXTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_9, "clang::MatrixTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_11, "clang::EnumTypeLoc::getDecl"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETLPARENLOC_13, "clang::ParenTypeLoc::getLParenLoc"),
      add_named_node(&mut g, METHOD_GETRPARENLOC_31, "clang::ParenTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_10, "clang::ParenTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERLOC_1, "clang::ParenTypeLoc::getInnerLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_8, "clang::ParenTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETVALUELOC_1, "clang::PipeTypeLoc::getValueLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_11, "clang::PipeTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETKWLOC_1, "clang::PipeTypeLoc::getKWLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_9, "clang::PipeTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_DEPENDENTVECTORTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_12, "clang::DependentVectorTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETELEMENTLOC_2, "clang::DependentVectorTypeLoc::getElementLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_10, "clang::DependentVectorTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETNAMELOC_6, "clang::DependentSizedExtVectorTypeLoc::getNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_14, "clang::DependentSizedExtVectorTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETELEMENTLOC_3, "clang::DependentSizedExtVectorTypeLoc::getElementLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_11, "clang::DependentSizedExtVectorTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_12, "clang::UnresolvedUsingTypeLoc::getDecl"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_15, "clang::QualifiedTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETUNQUALIFIEDLOC, "clang::QualifiedTypeLoc::getUnqualifiedLoc"),
      add_named_node(&mut g, METHOD_GETNEXTTYPELOC, "clang::QualifiedTypeLoc::getNextTypeLoc"),
      add_named_node(&mut g, METHOD_GETLOCALDATASIZE, "clang::QualifiedTypeLoc::getLocalDataSize"),
  ...
  g.add_edge((CLASS_BTFTAGATTRIBUTEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_16, "clang::BTFTagAttributedTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_FUNCTIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_17, "clang::FunctionTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATASIZE_2, "clang::FunctionTypeLoc::getExtraLocalDataSize"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATAALIGNMENT_2, "clang::FunctionTypeLoc::getExtraLocalDataAlignment"),
  ...
  g.add_edge((CLASS_DEPENDENTTEMPLATESPECIALIZATIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_18, "clang::DependentTemplateSpecializationTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATASIZE_3, "clang::DependentTemplateSpecializationTypeLoc::getExtraLocalDataSize"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATAALIGNMENT_3, "clang::DependentTemplateSpecializationTypeLoc::getExtraLocalDataAlignment"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_UNARYTRANSFORMTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_19, "clang::UnaryTransformTypeLoc::getLocalSourceRange"),
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETTYPEPTR, "clang::UnqualTypeLoc::getTypePtr"),
      add_named_node(&mut g, METHOD_GETTYPELOCCLASS, "clang::UnqualTypeLoc::getTypeLocClass"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETTYPELOCCLASS_1, "clang::TypeLoc::getTypeLocClass"),
      add_named_node(&mut g, METHOD_ISNULL, "clang::TypeLoc::isNull"),
      add_named_node(&mut g, METHOD_GETTYPE_2, "clang::TypeLoc::getType"),
      add_named_node(&mut g, METHOD_GETTYPEPTR_1, "clang::TypeLoc::getTypePtr"),
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_20, "clang::TypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETFULLDATASIZE, "clang::TypeLoc::getFullDataSize"),
      add_named_node(&mut g, METHOD_GETNEXTTYPELOC_1, "clang::TypeLoc::getNextTypeLoc"),
      add_named_node(&mut g, METHOD_GETUNQUALIFIEDLOC_1, "clang::TypeLoc::getUnqualifiedLoc"),
  ...
  g.add_edge((CLASS_TYPEOFEXPRTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_21, "clang::TypeOfExprTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_ELABORATEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALDATASIZE_1, "clang::ElaboratedTypeLoc::getLocalDataSize"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_13, "clang::RecordTypeLoc::getDecl"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_ADJUSTEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETINNERTYPE_15, "clang::AdjustedTypeLoc::getInnerType"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_23, "clang::AdjustedTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETLOCALDATASIZE_2, "clang::AdjustedTypeLoc::getLocalDataSize"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_AUTOTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_24, "clang::AutoTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
...
pub const CLASS_OBJCARRAYLITERAL: u64 = 94;
pub const CLASS_CXXSTDINITIALIZERLISTEXPR: u64 = 95;
pub const METHOD_GETSUBEXPR_2: u64 = 96;
pub const METHOD_GETBEGINLOC_40: u64 = 97;
pub const METHOD_GETENDLOC_39: u64 = 98;
pub const METHOD_GETSOURCERANGE_44: u64 = 99;
pub const METHOD_CHILDREN_30: u64 = 100;
pub const CLASS_CXXTYPEIDEXPR: u64 = 101;
pub const METHOD_ISPOTENTIALLYEVALUATED: u64 = 102;
pub const METHOD_ISTYPEOPERAND: u64 = 103;
pub const METHOD_GETTYPEOPERANDSOURCEINFO: u64 = 104;
pub const METHOD_GETEXPROPERAND: u64 = 105;
pub const METHOD_GETBEGINLOC_45: u64 = 106;
pub const METHOD_GETENDLOC_44: u64 = 107;
pub const METHOD_GETSOURCERANGE_45: u64 = 108;
pub const METHOD_CHILDREN_34: u64 = 109;
pub const CLASS_OBJCPROPERTYREFEXPR: u64 = 110;
pub const CLASS_OBJCMESSAGEEXPR: u64 = 111;
pub const CLASS_CXXPARENLISTINITEXPR: u64 = 112;
pub const METHOD_GETINITEXPRS: u64 = 113;
pub const METHOD_GETUSERSPECIFIEDINITEXPRS: u64 = 114;
pub const METHOD_GETBEGINLOC_36: u64 = 115;
pub const METHOD_GETENDLOC_35: u64 = 116;
pub const METHOD_GETINITLOC: u64 = 117;
pub const METHOD_GETSOURCERANGE_42: u64 = 118;
pub const METHOD_GETARRAYFILLER: u64 = 119;
pub const METHOD_GETINITIALIZEDFIELDINUNION: u64 = 120;
pub const METHOD_CHILDREN_27: u64 = 121;
pub const CLASS_DOSTMT: u64 = 122;
pub const METHOD_GETCOND_5: u64 = 123;
pub const METHOD_GETBODY_7: u64 = 124;
pub const METHOD_GETDOLOC: u64 = 125;
pub const METHOD_GETWHILELOC: u64 = 126;
pub const METHOD_GETRPARENLOC_14: u64 = 127;
pub const METHOD_GETBEGINLOC_70: u64 = 128;
pub const METHOD_GETENDLOC_69: u64 = 129;
pub const METHOD_CHILDREN_60: u64 = 130;
pub const CLASS_GOTOSTMT: u64 = 131;
pub const METHOD_GETLABEL_1: u64 = 132;
pub const METHOD_GETGOTOLOC: u64 = 133;
pub const METHOD_GETLABELLOC_1: u64 = 134;
pub const METHOD_GETBEGINLOC_81: u64 = 135;
pub const METHOD_GETENDLOC_80: u64 = 136;
pub const METHOD_CHILDREN_70: u64 = 137;
pub const CLASS_ASTYPEEXPR: u64 = 138;
pub const METHOD_GETSRCEXPR: u64 = 139;
pub const METHOD_GETBUILTINLOC: u64 = 140;
pub const METHOD_GETRPARENLOC_2: u64 = 141;
pub const METHOD_GETBEGINLOC_9: u64 = 142;
pub const METHOD_GETENDLOC_8: u64 = 143;
pub const METHOD_CHILDREN_5: u64 = 144;
pub const CLASS_OMPDISTRIBUTEPARALLELFORDIRECTIVE: u64 = 145;
pub const CLASS_ASMSTMT: u64 = 146;
pub const METHOD_GETASMLOC_1: u64 = 147;
pub const METHOD_ISSIMPLE: u64 = 148;
pub const METHOD_ISVOLATILE_2: u64 = 149;
pub const METHOD_GETBEGINLOC_10: u64 = 150;
pub const METHOD_GETENDLOC_9: u64 = 151;
pub const METHOD_GETNUMOUTPUTS: u64 = 152;
pub const METHOD_GETNUMPLUSOPERANDS: u64 = 153;
pub const METHOD_GETNUMINPUTS: u64 = 154;
pub const METHOD_GETNUMCLOBBERS: u64 = 155;
pub const METHOD_BEGIN_INPUTS: u64 = 156;
pub const METHOD_END_INPUTS: u64 = 157;
pub const METHOD_INPUTS: u64 = 158;
pub const METHOD_BEGIN_OUTPUTS: u64 = 159;
pub const METHOD_END_OUTPUTS: u64 = 160;
pub const METHOD_OUTPUTS: u64 = 161;
pub const METHOD_CHILDREN_6: u64 = 162;
pub const CLASS_IFSTMT: u64 = 163;
pub const METHOD_HASINITSTORAGE: u64 = 164;
pub const METHOD_HASVARSTORAGE: u64 = 165;
pub const METHOD_HASELSESTORAGE: u64 = 166;
pub const METHOD_GETCOND_7: u64 = 167;
pub const METHOD_GETTHEN: u64 = 168;
pub const METHOD_GETELSE: u64 = 169;
pub const METHOD_GETCONDITIONVARIABLE_1: u64 = 170;
pub const METHOD_GETCONDITIONVARIABLEDECLSTMT_1: u64 = 171;
pub const METHOD_GETINIT_5: u64 = 172;
pub const METHOD_GETIFLOC: u64 = 173;
pub const METHOD_GETELSELOC: u64 = 174;
pub const METHOD_ISCONSTEVAL_1: u64 = 175;
pub const METHOD_ISNONNEGATEDCONSTEVAL: u64 = 176;
pub const METHOD_ISNEGATEDCONSTEVAL: u64 = 177;
pub const METHOD_ISCONSTEXPR_2: u64 = 178;
pub const METHOD_GETSTATEMENTKIND: u64 = 179;
pub const METHOD_ISOBJCAVAILABILITYCHECK: u64 = 180;
pub const METHOD_GETBEGINLOC_82: u64 = 181;
pub const METHOD_GETENDLOC_81: u64 = 182;
pub const METHOD_GETLPARENLOC_6: u64 = 183;
pub const METHOD_GETRPARENLOC_18: u64 = 184;
pub const METHOD_CHILDREN_71: u64 = 185;
pub const CLASS_CAPTUREDSTMT: u64 = 186;
pub const METHOD_GETCAPTUREDSTMT: u64 = 187;
pub const METHOD_GETCAPTUREDDECL: u64 = 188;
pub const METHOD_GETCAPTUREDREGIONKIND: u64 = 189;
pub const METHOD_GETCAPTUREDRECORDDECL: u64 = 190;
pub const METHOD_CAPTURES_2: u64 = 191;
pub const METHOD_CAPTURE_BEGIN: u64 = 192;
pub const METHOD_CAPTURE_END: u64 = 193;
pub const METHOD_CAPTURE_SIZE: u64 = 194;
pub const METHOD_CAPTURE_INITS: u64 = 195;
pub const METHOD_CAPTURE_INIT_BEGIN: u64 = 196;
pub const METHOD_CAPTURE_INIT_END: u64 = 197;
pub const METHOD_GETBEGINLOC_49: u64 = 198;
pub const METHOD_GETENDLOC_48: u64 = 199;
pub const METHOD_GETSOURCERANGE_47: u64 = 200;
pub const METHOD_CHILDREN_38: u64 = 201;
pub const CLASS_CXXTHISEXPR: u64 = 202;
pub const METHOD_GETLOCATION_5: u64 = 203;
pub const METHOD_GETBEGINLOC_42: u64 = 204;
pub const METHOD_GETENDLOC_41: u64 = 205;
pub const METHOD_ISIMPLICIT_1: u64 = 206;
pub const METHOD_CHILDREN_31: u64 = 207;
pub const CLASS_OBJCINDIRECTCOPYRESTOREEXPR: u64 = 208;
pub const CLASS_COROUTINEBODYSTMT: u64 = 209;
pub const METHOD_HASDEPENDENTPROMISETYPE: u64 = 210;
pub const METHOD_GETBODY_6: u64 = 211;
pub const METHOD_GETPROMISEDECLSTMT: u64 = 212;
pub const METHOD_GETPROMISEDECL: u64 = 213;
pub const METHOD_GETINITSUSPENDSTMT: u64 = 214;
pub const METHOD_GETFINALSUSPENDSTMT: u64 = 215;
pub const METHOD_GETEXCEPTIONHANDLER: u64 = 216;
pub const METHOD_GETFALLTHROUGHHANDLER: u64 = 217;
pub const METHOD_GETALLOCATE: u64 = 218;
pub const METHOD_GETDEALLOCATE: u64 = 219;
pub const METHOD_GETRESULTDECL: u64 = 220;
pub const METHOD_GETRETURNVALUEINIT: u64 = 221;
pub const METHOD_GETRETURNVALUE: u64 = 222;
pub const METHOD_GETRETURNSTMT: u64 = 223;
pub const METHOD_GETRETURNSTMTONALLOCFAILURE: u64 = 224;
pub const METHOD_GETPARAMMOVES: u64 = 225;
pub const METHOD_GETBEGINLOC_61: u64 = 226;
pub const METHOD_GETENDLOC_60: u64 = 227;
pub const METHOD_CHILDREN_51: u64 = 228;
pub const METHOD_CHILDRENEXCLBODY: u64 = 229;
pub const CLASS_CORETURNSTMT: u64 = 230;
pub const METHOD_GETKEYWORDLOC: u64 = 231;
pub const METHOD_GETOPERAND_1: u64 = 232;
pub const METHOD_GETPROMISECALL: u64 = 233;
pub const METHOD_ISIMPLICIT_3: u64 = 234;
pub const METHOD_GETBEGINLOC_60: u64 = 235;
pub const METHOD_GETENDLOC_59: u64 = 236;
pub const METHOD_CHILDREN_50: u64 = 237;
pub const CLASS_ARRAYTYPETRAITEXPR: u64 = 238;
pub const METHOD_GETBEGINLOC_8: u64 = 239;
pub const METHOD_GETENDLOC_7: u64 = 240;
pub const METHOD_GETTRAIT: u64 = 241;
pub const METHOD_GETQUERIEDTYPE: u64 = 242;
pub const METHOD_GETQUERIEDTYPESOURCEINFO: u64 = 243;
pub const METHOD_GETVALUE_9: u64 = 244;
pub const METHOD_GETDIMENSIONEXPRESSION: u64 = 245;
pub const METHOD_CHILDREN_4: u64 = 246;
pub const CLASS_OBJCATCATCHSTMT: u64 = 247;
pub const CLASS_LABELSTMT: u64 = 248;
pub const METHOD_GETIDENTLOC: u64 = 249;
pub const METHOD_GETDECL_8: u64 = 250;
pub const METHOD_GETNAME_1: u64 = 251;
pub const METHOD_GETSUBSTMT_3: u64 = 252;
pub const METHOD_GETBEGINLOC_89: u64 = 253;
pub const METHOD_GETENDLOC_88: u64 = 254;
pub const METHOD_CHILDREN_77: u64 = 255;
pub const METHOD_ISSIDEENTRY: u64 = 256;
pub const CLASS_OBJCAUTORELEASEPOOLSTMT: u64 = 257;
pub const CLASS_OMPTILEDIRECTIVE: u64 = 258;
pub const CLASS_OBJCDICTIONARYLITERAL: u64 = 259;
pub const CLASS_OMPLOOPTRANSFORMATIONDIRECTIVE: u64 = 260;
pub const CLASS_OBJCSUBSCRIPTREFEXPR: u64 = 261;
pub const CLASS_SYCLUNIQUESTABLENAMEEXPR: u64 = 262;
pub const METHOD_GETTYPESOURCEINFO_8: u64 = 263;
pub const METHOD_GETBEGINLOC_114: u64 = 264;
pub const METHOD_GETENDLOC_113: u64 = 265;
pub const METHOD_GETLOCATION_14: u64 = 266;
pub const METHOD_GETLPARENLOCATION: u64 = 267;
pub const METHOD_GETRPARENLOCATION: u64 = 268;
pub const METHOD_CHILDREN_101: u64 = 269;
pub const CLASS_OMPFORSIMDDIRECTIVE: u64 = 270;
pub const CLASS_OMPTARGETPARALLELFORDIRECTIVE: u64 = 271;
pub const CLASS_OMPTASKLOOPSIMDDIRECTIVE: u64 = 272;
pub const CLASS_CASTEXPR: u64 = 273;
pub const METHOD_GETCASTKIND: u64 = 274;
pub const METHOD_GETCASTKINDNAME: u64 = 275;
pub const METHOD_GETSUBEXPR_4: u64 = 276;
pub const METHOD_GETSUBEXPRASWRITTEN: u64 = 277;
pub const METHOD_GETCONVERSIONFUNCTION: u64 = 278;
pub const METHOD_PATH_EMPTY: u64 = 279;
pub const METHOD_PATH_SIZE: u64 = 280;
pub const METHOD_PATH_BEGIN: u64 = 281;
pub const METHOD_PATH_END: u64 = 282;
pub const METHOD_PATH: u64 = 283;
pub const METHOD_GETTARGETUNIONFIELD: u64 = 284;
pub const METHOD_HASSTOREDFPFEATURES_2: u64 = 285;
pub const METHOD_GETSTOREDFPFEATURES_2: u64 = 286;
pub const METHOD_GETFPFEATURES_2: u64 = 287;
pub const METHOD_CHANGESVOLATILEQUALIFICATION: u64 = 288;
pub const METHOD_CHILDREN_40: u64 = 289;
pub const CLASS_OMPMASTERTASKLOOPSIMDDIRECTIVE: u64 = 290;
pub const CLASS_COAWAITEXPR: u64 = 291;
pub const METHOD_ISIMPLICIT_2: u64 = 292;
pub const CLASS_CXXTRYSTMT: u64 = 293;
pub const METHOD_GETBEGINLOC_44: u64 = 294;
pub const METHOD_GETTRYLOC: u64 = 295;
pub const METHOD_GETENDLOC_43: u64 = 296;
pub const METHOD_GETTRYBLOCK: u64 = 297;
pub const METHOD_GETNUMHANDLERS: u64 = 298;
pub const METHOD_CHILDREN_33: u64 = 299;
pub const CLASS_OMPMASKEDTASKLOOPSIMDDIRECTIVE: u64 = 300;
pub const CLASS_OMPPARALLELDIRECTIVE: u64 = 301;
pub const CLASS_COMPOUNDASSIGNOPERATOR: u64 = 302;
pub const METHOD_GETCOMPUTATIONLHSTYPE: u64 = 303;
pub const METHOD_GETCOMPUTATIONRESULTTYPE: u64 = 304;
pub const CLASS_OBJCISAEXPR: u64 = 305;
pub const CLASS_OBJCATFINALLYSTMT: u64 = 306;
pub const CLASS_OMPPARALLELMASTERTASKLOOPDIRECTIVE: u64 = 307;
pub const CLASS_OMPPARALLELMASKEDTASKLOOPDIRECTIVE: u64 = 308;
pub const CLASS_OMPMASTERDIRECTIVE: u64 = 309;
pub const CLASS_OBJCIVARREFEXPR: u64 = 310;
pub const CLASS_TYPOEXPR: u64 = 311;
pub const METHOD_CHILDREN_112: u64 = 312;
pub const METHOD_GETBEGINLOC_125: u64 = 313;
pub const METHOD_GETENDLOC_124: u64 = 314;
pub const CLASS_CUDAKERNELCALLEXPR: u64 = 315;
pub const METHOD_GETCONFIG: u64 = 316;
pub const CLASS_OMPITERATOREXPR: u64 = 317;
pub const CLASS_OMPTARGETUPDATEDIRECTIVE: u64 = 318;
pub const CLASS_OMPTARGETPARALLELDIRECTIVE: u64 = 319;
pub const CLASS_OMPMASKEDDIRECTIVE: u64 = 320;
pub const CLASS_SEHEXCEPTSTMT: u64 = 321;
pub const METHOD_GETBEGINLOC_110: u64 = 322;
pub const METHOD_GETEXCEPTLOC: u64 = 323;
pub const METHOD_GETENDLOC_109: u64 = 324;
pub const METHOD_GETFILTEREXPR: u64 = 325;
pub const METHOD_GETBLOCK: u64 = 326;
pub const METHOD_CHILDREN_97: u64 = 327;
pub const CLASS_CONSTANTEXPR: u64 = 328;
pub const METHOD_GETBEGINLOC_57: u64 = 329;
pub const METHOD_GETENDLOC_56: u64 = 330;
pub const METHOD_GETRESULTAPVALUEKIND: u64 = 331;
pub const METHOD_GETRESULTSTORAGEKIND: u64 = 332;
pub const METHOD_ISIMMEDIATEINVOCATION: u64 = 333;
pub const METHOD_HASAPVALUERESULT: u64 = 334;
pub const METHOD_GETAPVALUERESULT: u64 = 335;
pub const METHOD_GETRESULTASAPSINT: u64 = 336;
pub const METHOD_CHILDREN_47: u64 = 337;
pub const CLASS_SEHFINALLYSTMT: u64 = 338;
pub const METHOD_GETBEGINLOC_111: u64 = 339;
pub const METHOD_GETFINALLYLOC: u64 = 340;
pub const METHOD_GETENDLOC_110: u64 = 341;
pub const METHOD_GETBLOCK_1: u64 = 342;
pub const METHOD_CHILDREN_98: u64 = 343;
pub const CLASS_OMPPARALLELFORSIMDDIRECTIVE: u64 = 344;
pub const CLASS_CXXNOEXCEPTEXPR: u64 = 345;
pub const METHOD_GETOPERAND: u64 = 346;
pub const METHOD_GETBEGINLOC_33: u64 = 347;
pub const METHOD_GETENDLOC_32: u64 = 348;
pub const METHOD_GETSOURCERANGE_40: u64 = 349;
pub const METHOD_GETVALUE_5: u64 = 350;
pub const METHOD_CHILDREN_25: u64 = 351;
pub const CLASS_OMPPARALLELMASKEDDIRECTIVE: u64 = 352;
pub const CLASS_INITLISTEXPR: u64 = 353;
pub const METHOD_GETNUMINITS: u64 = 354;
pub const METHOD_GETINITS: u64 = 355;
pub const METHOD_INITS_1: u64 = 356;
pub const METHOD_GETARRAYFILLER_1: u64 = 357;
pub const METHOD_HASARRAYFILLER: u64 = 358;
pub const METHOD_HASDESIGNATEDINIT: u64 = 359;
pub const METHOD_GETINITIALIZEDFIELDINUNION_1: u64 = 360;
pub const METHOD_ISEXPLICIT_3: u64 = 361;
pub const METHOD_ISSTRINGLITERALINIT: u64 = 362;
pub const METHOD_ISTRANSPARENT: u64 = 363;
pub const METHOD_GETLBRACELOC_1: u64 = 364;
pub const METHOD_GETRBRACELOC_4: u64 = 365;
pub const METHOD_ISSEMANTICFORM: u64 = 366;
pub const METHOD_GETSEMANTICFORM_1: u64 = 367;
pub const METHOD_ISSYNTACTICFORM: u64 = 368;
pub const METHOD_GETSYNTACTICFORM: u64 = 369;
pub const METHOD_HADARRAYRANGEDESIGNATOR: u64 = 370;
pub const METHOD_GETBEGINLOC_87: u64 = 371;
pub const METHOD_GETENDLOC_86: u64 = 372;
pub const METHOD_CHILDREN_75: u64 = 373;
pub const METHOD_BEGIN: u64 = 374;
pub const METHOD_END: u64 = 375;
pub const METHOD_RBEGIN: u64 = 376;
pub const METHOD_REND: u64 = 377;
pub const CLASS_OMPTARGETTEAMSGENERICLOOPDIRECTIVE: u64 = 378;
pub const CLASS_USERDEFINEDLITERAL: u64 = 379;
pub const METHOD_GETLITERALOPERATORKIND: u64 = 380;
pub const METHOD_GETCOOKEDLITERAL: u64 = 381;
pub const METHOD_GETBEGINLOC_130: u64 = 382;
pub const METHOD_GETENDLOC_129: u64 = 383;
pub const METHOD_GETUDSUFFIXLOC: u64 = 384;
pub const METHOD_GETUDSUFFIX: u64 = 385;
pub const CLASS_CXXUNRESOLVEDCONSTRUCTEXPR: u64 = 386;
pub const METHOD_GETTYPEASWRITTEN_2: u64 = 387;
pub const METHOD_GETTYPESOURCEINFO_4: u64 = 388;
pub const METHOD_GETLPARENLOC_3: u64 = 389;
pub const METHOD_GETRPARENLOC_10: u64 = 390;
pub const METHOD_ISLISTINITIALIZATION_2: u64 = 391;
pub const METHOD_GETNUMARGS_2: u64 = 392;
pub const METHOD_ARG_BEGIN: u64 = 393;
pub const METHOD_ARG_END: u64 = 394;
pub const METHOD_ARGUMENTS_1: u64 = 395;
pub const METHOD_GETBEGINLOC_46: u64 = 396;
pub const METHOD_GETENDLOC_45: u64 = 397;
pub const METHOD_CHILDREN_35: u64 = 398;
pub const CLASS_PACKEXPANSIONEXPR: u64 = 399;
pub const METHOD_GETPATTERN_2: u64 = 400;
pub const METHOD_GETELLIPSISLOC_6: u64 = 401;
pub const METHOD_GETNUMEXPANSIONS_3: u64 = 402;
pub const METHOD_GETBEGINLOC_102: u64 = 403;
pub const METHOD_GETENDLOC_101: u64 = 404;
pub const METHOD_CHILDREN_90: u64 = 405;
pub const CLASS_OMPTARGETDIRECTIVE: u64 = 406;
pub const CLASS_OMPTARGETDATADIRECTIVE: u64 = 407;
pub const CLASS_CASESTMT: u64 = 408;
pub const METHOD_CASESTMTISGNURANGE: u64 = 409;
pub const METHOD_GETCASELOC: u64 = 410;
pub const METHOD_GETELLIPSISLOC_5: u64 = 411;
pub const METHOD_GETLHS_4: u64 = 412;
pub const METHOD_GETRHS_4: u64 = 413;
pub const METHOD_GETSUBSTMT_1: u64 = 414;
pub const METHOD_GETBEGINLOC_50: u64 = 415;
pub const METHOD_GETENDLOC_49: u64 = 416;
pub const METHOD_CHILDREN_39: u64 = 417;
pub const CLASS_OMPTASKGROUPDIRECTIVE: u64 = 418;
pub const CLASS_OMPTARGETTEAMSDIRECTIVE: u64 = 419;
pub const CLASS_OMPMETADIRECTIVE: u64 = 420;
pub const CLASS_OMPATOMICDIRECTIVE: u64 = 421;
pub const CLASS_FORSTMT: u64 = 422;
pub const METHOD_GETCONDITIONVARIABLE: u64 = 423;
pub const METHOD_GETCONDITIONVARIABLEDECLSTMT: u64 = 424;
pub const METHOD_GETINIT_4: u64 = 425;
pub const METHOD_GETCOND_6: u64 = 426;
pub const METHOD_GETINC_1: u64 = 427;
pub const METHOD_GETBODY_8: u64 = 428;
pub const METHOD_GETFORLOC_1: u64 = 429;
pub const METHOD_GETLPARENLOC_5: u64 = 430;
pub const METHOD_GETRPARENLOC_15: u64 = 431;
pub const METHOD_GETBEGINLOC_76: u64 = 432;
pub const METHOD_GETENDLOC_75: u64 = 433;
pub const METHOD_CHILDREN_66: u64 = 434;
pub const CLASS_OMPDISTRIBUTEDIRECTIVE: u64 = 435;
pub const CLASS_OMPDISTRIBUTEPARALLELFORSIMDDIRECTIVE: u64 = 436;
pub const CLASS_OMPGENERICLOOPDIRECTIVE: u64 = 437;
pub const CLASS_ATTRIBUTEDSTMT: u64 = 438;
pub const METHOD_GETATTRLOC: u64 = 439;
pub const METHOD_GETATTRS_1: u64 = 440;
pub const METHOD_GETSUBSTMT: u64 = 441;
pub const METHOD_GETBEGINLOC_12: u64 = 442;
pub const METHOD_GETENDLOC_11: u64 = 443;
pub const METHOD_CHILDREN_8: u64 = 444;
pub const CLASS_OBJCATTHROWSTMT: u64 = 445;
pub const CLASS_OMPTARGETEXITDATADIRECTIVE: u64 = 446;
pub const CLASS_OMPTARGETENTERDATADIRECTIVE: u64 = 447;
pub const CLASS_OMPTARGETTEAMSDISTRIBUTEPARALLELFORDIRECTIVE: u64 = 448;
pub const CLASS_OMPEXECUTABLEDIRECTIVE: u64 = 449;
pub const CLASS_OMPMASTERTASKLOOPDIRECTIVE: u64 = 450;
pub const CLASS_EXPLICITCASTEXPR: u64 = 451;
pub const METHOD_GETTYPEINFOASWRITTEN: u64 = 452;
pub const METHOD_GETTYPEASWRITTEN_3: u64 = 453;
pub const CLASS_OMPLOOPBASEDDIRECTIVE: u64 = 454;
pub const CLASS_OMPPARALLELGENERICLOOPDIRECTIVE: u64 = 455;
pub const CLASS_OMPARRAYSECTIONEXPR: u64 = 456;
pub const CLASS_RETURNSTMT: u64 = 457;
pub const METHOD_GETRETVALUE: u64 = 458;
pub const METHOD_GETNRVOCANDIDATE: u64 = 459;
pub const METHOD_GETRETURNLOC: u64 = 460;
pub const METHOD_GETBEGINLOC_109: u64 = 461;
pub const METHOD_GETENDLOC_108: u64 = 462;
pub const METHOD_CHILDREN_96: u64 = 463;
pub const CLASS_GCCASMSTMT: u64 = 464;
pub const METHOD_GETRPARENLOC_16: u64 = 465;
pub const METHOD_GETASMSTRING_1: u64 = 466;
pub const METHOD_ISASMGOTO: u64 = 467;
pub const METHOD_GETNUMLABELS: u64 = 468;
pub const METHOD_BEGIN_LABELS: u64 = 469;
pub const METHOD_END_LABELS: u64 = 470;
pub const METHOD_LABELS: u64 = 471;
pub const METHOD_GETBEGINLOC_78: u64 = 472;
pub const METHOD_GETENDLOC_77: u64 = 473;
pub const CLASS_CXXCATCHSTMT: u64 = 474;
pub const METHOD_GETBEGINLOC_21: u64 = 475;
pub const METHOD_GETENDLOC_20: u64 = 476;
pub const METHOD_GETCATCHLOC: u64 = 477;
pub const METHOD_GETEXCEPTIONDECL: u64 = 478;
pub const METHOD_GETCAUGHTTYPE: u64 = 479;
pub const METHOD_GETHANDLERBLOCK: u64 = 480;
pub const METHOD_CHILDREN_15: u64 = 481;
pub const CLASS_OMPSCOPEDIRECTIVE: u64 = 482;
pub const CLASS_OBJCATTRYSTMT: u64 = 483;
pub const CLASS_OMPTARGETTEAMSDISTRIBUTEPARALLELFORSIMDDIRECTIVE: u64 = 484;
pub const CLASS_CXXADDRSPACECASTEXPR: u64 = 485;
pub const CLASS_FUNCTIONPARMPACKEXPR: u64 = 486;
pub const METHOD_GETPARAMETERPACK: u64 = 487;
pub const METHOD_GETPARAMETERPACKLOCATION: u64 = 488;
pub const METHOD_BEGIN_1: u64 = 489;
pub const METHOD_END_1: u64 = 490;
pub const METHOD_GETNUMEXPANSIONS_2: u64 = 491;
pub const METHOD_GETBEGINLOC_77: u64 = 492;
pub const METHOD_GETENDLOC_76: u64 = 493;
pub const METHOD_CHILDREN_67: u64 = 494;
pub const CLASS_DECLREFEXPR: u64 = 495;
pub const METHOD_GETDECL_7: u64 = 496;
pub const METHOD_GETNAMEINFO_4: u64 = 497;
pub const METHOD_GETLOCATION_7: u64 = 498;
pub const METHOD_GETBEGINLOC_63: u64 = 499;
pub const METHOD_GETENDLOC_62: u64 = 500;
pub const METHOD_HASQUALIFIER_1: u64 = 501;
pub const METHOD_GETQUALIFIERLOC_10: u64 = 502;
pub const METHOD_GETQUALIFIER_13: u64 = 503;
pub const METHOD_GETFOUNDDECL_2: u64 = 504;
pub const METHOD_HASTEMPLATEKWANDARGSINFO: u64 = 505;
pub const METHOD_GETTEMPLATEKEYWORDLOC_3: u64 = 506;
pub const METHOD_GETLANGLELOC_1: u64 = 507;
pub const METHOD_GETRANGLELOC_1: u64 = 508;
pub const METHOD_HASTEMPLATEKEYWORD_1: u64 = 509;
pub const METHOD_HASEXPLICITTEMPLATEARGS_2: u64 = 510;
pub const METHOD_GETTEMPLATEARGS_3: u64 = 511;
pub const METHOD_GETNUMTEMPLATEARGS_1: u64 = 512;
pub const METHOD_TEMPLATE_ARGUMENTS_3: u64 = 513;
pub const METHOD_HADMULTIPLECANDIDATES_1: u64 = 514;
pub const METHOD_ISNONODRUSE: u64 = 515;
pub const METHOD_REFERSTOENCLOSINGVARIABLEORCAPTURE: u64 = 516;
pub const METHOD_ISIMMEDIATEESCALATING_2: u64 = 517;
pub const METHOD_ISCAPTUREDBYCOPYINLAMBDAWITHEXPLICITOBJECTPARAMETER: u64 = 518;
pub const METHOD_CHILDREN_53: u64 = 519;
pub const CLASS_OMPTEAMSDISTRIBUTEPARALLELFORSIMDDIRECTIVE: u64 = 520;
pub const CLASS_OMPARRAYSHAPINGEXPR: u64 = 521;
pub const CLASS_UNRESOLVEDLOOKUPEXPR: u64 = 522;
pub const METHOD_REQUIRESADL: u64 = 523;
pub const METHOD_ISOVERLOADED: u64 = 524;
pub const METHOD_GETNAMINGCLASS_1: u64 = 525;
pub const METHOD_GETBEGINLOC_128: u64 = 526;
pub const METHOD_GETENDLOC_127: u64 = 527;
pub const METHOD_CHILDREN_115: u64 = 528;
pub const CLASS_OMPTEAMSDISTRIBUTESIMDDIRECTIVE: u64 = 529;
pub const CLASS_ABSTRACTCONDITIONALOPERATOR: u64 = 530;
pub const METHOD_GETCOND: u64 = 531;
pub const METHOD_GETTRUEEXPR: u64 = 532;
pub const METHOD_GETFALSEEXPR: u64 = 533;
pub const METHOD_GETQUESTIONLOC: u64 = 534;
pub const METHOD_GETCOLONLOC_1: u64 = 535;
pub const CLASS_BINARYCONDITIONALOPERATOR: u64 = 536;
pub const METHOD_GETCOMMON: u64 = 537;
pub const METHOD_GETOPAQUEVALUE: u64 = 538;
pub const METHOD_GETCOND_1: u64 = 539;
pub const METHOD_GETTRUEEXPR_1: u64 = 540;
pub const METHOD_GETFALSEEXPR_1: u64 = 541;
pub const METHOD_GETBEGINLOC_13: u64 = 542;
pub const METHOD_GETENDLOC_12: u64 = 543;
pub const METHOD_CHILDREN_9: u64 = 544;
pub const CLASS_OMPBARRIERDIRECTIVE: u64 = 545;
pub const CLASS_OMPTASKDIRECTIVE: u64 = 546;
pub const CLASS_SHUFFLEVECTOREXPR: u64 = 547;
pub const METHOD_GETBUILTINLOC_4: u64 = 548;
pub const METHOD_GETRPARENLOC_22: u64 = 549;
pub const METHOD_GETBEGINLOC_115: u64 = 550;
pub const METHOD_GETENDLOC_114: u64 = 551;
pub const METHOD_GETNUMSUBEXPRS_2: u64 = 552;
pub const METHOD_CHILDREN_102: u64 = 553;
pub const CLASS_OMPFORDIRECTIVE: u64 = 554;
pub const CLASS_CONCEPTSPECIALIZATIONEXPR: u64 = 555;
pub const METHOD_GETTEMPLATEARGUMENTS_1: u64 = 556;
pub const METHOD_GETCONCEPTREFERENCE: u64 = 557;
pub const METHOD_GETNAMEDCONCEPT: u64 = 558;
pub const METHOD_HASEXPLICITTEMPLATEARGS_1: u64 = 559;
pub const METHOD_GETCONCEPTNAMELOC: u64 = 560;
pub const METHOD_GETTEMPLATEARGSASWRITTEN_2: u64 = 561;
pub const METHOD_GETNESTEDNAMESPECIFIERLOC: u64 = 562;
pub const METHOD_GETTEMPLATEKWLOC: u64 = 563;
pub const METHOD_GETFOUNDDECL_1: u64 = 564;
pub const METHOD_GETCONCEPTNAMEINFO: u64 = 565;
pub const METHOD_GETSPECIALIZATIONDECL: u64 = 566;
pub const METHOD_ISSATISFIED: u64 = 567;
pub const METHOD_GETSATISFACTION: u64 = 568;
pub const METHOD_GETBEGINLOC_55: u64 = 569;
pub const METHOD_GETENDLOC_54: u64 = 570;
pub const METHOD_GETEXPRLOC_6: u64 = 571;
pub const METHOD_CHILDREN_45: u64 = 572;
pub const CLASS_OMPPARALLELMASKEDTASKLOOPSIMDDIRECTIVE: u64 = 573;
pub const CLASS_GNUNULLEXPR: u64 = 574;
pub const METHOD_GETTOKENLOCATION: u64 = 575;
pub const METHOD_GETBEGINLOC_79: u64 = 576;
pub const METHOD_GETENDLOC_78: u64 = 577;
pub const METHOD_CHILDREN_68: u64 = 578;
pub const CLASS_OBJCBOOLLITERALEXPR: u64 = 579;
pub const CLASS_OMPINTEROPDIRECTIVE: u64 = 580;
pub const CLASS_REQUIRESEXPR: u64 = 581;
pub const METHOD_GETLOCALPARAMETERS: u64 = 582;
pub const METHOD_GETBODY_10: u64 = 583;
pub const METHOD_GETREQUIREMENTS: u64 = 584;
pub const METHOD_ISSATISFIED_1: u64 = 585;
pub const METHOD_GETREQUIRESKWLOC: u64 = 586;
pub const METHOD_GETLPARENLOC_8: u64 = 587;
pub const METHOD_GETRPARENLOC_21: u64 = 588;
pub const METHOD_GETRBRACELOC_5: u64 = 589;
pub const METHOD_GETBEGINLOC_108: u64 = 590;
pub const METHOD_GETENDLOC_107: u64 = 591;
pub const METHOD_CHILDREN_95: u64 = 592;
pub const CLASS_COYIELDEXPR: u64 = 593;
pub const CLASS_CXXDEPENDENTSCOPEMEMBEREXPR: u64 = 594;
pub const METHOD_ISIMPLICITACCESS: u64 = 595;
pub const METHOD_GETBASE_7: u64 = 596;
pub const METHOD_GETBASETYPE_1: u64 = 597;
pub const METHOD_ISARROW: u64 = 598;
pub const METHOD_GETOPERATORLOC_1: u64 = 599;
pub const METHOD_GETQUALIFIER_11: u64 = 600;
pub const METHOD_GETQUALIFIERLOC_8: u64 = 601;
pub const METHOD_GETFIRSTQUALIFIERFOUNDINSCOPE: u64 = 602;
pub const METHOD_GETMEMBERNAMEINFO: u64 = 603;
pub const METHOD_GETMEMBER: u64 = 604;
pub const METHOD_GETMEMBERLOC: u64 = 605;
pub const METHOD_GETTEMPLATEKEYWORDLOC_2: u64 = 606;
pub const METHOD_GETLANGLELOC: u64 = 607;
pub const METHOD_GETRANGLELOC: u64 = 608;
pub const METHOD_HASTEMPLATEKEYWORD: u64 = 609;
pub const METHOD_HASEXPLICITTEMPLATEARGS: u64 = 610;
pub const METHOD_GETTEMPLATEARGS_2: u64 = 611;
pub const METHOD_GETNUMTEMPLATEARGS: u64 = 612;
pub const METHOD_TEMPLATE_ARGUMENTS_2: u64 = 613;
pub const METHOD_GETBEGINLOC_26: u64 = 614;
pub const METHOD_GETENDLOC_25: u64 = 615;
pub const METHOD_CHILDREN_20: u64 = 616;
pub const CLASS_TYPETRAITEXPR: u64 = 617;
pub const METHOD_GETTRAIT_2: u64 = 618;
pub const METHOD_GETVALUE_10: u64 = 619;
pub const METHOD_GETNUMARGS_4: u64 = 620;
pub const METHOD_GETARGS_2: u64 = 621;
pub const METHOD_GETBEGINLOC_124: u64 = 622;
pub const METHOD_GETENDLOC_123: u64 = 623;
pub const METHOD_CHILDREN_111: u64 = 624;
pub const CLASS_CXXNEWEXPR: u64 = 625;
pub const METHOD_GETALLOCATEDTYPE: u64 = 626;
pub const METHOD_GETALLOCATEDTYPESOURCEINFO: u64 = 627;
pub const METHOD_SHOULDNULLCHECKALLOCATION: u64 = 628;
pub const METHOD_GETOPERATORNEW: u64 = 629;
pub const METHOD_GETOPERATORDELETE_2: u64 = 630;
pub const METHOD_ISARRAY: u64 = 631;
pub const METHOD_GETARRAYSIZE_1: u64 = 632;
pub const METHOD_GETNUMPLACEMENTARGS: u64 = 633;
pub const METHOD_ISPARENTYPEID: u64 = 634;
pub const METHOD_GETTYPEIDPARENS: u64 = 635;
pub const METHOD_ISGLOBALNEW: u64 = 636;
pub const METHOD_HASINITIALIZER: u64 = 637;
pub const METHOD_GETINITIALIZATIONSTYLE: u64 = 638;
pub const METHOD_GETINITIALIZER: u64 = 639;
pub const METHOD_GETCONSTRUCTEXPR: u64 = 640;
pub const METHOD_PASSALIGNMENT: u64 = 641;
pub const METHOD_DOESUSUALARRAYDELETEWANTSIZE_1: u64 = 642;
pub const METHOD_PLACEMENT_ARGUMENTS: u64 = 643;
pub const METHOD_PLACEMENT_ARG_BEGIN: u64 = 644;
pub const METHOD_PLACEMENT_ARG_END: u64 = 645;
pub const METHOD_RAW_ARG_BEGIN: u64 = 646;
pub const METHOD_RAW_ARG_END: u64 = 647;
pub const METHOD_GETBEGINLOC_32: u64 = 648;
pub const METHOD_GETENDLOC_31: u64 = 649;
pub const METHOD_GETDIRECTINITRANGE: u64 = 650;
pub const METHOD_GETSOURCERANGE_39: u64 = 651;
pub const METHOD_CHILDREN_24: u64 = 652;
pub const CLASS_CXXINHERITEDCTORINITEXPR: u64 = 653;
pub const METHOD_GETCONSTRUCTOR_1: u64 = 654;
pub const METHOD_CONSTRUCTSVBASE: u64 = 655;
pub const METHOD_GETCONSTRUCTIONKIND_1: u64 = 656;
pub const METHOD_INHERITEDFROMVBASE: u64 = 657;
pub const METHOD_GETLOCATION_3: u64 = 658;
pub const METHOD_GETBEGINLOC_30: u64 = 659;
pub const METHOD_GETENDLOC_29: u64 = 660;
pub const METHOD_CHILDREN_23: u64 = 661;
pub const CLASS_IMPLICITCASTEXPR: u64 = 662;
pub const METHOD_ISPARTOFEXPLICITCAST: u64 = 663;
pub const METHOD_GETBEGINLOC_84: u64 = 664;
pub const METHOD_GETENDLOC_83: u64 = 665;
pub const CLASS_CXXCONSTRUCTEXPR: u64 = 666;
pub const METHOD_GETCONSTRUCTOR: u64 = 667;
pub const METHOD_GETLOCATION_2: u64 = 668;
pub const METHOD_ISELIDABLE: u64 = 669;
pub const METHOD_HADMULTIPLECANDIDATES: u64 = 670;
pub const METHOD_ISLISTINITIALIZATION: u64 = 671;
pub const METHOD_ISSTDINITLISTINITIALIZATION: u64 = 672;
pub const METHOD_REQUIRESZEROINITIALIZATION: u64 = 673;
pub const METHOD_GETCONSTRUCTIONKIND: u64 = 674;
pub const METHOD_ARGUMENTS: u64 = 675;
pub const METHOD_ARG_BEGIN_1: u64 = 676;
pub const METHOD_ARG_END_1: u64 = 677;
pub const METHOD_GETARGS: u64 = 678;
pub const METHOD_GETNUMARGS_1: u64 = 679;
pub const METHOD_ISIMMEDIATEESCALATING_1: u64 = 680;
pub const METHOD_GETBEGINLOC_22: u64 = 681;
pub const METHOD_GETENDLOC_21: u64 = 682;
pub const METHOD_GETPARENORBRACERANGE: u64 = 683;
pub const METHOD_CHILDREN_16: u64 = 684;
pub const CLASS_COMPOUNDLITERALEXPR: u64 = 685;
pub const METHOD_GETINITIALIZER_1: u64 = 686;
pub const METHOD_ISFILESCOPE: u64 = 687;
pub const METHOD_GETLPARENLOC_4: u64 = 688;
pub const METHOD_GETTYPESOURCEINFO_5: u64 = 689;
pub const METHOD_GETBEGINLOC_53: u64 = 690;
pub const METHOD_GETENDLOC_52: u64 = 691;
pub const METHOD_CHILDREN_43: u64 = 692;
pub const CLASS_CXXBINDTEMPORARYEXPR: u64 = 693;
pub const METHOD_GETTEMPORARY: u64 = 694;
pub const METHOD_GETSUBEXPR_1: u64 = 695;
pub const METHOD_GETBEGINLOC_19: u64 = 696;
pub const METHOD_GETENDLOC_18: u64 = 697;
pub const METHOD_CHILDREN_13: u64 = 698;
pub const CLASS_CXXDEFAULTINITEXPR: u64 = 699;
pub const METHOD_HASREWRITTENINIT_1: u64 = 700;
pub const METHOD_GETFIELD: u64 = 701;
pub const METHOD_GETEXPR_1: u64 = 702;
pub const METHOD_GETREWRITTENEXPR_1: u64 = 703;
pub const METHOD_GETUSEDCONTEXT_1: u64 = 704;
pub const METHOD_GETUSEDLOCATION_1: u64 = 705;
pub const METHOD_GETBEGINLOC_24: u64 = 706;
pub const METHOD_GETENDLOC_23: u64 = 707;
pub const METHOD_CHILDREN_18: u64 = 708;
pub const CLASS_CXXDEFAULTARGEXPR: u64 = 709;
pub const METHOD_GETPARAM: u64 = 710;
pub const METHOD_HASREWRITTENINIT: u64 = 711;
pub const METHOD_GETEXPR: u64 = 712;
pub const METHOD_GETREWRITTENEXPR: u64 = 713;
pub const METHOD_GETADJUSTEDREWRITTENEXPR: u64 = 714;
pub const METHOD_GETUSEDCONTEXT: u64 = 715;
pub const METHOD_GETUSEDLOCATION: u64 = 716;
pub const METHOD_GETBEGINLOC_23: u64 = 717;
pub const METHOD_GETENDLOC_22: u64 = 718;
pub const METHOD_GETEXPRLOC_2: u64 = 719;
pub const METHOD_CHILDREN_17: u64 = 720;
pub const CLASS_OMPSECTIONDIRECTIVE: u64 = 721;
pub const CLASS_CXXTHROWEXPR: u64 = 722;
pub const METHOD_GETSUBEXPR_3: u64 = 723;
pub const METHOD_GETTHROWLOC: u64 = 724;
pub const METHOD_ISTHROWNVARIABLEINSCOPE: u64 = 725;
pub const METHOD_GETBEGINLOC_43: u64 = 726;
pub const METHOD_GETENDLOC_42: u64 = 727;
pub const METHOD_CHILDREN_32: u64 = 728;
pub const CLASS_MSPROPERTYSUBSCRIPTEXPR: u64 = 729;
pub const METHOD_GETBASE_4: u64 = 730;
pub const METHOD_GETIDX_1: u64 = 731;
pub const METHOD_GETBEGINLOC_94: u64 = 732;
pub const METHOD_GETENDLOC_93: u64 = 733;
pub const METHOD_GETRBRACKETLOC_3: u64 = 734;
pub const METHOD_GETEXPRLOC_7: u64 = 735;
pub const METHOD_CHILDREN_82: u64 = 736;
pub const CLASS_CXXREWRITTENBINARYOPERATOR: u64 = 737;
pub const METHOD_GETSEMANTICFORM: u64 = 738;
pub const METHOD_GETDECOMPOSEDFORM: u64 = 739;
pub const METHOD_ISREVERSED: u64 = 740;
pub const METHOD_GETOPERATOR_2: u64 = 741;
pub const METHOD_GETOPCODE_1: u64 = 742;
pub const METHOD_GETOPCODESTR_1: u64 = 743;
pub const METHOD_ISCOMPARISONOP_2: u64 = 744;
pub const METHOD_ISASSIGNMENTOP_2: u64 = 745;
pub const METHOD_GETLHS_3: u64 = 746;
pub const METHOD_GETRHS_3: u64 = 747;
pub const METHOD_GETOPERATORLOC_5: u64 = 748;
pub const METHOD_GETEXPRLOC_5: u64 = 749;
pub const METHOD_GETBEGINLOC_38: u64 = 750;
pub const METHOD_GETENDLOC_37: u64 = 751;
pub const METHOD_GETSOURCERANGE_43: u64 = 752;
pub const CLASS_PSEUDOOBJECTEXPR: u64 = 753;
pub const METHOD_GETSYNTACTICFORM_1: u64 = 754;
pub const METHOD_GETRESULTEXPRINDEX: u64 = 755;
pub const METHOD_GETRESULTEXPR_1: u64 = 756;
pub const METHOD_GETNUMSEMANTICEXPRS: u64 = 757;
pub const METHOD_SEMANTICS_BEGIN: u64 = 758;
pub const METHOD_SEMANTICS_END: u64 = 759;
pub const METHOD_SEMANTICS: u64 = 760;
pub const METHOD_GETEXPRLOC_11: u64 = 761;
pub const METHOD_GETBEGINLOC_106: u64 = 762;
pub const METHOD_GETENDLOC_105: u64 = 763;
pub const METHOD_CHILDREN_94: u64 = 764;
pub const CLASS_PARENEXPR: u64 = 765;
pub const METHOD_GETSUBEXPR_8: u64 = 766;
pub const METHOD_GETBEGINLOC_103: u64 = 767;
pub const METHOD_GETENDLOC_102: u64 = 768;
pub const METHOD_GETLPAREN: u64 = 769;
pub const METHOD_GETRPAREN: u64 = 770;
pub const METHOD_CHILDREN_91: u64 = 771;
pub const CLASS_EXTVECTORELEMENTEXPR: u64 = 772;
pub const METHOD_GETBASE_3: u64 = 773;
pub const METHOD_GETACCESSOR: u64 = 774;
pub const METHOD_GETACCESSORLOC: u64 = 775;
pub const METHOD_GETNUMELEMENTS_1: u64 = 776;
pub const METHOD_CONTAINSDUPLICATEELEMENTS: u64 = 777;
pub const METHOD_GETBEGINLOC_73: u64 = 778;
pub const METHOD_GETENDLOC_72: u64 = 779;
pub const METHOD_ISARROW_2: u64 = 780;
pub const METHOD_CHILDREN_63: u64 = 781;
pub const CLASS_GENERICSELECTIONEXPR: u64 = 782;
pub const METHOD_GETNUMASSOCS: u64 = 783;
pub const METHOD_GETRESULTINDEX: u64 = 784;
pub const METHOD_ISRESULTDEPENDENT: u64 = 785;
pub const METHOD_ISEXPRPREDICATE: u64 = 786;
pub const METHOD_ISTYPEPREDICATE: u64 = 787;
pub const METHOD_GETCONTROLLINGEXPR: u64 = 788;
pub const METHOD_GETCONTROLLINGTYPE: u64 = 789;
pub const METHOD_GETRESULTEXPR: u64 = 790;
pub const METHOD_GETASSOCEXPRS: u64 = 791;
pub const METHOD_GETASSOCTYPESOURCEINFOS: u64 = 792;
pub const METHOD_ASSOCIATIONS: u64 = 793;
pub const METHOD_GETGENERICLOC: u64 = 794;
pub const METHOD_GETDEFAULTLOC_2: u64 = 795;
pub const METHOD_GETRPARENLOC_17: u64 = 796;
pub const METHOD_GETBEGINLOC_80: u64 = 797;
pub const METHOD_GETENDLOC_79: u64 = 798;
pub const METHOD_CHILDREN_69: u64 = 799;
pub const CLASS_IMPLICITVALUEINITEXPR: u64 = 800;
pub const METHOD_GETBEGINLOC_85: u64 = 801;
pub const METHOD_GETENDLOC_84: u64 = 802;
pub const METHOD_CHILDREN_73: u64 = 803;
pub const CLASS_NOINITEXPR: u64 = 804;
pub const METHOD_GETBEGINLOC_98: u64 = 805;
pub const METHOD_GETENDLOC_97: u64 = 806;
pub const METHOD_CHILDREN_86: u64 = 807;
pub const CLASS_ARRAYINITINDEXEXPR: u64 = 808;
pub const METHOD_GETBEGINLOC_5: u64 = 809;
pub const METHOD_GETENDLOC_4: u64 = 810;
pub const METHOD_CHILDREN_1: u64 = 811;
pub const CLASS_DESIGNATEDINITEXPR: u64 = 812;
pub const METHOD_SIZE_1: u64 = 813;
pub const METHOD_DESIGNATORS: u64 = 814;
pub const METHOD_GETEQUALORCOLONLOC: u64 = 815;
pub const METHOD_ISDIRECTINIT_1: u64 = 816;
pub const METHOD_USESGNUSYNTAX: u64 = 817;
pub const METHOD_GETINIT_3: u64 = 818;
pub const METHOD_GETNUMSUBEXPRS_1: u64 = 819;
pub const METHOD_GETDESIGNATORSSOURCERANGE: u64 = 820;
pub const METHOD_GETBEGINLOC_68: u64 = 821;
pub const METHOD_GETENDLOC_67: u64 = 822;
pub const METHOD_CHILDREN_58: u64 = 823;
pub const CLASS_CONVERTVECTOREXPR: u64 = 824;
pub const METHOD_GETSRCEXPR_1: u64 = 825;
pub const METHOD_GETTYPESOURCEINFO_6: u64 = 826;
pub const METHOD_GETBUILTINLOC_3: u64 = 827;
pub const METHOD_GETRPARENLOC_13: u64 = 828;
pub const METHOD_GETBEGINLOC_59: u64 = 829;
pub const METHOD_GETENDLOC_58: u64 = 830;
pub const METHOD_CHILDREN_49: u64 = 831;
pub const CLASS_STMTEXPR: u64 = 832;
pub const METHOD_GETSUBSTMT_5: u64 = 833;
pub const METHOD_GETBEGINLOC_118: u64 = 834;
pub const METHOD_GETENDLOC_117: u64 = 835;
pub const METHOD_GETLPARENLOC_9: u64 = 836;
pub const METHOD_GETRPARENLOC_24: u64 = 837;
pub const METHOD_GETTEMPLATEDEPTH_1: u64 = 838;
pub const METHOD_CHILDREN_106: u64 = 839;
pub const CLASS_CONDITIONALOPERATOR: u64 = 840;
pub const METHOD_GETCOND_4: u64 = 841;
pub const METHOD_GETTRUEEXPR_2: u64 = 842;
pub const METHOD_GETFALSEEXPR_2: u64 = 843;
pub const METHOD_GETLHS_6: u64 = 844;
pub const METHOD_GETRHS_6: u64 = 845;
pub const METHOD_GETBEGINLOC_56: u64 = 846;
pub const METHOD_GETENDLOC_55: u64 = 847;
pub const METHOD_CHILDREN_46: u64 = 848;
pub const CLASS_BINARYOPERATOR: u64 = 849;
pub const METHOD_GETEXPRLOC_1: u64 = 850;
pub const METHOD_GETOPERATORLOC: u64 = 851;
pub const METHOD_GETOPCODE: u64 = 852;
pub const METHOD_GETLHS_1: u64 = 853;
pub const METHOD_GETRHS_1: u64 = 854;
pub const METHOD_GETBEGINLOC_14: u64 = 855;
pub const METHOD_GETENDLOC_13: u64 = 856;
pub const METHOD_GETOPCODESTR: u64 = 857;
pub const METHOD_ISPTRMEMOP: u64 = 858;
pub const METHOD_ISMULTIPLICATIVEOP: u64 = 859;
pub const METHOD_ISADDITIVEOP: u64 = 860;
pub const METHOD_ISSHIFTOP: u64 = 861;
pub const METHOD_ISBITWISEOP: u64 = 862;
pub const METHOD_ISRELATIONALOP: u64 = 863;
pub const METHOD_ISEQUALITYOP: u64 = 864;
pub const METHOD_ISCOMPARISONOP: u64 = 865;
pub const METHOD_ISCOMMAOP: u64 = 866;
pub const METHOD_ISLOGICALOP: u64 = 867;
pub const METHOD_ISASSIGNMENTOP: u64 = 868;
pub const METHOD_ISCOMPOUNDASSIGNMENTOP: u64 = 869;
pub const METHOD_ISSHIFTASSIGNOP: u64 = 870;
pub const METHOD_CHILDREN_10: u64 = 871;
pub const METHOD_HASSTOREDFPFEATURES: u64 = 872;
pub const METHOD_GETSTOREDFPFEATURES: u64 = 873;
pub const METHOD_GETFPFEATURES: u64 = 874;
pub const CLASS_CXXNAMEDCASTEXPR: u64 = 875;
pub const METHOD_GETCASTNAME: u64 = 876;
pub const METHOD_GETOPERATORLOC_2: u64 = 877;
pub const METHOD_GETRPARENLOC_8: u64 = 878;
pub const METHOD_GETBEGINLOC_31: u64 = 879;
pub const METHOD_GETENDLOC_30: u64 = 880;
pub const METHOD_GETANGLEBRACKETS: u64 = 881;
pub const CLASS_UNARYOPERATOR: u64 = 882;
pub const METHOD_GETOPCODE_2: u64 = 883;
pub const METHOD_GETSUBEXPR_9: u64 = 884;
pub const METHOD_GETOPERATORLOC_10: u64 = 885;
pub const METHOD_CANOVERFLOW: u64 = 886;
pub const METHOD_ISPREFIX: u64 = 887;
pub const METHOD_ISPOSTFIX: u64 = 888;
pub const METHOD_ISINCREMENTOP: u64 = 889;
pub const METHOD_ISDECREMENTOP: u64 = 890;
pub const METHOD_ISINCREMENTDECREMENTOP: u64 = 891;
pub const METHOD_ISARITHMETICOP: u64 = 892;
pub const METHOD_GETBEGINLOC_127: u64 = 893;
pub const METHOD_GETENDLOC_126: u64 = 894;
pub const METHOD_GETEXPRLOC_12: u64 = 895;
pub const METHOD_CHILDREN_114: u64 = 896;
pub const METHOD_HASSTOREDFPFEATURES_4: u64 = 897;
pub const METHOD_GETSTOREDFPFEATURES_4: u64 = 898;
pub const METHOD_GETFPOPTIONSOVERRIDE: u64 = 899;
pub const CLASS_CXXDYNAMICCASTEXPR: u64 = 900;
pub const METHOD_ISALWAYSNULL: u64 = 901;
pub const CLASS_CXXSTATICCASTEXPR: u64 = 902;
pub const CLASS_MEMBEREXPR: u64 = 903;
pub const METHOD_GETBASE_6: u64 = 904;
pub const METHOD_GETMEMBERDECL: u64 = 905;
pub const METHOD_GETFOUNDDECL_3: u64 = 906;
pub const METHOD_HASQUALIFIER_2: u64 = 907;
pub const METHOD_GETQUALIFIERLOC_14: u64 = 908;
pub const METHOD_GETQUALIFIER_15: u64 = 909;
pub const METHOD_GETTEMPLATEKEYWORDLOC_5: u64 = 910;
pub const METHOD_GETLANGLELOC_3: u64 = 911;
pub const METHOD_GETRANGLELOC_3: u64 = 912;
pub const METHOD_HASTEMPLATEKEYWORD_3: u64 = 913;
pub const METHOD_HASEXPLICITTEMPLATEARGS_4: u64 = 914;
pub const METHOD_GETTEMPLATEARGS_5: u64 = 915;
pub const METHOD_GETNUMTEMPLATEARGS_3: u64 = 916;
pub const METHOD_TEMPLATE_ARGUMENTS_5: u64 = 917;
pub const METHOD_GETMEMBERNAMEINFO_1: u64 = 918;
pub const METHOD_GETOPERATORLOC_6: u64 = 919;
pub const METHOD_ISARROW_4: u64 = 920;
pub const METHOD_GETMEMBERLOC_2: u64 = 921;
pub const METHOD_GETBEGINLOC_97: u64 = 922;
pub const METHOD_GETENDLOC_96: u64 = 923;
pub const METHOD_GETEXPRLOC_9: u64 = 924;
pub const METHOD_ISIMPLICITACCESS_2: u64 = 925;
pub const METHOD_HADMULTIPLECANDIDATES_2: u64 = 926;
pub const METHOD_ISNONODRUSE_1: u64 = 927;
pub const METHOD_CHILDREN_85: u64 = 928;
pub const CLASS_UNARYEXPRORTYPETRAITEXPR: u64 = 929;
pub const METHOD_GETKIND_5: u64 = 930;
pub const METHOD_ISARGUMENTTYPE: u64 = 931;
pub const METHOD_GETARGUMENTTYPE: u64 = 932;
pub const METHOD_GETARGUMENTTYPEINFO: u64 = 933;
pub const METHOD_GETARGUMENTEXPR: u64 = 934;
pub const METHOD_GETTYPEOFARGUMENT: u64 = 935;
pub const METHOD_GETOPERATORLOC_9: u64 = 936;
pub const METHOD_GETRPARENLOC_26: u64 = 937;
pub const METHOD_GETBEGINLOC_126: u64 = 938;
pub const METHOD_GETENDLOC_125: u64 = 939;
pub const METHOD_CHILDREN_113: u64 = 940;
pub const CLASS_OFFSETOFEXPR: u64 = 941;
pub const METHOD_GETOPERATORLOC_7: u64 = 942;
pub const METHOD_GETRPARENLOC_19: u64 = 943;
pub const METHOD_GETTYPESOURCEINFO_7: u64 = 944;
pub const METHOD_GETNUMCOMPONENTS: u64 = 945;
pub const METHOD_GETNUMEXPRESSIONS: u64 = 946;
pub const METHOD_GETBEGINLOC_100: u64 = 947;
pub const METHOD_GETENDLOC_99: u64 = 948;
pub const METHOD_CHILDREN_88: u64 = 949;
pub const CLASS_PREDEFINEDEXPR: u64 = 950;
pub const METHOD_GETIDENTKIND: u64 = 951;
pub const METHOD_ISTRANSPARENT_1: u64 = 952;
pub const METHOD_GETLOCATION_13: u64 = 953;
pub const METHOD_GETFUNCTIONNAME: u64 = 954;
pub const METHOD_GETIDENTKINDNAME: u64 = 955;
pub const METHOD_GETBEGINLOC_105: u64 = 956;
pub const METHOD_GETENDLOC_104: u64 = 957;
pub const METHOD_CHILDREN_93: u64 = 958;
pub const CLASS_OPAQUEVALUEEXPR: u64 = 959;
pub const METHOD_GETLOCATION_12: u64 = 960;
pub const METHOD_GETBEGINLOC_101: u64 = 961;
pub const METHOD_GETENDLOC_100: u64 = 962;
pub const METHOD_GETEXPRLOC_10: u64 = 963;
pub const METHOD_CHILDREN_89: u64 = 964;
pub const METHOD_GETSOURCEEXPR: u64 = 965;
pub const METHOD_ISUNIQUE: u64 = 966;
pub const CLASS_SWITCHCASE: u64 = 967;
pub const METHOD_GETNEXTSWITCHCASE: u64 = 968;
pub const METHOD_GETKEYWORDLOC_4: u64 = 969;
pub const METHOD_GETCOLONLOC_3: u64 = 970;
pub const METHOD_GETSUBSTMT_6: u64 = 971;
pub const METHOD_GETBEGINLOC_122: u64 = 972;
pub const METHOD_GETENDLOC_121: u64 = 973;
pub const CLASS_COMPOUNDSTMT: u64 = 974;
pub const METHOD_BODY_EMPTY: u64 = 975;
pub const METHOD_SIZE: u64 = 976;
pub const METHOD_HASSTOREDFPFEATURES_3: u64 = 977;
pub const METHOD_GETSTOREDFPFEATURES_3: u64 = 978;
pub const METHOD_BODY: u64 = 979;
pub const METHOD_BODY_BEGIN: u64 = 980;
pub const METHOD_BODY_END: u64 = 981;
pub const METHOD_BODY_FRONT: u64 = 982;
pub const METHOD_BODY_BACK: u64 = 983;
pub const METHOD_BODY_RBEGIN: u64 = 984;
pub const METHOD_BODY_REND: u64 = 985;
pub const METHOD_GETSTMTEXPRRESULT: u64 = 986;
pub const METHOD_GETBEGINLOC_54: u64 = 987;
pub const METHOD_GETENDLOC_53: u64 = 988;
pub const METHOD_GETLBRACLOC: u64 = 989;
pub const METHOD_GETRBRACLOC: u64 = 990;
pub const METHOD_CHILDREN_44: u64 = 991;
pub const CLASS_OBJCSELECTOREXPR: u64 = 992;
pub const CLASS_NULLSTMT: u64 = 993;
pub const METHOD_GETSEMILOC: u64 = 994;
pub const METHOD_HASLEADINGEMPTYMACRO: u64 = 995;
pub const METHOD_GETBEGINLOC_99: u64 = 996;
pub const METHOD_GETENDLOC_98: u64 = 997;
pub const METHOD_CHILDREN_87: u64 = 998;
pub const CLASS_DECLSTMT: u64 = 999;
pub const METHOD_ISSINGLEDECL: u64 = 1000;
pub const METHOD_GETSINGLEDECL: u64 = 1001;
pub const METHOD_GETDECLGROUP: u64 = 1002;
pub const METHOD_GETENDLOC_63: u64 = 1003;
pub const METHOD_GETBEGINLOC_64: u64 = 1004;
pub const METHOD_CHILDREN_54: u64 = 1005;
pub const METHOD_DECLS: u64 = 1006;
pub const METHOD_DECL_BEGIN: u64 = 1007;
pub const METHOD_DECL_END: u64 = 1008;
pub const CLASS_RECORDDECL: u64 = 1009;
pub const METHOD_GETPREVIOUSDECL_5: u64 = 1010;
pub const METHOD_GETMOSTRECENTDECL_7: u64 = 1011;
pub const METHOD_HASFLEXIBLEARRAYMEMBER: u64 = 1012;
pub const METHOD_ISANONYMOUSSTRUCTORUNION_1: u64 = 1013;
pub const METHOD_HASOBJECTMEMBER: u64 = 1014;
pub const METHOD_HASVOLATILEMEMBER: u64 = 1015;
pub const METHOD_HASLOADEDFIELDSFROMEXTERNALSTORAGE: u64 = 1016;
pub const METHOD_ISNONTRIVIALTOPRIMITIVEDEFAULTINITIALIZE: u64 = 1017;
pub const METHOD_ISNONTRIVIALTOPRIMITIVECOPY: u64 = 1018;
pub const METHOD_ISNONTRIVIALTOPRIMITIVEDESTROY: u64 = 1019;
pub const METHOD_HASNONTRIVIALTOPRIMITIVEDEFAULTINITIALIZECUNION: u64 = 1020;
pub const METHOD_HASNONTRIVIALTOPRIMITIVEDESTRUCTCUNION: u64 = 1021;
pub const METHOD_HASNONTRIVIALTOPRIMITIVECOPYCUNION: u64 = 1022;
pub const METHOD_CANPASSINREGISTERS: u64 = 1023;
pub const METHOD_GETARGPASSINGRESTRICTIONS: u64 = 1024;
pub const METHOD_ISPARAMDESTROYEDINCALLEE: u64 = 1025;
pub const METHOD_ISRANDOMIZED: u64 = 1026;
pub const METHOD_ISINJECTEDCLASSNAME: u64 = 1027;
pub const METHOD_ISLAMBDA_1: u64 = 1028;
pub const METHOD_ISCAPTUREDRECORD: u64 = 1029;
pub const METHOD_GETDEFINITION_3: u64 = 1030;
pub const METHOD_ISORCONTAINSUNION: u64 = 1031;
pub const METHOD_FIELDS: u64 = 1032;
pub const METHOD_FIELD_BEGIN: u64 = 1033;
pub const METHOD_FIELD_END: u64 = 1034;
pub const METHOD_FIELD_EMPTY: u64 = 1035;
pub const METHOD_FINDFIRSTNAMEDDATAMEMBER: u64 = 1036;
pub const CLASS_TAGDECL: u64 = 1037;
pub const METHOD_GETBRACERANGE: u64 = 1038;
pub const METHOD_GETINNERLOCSTART_1: u64 = 1039;
pub const METHOD_GETOUTERLOCSTART_1: u64 = 1040;
pub const METHOD_GETSOURCERANGE_23: u64 = 1041;
pub const METHOD_GETCANONICALDECL_17: u64 = 1042;
pub const METHOD_ISTHISDECLARATIONADEFINITION_3: u64 = 1043;
pub const METHOD_ISCOMPLETEDEFINITION: u64 = 1044;
pub const METHOD_ISCOMPLETEDEFINITIONREQUIRED: u64 = 1045;
pub const METHOD_ISBEINGDEFINED_1: u64 = 1046;
pub const METHOD_ISEMBEDDEDINDECLARATOR: u64 = 1047;
pub const METHOD_ISFREESTANDING: u64 = 1048;
pub const METHOD_MAYHAVEOUTOFDATEDEF: u64 = 1049;
pub const METHOD_ISDEPENDENTTYPE: u64 = 1050;
pub const METHOD_ISTHISDECLARATIONADEMOTEDDEFINITION: u64 = 1051;
pub const METHOD_GETDEFINITION_4: u64 = 1052;
pub const METHOD_GETKINDNAME: u64 = 1053;
pub const METHOD_GETTAGKIND: u64 = 1054;
pub const METHOD_ISSTRUCT: u64 = 1055;
pub const METHOD_ISINTERFACE: u64 = 1056;
pub const METHOD_ISCLASS: u64 = 1057;
pub const METHOD_ISUNION: u64 = 1058;
pub const METHOD_ISENUM: u64 = 1059;
pub const METHOD_HASNAMEFORLINKAGE: u64 = 1060;
pub const METHOD_GETTYPEDEFNAMEFORANONDECL: u64 = 1061;
pub const METHOD_GETQUALIFIER_5: u64 = 1062;
pub const METHOD_GETQUALIFIERLOC_2: u64 = 1063;
pub const METHOD_GETNUMTEMPLATEPARAMETERLISTS_1: u64 = 1064;
pub const CLASS_HLSLBUFFERDECL: u64 = 1065;
pub const METHOD_GETSOURCERANGE_14: u64 = 1066;
pub const METHOD_GETLOCSTART: u64 = 1067;
pub const METHOD_GETLBRACELOC: u64 = 1068;
pub const METHOD_GETRBRACELOC_1: u64 = 1069;
pub const METHOD_ISCBUFFER: u64 = 1070;
pub const CLASS_BUILTINBITCASTEXPR: u64 = 1071;
pub const METHOD_GETBEGINLOC_17: u64 = 1072;
pub const METHOD_GETENDLOC_16: u64 = 1073;
pub const CLASS_CONSTRUCTORUSINGSHADOWDECL: u64 = 1074;
pub const METHOD_GETINTRODUCER: u64 = 1075;
pub const METHOD_GETPARENT_1: u64 = 1076;
pub const METHOD_GETNOMINATEDBASECLASSSHADOWDECL: u64 = 1077;
pub const METHOD_GETCONSTRUCTEDBASECLASSSHADOWDECL: u64 = 1078;
pub const METHOD_GETNOMINATEDBASECLASS: u64 = 1079;
pub const METHOD_GETCONSTRUCTEDBASECLASS: u64 = 1080;
pub const METHOD_CONSTRUCTSVIRTUALBASE: u64 = 1081;
pub const CLASS_USINGSHADOWDECL: u64 = 1082;
pub const METHOD_GETCANONICALDECL_26: u64 = 1083;
pub const METHOD_GETTARGETDECL: u64 = 1084;
pub const METHOD_GETINTRODUCER_1: u64 = 1085;
pub const METHOD_GETNEXTUSINGSHADOWDECL: u64 = 1086;
pub const CLASS_USINGDECL: u64 = 1087;
pub const METHOD_GETUSINGLOC_2: u64 = 1088;
pub const METHOD_GETQUALIFIERLOC_5: u64 = 1089;
pub const METHOD_GETQUALIFIER_8: u64 = 1090;
pub const METHOD_GETNAMEINFO_3: u64 = 1091;
pub const METHOD_ISACCESSDECLARATION_1: u64 = 1092;
pub const METHOD_HASTYPENAME: u64 = 1093;
pub const METHOD_GETSOURCERANGE_32: u64 = 1094;
pub const METHOD_GETCANONICALDECL_23: u64 = 1095;
pub const CLASS_INDIRECTGOTOSTMT: u64 = 1096;
pub const METHOD_GETGOTOLOC_1: u64 = 1097;
pub const METHOD_GETSTARLOC: u64 = 1098;
pub const METHOD_GETTARGET: u64 = 1099;
pub const METHOD_GETCONSTANTTARGET: u64 = 1100;
pub const METHOD_GETBEGINLOC_86: u64 = 1101;
pub const METHOD_GETENDLOC_85: u64 = 1102;
pub const METHOD_CHILDREN_74: u64 = 1103;
pub const CLASS_CXXRECORDDECL: u64 = 1104;
pub const METHOD_GETCANONICALDECL_4: u64 = 1105;
pub const METHOD_GETPREVIOUSDECL: u64 = 1106;
pub const METHOD_GETMOSTRECENTDECL_1: u64 = 1107;
pub const METHOD_GETMOSTRECENTNONINJECTEDDECL: u64 = 1108;
pub const METHOD_GETDEFINITION: u64 = 1109;
pub const METHOD_HASDEFINITION: u64 = 1110;
pub const METHOD_ISDYNAMICCLASS: u64 = 1111;
pub const METHOD_MAYBEDYNAMICCLASS: u64 = 1112;
pub const METHOD_MAYBENONDYNAMICCLASS: u64 = 1113;
pub const METHOD_ISPARSINGBASESPECIFIERS: u64 = 1114;
pub const METHOD_GETODRHASH: u64 = 1115;
pub const METHOD_GETNUMBASES: u64 = 1116;
pub const METHOD_BASES: u64 = 1117;
pub const METHOD_BASES_BEGIN: u64 = 1118;
pub const METHOD_BASES_END: u64 = 1119;
pub const METHOD_GETNUMVBASES: u64 = 1120;
pub const METHOD_VBASES: u64 = 1121;
pub const METHOD_VBASES_BEGIN: u64 = 1122;
pub const METHOD_VBASES_END: u64 = 1123;
pub const METHOD_HASANYDEPENDENTBASES: u64 = 1124;
pub const METHOD_METHODS: u64 = 1125;
pub const METHOD_METHOD_BEGIN: u64 = 1126;
pub const METHOD_METHOD_END: u64 = 1127;
pub const METHOD_CTORS: u64 = 1128;
pub const METHOD_CTOR_BEGIN: u64 = 1129;
pub const METHOD_CTOR_END: u64 = 1130;
pub const METHOD_FRIENDS: u64 = 1131;
pub const METHOD_FRIEND_BEGIN: u64 = 1132;
pub const METHOD_FRIEND_END: u64 = 1133;
pub const METHOD_HASFRIENDS: u64 = 1134;
pub const METHOD_DEFAULTEDCOPYCONSTRUCTORISDELETED: u64 = 1135;
pub const METHOD_DEFAULTEDMOVECONSTRUCTORISDELETED: u64 = 1136;
pub const METHOD_DEFAULTEDDESTRUCTORISDELETED: u64 = 1137;
pub const METHOD_HASSIMPLECOPYCONSTRUCTOR: u64 = 1138;
pub const METHOD_HASSIMPLEMOVECONSTRUCTOR: u64 = 1139;
pub const METHOD_HASSIMPLECOPYASSIGNMENT: u64 = 1140;
pub const METHOD_HASSIMPLEMOVEASSIGNMENT: u64 = 1141;
pub const METHOD_HASSIMPLEDESTRUCTOR: u64 = 1142;
pub const METHOD_HASDEFAULTCONSTRUCTOR: u64 = 1143;
pub const METHOD_NEEDSIMPLICITDEFAULTCONSTRUCTOR: u64 = 1144;
pub const METHOD_HASUSERDECLAREDCONSTRUCTOR: u64 = 1145;
pub const METHOD_HASUSERPROVIDEDDEFAULTCONSTRUCTOR: u64 = 1146;
pub const METHOD_HASUSERDECLAREDCOPYCONSTRUCTOR: u64 = 1147;
pub const METHOD_NEEDSIMPLICITCOPYCONSTRUCTOR: u64 = 1148;
pub const METHOD_NEEDSOVERLOADRESOLUTIONFORCOPYCONSTRUCTOR: u64 = 1149;
pub const METHOD_IMPLICITCOPYCONSTRUCTORHASCONSTPARAM: u64 = 1150;
pub const METHOD_HASCOPYCONSTRUCTORWITHCONSTPARAM: u64 = 1151;
pub const METHOD_HASUSERDECLAREDMOVEOPERATION: u64 = 1152;
pub const METHOD_HASUSERDECLAREDMOVECONSTRUCTOR: u64 = 1153;
pub const METHOD_HASMOVECONSTRUCTOR: u64 = 1154;
pub const METHOD_NEEDSIMPLICITMOVECONSTRUCTOR: u64 = 1155;
pub const METHOD_NEEDSOVERLOADRESOLUTIONFORMOVECONSTRUCTOR: u64 = 1156;
pub const METHOD_HASUSERDECLAREDCOPYASSIGNMENT: u64 = 1157;
pub const METHOD_NEEDSIMPLICITCOPYASSIGNMENT: u64 = 1158;
pub const METHOD_NEEDSOVERLOADRESOLUTIONFORCOPYASSIGNMENT: u64 = 1159;
pub const METHOD_IMPLICITCOPYASSIGNMENTHASCONSTPARAM: u64 = 1160;
pub const METHOD_HASCOPYASSIGNMENTWITHCONSTPARAM: u64 = 1161;
pub const METHOD_HASUSERDECLAREDMOVEASSIGNMENT: u64 = 1162;
pub const METHOD_HASMOVEASSIGNMENT: u64 = 1163;
pub const METHOD_NEEDSIMPLICITMOVEASSIGNMENT: u64 = 1164;
pub const METHOD_NEEDSOVERLOADRESOLUTIONFORMOVEASSIGNMENT: u64 = 1165;
pub const METHOD_HASUSERDECLAREDDESTRUCTOR: u64 = 1166;
pub const METHOD_NEEDSIMPLICITDESTRUCTOR: u64 = 1167;
pub const METHOD_NEEDSOVERLOADRESOLUTIONFORDESTRUCTOR: u64 = 1168;
pub const METHOD_ISLAMBDA: u64 = 1169;
pub const METHOD_ISGENERICLAMBDA: u64 = 1170;
pub const METHOD_LAMBDAISDEFAULTCONSTRUCTIBLEANDASSIGNABLE: u64 = 1171;
pub const METHOD_GETLAMBDACALLOPERATOR: u64 = 1172;
pub const METHOD_GETDEPENDENTLAMBDACALLOPERATOR: u64 = 1173;
pub const METHOD_GETLAMBDASTATICINVOKER: u64 = 1174;
pub const METHOD_GETGENERICLAMBDATEMPLATEPARAMETERLIST: u64 = 1175;
pub const METHOD_GETLAMBDAEXPLICITTEMPLATEPARAMETERS: u64 = 1176;
pub const METHOD_GETLAMBDACAPTUREDEFAULT: u64 = 1177;
pub const METHOD_ISCAPTURELESSLAMBDA: u64 = 1178;
pub const METHOD_CAPTURES_1: u64 = 1179;
pub const METHOD_CAPTURES_BEGIN: u64 = 1180;
pub const METHOD_CAPTURES_END: u64 = 1181;
pub const METHOD_CAPTURE_SIZE_2: u64 = 1182;
pub const METHOD_CONVERSION_BEGIN: u64 = 1183;
pub const METHOD_CONVERSION_END: u64 = 1184;
pub const METHOD_GETVISIBLECONVERSIONFUNCTIONS: u64 = 1185;
pub const METHOD_ISAGGREGATE: u64 = 1186;
pub const METHOD_HASINCLASSINITIALIZER: u64 = 1187;
pub const METHOD_HASUNINITIALIZEDREFERENCEMEMBER: u64 = 1188;
pub const METHOD_ISPOD: u64 = 1189;
pub const METHOD_ISCLIKE: u64 = 1190;
pub const METHOD_ISEMPTY: u64 = 1191;
pub const METHOD_HASINITMETHOD: u64 = 1192;
pub const METHOD_HASPRIVATEFIELDS: u64 = 1193;
pub const METHOD_HASPROTECTEDFIELDS: u64 = 1194;
pub const METHOD_HASDIRECTFIELDS: u64 = 1195;
pub const METHOD_ISPOLYMORPHIC: u64 = 1196;
pub const METHOD_ISABSTRACT: u64 = 1197;
pub const METHOD_ISSTANDARDLAYOUT: u64 = 1198;
pub const METHOD_ISCXX11STANDARDLAYOUT: u64 = 1199;
pub const METHOD_HASMUTABLEFIELDS: u64 = 1200;
pub const METHOD_HASVARIANTMEMBERS: u64 = 1201;
pub const METHOD_HASTRIVIALDEFAULTCONSTRUCTOR: u64 = 1202;
pub const METHOD_HASNONTRIVIALDEFAULTCONSTRUCTOR: u64 = 1203;
pub const METHOD_HASCONSTEXPRNONCOPYMOVECONSTRUCTOR: u64 = 1204;
pub const METHOD_DEFAULTEDDEFAULTCONSTRUCTORISCONSTEXPR: u64 = 1205;
pub const METHOD_HASCONSTEXPRDEFAULTCONSTRUCTOR: u64 = 1206;
pub const METHOD_HASTRIVIALCOPYCONSTRUCTOR: u64 = 1207;
pub const METHOD_HASTRIVIALCOPYCONSTRUCTORFORCALL: u64 = 1208;
pub const METHOD_HASNONTRIVIALCOPYCONSTRUCTOR: u64 = 1209;
pub const METHOD_HASNONTRIVIALCOPYCONSTRUCTORFORCALL: u64 = 1210;
pub const METHOD_HASTRIVIALMOVECONSTRUCTOR: u64 = 1211;
pub const METHOD_HASTRIVIALMOVECONSTRUCTORFORCALL: u64 = 1212;
pub const METHOD_HASNONTRIVIALMOVECONSTRUCTOR: u64 = 1213;
pub const METHOD_HASNONTRIVIALMOVECONSTRUCTORFORCALL: u64 = 1214;
pub const METHOD_HASTRIVIALCOPYASSIGNMENT: u64 = 1215;
pub const METHOD_HASNONTRIVIALCOPYASSIGNMENT: u64 = 1216;
pub const METHOD_HASTRIVIALMOVEASSIGNMENT: u64 = 1217;
pub const METHOD_HASNONTRIVIALMOVEASSIGNMENT: u64 = 1218;
pub const METHOD_DEFAULTEDDESTRUCTORISCONSTEXPR: u64 = 1219;
pub const METHOD_HASCONSTEXPRDESTRUCTOR: u64 = 1220;
pub const METHOD_HASTRIVIALDESTRUCTOR: u64 = 1221;
pub const METHOD_HASTRIVIALDESTRUCTORFORCALL: u64 = 1222;
pub const METHOD_HASNONTRIVIALDESTRUCTOR: u64 = 1223;
pub const METHOD_HASNONTRIVIALDESTRUCTORFORCALL: u64 = 1224;
pub const METHOD_ALLOWCONSTDEFAULTINIT: u64 = 1225;
pub const METHOD_HASIRRELEVANTDESTRUCTOR: u64 = 1226;
pub const METHOD_HASNONLITERALTYPEFIELDSORBASES: u64 = 1227;
pub const METHOD_HASINHERITEDCONSTRUCTOR: u64 = 1228;
pub const METHOD_HASINHERITEDASSIGNMENT: u64 = 1229;
pub const METHOD_ISTRIVIALLYCOPYABLE: u64 = 1230;
pub const METHOD_ISTRIVIALLYCOPYCONSTRUCTIBLE: u64 = 1231;
pub const METHOD_ISTRIVIAL: u64 = 1232;
pub const METHOD_ISLITERAL: u64 = 1233;
pub const METHOD_ISSTRUCTURAL: u64 = 1234;
pub const METHOD_GETINSTANTIATEDFROMMEMBERCLASS: u64 = 1235;
pub const METHOD_GETMEMBERSPECIALIZATIONINFO: u64 = 1236;
pub const METHOD_GETDESCRIBEDCLASSTEMPLATE: u64 = 1237;
pub const METHOD_GETTEMPLATESPECIALIZATIONKIND: u64 = 1238;
pub const METHOD_GETTEMPLATEINSTANTIATIONPATTERN: u64 = 1239;
pub const METHOD_GETDESTRUCTOR: u64 = 1240;
pub const METHOD_ISANYDESTRUCTORNORETURN: u64 = 1241;
pub const METHOD_ISLOCALCLASS: u64 = 1242;
pub const METHOD_MAYBEABSTRACT: u64 = 1243;
pub const METHOD_ISEFFECTIVELYFINAL: u64 = 1244;
pub const METHOD_GETLAMBDAMANGLINGNUMBER: u64 = 1245;
pub const METHOD_HASKNOWNLAMBDAINTERNALLINKAGE: u64 = 1246;
pub const METHOD_GETLAMBDACONTEXTDECL: u64 = 1247;
pub const METHOD_GETLAMBDAINDEXINCONTEXT: u64 = 1248;
pub const METHOD_GETLAMBDANUMBERING: u64 = 1249;
pub const METHOD_GETDEVICELAMBDAMANGLINGNUMBER: u64 = 1250;
pub const METHOD_GETMSINHERITANCEMODEL: u64 = 1251;
pub const METHOD_CALCULATEINHERITANCEMODEL: u64 = 1252;
pub const METHOD_NULLFIELDOFFSETISZERO: u64 = 1253;
pub const METHOD_GETMSVTORDISPMODE: u64 = 1254;
pub const METHOD_ISDEPENDENTLAMBDA: u64 = 1255;
pub const METHOD_ISNEVERDEPENDENTLAMBDA: u64 = 1256;
pub const METHOD_GETLAMBDADEPENDENCYKIND: u64 = 1257;
pub const METHOD_GETLAMBDATYPEINFO: u64 = 1258;
pub const METHOD_ISINTERFACELIKE: u64 = 1259;
pub const CLASS_OMPTEAMSGENERICLOOPDIRECTIVE: u64 = 1260;
pub const CLASS_TOPLEVELSTMTDECL: u64 = 1261;
pub const METHOD_GETSOURCERANGE_27: u64 = 1262;
pub const METHOD_GETSTMT_1: u64 = 1263;
pub const METHOD_ISSEMIMISSING: u64 = 1264;
pub const CLASS_USINGENUMDECL: u64 = 1265;
pub const METHOD_GETUSINGLOC_4: u64 = 1266;
pub const METHOD_GETENUMLOC: u64 = 1267;
pub const METHOD_GETQUALIFIER_10: u64 = 1268;
pub const METHOD_GETQUALIFIERLOC_7: u64 = 1269;
pub const METHOD_GETENUMTYPELOC: u64 = 1270;
pub const METHOD_GETENUMTYPE: u64 = 1271;
pub const METHOD_GETENUMDECL: u64 = 1272;
pub const METHOD_GETSOURCERANGE_34: u64 = 1273;
pub const METHOD_GETCANONICALDECL_24: u64 = 1274;
pub const CLASS_OMPERRORDIRECTIVE: u64 = 1275;
pub const CLASS_BASEUSINGDECL: u64 = 1276;
pub const METHOD_SHADOWS: u64 = 1277;
pub const METHOD_SHADOW_BEGIN: u64 = 1278;
pub const METHOD_SHADOW_END: u64 = 1279;
pub const METHOD_SHADOW_SIZE: u64 = 1280;
pub const CLASS_CLASSTEMPLATEDECL: u64 = 1281;
pub const METHOD_GETTEMPLATEDDECL: u64 = 1282;
pub const METHOD_ISTHISDECLARATIONADEFINITION: u64 = 1283;
pub const METHOD_GETCANONICALDECL_5: u64 = 1284;
pub const METHOD_GETPREVIOUSDECL_1: u64 = 1285;
pub const METHOD_GETMOSTRECENTDECL_2: u64 = 1286;
pub const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE: u64 = 1287;
pub const METHOD_SPECIALIZATIONS: u64 = 1288;
pub const METHOD_SPEC_BEGIN: u64 = 1289;
pub const METHOD_SPEC_END: u64 = 1290;
pub const CLASS_OBJCTYPEPARAMDECL: u64 = 1291;
pub const CLASS_TEMPLATETEMPLATEPARMDECL: u64 = 1292;
pub const METHOD_ISPARAMETERPACK_3: u64 = 1293;
pub const METHOD_ISPACKEXPANSION_1: u64 = 1294;
pub const METHOD_ISEXPANDEDPARAMETERPACK_1: u64 = 1295;
pub const METHOD_GETNUMEXPANSIONTEMPLATEPARAMETERS: u64 = 1296;
pub const METHOD_GETDEFAULTARGSTORAGE_1: u64 = 1297;
pub const METHOD_HASDEFAULTARGUMENT_1: u64 = 1298;
pub const METHOD_GETDEFAULTARGUMENT_1: u64 = 1299;
pub const METHOD_GETDEFAULTARGUMENTLOC_1: u64 = 1300;
pub const METHOD_DEFAULTARGUMENTWASINHERITED_1: u64 = 1301;
pub const METHOD_GETSOURCERANGE_25: u64 = 1302;
pub const CLASS_OBJCCONTAINERDECL: u64 = 1303;
pub const CLASS_OBJCPROPERTYDECL: u64 = 1304;
pub const CLASS_BLOCKDECL: u64 = 1305;
pub const METHOD_GETCARETLOCATION: u64 = 1306;
pub const METHOD_ISVARIADIC_1: u64 = 1307;
pub const METHOD_GETCOMPOUNDBODY: u64 = 1308;
pub const METHOD_GETBODY: u64 = 1309;
pub const METHOD_GETSIGNATUREASWRITTEN: u64 = 1310;
pub const METHOD_PARAMETERS: u64 = 1311;
pub const METHOD_PARAM_EMPTY: u64 = 1312;
pub const METHOD_PARAM_BEGIN: u64 = 1313;
pub const METHOD_PARAM_END: u64 = 1314;
pub const METHOD_PARAM_SIZE: u64 = 1315;
pub const METHOD_GETNUMPARAMS_1: u64 = 1316;
pub const METHOD_HASCAPTURES: u64 = 1317;
pub const METHOD_GETNUMCAPTURES: u64 = 1318;
pub const METHOD_CAPTURES: u64 = 1319;
pub const METHOD_CAPTURE_BEGIN_1: u64 = 1320;
pub const METHOD_CAPTURE_END_1: u64 = 1321;
pub const METHOD_CAPTURESCXXTHIS: u64 = 1322;
pub const METHOD_BLOCKMISSINGRETURNTYPE: u64 = 1323;
pub const METHOD_ISCONVERSIONFROMLAMBDA: u64 = 1324;
pub const METHOD_DOESNOTESCAPE: u64 = 1325;
pub const METHOD_CANAVOIDCOPYTOHEAP: u64 = 1326;
pub const METHOD_GETBLOCKMANGLINGNUMBER: u64 = 1327;
pub const METHOD_GETBLOCKMANGLINGCONTEXTDECL: u64 = 1328;
pub const METHOD_GETSOURCERANGE_1: u64 = 1329;
pub const CLASS_UNRESOLVEDUSINGIFEXISTSDECL: u64 = 1330;
pub const CLASS_OBJCPROTOCOLDECL: u64 = 1331;
pub const CLASS_OMPALLOCATEDECL: u64 = 1332;
pub const CLASS_OBJCINTERFACEDECL: u64 = 1333;
pub const CLASS_OMPORDEREDDIRECTIVE: u64 = 1334;
pub const CLASS_CXXDELETEEXPR: u64 = 1335;
pub const METHOD_ISGLOBALDELETE: u64 = 1336;
pub const METHOD_ISARRAYFORM: u64 = 1337;
pub const METHOD_ISARRAYFORMASWRITTEN: u64 = 1338;
pub const METHOD_DOESUSUALARRAYDELETEWANTSIZE: u64 = 1339;
pub const METHOD_GETOPERATORDELETE_1: u64 = 1340;
pub const METHOD_GETARGUMENT: u64 = 1341;
pub const METHOD_GETDESTROYEDTYPE: u64 = 1342;
pub const METHOD_GETBEGINLOC_25: u64 = 1343;
pub const METHOD_GETENDLOC_24: u64 = 1344;
pub const METHOD_CHILDREN_19: u64 = 1345;
pub const CLASS_STATICASSERTDECL: u64 = 1346;
pub const METHOD_GETASSERTEXPR: u64 = 1347;
pub const METHOD_GETMESSAGE: u64 = 1348;
pub const METHOD_ISFAILED: u64 = 1349;
pub const METHOD_GETRPARENLOC_1: u64 = 1350;
pub const METHOD_GETSOURCERANGE_22: u64 = 1351;
pub const CLASS_CXXOPERATORCALLEXPR: u64 = 1352;
pub const METHOD_GETOPERATOR_1: u64 = 1353;
pub const METHOD_ISASSIGNMENTOP_1: u64 = 1354;
pub const METHOD_ISCOMPARISONOP_1: u64 = 1355;
pub const METHOD_ISINFIXBINARYOP: u64 = 1356;
pub const METHOD_GETOPERATORLOC_3: u64 = 1357;
pub const METHOD_GETEXPRLOC_4: u64 = 1358;
pub const METHOD_GETBEGINLOC_35: u64 = 1359;
pub const METHOD_GETENDLOC_34: u64 = 1360;
pub const METHOD_GETSOURCERANGE_41: u64 = 1361;
pub const CLASS_OBJCPROPERTYIMPLDECL: u64 = 1362;
pub const CLASS_OMPTARGETTEAMSDISTRIBUTESIMDDIRECTIVE: u64 = 1363;
pub const CLASS_IMPORTDECL: u64 = 1364;
pub const METHOD_GETIMPORTEDMODULE: u64 = 1365;
pub const METHOD_GETIDENTIFIERLOCS: u64 = 1366;
pub const METHOD_GETSOURCERANGE_15: u64 = 1367;
pub const CLASS_TRANSLATIONUNITDECL: u64 = 1368;
pub const METHOD_GETASTCONTEXT: u64 = 1369;
pub const METHOD_GETANONYMOUSNAMESPACE_1: u64 = 1370;
pub const CLASS_OMPTARGETPARALLELGENERICLOOPDIRECTIVE: u64 = 1371;
pub const CLASS_OMPTHREADPRIVATEDECL: u64 = 1372;
pub const CLASS_BINDINGDECL: u64 = 1373;
pub const METHOD_GETBINDING: u64 = 1374;
pub const METHOD_GETDECOMPOSEDDECL: u64 = 1375;
pub const METHOD_GETHOLDINGVAR: u64 = 1376;
pub const CLASS_FRIENDTEMPLATEDECL: u64 = 1377;
pub const METHOD_GETFRIENDTYPE_1: u64 = 1378;
pub const METHOD_GETFRIENDDECL_1: u64 = 1379;
pub const METHOD_GETFRIENDLOC_1: u64 = 1380;
pub const METHOD_GETNUMTEMPLATEPARAMETERS: u64 = 1381;
pub const CLASS_USINGDIRECTIVEDECL: u64 = 1382;
pub const METHOD_GETQUALIFIERLOC_6: u64 = 1383;
pub const METHOD_GETQUALIFIER_9: u64 = 1384;
pub const METHOD_GETNOMINATEDNAMESPACEASWRITTEN: u64 = 1385;
pub const METHOD_GETNOMINATEDNAMESPACE: u64 = 1386;
pub const METHOD_GETCOMMONANCESTOR: u64 = 1387;
pub const METHOD_GETUSINGLOC_3: u64 = 1388;
pub const METHOD_GETNAMESPACEKEYLOCATION: u64 = 1389;
pub const METHOD_GETIDENTLOCATION: u64 = 1390;
pub const METHOD_GETSOURCERANGE_33: u64 = 1391;
pub const CLASS_OBJCCATEGORYDECL: u64 = 1392;
pub const CLASS_IMPLICITCONCEPTSPECIALIZATIONDECL: u64 = 1393;
pub const METHOD_GETTEMPLATEARGUMENTS: u64 = 1394;
pub const CLASS_VARTEMPLATESPECIALIZATIONDECL: u64 = 1395;
pub const METHOD_GETSPECIALIZEDTEMPLATE_1: u64 = 1396;
pub const METHOD_GETTEMPLATEARGS_1: u64 = 1397;
pub const METHOD_GETTEMPLATEARGSINFO: u64 = 1398;
pub const METHOD_GETSPECIALIZATIONKIND_1: u64 = 1399;
pub const METHOD_ISEXPLICITSPECIALIZATION_1: u64 = 1400;
pub const METHOD_ISCLASSSCOPEEXPLICITSPECIALIZATION_1: u64 = 1401;
pub const METHOD_ISEXPLICITINSTANTIATIONORSPECIALIZATION_1: u64 = 1402;
pub const METHOD_GETPOINTOFINSTANTIATION_3: u64 = 1403;
pub const METHOD_GETINSTANTIATEDFROM_1: u64 = 1404;
pub const METHOD_GETSPECIALIZEDTEMPLATEORPARTIAL_1: u64 = 1405;
pub const METHOD_GETTEMPLATEINSTANTIATIONARGS_1: u64 = 1406;
pub const METHOD_GETTYPEASWRITTEN_1: u64 = 1407;
pub const METHOD_GETEXTERNLOC_2: u64 = 1408;
pub const METHOD_GETTEMPLATEKEYWORDLOC_1: u64 = 1409;
pub const METHOD_GETSOURCERANGE_38: u64 = 1410;
pub const CLASS_REQUIRESEXPRBODYDECL: u64 = 1411;
pub const CLASS_FRIENDDECL: u64 = 1412;
pub const METHOD_GETFRIENDTYPE: u64 = 1413;
pub const METHOD_GETFRIENDTYPENUMTEMPLATEPARAMETERLISTS: u64 = 1414;
pub const METHOD_GETFRIENDDECL: u64 = 1415;
pub const METHOD_GETFRIENDLOC: u64 = 1416;
pub const METHOD_GETSOURCERANGE_12: u64 = 1417;
pub const METHOD_ISUNSUPPORTEDFRIEND: u64 = 1418;
pub const CLASS_TEMPLATETYPEPARMDECL: u64 = 1419;
pub const METHOD_WASDECLAREDWITHTYPENAME: u64 = 1420;
pub const METHOD_GETDEFAULTARGSTORAGE_2: u64 = 1421;
pub const METHOD_HASDEFAULTARGUMENT_2: u64 = 1422;
pub const METHOD_GETDEFAULTARGUMENT_2: u64 = 1423;
pub const METHOD_GETDEFAULTARGUMENTINFO: u64 = 1424;
pub const METHOD_GETDEFAULTARGUMENTLOC_2: u64 = 1425;
pub const METHOD_DEFAULTARGUMENTWASINHERITED_2: u64 = 1426;
pub const METHOD_GETDEPTH_1: u64 = 1427;
pub const METHOD_GETINDEX_3: u64 = 1428;
pub const METHOD_ISPARAMETERPACK_4: u64 = 1429;
pub const METHOD_ISPACKEXPANSION_2: u64 = 1430;
pub const METHOD_ISEXPANDEDPARAMETERPACK_2: u64 = 1431;
pub const METHOD_GETNUMEXPANSIONPARAMETERS: u64 = 1432;
pub const METHOD_GETTYPECONSTRAINT: u64 = 1433;
pub const METHOD_HASTYPECONSTRAINT: u64 = 1434;
pub const METHOD_GETSOURCERANGE_26: u64 = 1435;
pub const CLASS_ACCESSSPECDECL: u64 = 1436;
pub const METHOD_GETACCESSSPECIFIERLOC: u64 = 1437;
pub const METHOD_GETCOLONLOC: u64 = 1438;
pub const METHOD_GETSOURCERANGE: u64 = 1439;
pub const CLASS_TEMPLATEDECL: u64 = 1440;
pub const METHOD_GETTEMPLATEPARAMETERS_1: u64 = 1441;
pub const METHOD_HASASSOCIATEDCONSTRAINTS_1: u64 = 1442;
pub const METHOD_GETTEMPLATEDDECL_2: u64 = 1443;
pub const METHOD_ISTYPEALIAS_1: u64 = 1444;
pub const METHOD_GETSOURCERANGE_24: u64 = 1445;
pub const CLASS_EXPORTDECL: u64 = 1446;
pub const METHOD_GETEXPORTLOC: u64 = 1447;
pub const METHOD_GETRBRACELOC: u64 = 1448;
pub const METHOD_HASBRACES: u64 = 1449;
pub const METHOD_GETENDLOC_1: u64 = 1450;
pub const METHOD_GETSOURCERANGE_9: u64 = 1451;
pub const CLASS_FILESCOPEASMDECL: u64 = 1452;
pub const METHOD_GETASMLOC: u64 = 1453;
pub const METHOD_GETRPARENLOC: u64 = 1454;
pub const METHOD_GETSOURCERANGE_11: u64 = 1455;
pub const METHOD_GETASMSTRING: u64 = 1456;
pub const CLASS_OMPPARALLELMASTERDIRECTIVE: u64 = 1457;
pub const CLASS_VARDECL: u64 = 1458;
pub const METHOD_GETSOURCERANGE_36: u64 = 1459;
pub const METHOD_GETSTORAGECLASS_1: u64 = 1460;
pub const METHOD_GETTSCSPEC: u64 = 1461;
pub const METHOD_GETTLSKIND: u64 = 1462;
pub const METHOD_HASLOCALSTORAGE: u64 = 1463;
pub const METHOD_ISSTATICLOCAL: u64 = 1464;
pub const METHOD_HASEXTERNALSTORAGE: u64 = 1465;
pub const METHOD_HASGLOBALSTORAGE: u64 = 1466;
pub const METHOD_GETSTORAGEDURATION_1: u64 = 1467;
pub const METHOD_GETLANGUAGELINKAGE_1: u64 = 1468;
pub const METHOD_ISEXTERNC_1: u64 = 1469;
pub const METHOD_ISINEXTERNCCONTEXT_1: u64 = 1470;
pub const METHOD_ISINEXTERNCXXCONTEXT_1: u64 = 1471;
pub const METHOD_ISLOCALVARDECL: u64 = 1472;
pub const METHOD_ISLOCALVARDECLORPARM: u64 = 1473;
pub const METHOD_ISFUNCTIONORMETHODVARDECL: u64 = 1474;
pub const METHOD_ISSTATICDATAMEMBER: u64 = 1475;
pub const METHOD_GETCANONICALDECL_27: u64 = 1476;
pub const METHOD_ISTHISDECLARATIONADEFINITION_4: u64 = 1477;
pub const METHOD_HASDEFINITION_1: u64 = 1478;
pub const METHOD_GETACTINGDEFINITION: u64 = 1479;
pub const METHOD_GETDEFINITION_5: u64 = 1480;
pub const METHOD_ISOUTOFLINE_2: u64 = 1481;
pub const METHOD_ISFILEVARDECL: u64 = 1482;
pub const METHOD_GETANYINITIALIZER: u64 = 1483;
pub const METHOD_HASINIT: u64 = 1484;
pub const METHOD_GETINIT: u64 = 1485;
pub const METHOD_GETINITIALIZINGDECLARATION: u64 = 1486;
pub const METHOD_ENSUREEVALUATEDSTMT: u64 = 1487;
pub const METHOD_GETEVALUATEDSTMT: u64 = 1488;
pub const METHOD_EVALUATEVALUE: u64 = 1489;
pub const METHOD_GETEVALUATEDVALUE: u64 = 1490;
pub const METHOD_HASCONSTANTINITIALIZATION: u64 = 1491;
pub const METHOD_GETINITSTYLE: u64 = 1492;
pub const METHOD_ISDIRECTINIT: u64 = 1493;
pub const METHOD_ISTHISDECLARATIONADEMOTEDDEFINITION_1: u64 = 1494;
pub const METHOD_ISEXCEPTIONVARIABLE: u64 = 1495;
pub const METHOD_ISNRVOVARIABLE: u64 = 1496;
pub const METHOD_ISCXXFORRANGEDECL: u64 = 1497;
pub const METHOD_ISOBJCFORDECL: u64 = 1498;
pub const METHOD_ISARCPSEUDOSTRONG: u64 = 1499;
pub const METHOD_ISINLINE_1: u64 = 1500;
pub const METHOD_ISINLINESPECIFIED_1: u64 = 1501;
pub const METHOD_ISCONSTEXPR_1: u64 = 1502;
pub const METHOD_ISINITCAPTURE_1: u64 = 1503;
pub const METHOD_ISPARAMETERPACK_5: u64 = 1504;
pub const METHOD_ISPREVIOUSDECLINSAMEBLOCKSCOPE: u64 = 1505;
pub const METHOD_ISESCAPINGBYREF: u64 = 1506;
pub const METHOD_ISNONESCAPINGBYREF: u64 = 1507;
pub const METHOD_HASDEPENDENTALIGNMENT: u64 = 1508;
pub const METHOD_GETTEMPLATEINSTANTIATIONPATTERN_2: u64 = 1509;
pub const METHOD_GETINSTANTIATEDFROMSTATICDATAMEMBER: u64 = 1510;
pub const METHOD_GETTEMPLATESPECIALIZATIONKIND_3: u64 = 1511;
pub const METHOD_GETTEMPLATESPECIALIZATIONKINDFORINSTANTIATION_1: u64 = 1512;
pub const METHOD_GETPOINTOFINSTANTIATION_2: u64 = 1513;
pub const METHOD_GETMEMBERSPECIALIZATIONINFO_3: u64 = 1514;
pub const METHOD_GETDESCRIBEDVARTEMPLATE: u64 = 1515;
pub const METHOD_ISKNOWNTOBEDEFINED: u64 = 1516;
pub const CLASS_VARTEMPLATEDECL: u64 = 1517;
pub const METHOD_GETTEMPLATEDDECL_4: u64 = 1518;
pub const METHOD_ISTHISDECLARATIONADEFINITION_5: u64 = 1519;
pub const METHOD_GETCANONICALDECL_28: u64 = 1520;
pub const METHOD_GETPREVIOUSDECL_7: u64 = 1521;
pub const METHOD_GETMOSTRECENTDECL_8: u64 = 1522;
pub const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_5: u64 = 1523;
pub const METHOD_SPECIALIZATIONS_2: u64 = 1524;
pub const METHOD_SPEC_BEGIN_1: u64 = 1525;
pub const METHOD_SPEC_END_1: u64 = 1526;
pub const CLASS_OMPTEAMSDIRECTIVE: u64 = 1527;
pub const CLASS_CLASSTEMPLATESPECIALIZATIONDECL: u64 = 1528;
pub const METHOD_GETSPECIALIZEDTEMPLATE: u64 = 1529;
pub const METHOD_GETTEMPLATEARGS: u64 = 1530;
pub const METHOD_GETSPECIALIZATIONKIND: u64 = 1531;
pub const METHOD_ISEXPLICITSPECIALIZATION: u64 = 1532;
pub const METHOD_ISCLASSSCOPEEXPLICITSPECIALIZATION: u64 = 1533;
pub const METHOD_ISEXPLICITINSTANTIATIONORSPECIALIZATION: u64 = 1534;
pub const METHOD_GETPOINTOFINSTANTIATION: u64 = 1535;
pub const METHOD_GETINSTANTIATEDFROM: u64 = 1536;
pub const METHOD_GETSPECIALIZEDTEMPLATEORPARTIAL: u64 = 1537;
pub const METHOD_GETTEMPLATEINSTANTIATIONARGS: u64 = 1538;
pub const METHOD_GETTYPEASWRITTEN: u64 = 1539;
pub const METHOD_GETEXTERNLOC: u64 = 1540;
pub const METHOD_GETTEMPLATEKEYWORDLOC: u64 = 1541;
pub const METHOD_GETSOURCERANGE_3: u64 = 1542;
pub const CLASS_EXPRESSIONTRAITEXPR: u64 = 1543;
pub const METHOD_GETBEGINLOC_72: u64 = 1544;
pub const METHOD_GETENDLOC_71: u64 = 1545;
pub const METHOD_GETTRAIT_1: u64 = 1546;
pub const METHOD_GETQUERIEDEXPRESSION: u64 = 1547;
pub const METHOD_GETVALUE_7: u64 = 1548;
pub const METHOD_CHILDREN_62: u64 = 1549;
pub const CLASS_MSPROPERTYDECL: u64 = 1550;
pub const METHOD_HASGETTER: u64 = 1551;
pub const METHOD_GETGETTERID: u64 = 1552;
pub const METHOD_HASSETTER: u64 = 1553;
pub const METHOD_GETSETTERID: u64 = 1554;
pub const CLASS_NAMEDDECL: u64 = 1555;
pub const METHOD_GETIDENTIFIER_4: u64 = 1556;
pub const METHOD_GETNAME_3: u64 = 1557;
pub const METHOD_GETNAMEASSTRING: u64 = 1558;
pub const METHOD_GETDECLNAME: u64 = 1559;
pub const METHOD_GETQUALIFIEDNAMEASSTRING: u64 = 1560;
pub const METHOD_HASLINKAGE: u64 = 1561;
pub const METHOD_ISCXXCLASSMEMBER: u64 = 1562;
pub const METHOD_ISCXXINSTANCEMEMBER: u64 = 1563;
pub const METHOD_GETLINKAGEINTERNAL: u64 = 1564;
pub const METHOD_GETFORMALLINKAGE: u64 = 1565;
pub const METHOD_HASEXTERNALFORMALLINKAGE: u64 = 1566;
pub const METHOD_ISEXTERNALLYVISIBLE: u64 = 1567;
pub const METHOD_ISEXTERNALLYDECLARABLE: u64 = 1568;
pub const METHOD_GETVISIBILITY_1: u64 = 1569;
pub const METHOD_GETLINKAGEANDVISIBILITY_1: u64 = 1570;
pub const METHOD_ISLINKAGEVALID: u64 = 1571;
pub const METHOD_HASLINKAGEBEENCOMPUTED: u64 = 1572;
pub const METHOD_GETUNDERLYINGDECL: u64 = 1573;
pub const METHOD_GETMOSTRECENTDECL_6: u64 = 1574;
pub const METHOD_GETOBJCFSTRINGFORMATTINGFAMILY: u64 = 1575;
pub const CLASS_TYPEALIASTEMPLATEDECL: u64 = 1576;
pub const METHOD_GETTEMPLATEDDECL_3: u64 = 1577;
pub const METHOD_GETCANONICALDECL_19: u64 = 1578;
pub const METHOD_GETPREVIOUSDECL_6: u64 = 1579;
pub const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_4: u64 = 1580;
pub const CLASS_VALUEDECL: u64 = 1581;
pub const METHOD_GETTYPE: u64 = 1582;
pub const METHOD_ISWEAK: u64 = 1583;
pub const METHOD_ISINITCAPTURE: u64 = 1584;
pub const METHOD_GETPOTENTIALLYDECOMPOSEDVARDECL: u64 = 1585;
pub const CLASS_OBJCCOMPATIBLEALIASDECL: u64 = 1586;
pub const CLASS_INDIRECTFIELDDECL: u64 = 1587;
pub const METHOD_CHAIN: u64 = 1588;
pub const METHOD_CHAIN_BEGIN: u64 = 1589;
pub const METHOD_CHAIN_END: u64 = 1590;
pub const METHOD_GETCHAININGSIZE: u64 = 1591;
pub const METHOD_GETANONFIELD: u64 = 1592;
pub const METHOD_GETVARDECL: u64 = 1593;
pub const METHOD_GETCANONICALDECL_13: u64 = 1594;
pub const CLASS_OBJCIMPLDECL: u64 = 1595;
pub const CLASS_OMPCAPTUREDEXPRDECL: u64 = 1596;
pub const CLASS_USINGPACKDECL: u64 = 1597;
pub const METHOD_GETINSTANTIATEDFROMUSINGDECL: u64 = 1598;
pub const METHOD_EXPANSIONS: u64 = 1599;
pub const METHOD_GETSOURCERANGE_35: u64 = 1600;
pub const METHOD_GETCANONICALDECL_25: u64 = 1601;
pub const CLASS_ENUMDECL: u64 = 1602;
pub const METHOD_GETCANONICALDECL_9: u64 = 1603;
pub const METHOD_GETPREVIOUSDECL_3: u64 = 1604;
pub const METHOD_GETMOSTRECENTDECL_4: u64 = 1605;
pub const METHOD_GETDEFINITION_1: u64 = 1606;
pub const METHOD_GETSOURCERANGE_8: u64 = 1607;
pub const METHOD_ENUMERATORS: u64 = 1608;
pub const METHOD_ENUMERATOR_BEGIN: u64 = 1609;
pub const METHOD_ENUMERATOR_END: u64 = 1610;
pub const METHOD_GETPROMOTIONTYPE: u64 = 1611;
pub const METHOD_GETINTEGERTYPE: u64 = 1612;
pub const METHOD_GETINTEGERTYPESOURCEINFO: u64 = 1613;
pub const METHOD_GETINTEGERTYPERANGE: u64 = 1614;
pub const METHOD_GETNUMPOSITIVEBITS: u64 = 1615;
pub const METHOD_GETNUMNEGATIVEBITS: u64 = 1616;
pub const METHOD_ISSCOPED: u64 = 1617;
pub const METHOD_ISSCOPEDUSINGCLASSTAG: u64 = 1618;
pub const METHOD_ISFIXED: u64 = 1619;
pub const METHOD_ISCOMPLETE: u64 = 1620;
pub const METHOD_ISCLOSED: u64 = 1621;
pub const METHOD_ISCLOSEDFLAG: u64 = 1622;
pub const METHOD_ISCLOSEDNONFLAG: u64 = 1623;
pub const METHOD_GETTEMPLATEINSTANTIATIONPATTERN_1: u64 = 1624;
pub const METHOD_GETINSTANTIATEDFROMMEMBERENUM: u64 = 1625;
pub const METHOD_GETTEMPLATESPECIALIZATIONKIND_1: u64 = 1626;
pub const METHOD_GETMEMBERSPECIALIZATIONINFO_1: u64 = 1627;
pub const CLASS_TYPEDEFNAMEDECL: u64 = 1628;
pub const METHOD_ISMODED: u64 = 1629;
pub const METHOD_GETTYPESOURCEINFO_1: u64 = 1630;
pub const METHOD_GETUNDERLYINGTYPE_4: u64 = 1631;
pub const METHOD_GETCANONICALDECL_20: u64 = 1632;
pub const METHOD_ISTRANSPARENTTAG: u64 = 1633;
pub const CLASS_CHOOSEEXPR: u64 = 1634;
pub const METHOD_ISCONDITIONTRUE: u64 = 1635;
pub const METHOD_ISCONDITIONDEPENDENT: u64 = 1636;
pub const METHOD_GETCHOSENSUBEXPR: u64 = 1637;
pub const METHOD_GETCOND_3: u64 = 1638;
pub const METHOD_GETLHS_5: u64 = 1639;
pub const METHOD_GETRHS_5: u64 = 1640;
pub const METHOD_GETBUILTINLOC_2: u64 = 1641;
pub const METHOD_GETRPARENLOC_12: u64 = 1642;
pub const METHOD_GETBEGINLOC_52: u64 = 1643;
pub const METHOD_GETENDLOC_51: u64 = 1644;
pub const METHOD_CHILDREN_42: u64 = 1645;
pub const CLASS_TYPEALIASDECL: u64 = 1646;
pub const METHOD_GETSOURCERANGE_28: u64 = 1647;
pub const METHOD_GETDESCRIBEDALIASTEMPLATE: u64 = 1648;
pub const CLASS_SEHLEAVESTMT: u64 = 1649;
pub const METHOD_GETLEAVELOC: u64 = 1650;
pub const METHOD_GETBEGINLOC_112: u64 = 1651;
pub const METHOD_GETENDLOC_111: u64 = 1652;
pub const METHOD_CHILDREN_99: u64 = 1653;
pub const CLASS_OMPDECLAREREDUCTIONDECL: u64 = 1654;
pub const CLASS_BUILTINTEMPLATEDECL: u64 = 1655;
pub const METHOD_GETSOURCERANGE_2: u64 = 1656;
pub const METHOD_GETBUILTINTEMPLATEKIND: u64 = 1657;
pub const CLASS_OMPDECLAREMAPPERDECL: u64 = 1658;
pub const CLASS_MSGUIDDECL: u64 = 1659;
pub const METHOD_GETPARTS: u64 = 1660;
pub const METHOD_GETASAPVALUE: u64 = 1661;
pub const CLASS_UNRESOLVEDUSINGVALUEDECL: u64 = 1662;
pub const METHOD_GETUSINGLOC_1: u64 = 1663;
pub const METHOD_ISACCESSDECLARATION: u64 = 1664;
pub const METHOD_GETQUALIFIERLOC_4: u64 = 1665;
pub const METHOD_GETQUALIFIER_7: u64 = 1666;
pub const METHOD_GETNAMEINFO_2: u64 = 1667;
pub const METHOD_ISPACKEXPANSION_4: u64 = 1668;
pub const METHOD_GETELLIPSISLOC_3: u64 = 1669;
pub const METHOD_GETSOURCERANGE_31: u64 = 1670;
pub const METHOD_GETCANONICALDECL_22: u64 = 1671;
pub const CLASS_NONTYPETEMPLATEPARMDECL: u64 = 1672;
pub const METHOD_GETSOURCERANGE_20: u64 = 1673;
pub const METHOD_GETDEFAULTARGSTORAGE: u64 = 1674;
pub const METHOD_HASDEFAULTARGUMENT: u64 = 1675;
pub const METHOD_GETDEFAULTARGUMENT: u64 = 1676;
pub const METHOD_GETDEFAULTARGUMENTLOC: u64 = 1677;
pub const METHOD_DEFAULTARGUMENTWASINHERITED: u64 = 1678;
pub const METHOD_ISPARAMETERPACK_2: u64 = 1679;
pub const METHOD_ISPACKEXPANSION: u64 = 1680;
pub const METHOD_ISEXPANDEDPARAMETERPACK: u64 = 1681;
pub const METHOD_GETNUMEXPANSIONTYPES: u64 = 1682;
pub const METHOD_GETPLACEHOLDERTYPECONSTRAINT: u64 = 1683;
pub const METHOD_HASPLACEHOLDERTYPECONSTRAINT: u64 = 1684;
pub const CLASS_OBJCIVARDECL: u64 = 1685;
pub const CLASS_FIELDDECL: u64 = 1686;
pub const METHOD_GETFIELDINDEX: u64 = 1687;
pub const METHOD_ISMUTABLE: u64 = 1688;
pub const METHOD_ISBITFIELD: u64 = 1689;
pub const METHOD_ISUNNAMEDBITFIELD: u64 = 1690;
pub const METHOD_ISANONYMOUSSTRUCTORUNION: u64 = 1691;
pub const METHOD_GETBITWIDTH: u64 = 1692;
pub const METHOD_ISPOTENTIALLYOVERLAPPING: u64 = 1693;
pub const METHOD_GETINCLASSINITSTYLE: u64 = 1694;
pub const METHOD_HASINCLASSINITIALIZER_1: u64 = 1695;
pub const METHOD_HASNONNULLINCLASSINITIALIZER: u64 = 1696;
pub const METHOD_GETINCLASSINITIALIZER: u64 = 1697;
pub const METHOD_HASCAPTUREDVLATYPE: u64 = 1698;
pub const METHOD_GETCAPTUREDVLATYPE: u64 = 1699;
pub const METHOD_GETPARENT_2: u64 = 1700;
pub const METHOD_GETSOURCERANGE_10: u64 = 1701;
pub const METHOD_GETCANONICALDECL_10: u64 = 1702;
pub const CLASS_OBJCATDEFSFIELDDECL: u64 = 1703;
pub const CLASS_EXPRWITHCLEANUPS: u64 = 1704;
pub const METHOD_GETOBJECTS: u64 = 1705;
pub const METHOD_GETNUMOBJECTS: u64 = 1706;
pub const METHOD_CLEANUPSHAVESIDEEFFECTS: u64 = 1707;
pub const METHOD_GETBEGINLOC_71: u64 = 1708;
pub const METHOD_GETENDLOC_70: u64 = 1709;
pub const METHOD_CHILDREN_61: u64 = 1710;
pub const CLASS_FUNCTIONDECL: u64 = 1711;
pub const METHOD_GETNAMEINFO: u64 = 1712;
pub const METHOD_GETELLIPSISLOC_1: u64 = 1713;
pub const METHOD_GETSOURCERANGE_13: u64 = 1714;
pub const METHOD_HASBODY_1: u64 = 1715;
pub const METHOD_HASTRIVIALBODY: u64 = 1716;
pub const METHOD_ISDEFINED: u64 = 1717;
pub const METHOD_GETDEFINITION_2: u64 = 1718;
pub const METHOD_GETBODY_3: u64 = 1719;
pub const METHOD_ISTHISDECLARATIONADEFINITION_1: u64 = 1720;
pub const METHOD_ISTHISDECLARATIONINSTANTIATEDFROMAFRIENDDEFINITION: u64 = 1721;
pub const METHOD_DOESTHISDECLARATIONHAVEABODY: u64 = 1722;
pub const METHOD_GETDEFAULTEDFUNCTIONINFO: u64 = 1723;
pub const METHOD_ISVARIADIC_2: u64 = 1724;
pub const METHOD_ISVIRTUALASWRITTEN: u64 = 1725;
pub const METHOD_ISPUREVIRTUAL: u64 = 1726;
pub const METHOD_ISLATETEMPLATEPARSED: u64 = 1727;
pub const METHOD_ISTRIVIAL_1: u64 = 1728;
pub const METHOD_ISTRIVIALFORCALL: u64 = 1729;
pub const METHOD_ISDEFAULTED: u64 = 1730;
pub const METHOD_ISEXPLICITLYDEFAULTED: u64 = 1731;
pub const METHOD_GETDEFAULTLOC: u64 = 1732;
pub const METHOD_ISUSERPROVIDED: u64 = 1733;
pub const METHOD_ISINELIGIBLEORNOTSELECTED: u64 = 1734;
pub const METHOD_HASIMPLICITRETURNZERO: u64 = 1735;
pub const METHOD_HASPROTOTYPE: u64 = 1736;
pub const METHOD_HASWRITTENPROTOTYPE: u64 = 1737;
pub const METHOD_HASINHERITEDPROTOTYPE: u64 = 1738;
pub const METHOD_ISCONSTEXPR: u64 = 1739;
pub const METHOD_GETCONSTEXPRKIND: u64 = 1740;
pub const METHOD_ISCONSTEXPRSPECIFIED: u64 = 1741;
pub const METHOD_ISCONSTEVAL: u64 = 1742;
pub const METHOD_BODYCONTAINSIMMEDIATEESCALATINGEXPRESSIONS: u64 = 1743;
pub const METHOD_ISIMMEDIATEESCALATING: u64 = 1744;
pub const METHOD_ISIMMEDIATEFUNCTION: u64 = 1745;
pub const METHOD_INSTANTIATIONISPENDING: u64 = 1746;
pub const METHOD_USESSEHTRY: u64 = 1747;
pub const METHOD_ISDELETED: u64 = 1748;
pub const METHOD_ISDELETEDASWRITTEN: u64 = 1749;
pub const METHOD_ISMAIN: u64 = 1750;
pub const METHOD_ISMSVCRTENTRYPOINT: u64 = 1751;
pub const METHOD_ISRESERVEDGLOBALPLACEMENTOPERATOR: u64 = 1752;
pub const METHOD_ISINLINEBUILTINDECLARATION: u64 = 1753;
pub const METHOD_ISDESTROYINGOPERATORDELETE: u64 = 1754;
pub const METHOD_GETLANGUAGELINKAGE: u64 = 1755;
pub const METHOD_ISEXTERNC: u64 = 1756;
pub const METHOD_ISINEXTERNCCONTEXT: u64 = 1757;
pub const METHOD_ISINEXTERNCXXCONTEXT: u64 = 1758;
pub const METHOD_ISGLOBAL: u64 = 1759;
pub const METHOD_ISNORETURN: u64 = 1760;
pub const METHOD_HASSKIPPEDBODY: u64 = 1761;
pub const METHOD_WILLHAVEBODY: u64 = 1762;
pub const METHOD_ISMULTIVERSION: u64 = 1763;
pub const METHOD_FRIENDCONSTRAINTREFERSTOENCLOSINGTEMPLATE: u64 = 1764;
pub const METHOD_ISMEMBERLIKECONSTRAINEDFRIEND: u64 = 1765;
pub const METHOD_GETMULTIVERSIONKIND: u64 = 1766;
pub const METHOD_ISCPUDISPATCHMULTIVERSION: u64 = 1767;
pub const METHOD_ISCPUSPECIFICMULTIVERSION: u64 = 1768;
pub const METHOD_ISTARGETMULTIVERSION: u64 = 1769;
pub const METHOD_ISTARGETCLONESMULTIVERSION: u64 = 1770;
pub const METHOD_GETCANONICALDECL_11: u64 = 1771;
pub const METHOD_PARAMETERS_2: u64 = 1772;
pub const METHOD_PARAM_EMPTY_1: u64 = 1773;
pub const METHOD_PARAM_BEGIN_1: u64 = 1774;
pub const METHOD_PARAM_END_1: u64 = 1775;
pub const METHOD_PARAM_SIZE_1: u64 = 1776;
pub const METHOD_GETNUMPARAMS_3: u64 = 1777;
pub const METHOD_GETMINREQUIREDARGUMENTS: u64 = 1778;
pub const METHOD_GETMINREQUIREDEXPLICITARGUMENTS: u64 = 1779;
pub const METHOD_HASCXXEXPLICITFUNCTIONOBJECTPARAMETER: u64 = 1780;
pub const METHOD_GETNUMNONOBJECTPARAMS: u64 = 1781;
pub const METHOD_HASONEPARAMORDEFAULTARGS: u64 = 1782;
pub const METHOD_GETFUNCTIONTYPELOC: u64 = 1783;
pub const METHOD_GETRETURNTYPE_1: u64 = 1784;
pub const METHOD_GETRETURNTYPESOURCERANGE: u64 = 1785;
pub const METHOD_GETPARAMETERSSOURCERANGE: u64 = 1786;
pub const METHOD_GETDECLAREDRETURNTYPE: u64 = 1787;
pub const METHOD_GETEXCEPTIONSPECTYPE_1: u64 = 1788;
pub const METHOD_GETEXCEPTIONSPECSOURCERANGE: u64 = 1789;
pub const METHOD_GETCALLRESULTTYPE: u64 = 1790;
pub const METHOD_GETSTORAGECLASS: u64 = 1791;
pub const METHOD_ISINLINESPECIFIED: u64 = 1792;
pub const METHOD_USESFPINTRIN: u64 = 1793;
pub const METHOD_ISINLINED: u64 = 1794;
pub const METHOD_ISINLINEDEFINITIONEXTERNALLYVISIBLE: u64 = 1795;
pub const METHOD_ISMSEXTERNINLINE: u64 = 1796;
pub const METHOD_DOESDECLARATIONFORCEEXTERNALLYVISIBLEDEFINITION: u64 = 1797;
pub const METHOD_ISSTATIC_1: u64 = 1798;
pub const METHOD_ISOVERLOADEDOPERATOR: u64 = 1799;
pub const METHOD_GETOVERLOADEDOPERATOR: u64 = 1800;
pub const METHOD_GETLITERALIDENTIFIER: u64 = 1801;
pub const METHOD_GETINSTANTIATEDFROMMEMBERFUNCTION: u64 = 1802;
pub const METHOD_GETTEMPLATEDKIND: u64 = 1803;
pub const METHOD_GETMEMBERSPECIALIZATIONINFO_2: u64 = 1804;
pub const METHOD_GETINSTANTIATEDFROMDECL: u64 = 1805;
pub const METHOD_GETDESCRIBEDFUNCTIONTEMPLATE: u64 = 1806;
pub const METHOD_ISFUNCTIONTEMPLATESPECIALIZATION: u64 = 1807;
pub const METHOD_GETTEMPLATESPECIALIZATIONINFO: u64 = 1808;
pub const METHOD_ISIMPLICITLYINSTANTIABLE: u64 = 1809;
pub const METHOD_ISTEMPLATEINSTANTIATION: u64 = 1810;
pub const METHOD_GETPRIMARYTEMPLATE: u64 = 1811;
pub const METHOD_GETTEMPLATESPECIALIZATIONARGS: u64 = 1812;
pub const METHOD_GETTEMPLATESPECIALIZATIONARGSASWRITTEN: u64 = 1813;
pub const METHOD_GETDEPENDENTSPECIALIZATIONINFO: u64 = 1814;
pub const METHOD_GETTEMPLATESPECIALIZATIONKIND_2: u64 = 1815;
pub const METHOD_GETTEMPLATESPECIALIZATIONKINDFORINSTANTIATION: u64 = 1816;
pub const METHOD_GETPOINTOFINSTANTIATION_1: u64 = 1817;
pub const METHOD_ISOUTOFLINE_1: u64 = 1818;
pub const METHOD_GETMEMORYFUNCTIONKIND: u64 = 1819;
pub const METHOD_GETODRHASH_1: u64 = 1820;
pub const CLASS_CXXCONSTRUCTORDECL: u64 = 1821;
pub const METHOD_GETEXPLICITSPECIFIER: u64 = 1822;
pub const METHOD_ISEXPLICIT: u64 = 1823;
pub const METHOD_INITS: u64 = 1824;
pub const METHOD_INIT_BEGIN: u64 = 1825;
pub const METHOD_INIT_END: u64 = 1826;
pub const METHOD_INIT_RBEGIN: u64 = 1827;
pub const METHOD_INIT_REND: u64 = 1828;
pub const METHOD_GETNUMCTORINITIALIZERS: u64 = 1829;
pub const METHOD_ISDELEGATINGCONSTRUCTOR: u64 = 1830;
pub const METHOD_GETTARGETCONSTRUCTOR: u64 = 1831;
pub const METHOD_ISDEFAULTCONSTRUCTOR: u64 = 1832;
pub const METHOD_ISCOPYCONSTRUCTOR: u64 = 1833;
pub const METHOD_ISMOVECONSTRUCTOR: u64 = 1834;
pub const METHOD_ISCOPYORMOVECONSTRUCTOR: u64 = 1835;
pub const METHOD_ISSPECIALIZATIONCOPYINGOBJECT: u64 = 1836;
pub const METHOD_ISINHERITINGCONSTRUCTOR: u64 = 1837;
pub const METHOD_GETINHERITEDCONSTRUCTOR: u64 = 1838;
pub const METHOD_GETCANONICALDECL: u64 = 1839;
pub const CLASS_OMPCRITICALDIRECTIVE: u64 = 1840;
pub const CLASS_CXXTEMPORARYOBJECTEXPR: u64 = 1841;
pub const METHOD_GETTYPESOURCEINFO_3: u64 = 1842;
pub const METHOD_GETBEGINLOC_41: u64 = 1843;
pub const METHOD_GETENDLOC_40: u64 = 1844;
pub const CLASS_CXXDEDUCTIONGUIDEDECL: u64 = 1845;
pub const METHOD_GETEXPLICITSPECIFIER_2: u64 = 1846;
pub const METHOD_ISEXPLICIT_2: u64 = 1847;
pub const METHOD_GETDEDUCEDTEMPLATE: u64 = 1848;
pub const METHOD_GETCORRESPONDINGCONSTRUCTOR: u64 = 1849;
pub const METHOD_GETDEDUCTIONCANDIDATEKIND: u64 = 1850;
pub const CLASS_UNINITIALIZEDATTR: u64 = 1851;
pub const CLASS_ACQUIRECAPABILITYATTR: u64 = 1852;
pub const CLASS_REINITIALIZESATTR: u64 = 1853;
pub const CLASS_OBJCIMPLEMENTATIONDECL: u64 = 1854;
pub const CLASS_WORKGROUPSIZEHINTATTR: u64 = 1855;
pub const CLASS_LOADERUNINITIALIZEDATTR: u64 = 1856;
pub const CLASS_PRAGMACLANGRELROSECTIONATTR: u64 = 1857;
pub const CLASS_CXXNULLPTRLITERALEXPR: u64 = 1858;
pub const METHOD_GETBEGINLOC_34: u64 = 1859;
pub const METHOD_GETENDLOC_33: u64 = 1860;
pub const METHOD_GETLOCATION_4: u64 = 1861;
pub const METHOD_CHILDREN_26: u64 = 1862;
pub const CLASS_OBJCPRECISELIFETIMEATTR: u64 = 1863;
pub const CLASS_REFERENCETYPELOC: u64 = 1864;
pub const METHOD_GETINNERTYPE_1: u64 = 1865;
pub const CLASS_OMPTASKLOOPDIRECTIVE: u64 = 1866;
pub const CLASS_OBJCMETHODDECL: u64 = 1867;
pub const CLASS_OSCONSUMESTHISATTR: u64 = 1868;
pub const CLASS_OMPPARALLELFORDIRECTIVE: u64 = 1869;
pub const CLASS_VECTORCALLATTR: u64 = 1870;
pub const CLASS_ANYX86INTERRUPTATTR: u64 = 1871;
pub const CLASS_NOINSTRUMENTFUNCTIONATTR: u64 = 1872;
pub const CLASS_CXXFOLDEXPR: u64 = 1873;
pub const METHOD_GETCALLEE: u64 = 1874;
pub const METHOD_GETLHS_2: u64 = 1875;
pub const METHOD_GETRHS_2: u64 = 1876;
pub const METHOD_ISRIGHTFOLD: u64 = 1877;
pub const METHOD_ISLEFTFOLD: u64 = 1878;
pub const METHOD_GETPATTERN_1: u64 = 1879;
pub const METHOD_GETINIT_1: u64 = 1880;
pub const METHOD_GETLPARENLOC_1: u64 = 1881;
pub const METHOD_GETRPARENLOC_5: u64 = 1882;
pub const METHOD_GETELLIPSISLOC_4: u64 = 1883;
pub const METHOD_GETOPERATOR: u64 = 1884;
pub const METHOD_GETNUMEXPANSIONS_1: u64 = 1885;
pub const METHOD_GETBEGINLOC_27: u64 = 1886;
pub const METHOD_GETENDLOC_26: u64 = 1887;
pub const METHOD_CHILDREN_21: u64 = 1888;
pub const CLASS_BUILTINALIASATTR: u64 = 1889;
pub const CLASS_CONSUMABLEATTR: u64 = 1890;
pub const CLASS_READONLYPLACEMENTATTR: u64 = 1891;
pub const CLASS_SUBSTNONTYPETEMPLATEPARMEXPR: u64 = 1892;
pub const METHOD_GETNAMELOC_1: u64 = 1893;
pub const METHOD_GETBEGINLOC_120: u64 = 1894;
pub const METHOD_GETENDLOC_119: u64 = 1895;
pub const METHOD_GETREPLACEMENT: u64 = 1896;
pub const METHOD_GETASSOCIATEDDECL_2: u64 = 1897;
pub const METHOD_GETINDEX_4: u64 = 1898;
pub const METHOD_GETPACKINDEX_1: u64 = 1899;
pub const METHOD_GETPARAMETER: u64 = 1900;
pub const METHOD_ISREFERENCEPARAMETER: u64 = 1901;
pub const METHOD_CHILDREN_108: u64 = 1902;
pub const CLASS_COUNTEDBYATTR: u64 = 1903;
pub const CLASS_MSABIATTR: u64 = 1904;
pub const CLASS_TYPETAGFORDATATYPEATTR: u64 = 1905;
pub const CLASS_ALIASATTR: u64 = 1906;
pub const CLASS_ENFORCETCBATTR: u64 = 1907;
pub const CLASS_SWIFTVERSIONEDREMOVALATTR: u64 = 1908;
pub const CLASS_ALLOCSIZEATTR: u64 = 1909;
pub const CLASS_ASSERTCAPABILITYATTR: u64 = 1910;
pub const CLASS_PATCHABLEFUNCTIONENTRYATTR: u64 = 1911;
pub const CLASS_ARRAYTYPE: u64 = 1912;
pub const METHOD_GETELEMENTTYPE: u64 = 1913;
pub const METHOD_GETSIZEMODIFIER: u64 = 1914;
pub const METHOD_GETINDEXTYPEQUALIFIERS: u64 = 1915;
pub const METHOD_GETINDEXTYPECVRQUALIFIERS: u64 = 1916;
pub const CLASS_ALIGNVALUEATTR: u64 = 1917;
pub const CLASS_SWIFTBRIDGEATTR: u64 = 1918;
pub const CLASS_MIPS16ATTR: u64 = 1919;
pub const CLASS_CONSTANTARRAYTYPELOC: u64 = 1920;
pub const CLASS_IFUNCATTR: u64 = 1921;
pub const CLASS_OMPCAPTURENOINITATTR: u64 = 1922;
pub const CLASS_ARMLOCALLYSTREAMINGATTR: u64 = 1923;
pub const CLASS_VECRETURNATTR: u64 = 1924;
pub const CLASS_SWIFTIMPORTPROPERTYASACCESSORSATTR: u64 = 1925;
pub const CLASS_EMPTYBASESATTR: u64 = 1926;
pub const CLASS_INHERITABLEATTR: u64 = 1927;
pub const CLASS_OBJCINDEPENDENTCLASSATTR: u64 = 1928;
pub const CLASS_INITSEGATTR: u64 = 1929;
pub const CLASS_NAKEDATTR: u64 = 1930;
pub const CLASS_UNSAFEBUFFERUSAGEATTR: u64 = 1931;
pub const CLASS_CONTINUESTMT: u64 = 1932;
pub const METHOD_GETCONTINUELOC: u64 = 1933;
pub const METHOD_GETBEGINLOC_58: u64 = 1934;
pub const METHOD_GETENDLOC_57: u64 = 1935;
pub const METHOD_CHILDREN_48: u64 = 1936;
pub const CLASS_ATOMICTYPELOC: u64 = 1937;
pub const METHOD_GETVALUELOC: u64 = 1938;
pub const METHOD_GETLOCALSOURCERANGE: u64 = 1939;
pub const METHOD_GETKWLOC: u64 = 1940;
pub const METHOD_GETLPARENLOC_12: u64 = 1941;
pub const METHOD_GETRPARENLOC_29: u64 = 1942;
pub const METHOD_GETPARENSRANGE: u64 = 1943;
pub const METHOD_GETINNERTYPE_2: u64 = 1944;
pub const CLASS_DECLTYPETYPELOC: u64 = 1945;
pub const METHOD_GETUNDERLYINGEXPR_2: u64 = 1946;
pub const METHOD_GETDECLTYPELOC: u64 = 1947;
pub const METHOD_GETRPARENLOC_30: u64 = 1948;
pub const METHOD_GETLOCALSOURCERANGE_1: u64 = 1949;
pub const CLASS_DEPENDENTVECTORTYPE: u64 = 1950;
pub const METHOD_GETSIZEEXPR_3: u64 = 1951;
pub const METHOD_GETELEMENTTYPE_3: u64 = 1952;
pub const METHOD_GETATTRIBUTELOC_3: u64 = 1953;
pub const METHOD_GETVECTORKIND: u64 = 1954;
pub const METHOD_ISSUGARED_17: u64 = 1955;
pub const METHOD_DESUGAR_17: u64 = 1956;
pub const CLASS_SWIFTVERSIONEDADDITIONATTR: u64 = 1957;
pub const CLASS_SUPPRESSATTR: u64 = 1958;
pub const CLASS_VECTORTYPELOC: u64 = 1959;
pub const METHOD_GETNAMELOC_2: u64 = 1960;
pub const METHOD_GETLOCALSOURCERANGE_2: u64 = 1961;
pub const METHOD_GETELEMENTLOC: u64 = 1962;
pub const METHOD_GETINNERTYPE_3: u64 = 1963;
pub const CLASS_OBJCPROTOCOLEXPR: u64 = 1964;
pub const CLASS_C11NORETURNATTR: u64 = 1965;
pub const CLASS_CALLEDONCEATTR: u64 = 1966;
pub const CLASS_WEBASSEMBLYIMPORTMODULEATTR: u64 = 1967;
pub const CLASS_OMPDEPOBJDIRECTIVE: u64 = 1968;
pub const CLASS_UNRESOLVEDMEMBEREXPR: u64 = 1969;
pub const METHOD_ISIMPLICITACCESS_3: u64 = 1970;
pub const METHOD_GETBASE_8: u64 = 1971;
pub const METHOD_GETBASETYPE_2: u64 = 1972;
pub const METHOD_HASUNRESOLVEDUSING: u64 = 1973;
pub const METHOD_ISARROW_5: u64 = 1974;
pub const METHOD_GETOPERATORLOC_11: u64 = 1975;
pub const METHOD_GETNAMINGCLASS_2: u64 = 1976;
pub const METHOD_GETMEMBERNAMEINFO_2: u64 = 1977;
pub const METHOD_GETMEMBERNAME: u64 = 1978;
pub const METHOD_GETMEMBERLOC_3: u64 = 1979;
pub const METHOD_GETEXPRLOC_13: u64 = 1980;
pub const METHOD_GETBEGINLOC_129: u64 = 1981;
pub const METHOD_GETENDLOC_128: u64 = 1982;
pub const METHOD_CHILDREN_116: u64 = 1983;
pub const CLASS_OBJCDESIGNATEDINITIALIZERATTR: u64 = 1984;
pub const CLASS_STRINGLITERAL: u64 = 1985;
pub const METHOD_GETSTRING: u64 = 1986;
pub const METHOD_GETBYTES: u64 = 1987;
pub const METHOD_GETBYTELENGTH: u64 = 1988;
pub const METHOD_GETLENGTH: u64 = 1989;
pub const METHOD_GETCHARBYTEWIDTH: u64 = 1990;
pub const METHOD_GETKIND_4: u64 = 1991;
pub const METHOD_ISORDINARY: u64 = 1992;
pub const METHOD_ISWIDE: u64 = 1993;
pub const METHOD_ISUTF8: u64 = 1994;
pub const METHOD_ISUTF16: u64 = 1995;
pub const METHOD_ISUTF32: u64 = 1996;
pub const METHOD_ISUNEVALUATED: u64 = 1997;
pub const METHOD_ISPASCAL: u64 = 1998;
pub const METHOD_CONTAINSNONASCII: u64 = 1999;
pub const METHOD_CONTAINSNONASCIIORNULL: u64 = 2000;
pub const METHOD_GETNUMCONCATENATED: u64 = 2001;
pub const METHOD_TOKLOC_BEGIN: u64 = 2002;
pub const METHOD_TOKLOC_END: u64 = 2003;
pub const METHOD_GETBEGINLOC_119: u64 = 2004;
pub const METHOD_GETENDLOC_118: u64 = 2005;
pub const METHOD_CHILDREN_107: u64 = 2006;
pub const CLASS_STRICTGUARDSTACKCHECKATTR: u64 = 2007;
pub const CLASS_OMPTEAMSDISTRIBUTEPARALLELFORDIRECTIVE: u64 = 2008;
pub const CLASS_XRAYLOGARGSATTR: u64 = 2009;
pub const CLASS_SWIFTINDIRECTRESULTATTR: u64 = 2010;
pub const CLASS_COMPLEXTYPELOC: u64 = 2011;
pub const CLASS_OMPSECTIONSDIRECTIVE: u64 = 2012;
pub const CLASS_HLSLSV_DISPATCHTHREADIDATTR: u64 = 2013;
pub const CLASS_FASTCALLATTR: u64 = 2014;
pub const CLASS_DECLARATORDECL: u64 = 2015;
pub const METHOD_GETTYPESOURCEINFO: u64 = 2016;
pub const METHOD_GETINNERLOCSTART: u64 = 2017;
pub const METHOD_GETOUTERLOCSTART: u64 = 2018;
pub const METHOD_GETSOURCERANGE_6: u64 = 2019;
pub const METHOD_GETBEGINLOC_1: u64 = 2020;
pub const METHOD_GETQUALIFIER_3: u64 = 2021;
pub const METHOD_GETQUALIFIERLOC: u64 = 2022;
pub const METHOD_GETTRAILINGREQUIRESCLAUSE: u64 = 2023;
pub const METHOD_GETNUMTEMPLATEPARAMETERLISTS: u64 = 2024;
pub const METHOD_GETTYPESPECSTARTLOC: u64 = 2025;
pub const METHOD_GETTYPESPECENDLOC: u64 = 2026;
pub const CLASS_CXXCONVERSIONDECL: u64 = 2027;
pub const METHOD_GETEXPLICITSPECIFIER_1: u64 = 2028;
pub const METHOD_ISEXPLICIT_1: u64 = 2029;
pub const METHOD_GETCONVERSIONTYPE: u64 = 2030;
pub const METHOD_ISLAMBDATOBLOCKPOINTERCONVERSION: u64 = 2031;
pub const METHOD_GETCANONICALDECL_1: u64 = 2032;
pub const CLASS_NAMESPACEDECL: u64 = 2033;
pub const METHOD_ISANONYMOUSNAMESPACE: u64 = 2034;
pub const METHOD_ISINLINE: u64 = 2035;
pub const METHOD_ISNESTED: u64 = 2036;
pub const METHOD_GETORIGINALNAMESPACE: u64 = 2037;
pub const METHOD_ISORIGINALNAMESPACE: u64 = 2038;
pub const METHOD_GETANONYMOUSNAMESPACE: u64 = 2039;
pub const METHOD_GETCANONICALDECL_15: u64 = 2040;
pub const METHOD_GETSOURCERANGE_19: u64 = 2041;
pub const METHOD_GETBEGINLOC_2: u64 = 2042;
pub const METHOD_GETRBRACELOC_3: u64 = 2043;
pub const CLASS_ARTIFICIALATTR: u64 = 2044;
pub const CLASS_RELEASEHANDLEATTR: u64 = 2045;
pub const CLASS_SWIFTASYNCCONTEXTATTR: u64 = 2046;
pub const CLASS_MINVECTORWIDTHATTR: u64 = 2047;
pub const CLASS_CLEANUPATTR: u64 = 2048;
pub const CLASS_OMPREFERENCEDVARATTR: u64 = 2049;
pub const CLASS_OMPUNROLLDIRECTIVE: u64 = 2050;
pub const CLASS_TRYACQUIRECAPABILITYATTR: u64 = 2051;
pub const CLASS_TRANSPARENTUNIONATTR: u64 = 2052;
pub const CLASS_DESIGNATEDINITUPDATEEXPR: u64 = 2053;
pub const METHOD_GETBEGINLOC_69: u64 = 2054;
pub const METHOD_GETENDLOC_68: u64 = 2055;
pub const METHOD_GETBASE_2: u64 = 2056;
pub const METHOD_GETUPDATER: u64 = 2057;
pub const METHOD_CHILDREN_59: u64 = 2058;
pub const CLASS_FULLEXPR: u64 = 2059;
pub const METHOD_GETSUBEXPR_5: u64 = 2060;
pub const CLASS_SWIFTIMPORTASNONGENERICATTR: u64 = 2061;
pub const CLASS_ARMNEWATTR: u64 = 2062;
pub const CLASS_SWIFTASYNCCALLATTR: u64 = 2063;
pub const CLASS_MSASMSTMT: u64 = 2064;
pub const METHOD_GETLBRACELOC_2: u64 = 2065;
pub const METHOD_GETENDLOC_90: u64 = 2066;
pub const METHOD_HASBRACES_2: u64 = 2067;
pub const METHOD_GETASMSTRING_2: u64 = 2068;
pub const METHOD_GETALLCONSTRAINTS: u64 = 2069;
pub const METHOD_GETCLOBBERS: u64 = 2070;
pub const METHOD_GETALLEXPRS: u64 = 2071;
pub const METHOD_GETBEGINLOC_91: u64 = 2072;
pub const METHOD_CHILDREN_79: u64 = 2073;
pub const CLASS_M68KINTERRUPTATTR: u64 = 2074;
pub const CLASS_BLOCKPOINTERTYPE: u64 = 2075;
pub const METHOD_GETPOINTEETYPE: u64 = 2076;
pub const METHOD_ISSUGARED_5: u64 = 2077;
pub const METHOD_DESUGAR_5: u64 = 2078;
pub const CLASS_DEPENDENTTYPEOFEXPRTYPE: u64 = 2079;
pub const CLASS_SWIFTASYNCATTR: u64 = 2080;
pub const CLASS_SECTIONATTR: u64 = 2081;
pub const CLASS_OSRETURNSNOTRETAINEDATTR: u64 = 2082;
pub const CLASS_ANYX86NOCALLERSAVEDREGISTERSATTR: u64 = 2083;
pub const CLASS_CXXUUIDOFEXPR: u64 = 2084;
pub const METHOD_ISTYPEOPERAND_1: u64 = 2085;
pub const METHOD_GETTYPEOPERANDSOURCEINFO_1: u64 = 2086;
pub const METHOD_GETEXPROPERAND_1: u64 = 2087;
pub const METHOD_GETGUIDDECL: u64 = 2088;
pub const METHOD_GETBEGINLOC_47: u64 = 2089;
pub const METHOD_GETENDLOC_46: u64 = 2090;
pub const METHOD_GETSOURCERANGE_46: u64 = 2091;
pub const METHOD_CHILDREN_36: u64 = 2092;
pub const CLASS_CDECLATTR: u64 = 2093;
pub const CLASS_STANDALONEDEBUGATTR: u64 = 2094;
pub const CLASS_CONVERGENTATTR: u64 = 2095;
pub const CLASS_UNUSEDATTR: u64 = 2096;
pub const CLASS_ARMBUILTINALIASATTR: u64 = 2097;
pub const CLASS_OBJCOBJECTPOINTERTYPE: u64 = 2098;
pub const CLASS_SELECTANYATTR: u64 = 2099;
pub const CLASS_COLDATTR: u64 = 2100;
pub const CLASS_UNRESOLVEDUSINGTYPENAMEDECL: u64 = 2101;
pub const METHOD_GETUSINGLOC: u64 = 2102;
pub const METHOD_GETTYPENAMELOC: u64 = 2103;
pub const METHOD_GETQUALIFIERLOC_3: u64 = 2104;
pub const METHOD_GETQUALIFIER_6: u64 = 2105;
pub const METHOD_GETNAMEINFO_1: u64 = 2106;
pub const METHOD_ISPACKEXPANSION_3: u64 = 2107;
pub const METHOD_GETELLIPSISLOC_2: u64 = 2108;
pub const METHOD_GETCANONICALDECL_21: u64 = 2109;
pub const CLASS_ACQUIREHANDLEATTR: u64 = 2110;
pub const CLASS_OPENCLGLOBALADDRESSSPACEATTR: u64 = 2111;
pub const CLASS_OPENCLACCESSATTR: u64 = 2112;
pub const CLASS_CXXSCALARVALUEINITEXPR: u64 = 2113;
pub const METHOD_GETTYPESOURCEINFO_2: u64 = 2114;
pub const METHOD_GETRPARENLOC_9: u64 = 2115;
pub const METHOD_GETBEGINLOC_39: u64 = 2116;
pub const METHOD_GETENDLOC_38: u64 = 2117;
pub const METHOD_CHILDREN_29: u64 = 2118;
pub const CLASS_CSTYLECASTEXPR: u64 = 2119;
pub const METHOD_GETLPARENLOC: u64 = 2120;
pub const METHOD_GETRPARENLOC_4: u64 = 2121;
pub const METHOD_GETBEGINLOC_18: u64 = 2122;
pub const METHOD_GETENDLOC_17: u64 = 2123;
pub const CLASS_LIKELYATTR: u64 = 2124;
pub const CLASS_ARMINATTR: u64 = 2125;
pub const CLASS_CODEALIGNATTR: u64 = 2126;
pub const CLASS_ASSERTSHAREDLOCKATTR: u64 = 2127;
pub const CLASS_AMDGPUNUMSGPRATTR: u64 = 2128;
pub const CLASS_CMSENSCALLATTR: u64 = 2129;
pub const CLASS_NOCOMMONATTR: u64 = 2130;
pub const CLASS_LIFETIMEEXTENDEDTEMPORARYDECL: u64 = 2131;
pub const METHOD_GETEXTENDINGDECL: u64 = 2132;
pub const METHOD_GETSTORAGEDURATION: u64 = 2133;
pub const METHOD_GETTEMPORARYEXPR: u64 = 2134;
pub const METHOD_GETMANGLINGNUMBER: u64 = 2135;
pub const METHOD_GETVALUE: u64 = 2136;
pub const METHOD_CHILDRENEXPR: u64 = 2137;
pub const CLASS_PRAGMACLANGDATASECTIONATTR: u64 = 2138;
pub const CLASS_VISIBILITYATTR: u64 = 2139;
pub const CLASS_CFICANONICALJUMPTABLEATTR: u64 = 2140;
pub const CLASS_OMPPARALLELSECTIONSDIRECTIVE: u64 = 2141;
pub const CLASS_EXTERNCCONTEXTDECL: u64 = 2142;
pub const CLASS_HLSLSV_GROUPINDEXATTR: u64 = 2143;
pub const CLASS_IMAGINARYLITERAL: u64 = 2144;
pub const METHOD_GETSUBEXPR_6: u64 = 2145;
pub const METHOD_GETBEGINLOC_83: u64 = 2146;
pub const METHOD_GETENDLOC_82: u64 = 2147;
pub const METHOD_CHILDREN_72: u64 = 2148;
pub const CLASS_OBJCNSOBJECTATTR: u64 = 2149;
pub const CLASS_WARNUNUSEDATTR: u64 = 2150;
pub const CLASS_NONNULLATTR: u64 = 2151;
pub const CLASS_MUSTTAILATTR: u64 = 2152;
pub const CLASS_OMPCANONICALLOOP: u64 = 2153;
pub const CLASS_WEBASSEMBLYIMPORTNAMEATTR: u64 = 2154;
pub const CLASS_AMDGPUNUMVGPRATTR: u64 = 2155;
pub const CLASS_OMPSIMDDIRECTIVE: u64 = 2156;
pub const CLASS_WHILESTMT: u64 = 2157;
pub const METHOD_HASVARSTORAGE_2: u64 = 2158;
pub const METHOD_GETCOND_9: u64 = 2159;
pub const METHOD_GETBODY_12: u64 = 2160;
pub const METHOD_GETCONDITIONVARIABLE_3: u64 = 2161;
pub const METHOD_GETCONDITIONVARIABLEDECLSTMT_3: u64 = 2162;
pub const METHOD_GETWHILELOC_1: u64 = 2163;
pub const METHOD_GETLPARENLOC_11: u64 = 2164;
pub const METHOD_GETRPARENLOC_28: u64 = 2165;
pub const METHOD_GETBEGINLOC_132: u64 = 2166;
pub const METHOD_GETENDLOC_131: u64 = 2167;
pub const METHOD_CHILDREN_118: u64 = 2168;
pub const CLASS_CFCONSUMEDATTR: u64 = 2169;
pub const CLASS_NOINLINEATTR: u64 = 2170;
pub const CLASS_CUDASHAREDATTR: u64 = 2171;
pub const CLASS_BUILTINTYPE: u64 = 2172;
pub const METHOD_GETKIND: u64 = 2173;
pub const METHOD_ISSUGARED_6: u64 = 2174;
pub const METHOD_DESUGAR_6: u64 = 2175;
pub const METHOD_ISINTEGER: u64 = 2176;
pub const METHOD_ISSIGNEDINTEGER: u64 = 2177;
pub const METHOD_ISUNSIGNEDINTEGER: u64 = 2178;
pub const METHOD_ISFLOATINGPOINT: u64 = 2179;
pub const METHOD_ISSVEBOOL: u64 = 2180;
pub const METHOD_ISSVECOUNT: u64 = 2181;
pub const METHOD_ISPLACEHOLDERTYPE: u64 = 2182;
pub const METHOD_ISNONOVERLOADPLACEHOLDERTYPE: u64 = 2183;
pub const CLASS_AMDGPUFLATWORKGROUPSIZEATTR: u64 = 2184;
pub const CLASS_OMPTARGETSIMDDIRECTIVE: u64 = 2185;
pub const CLASS_ENUMCONSTANTDECL: u64 = 2186;
pub const METHOD_GETINITEXPR: u64 = 2187;
pub const METHOD_GETINITVAL: u64 = 2188;
pub const METHOD_GETSOURCERANGE_7: u64 = 2189;
pub const METHOD_GETCANONICALDECL_8: u64 = 2190;
pub const CLASS_THREADATTR: u64 = 2191;
pub const CLASS_OBJCGCATTR: u64 = 2192;
pub const CLASS_OPENCLUNROLLHINTATTR: u64 = 2193;
pub const CLASS_DEPENDENTADDRESSSPACETYPELOC: u64 = 2194;
pub const METHOD_GETATTRNAMELOC: u64 = 2195;
pub const METHOD_GETATTREXPROPERAND: u64 = 2196;
pub const METHOD_GETATTROPERANDPARENSRANGE: u64 = 2197;
pub const METHOD_GETLOCALSOURCERANGE_3: u64 = 2198;
pub const METHOD_GETINNERTYPE_4: u64 = 2199;
pub const METHOD_GETPOINTEETYPELOC: u64 = 2200;
pub const CLASS_BLOCKPOINTERTYPELOC: u64 = 2201;
pub const METHOD_GETCARETLOC: u64 = 2202;
pub const CLASS_TYPENONNULLATTR: u64 = 2203;
pub const CLASS_NODEREFATTR: u64 = 2204;
pub const CLASS_VARTEMPLATEPARTIALSPECIALIZATIONDECL: u64 = 2205;
pub const METHOD_GETTEMPLATEPARAMETERS_2: u64 = 2206;
pub const METHOD_GETTEMPLATEARGSASWRITTEN_1: u64 = 2207;
pub const METHOD_HASASSOCIATEDCONSTRAINTS_2: u64 = 2208;
pub const METHOD_GETINSTANTIATEDFROMMEMBER_1: u64 = 2209;
pub const METHOD_GETSOURCERANGE_37: u64 = 2210;
pub const CLASS_ALLOCALIGNATTR: u64 = 2211;
pub const CLASS_ARMSTREAMINGCOMPATIBLEATTR: u64 = 2212;
pub const CLASS_UPTRATTR: u64 = 2213;
pub const CLASS_ANALYZERNORETURNATTR: u64 = 2214;
pub const CLASS_ASMLABELATTR: u64 = 2215;
pub const CLASS_ASSUMPTIONATTR: u64 = 2216;
pub const CLASS_OPENCLLOCALADDRESSSPACEATTR: u64 = 2217;
pub const CLASS_DECAYEDTYPELOC: u64 = 2218;
pub const CLASS_OBJCINERTUNSAFEUNRETAINEDATTR: u64 = 2219;
pub const CLASS_STMTATTR: u64 = 2220;
pub const CLASS_BTFTYPETAGATTR: u64 = 2221;
pub const CLASS_TYPENULLABLEATTR: u64 = 2222;
pub const CLASS_CALLABLEWHENATTR: u64 = 2223;
pub const CLASS_OBJCNONLAZYCLASSATTR: u64 = 2224;
pub const CLASS_ALIGNNATURALATTR: u64 = 2225;
pub const CLASS_ADDRESSSPACEATTR: u64 = 2226;
pub const CLASS_BUILTINATTR: u64 = 2227;
pub const CLASS_INTERNALLINKAGEATTR: u64 = 2228;
pub const CLASS_SWIFTERRORATTR: u64 = 2229;
pub const CLASS_ABITAGATTR: u64 = 2230;
pub const CLASS_OPENCLGLOBALHOSTADDRESSSPACEATTR: u64 = 2231;
pub const CLASS_RECOVERYEXPR: u64 = 2232;
pub const METHOD_SUBEXPRESSIONS: u64 = 2233;
pub const METHOD_GETBEGINLOC_107: u64 = 2234;
pub const METHOD_GETENDLOC_106: u64 = 2235;
pub const CLASS_OPENCLKERNELATTR: u64 = 2236;
pub const CLASS_LOOPHINTATTR: u64 = 2237;
pub const CLASS_ARMPRESERVESATTR: u64 = 2238;
pub const CLASS_OBJCKINDOFATTR: u64 = 2239;
pub const CLASS_FUNCTIONTEMPLATEDECL: u64 = 2240;
pub const METHOD_GETTEMPLATEDDECL_1: u64 = 2241;
pub const METHOD_ISTHISDECLARATIONADEFINITION_2: u64 = 2242;
pub const METHOD_GETCANONICALDECL_12: u64 = 2243;
pub const METHOD_GETPREVIOUSDECL_4: u64 = 2244;
pub const METHOD_GETMOSTRECENTDECL_5: u64 = 2245;
pub const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_2: u64 = 2246;
pub const METHOD_SPECIALIZATIONS_1: u64 = 2247;
pub const METHOD_SPEC_BEGIN_2: u64 = 2248;
pub const METHOD_SPEC_END_2: u64 = 2249;
pub const METHOD_ISABBREVIATED: u64 = 2250;
pub const CLASS_STRICTFPATTR: u64 = 2251;
pub const CLASS_CFGUARDATTR: u64 = 2252;
pub const CLASS_CUDADEVICEBUILTINTEXTURETYPEATTR: u64 = 2253;
pub const CLASS_TARGETATTR: u64 = 2254;
pub const CLASS_DECAYEDTYPE: u64 = 2255;
pub const METHOD_GETDECAYEDTYPE: u64 = 2256;
pub const METHOD_GETPOINTEETYPE_1: u64 = 2257;
pub const CLASS_NVPTXKERNELATTR: u64 = 2258;
pub const CLASS_BUILTINTYPELOC: u64 = 2259;
pub const METHOD_GETBUILTINLOC_6: u64 = 2260;
pub const METHOD_GETNAMELOC_3: u64 = 2261;
pub const METHOD_GETWRITTENBUILTINSPECS: u64 = 2262;
pub const METHOD_NEEDSEXTRALOCALDATA: u64 = 2263;
pub const METHOD_GETEXTRALOCALDATASIZE: u64 = 2264;
pub const METHOD_GETEXTRALOCALDATAALIGNMENT: u64 = 2265;
pub const METHOD_GETLOCALSOURCERANGE_4: u64 = 2266;
pub const METHOD_GETWRITTENSIGNSPEC: u64 = 2267;
pub const METHOD_HASWRITTENSIGNSPEC: u64 = 2268;
pub const METHOD_GETWRITTENWIDTHSPEC: u64 = 2269;
pub const METHOD_HASWRITTENWIDTHSPEC: u64 = 2270;
pub const METHOD_GETWRITTENTYPESPEC: u64 = 2271;
pub const METHOD_HASWRITTENTYPESPEC: u64 = 2272;
pub const METHOD_HASMODEATTR: u64 = 2273;
pub const CLASS_PARAMETERABIATTR: u64 = 2274;
pub const CLASS_NSERRORDOMAINATTR: u64 = 2275;
pub const CLASS_POINTERTYPELOC: u64 = 2276;
pub const METHOD_GETSTARLOC_1: u64 = 2277;
pub const CLASS_PTR64ATTR: u64 = 2278;
pub const CLASS_ARMMVESTRICTPOLYMORPHISMATTR: u64 = 2279;
pub const CLASS_SWIFTERRORRESULTATTR: u64 = 2280;
pub const CLASS_SEHTRYSTMT: u64 = 2281;
pub const METHOD_GETBEGINLOC_113: u64 = 2282;
pub const METHOD_GETTRYLOC_1: u64 = 2283;
pub const METHOD_GETENDLOC_112: u64 = 2284;
pub const METHOD_GETISCXXTRY: u64 = 2285;
pub const METHOD_GETTRYBLOCK_1: u64 = 2286;
pub const METHOD_GETHANDLER: u64 = 2287;
pub const METHOD_GETEXCEPTHANDLER: u64 = 2288;
pub const METHOD_GETFINALLYHANDLER: u64 = 2289;
pub const METHOD_CHILDREN_100: u64 = 2290;
pub const CLASS_TYPEATTR: u64 = 2291;
pub const CLASS_FUNCTIONNOPROTOTYPELOC: u64 = 2292;
pub const CLASS_OPENCLGLOBALDEVICEADDRESSSPACEATTR: u64 = 2293;
pub const CLASS_ARRAYTYPELOC: u64 = 2294;
pub const METHOD_GETLBRACKETLOC_2: u64 = 2295;
pub const METHOD_GETRBRACKETLOC_5: u64 = 2296;
pub const METHOD_GETBRACKETSRANGE_2: u64 = 2297;
pub const METHOD_GETSIZEEXPR_5: u64 = 2298;
pub const METHOD_GETELEMENTLOC_1: u64 = 2299;
pub const METHOD_GETLOCALSOURCERANGE_5: u64 = 2300;
pub const METHOD_GETINNERTYPE_5: u64 = 2301;
pub const CLASS_SWIFTCONTEXTATTR: u64 = 2302;
pub const CLASS_AVRSIGNALATTR: u64 = 2303;
pub const CLASS_VECTYPEHINTATTR: u64 = 2304;
pub const CLASS_ENUMTYPE: u64 = 2305;
pub const METHOD_GETDECL: u64 = 2306;
pub const METHOD_ISSUGARED_19: u64 = 2307;
pub const METHOD_DESUGAR_19: u64 = 2308;
pub const CLASS_DEPENDENTSIZEDEXTVECTORTYPE: u64 = 2309;
pub const METHOD_GETSIZEEXPR_2: u64 = 2310;
pub const METHOD_GETELEMENTTYPE_2: u64 = 2311;
pub const METHOD_GETATTRIBUTELOC_1: u64 = 2312;
pub const METHOD_ISSUGARED_15: u64 = 2313;
pub const METHOD_DESUGAR_15: u64 = 2314;
pub const CLASS_NOMERGEATTR: u64 = 2315;
pub const CLASS_OBJCFORCOLLECTIONSTMT: u64 = 2316;
pub const CLASS_TAGTYPELOC: u64 = 2317;
pub const METHOD_GETDECL_9: u64 = 2318;
pub const METHOD_ISDEFINITION: u64 = 2319;
pub const CLASS_AMDGPUWAVESPEREUATTR: u64 = 2320;
pub const CLASS_OMPCAPTUREKINDATTR: u64 = 2321;
pub const CLASS_WEBASSEMBLYEXPORTNAMEATTR: u64 = 2322;
pub const CLASS_CUDAGLOBALATTR: u64 = 2323;
pub const CLASS_OPENCLCONSTANTADDRESSSPACEATTR: u64 = 2324;
pub const CLASS_PARAMTYPESTATEATTR: u64 = 2325;
pub const CLASS_OMPLOOPDIRECTIVE: u64 = 2326;
pub const CLASS_BPFPRESERVESTATICOFFSETATTR: u64 = 2327;
pub const CLASS_ATTR: u64 = 2328;
pub const CLASS_ACQUIREDBEFOREATTR: u64 = 2329;
pub const CLASS_ARMSTREAMINGATTR: u64 = 2330;
pub const CLASS_NOESCAPEATTR: u64 = 2331;
pub const CLASS_CFRETURNSRETAINEDATTR: u64 = 2332;
pub const CLASS_USEHANDLEATTR: u64 = 2333;
pub const CLASS_USINGIFEXISTSATTR: u64 = 2334;
pub const CLASS_ARMOUTATTR: u64 = 2335;
pub const CLASS_OMPTARGETTEAMSDISTRIBUTEDIRECTIVE: u64 = 2336;
pub const CLASS_COROLIFETIMEBOUNDATTR: u64 = 2337;
pub const CLASS_SHAREDTRYLOCKFUNCTIONATTR: u64 = 2338;
pub const CLASS_OMPDECLARESIMDDECLATTR: u64 = 2339;
pub const CLASS_UUIDATTR: u64 = 2340;
pub const CLASS_TYPEDEFTYPELOC: u64 = 2341;
pub const METHOD_GETTYPEDEFNAMEDECL: u64 = 2342;
pub const CLASS_PREFERREDTYPEATTR: u64 = 2343;
pub const CLASS_CUDALAUNCHBOUNDSATTR: u64 = 2344;
pub const CLASS_CAPTUREDRECORDATTR: u64 = 2345;
pub const CLASS_OBJCROOTCLASSATTR: u64 = 2346;
pub const CLASS_TARGETCLONESATTR: u64 = 2347;
pub const CLASS_RENDERSCRIPTKERNELATTR: u64 = 2348;
pub const CLASS_ASSUMEALIGNEDATTR: u64 = 2349;
pub const CLASS_AVAILABLEONLYINDEFAULTEVALMETHODATTR: u64 = 2350;
pub const CLASS_MATERIALIZETEMPORARYEXPR: u64 = 2351;
pub const METHOD_GETSUBEXPR_7: u64 = 2352;
pub const METHOD_GETSTORAGEDURATION_2: u64 = 2353;
pub const METHOD_GETLIFETIMEEXTENDEDTEMPORARYDECL: u64 = 2354;
pub const METHOD_GETEXTENDINGDECL_1: u64 = 2355;
pub const METHOD_GETMANGLINGNUMBER_1: u64 = 2356;
pub const METHOD_ISBOUNDTOLVALUEREFERENCE: u64 = 2357;
pub const METHOD_GETBEGINLOC_95: u64 = 2358;
pub const METHOD_GETENDLOC_94: u64 = 2359;
pub const METHOD_CHILDREN_83: u64 = 2360;
pub const CLASS_COMPLEXTYPE: u64 = 2361;
pub const METHOD_GETELEMENTTYPE_1: u64 = 2362;
pub const METHOD_ISSUGARED_7: u64 = 2363;
pub const METHOD_DESUGAR_7: u64 = 2364;
pub const CLASS_TEMPLATESPECIALIZATIONTYPELOC: u64 = 2365;
pub const METHOD_GETTEMPLATEKEYWORDLOC_7: u64 = 2366;
pub const METHOD_GETLANGLELOC_5: u64 = 2367;
pub const METHOD_GETRANGLELOC_5: u64 = 2368;
pub const METHOD_GETNUMARGS_5: u64 = 2369;
pub const METHOD_GETTEMPLATENAMELOC: u64 = 2370;
pub const METHOD_GETLOCALSOURCERANGE_6: u64 = 2371;
pub const METHOD_GETEXTRALOCALDATASIZE_1: u64 = 2372;
pub const METHOD_GETEXTRALOCALDATAALIGNMENT_1: u64 = 2373;
pub const CLASS_PRAGMACLANGTEXTSECTIONATTR: u64 = 2374;
pub const CLASS_DEPENDENTCOAWAITEXPR: u64 = 2375;
pub const METHOD_GETOPERAND_3: u64 = 2376;
pub const METHOD_GETOPERATORCOAWAITLOOKUP: u64 = 2377;
pub const METHOD_GETKEYWORDLOC_2: u64 = 2378;
pub const METHOD_GETBEGINLOC_66: u64 = 2379;
pub const METHOD_GETENDLOC_65: u64 = 2380;
pub const METHOD_CHILDREN_56: u64 = 2381;
pub const CLASS_CODESEGATTR: u64 = 2382;
pub const CLASS_DECLORSTMTATTR: u64 = 2383;
pub const CLASS_INJECTEDCLASSNAMETYPELOC: u64 = 2384;
pub const METHOD_GETDECL_10: u64 = 2385;
pub const CLASS_PASSOBJECTSIZEATTR: u64 = 2386;
pub const CLASS_SOURCELOCEXPR: u64 = 2387;
pub const METHOD_GETBUILTINSTR: u64 = 2388;
pub const METHOD_GETIDENTKIND_1: u64 = 2389;
pub const METHOD_ISINTTYPE: u64 = 2390;
pub const METHOD_GETPARENTCONTEXT: u64 = 2391;
pub const METHOD_GETLOCATION_15: u64 = 2392;
pub const METHOD_GETBEGINLOC_117: u64 = 2393;
pub const METHOD_GETENDLOC_116: u64 = 2394;
pub const METHOD_CHILDREN_104: u64 = 2395;
pub const CLASS_X86FORCEALIGNARGPOINTERATTR: u64 = 2396;
pub const CLASS_UNLIKELYATTR: u64 = 2397;
pub const CLASS_CONSTRUCTORATTR: u64 = 2398;
pub const CLASS_AUTOTYPE: u64 = 2399;
pub const METHOD_GETTYPECONSTRAINTARGUMENTS: u64 = 2400;
pub const METHOD_GETTYPECONSTRAINTCONCEPT: u64 = 2401;
pub const METHOD_ISCONSTRAINED: u64 = 2402;
pub const METHOD_ISDECLTYPEAUTO: u64 = 2403;
pub const METHOD_ISGNUAUTOTYPE: u64 = 2404;
pub const METHOD_GETKEYWORD: u64 = 2405;
pub const CLASS_UNARYTRANSFORMTYPE: u64 = 2406;
pub const METHOD_ISSUGARED_42: u64 = 2407;
pub const METHOD_DESUGAR_42: u64 = 2408;
pub const METHOD_GETUNDERLYINGTYPE_2: u64 = 2409;
pub const METHOD_GETBASETYPE: u64 = 2410;
pub const METHOD_GETUTTKIND: u64 = 2411;
pub const CLASS_BITINTTYPE: u64 = 2412;
pub const METHOD_ISUNSIGNED: u64 = 2413;
pub const METHOD_ISSIGNED: u64 = 2414;
pub const METHOD_GETNUMBITS: u64 = 2415;
pub const METHOD_ISSUGARED_4: u64 = 2416;
pub const METHOD_DESUGAR_4: u64 = 2417;
pub const CLASS_CXXDESTRUCTORDECL: u64 = 2418;
pub const METHOD_GETOPERATORDELETE: u64 = 2419;
pub const METHOD_GETOPERATORDELETETHISARG: u64 = 2420;
pub const METHOD_GETCANONICALDECL_2: u64 = 2421;
pub const CLASS_ALIGNEDATTR: u64 = 2422;
pub const CLASS_CONSUMABLEAUTOCASTATTR: u64 = 2423;
pub const CLASS_OMPSCANDIRECTIVE: u64 = 2424;
pub const CLASS_TAGTYPE: u64 = 2425;
pub const METHOD_GETDECL_3: u64 = 2426;
pub const METHOD_ISBEINGDEFINED: u64 = 2427;
pub const CLASS_UNAVAILABLEATTR: u64 = 2428;
pub const CLASS_TYPEOFTYPE: u64 = 2429;
pub const METHOD_GETUNMODIFIEDTYPE: u64 = 2430;
pub const METHOD_DESUGAR_40: u64 = 2431;
pub const METHOD_ISSUGARED_40: u64 = 2432;
pub const METHOD_GETKIND_2: u64 = 2433;
pub const CLASS_ARMINTERRUPTATTR: u64 = 2434;
pub const CLASS_OMPSINGLEDIRECTIVE: u64 = 2435;
pub const CLASS_SIZEOFPACKEXPR: u64 = 2436;
pub const METHOD_GETOPERATORLOC_8: u64 = 2437;
pub const METHOD_GETPACKLOC: u64 = 2438;
pub const METHOD_GETRPARENLOC_23: u64 = 2439;
pub const METHOD_GETPACK: u64 = 2440;
pub const METHOD_GETPACKLENGTH: u64 = 2441;
pub const METHOD_ISPARTIALLYSUBSTITUTED: u64 = 2442;
pub const METHOD_GETPARTIALARGUMENTS: u64 = 2443;
pub const METHOD_GETBEGINLOC_116: u64 = 2444;
pub const METHOD_GETENDLOC_115: u64 = 2445;
pub const METHOD_CHILDREN_103: u64 = 2446;
pub const CLASS_OBJCTYPEPARAMTYPELOC: u64 = 2447;
pub const CLASS_WEBASSEMBLYFUNCREFATTR: u64 = 2448;
pub const CLASS_PRAGMACOMMENTDECL: u64 = 2449;
pub const METHOD_GETCOMMENTKIND: u64 = 2450;
pub const METHOD_GETARG: u64 = 2451;
pub const CLASS_ARRAYINITLOOPEXPR: u64 = 2452;
pub const METHOD_GETCOMMONEXPR: u64 = 2453;
pub const METHOD_GETSUBEXPR: u64 = 2454;
pub const METHOD_GETARRAYSIZE: u64 = 2455;
pub const METHOD_GETBEGINLOC_6: u64 = 2456;
pub const METHOD_GETENDLOC_5: u64 = 2457;
pub const METHOD_CHILDREN_2: u64 = 2458;
pub const CLASS_REQUIRESCAPABILITYATTR: u64 = 2459;
pub const CLASS_CORODISABLELIFETIMEBOUNDATTR: u64 = 2460;
pub const CLASS_OMPREQUIRESDECL: u64 = 2461;
pub const CLASS_USEDATTR: u64 = 2462;
pub const CLASS_REGCALLATTR: u64 = 2463;
pub const CLASS_EXPR: u64 = 2464;
pub const METHOD_GETTYPE_1: u64 = 2465;
pub const METHOD_GETDEPENDENCE_1: u64 = 2466;
pub const METHOD_ISVALUEDEPENDENT: u64 = 2467;
pub const METHOD_ISTYPEDEPENDENT: u64 = 2468;
pub const METHOD_ISINSTANTIATIONDEPENDENT: u64 = 2469;
pub const METHOD_CONTAINSUNEXPANDEDPARAMETERPACK_1: u64 = 2470;
pub const METHOD_CONTAINSERRORS_1: u64 = 2471;
pub const METHOD_GETEXPRLOC_14: u64 = 2472;
pub const METHOD_ISREADIFDISCARDEDINCPLUSPLUS11: u64 = 2473;
pub const METHOD_ISLVALUE: u64 = 2474;
pub const METHOD_ISPRVALUE: u64 = 2475;
pub const METHOD_ISXVALUE: u64 = 2476;
pub const METHOD_ISGLVALUE: u64 = 2477;
pub const METHOD_GETVALUEKIND: u64 = 2478;
pub const METHOD_GETOBJECTKIND: u64 = 2479;
pub const METHOD_ISORDINARYORBITFIELDOBJECT: u64 = 2480;
pub const METHOD_REFERSTOBITFIELD: u64 = 2481;
pub const METHOD_GETSOURCEBITFIELD: u64 = 2482;
pub const METHOD_GETREFERENCEDDECLOFCALLEE: u64 = 2483;
pub const METHOD_GETOBJCPROPERTY: u64 = 2484;
pub const METHOD_ISOBJCSELFEXPR: u64 = 2485;
pub const METHOD_REFERSTOVECTORELEMENT: u64 = 2486;
pub const METHOD_REFERSTOMATRIXELEMENT: u64 = 2487;
pub const METHOD_REFERSTOGLOBALREGISTERVAR: u64 = 2488;
pub const METHOD_HASPLACEHOLDERTYPE: u64 = 2489;
pub const METHOD_IGNOREUNLESSSPELLEDINSOURCE: u64 = 2490;
pub const METHOD_IGNOREIMPCASTS: u64 = 2491;
pub const METHOD_IGNORECASTS: u64 = 2492;
pub const METHOD_IGNOREIMPLICIT: u64 = 2493;
pub const METHOD_IGNOREIMPLICITASWRITTEN: u64 = 2494;
pub const METHOD_IGNOREPARENS: u64 = 2495;
pub const METHOD_IGNOREPARENIMPCASTS: u64 = 2496;
pub const METHOD_IGNOREPARENCASTS: u64 = 2497;
pub const METHOD_IGNORECONVERSIONOPERATORSINGLESTEP: u64 = 2498;
pub const METHOD_IGNOREPARENLVALUECASTS: u64 = 2499;
pub const METHOD_IGNOREPARENBASECASTS: u64 = 2500;
pub const METHOD_ISDEFAULTARGUMENT: u64 = 2501;
pub const METHOD_ISIMPLICITCXXTHIS: u64 = 2502;
pub const METHOD_GETBESTDYNAMICCLASSTYPE: u64 = 2503;
pub const METHOD_GETBESTDYNAMICCLASSTYPEEXPR: u64 = 2504;
pub const METHOD_SKIPRVALUESUBOBJECTADJUSTMENTS: u64 = 2505;
pub const CLASS_OBJCCLASSSTUBATTR: u64 = 2506;
pub const CLASS_CXX11NORETURNATTR: u64 = 2507;
pub const CLASS_MSPROPERTYREFEXPR: u64 = 2508;
pub const METHOD_GETSOURCERANGE_48: u64 = 2509;
pub const METHOD_ISIMPLICITACCESS_1: u64 = 2510;
pub const METHOD_GETBEGINLOC_93: u64 = 2511;
pub const METHOD_GETENDLOC_92: u64 = 2512;
pub const METHOD_CHILDREN_81: u64 = 2513;
pub const METHOD_GETBASEEXPR: u64 = 2514;
pub const METHOD_GETPROPERTYDECL: u64 = 2515;
pub const METHOD_ISARROW_3: u64 = 2516;
pub const METHOD_GETMEMBERLOC_1: u64 = 2517;
pub const METHOD_GETQUALIFIERLOC_13: u64 = 2518;
pub const CLASS_DIAGNOSEASBUILTINATTR: u64 = 2519;
pub const CLASS_COROONLYDESTROYWHENCOMPLETEATTR: u64 = 2520;
pub const CLASS_PRAGMACLANGRODATASECTIONATTR: u64 = 2521;
pub const CLASS_CALLBACKATTR: u64 = 2522;
pub const CLASS_RETAINATTR: u64 = 2523;
pub const CLASS_PTGUARDEDVARATTR: u64 = 2524;
pub const CLASS_SPECULATIVELOADHARDENINGATTR: u64 = 2525;
pub const CLASS_ALWAYSINLINEATTR: u64 = 2526;
pub const CLASS_CUDADEVICEATTR: u64 = 2527;
pub const CLASS_EXTVECTORTYPE: u64 = 2528;
pub const METHOD_ISSUGARED_20: u64 = 2529;
pub const METHOD_DESUGAR_20: u64 = 2530;
pub const CLASS_ASSERTEXCLUSIVELOCKATTR: u64 = 2531;
pub const CLASS_COMMONATTR: u64 = 2532;
pub const CLASS_REQDWORKGROUPSIZEATTR: u64 = 2533;
pub const CLASS_OBJCRUNTIMEVISIBLEATTR: u64 = 2534;
pub const CLASS_PASCALATTR: u64 = 2535;
pub const CLASS_AARCH64VECTORPCSATTR: u64 = 2536;
pub const CLASS_CXXMEMBERCALLEXPR: u64 = 2537;
pub const METHOD_GETIMPLICITOBJECTARGUMENT: u64 = 2538;
pub const METHOD_GETOBJECTTYPE: u64 = 2539;
pub const METHOD_GETMETHODDECL: u64 = 2540;
pub const METHOD_GETRECORDDECL: u64 = 2541;
pub const METHOD_GETEXPRLOC_3: u64 = 2542;
pub const CLASS_RETURNSTWICEATTR: u64 = 2543;
pub const CLASS_INITPRIORITYATTR: u64 = 2544;
pub const CLASS_RESTRICTATTR: u64 = 2545;
pub const CLASS_BPFPRESERVEACCESSINDEXATTR: u64 = 2546;
pub const CLASS_HLSLGROUPSHAREDADDRESSSPACEATTR: u64 = 2547;
pub const CLASS_SWIFTASYNCERRORATTR: u64 = 2548;
pub const CLASS_FLOATINGLITERAL: u64 = 2549;
pub const METHOD_GETVALUE_8: u64 = 2550;
pub const METHOD_GETRAWSEMANTICS: u64 = 2551;
pub const METHOD_GETSEMANTICS: u64 = 2552;
pub const METHOD_ISEXACT: u64 = 2553;
pub const METHOD_GETVALUEASAPPROXIMATEDOUBLE: u64 = 2554;
pub const METHOD_GETLOCATION_10: u64 = 2555;
pub const METHOD_GETBEGINLOC_75: u64 = 2556;
pub const METHOD_GETENDLOC_74: u64 = 2557;
pub const METHOD_CHILDREN_65: u64 = 2558;
pub const CLASS_PACKEDATTR: u64 = 2559;
pub const CLASS_GUARDEDBYATTR: u64 = 2560;
pub const CLASS_RETURNSNONNULLATTR: u64 = 2561;
pub const CLASS_CONSTANTARRAYTYPE: u64 = 2562;
pub const METHOD_GETSIZE: u64 = 2563;
pub const METHOD_GETSIZEEXPR: u64 = 2564;
pub const METHOD_ISSUGARED_8: u64 = 2565;
pub const METHOD_DESUGAR_8: u64 = 2566;
pub const CLASS_WEAKATTR: u64 = 2567;
pub const CLASS_CONSTINITATTR: u64 = 2568;
pub const CLASS_MATRIXSUBSCRIPTEXPR: u64 = 2569;
pub const METHOD_ISINCOMPLETE: u64 = 2570;
pub const METHOD_GETBASE_5: u64 = 2571;
pub const METHOD_GETROWIDX: u64 = 2572;
pub const METHOD_GETCOLUMNIDX: u64 = 2573;
pub const METHOD_GETBEGINLOC_96: u64 = 2574;
pub const METHOD_GETENDLOC_95: u64 = 2575;
pub const METHOD_GETEXPRLOC_8: u64 = 2576;
pub const METHOD_GETRBRACKETLOC_4: u64 = 2577;
pub const METHOD_CHILDREN_84: u64 = 2578;
pub const CLASS_SENTINELATTR: u64 = 2579;
pub const CLASS_NOTHROWATTR: u64 = 2580;
pub const CLASS_INCOMPLETEARRAYTYPE: u64 = 2581;
pub const METHOD_ISSUGARED_23: u64 = 2582;
pub const METHOD_DESUGAR_23: u64 = 2583;
pub const CLASS_CFRETURNSNOTRETAINEDATTR: u64 = 2584;
pub const CLASS_OMPTARGETPARALLELFORSIMDDIRECTIVE: u64 = 2585;
pub const CLASS_EMPTYDECL: u64 = 2586;
pub const CLASS_THISCALLATTR: u64 = 2587;
pub const CLASS_TEMPLATEPARAMOBJECTDECL: u64 = 2588;
pub const METHOD_GETVALUE_2: u64 = 2589;
pub const METHOD_GETCANONICALDECL_18: u64 = 2590;
pub const CLASS_TYPEVISIBILITYATTR: u64 = 2591;
pub const CLASS_OBJCINTERFACETYPE: u64 = 2592;
pub const CLASS_TYPENULLABLERESULTATTR: u64 = 2593;
pub const CLASS_CUDADEVICEBUILTINSURFACETYPEATTR: u64 = 2594;
pub const CLASS_MIPSINTERRUPTATTR: u64 = 2595;
pub const CLASS_OMPTEAMSDISTRIBUTEDIRECTIVE: u64 = 2596;
pub const CLASS_OWNERSHIPATTR: u64 = 2597;
pub const CLASS_NSRETURNSNOTRETAINEDATTR: u64 = 2598;
pub const CLASS_RELEASECAPABILITYATTR: u64 = 2599;
pub const CLASS_PUREATTR: u64 = 2600;
pub const CLASS_CXXBOOLLITERALEXPR: u64 = 2601;
pub const METHOD_GETVALUE_4: u64 = 2602;
pub const METHOD_GETBEGINLOC_20: u64 = 2603;
pub const METHOD_GETENDLOC_19: u64 = 2604;
pub const METHOD_GETLOCATION_1: u64 = 2605;
pub const METHOD_CHILDREN_14: u64 = 2606;
pub const CLASS_OPTIMIZENONEATTR: u64 = 2607;
pub const CLASS_LTOVISIBILITYPUBLICATTR: u64 = 2608;
pub const CLASS_OBJCSUBCLASSINGRESTRICTEDATTR: u64 = 2609;
pub const CLASS_NORETURNATTR: u64 = 2610;
pub const CLASS_LINKAGESPECDECL: u64 = 2611;
pub const METHOD_GETLANGUAGE: u64 = 2612;
pub const METHOD_HASBRACES_1: u64 = 2613;
pub const METHOD_GETEXTERNLOC_1: u64 = 2614;
pub const METHOD_GETRBRACELOC_2: u64 = 2615;
pub const METHOD_GETENDLOC_2: u64 = 2616;
pub const METHOD_GETSOURCERANGE_17: u64 = 2617;
pub const CLASS_NAMESPACEALIASDECL: u64 = 2618;
pub const METHOD_GETCANONICALDECL_14: u64 = 2619;
pub const METHOD_GETQUALIFIERLOC_1: u64 = 2620;
pub const METHOD_GETQUALIFIER_4: u64 = 2621;
pub const METHOD_GETNAMESPACE: u64 = 2622;
pub const METHOD_GETALIASLOC: u64 = 2623;
pub const METHOD_GETNAMESPACELOC: u64 = 2624;
pub const METHOD_GETTARGETNAMELOC: u64 = 2625;
pub const METHOD_GETALIASEDNAMESPACE: u64 = 2626;
pub const METHOD_GETSOURCERANGE_18: u64 = 2627;
pub const CLASS_OBJCNONRUNTIMEPROTOCOLATTR: u64 = 2628;
pub const CLASS_FINALATTR: u64 = 2629;
pub const CLASS_OBJCRETURNSINNERPOINTERATTR: u64 = 2630;
pub const CLASS_CPUDISPATCHATTR: u64 = 2631;
pub const CLASS_PTGUARDEDBYATTR: u64 = 2632;
pub const CLASS_DECL: u64 = 2633;
pub const METHOD_GETSOURCERANGE_5: u64 = 2634;
pub const METHOD_GETBEGINLOC: u64 = 2635;
pub const METHOD_GETENDLOC: u64 = 2636;
pub const METHOD_GETLOCATION: u64 = 2637;
pub const METHOD_GETKIND_6: u64 = 2638;
pub const METHOD_GETDECLKINDNAME: u64 = 2639;
pub const METHOD_GETNEXTDECLINCONTEXT: u64 = 2640;
pub const METHOD_GETDECLCONTEXT: u64 = 2641;
pub const METHOD_GETNONTRANSPARENTDECLCONTEXT: u64 = 2642;
pub const METHOD_GETNONCLOSURECONTEXT: u64 = 2643;
pub const METHOD_GETTRANSLATIONUNITDECL: u64 = 2644;
pub const METHOD_ISINANONYMOUSNAMESPACE: u64 = 2645;
pub const METHOD_ISINSTDNAMESPACE: u64 = 2646;
pub const METHOD_ISFILECONTEXTDECL: u64 = 2647;
pub const METHOD_GETASTCONTEXT_1: u64 = 2648;
pub const METHOD_GETLANGOPTS: u64 = 2649;
pub const METHOD_GETACCESS: u64 = 2650;
pub const METHOD_GETACCESSUNSAFE: u64 = 2651;
pub const METHOD_HASATTRS: u64 = 2652;
pub const METHOD_GETATTRS: u64 = 2653;
pub const METHOD_ATTRS: u64 = 2654;
pub const METHOD_ATTR_BEGIN: u64 = 2655;
pub const METHOD_ATTR_END: u64 = 2656;
pub const METHOD_GETMAXALIGNMENT: u64 = 2657;
pub const METHOD_ISINVALIDDECL: u64 = 2658;
pub const METHOD_ISIMPLICIT: u64 = 2659;
pub const METHOD_ISREFERENCED: u64 = 2660;
pub const METHOD_ISTHISDECLARATIONREFERENCED: u64 = 2661;
pub const METHOD_ISTOPLEVELDECLINOBJCCONTAINER: u64 = 2662;
pub const METHOD_GETEXTERNALSOURCESYMBOLATTR: u64 = 2663;
pub const METHOD_ISMODULEPRIVATE: u64 = 2664;
pub const METHOD_ISINEXPORTDECLCONTEXT: u64 = 2665;
pub const METHOD_ISINVISIBLEOUTSIDETHEOWNINGMODULE: u64 = 2666;
pub const METHOD_ISINANOTHERMODULEUNIT: u64 = 2667;
pub const METHOD_ISDISCARDEDINGLOBALMODULEFRAGMENT: u64 = 2668;
pub const METHOD_SHOULDSKIPCHECKINGODR: u64 = 2669;
pub const METHOD_HASDEFININGATTR: u64 = 2670;
pub const METHOD_GETDEFININGATTR: u64 = 2671;
pub const METHOD_GETVERSIONINTRODUCED: u64 = 2672;
pub const METHOD_ISWEAKIMPORTED: u64 = 2673;
pub const METHOD_ISFROMASTFILE: u64 = 2674;
pub const METHOD_GETGLOBALID: u64 = 2675;
pub const METHOD_GETOWNINGMODULEID: u64 = 2676;
pub const METHOD_GETIMPORTEDOWNINGMODULE: u64 = 2677;
pub const METHOD_GETLOCALOWNINGMODULE: u64 = 2678;
pub const METHOD_HASOWNINGMODULE: u64 = 2679;
pub const METHOD_GETOWNINGMODULE: u64 = 2680;
pub const METHOD_ISUNCONDITIONALLYVISIBLE: u64 = 2681;
pub const METHOD_ISREACHABLE: u64 = 2682;
pub const METHOD_GETMODULEOWNERSHIPKIND: u64 = 2683;
pub const METHOD_GETIDENTIFIERNAMESPACE: u64 = 2684;
pub const METHOD_HASTAGIDENTIFIERNAMESPACE: u64 = 2685;
pub const METHOD_GETLEXICALDECLCONTEXT: u64 = 2686;
pub const METHOD_ISOUTOFLINE: u64 = 2687;
pub const METHOD_ISTEMPLATED: u64 = 2688;
pub const METHOD_GETTEMPLATEDEPTH: u64 = 2689;
pub const METHOD_ISDEFINEDOUTSIDEFUNCTIONORMETHOD: u64 = 2690;
pub const METHOD_ISINLOCALSCOPEFORINSTANTIATION: u64 = 2691;
pub const METHOD_GETCANONICALDECL_7: u64 = 2692;
pub const METHOD_ISCANONICALDECL: u64 = 2693;
pub const METHOD_REDECLS: u64 = 2694;
pub const METHOD_REDECLS_BEGIN: u64 = 2695;
pub const METHOD_REDECLS_END: u64 = 2696;
pub const METHOD_GETPREVIOUSDECL_2: u64 = 2697;
pub const METHOD_ISFIRSTDECL: u64 = 2698;
pub const METHOD_GETMOSTRECENTDECL_3: u64 = 2699;
pub const METHOD_GETBODY_2: u64 = 2700;
pub const METHOD_HASBODY: u64 = 2701;
pub const METHOD_GETBODYRBRACE: u64 = 2702;
pub const METHOD_ISTEMPLATEPARAMETER: u64 = 2703;
pub const METHOD_ISTEMPLATEPARAMETERPACK: u64 = 2704;
pub const METHOD_ISPARAMETERPACK_1: u64 = 2705;
pub const METHOD_ISTEMPLATEDECL: u64 = 2706;
pub const METHOD_ISFUNCTIONORFUNCTIONTEMPLATE: u64 = 2707;
pub const METHOD_GETDESCRIBEDTEMPLATE: u64 = 2708;
pub const METHOD_GETDESCRIBEDTEMPLATEPARAMS: u64 = 2709;
pub const METHOD_GETASFUNCTION: u64 = 2710;
pub const METHOD_ISLOCALEXTERNDECL: u64 = 2711;
pub const METHOD_GETFRIENDOBJECTKIND: u64 = 2712;
pub const METHOD_GETID: u64 = 2713;
pub const METHOD_ISFUNCTIONPOINTERTYPE: u64 = 2714;
pub const CLASS_OBJCREQUIRESSUPERATTR: u64 = 2715;
pub const CLASS_CFUNKNOWNTRANSFERATTR: u64 = 2716;
pub const CLASS_PRESERVEMOSTATTR: u64 = 2717;
pub const CLASS_EXTVECTORTYPELOC: u64 = 2718;
pub const CLASS_OBJCREQUIRESPROPERTYDEFSATTR: u64 = 2719;
pub const CLASS_NODEBUGATTR: u64 = 2720;
pub const CLASS_PTR32ATTR: u64 = 2721;
pub const CLASS_HLSLRESOURCEATTR: u64 = 2722;
pub const CLASS_OBJCOWNERSHIPATTR: u64 = 2723;
pub const CLASS_AMDGPUKERNELCALLATTR: u64 = 2724;
pub const CLASS_EXCLUSIVETRYLOCKFUNCTIONATTR: u64 = 2725;
pub const CLASS_CONSTANTMATRIXTYPE: u64 = 2726;
pub const METHOD_GETNUMROWS: u64 = 2727;
pub const METHOD_GETNUMCOLUMNS: u64 = 2728;
pub const METHOD_GETNUMELEMENTSFLATTENED: u64 = 2729;
pub const CLASS_NOBUILTINATTR: u64 = 2730;
pub const CLASS_FIXEDPOINTLITERAL: u64 = 2731;
pub const METHOD_GETBEGINLOC_74: u64 = 2732;
pub const METHOD_GETENDLOC_73: u64 = 2733;
pub const METHOD_GETLOCATION_9: u64 = 2734;
pub const METHOD_GETSCALE: u64 = 2735;
pub const METHOD_CHILDREN_64: u64 = 2736;
pub const CLASS_SWIFTPRIVATEATTR: u64 = 2737;
pub const CLASS_OBJCBRIDGERELATEDATTR: u64 = 2738;
pub const CLASS_OBJCEXTERNALLYRETAINEDATTR: u64 = 2739;
pub const CLASS_LAMBDAEXPR: u64 = 2740;
pub const METHOD_GETCAPTUREDEFAULT: u64 = 2741;
pub const METHOD_GETCAPTUREDEFAULTLOC: u64 = 2742;
pub const METHOD_CAPTURES_3: u64 = 2743;
pub const METHOD_CAPTURE_BEGIN_2: u64 = 2744;
pub const METHOD_CAPTURE_END_2: u64 = 2745;
pub const METHOD_CAPTURE_SIZE_1: u64 = 2746;
pub const METHOD_EXPLICIT_CAPTURES: u64 = 2747;
pub const METHOD_EXPLICIT_CAPTURE_BEGIN: u64 = 2748;
pub const METHOD_EXPLICIT_CAPTURE_END: u64 = 2749;
pub const METHOD_IMPLICIT_CAPTURES: u64 = 2750;
pub const METHOD_IMPLICIT_CAPTURE_BEGIN: u64 = 2751;
pub const METHOD_IMPLICIT_CAPTURE_END: u64 = 2752;
pub const METHOD_CAPTURE_INITS_1: u64 = 2753;
pub const METHOD_CAPTURE_INIT_BEGIN_1: u64 = 2754;
pub const METHOD_CAPTURE_INIT_END_1: u64 = 2755;
pub const METHOD_GETINTRODUCERRANGE: u64 = 2756;
pub const METHOD_GETLAMBDACLASS: u64 = 2757;
pub const METHOD_GETCALLOPERATOR: u64 = 2758;
pub const METHOD_GETDEPENDENTCALLOPERATOR: u64 = 2759;
pub const METHOD_GETTEMPLATEPARAMETERLIST: u64 = 2760;
pub const METHOD_GETEXPLICITTEMPLATEPARAMETERS: u64 = 2761;
pub const METHOD_GETTRAILINGREQUIRESCLAUSE_1: u64 = 2762;
pub const METHOD_ISGENERICLAMBDA_1: u64 = 2763;
pub const METHOD_GETBODY_9: u64 = 2764;
pub const METHOD_GETCOMPOUNDSTMTBODY: u64 = 2765;
pub const METHOD_ISMUTABLE_1: u64 = 2766;
pub const METHOD_HASEXPLICITPARAMETERS: u64 = 2767;
pub const METHOD_HASEXPLICITRESULTTYPE: u64 = 2768;
pub const METHOD_GETBEGINLOC_90: u64 = 2769;
pub const METHOD_GETENDLOC_89: u64 = 2770;
pub const METHOD_CHILDREN_78: u64 = 2771;
pub const CLASS_MIPSLONGCALLATTR: u64 = 2772;
pub const CLASS_OBJCBRIDGEMUTABLEATTR: u64 = 2773;
pub const CLASS_DEPENDENTBITINTTYPELOC: u64 = 2774;
pub const CLASS_ARMINOUTATTR: u64 = 2775;
pub const CLASS_SUBSTNONTYPETEMPLATEPARMPACKEXPR: u64 = 2776;
pub const METHOD_GETASSOCIATEDDECL_3: u64 = 2777;
pub const METHOD_GETINDEX_5: u64 = 2778;
pub const METHOD_GETPARAMETERPACK_1: u64 = 2779;
pub const METHOD_GETPARAMETERPACKLOCATION_1: u64 = 2780;
pub const METHOD_GETARGUMENTPACK_1: u64 = 2781;
pub const METHOD_GETBEGINLOC_121: u64 = 2782;
pub const METHOD_GETENDLOC_120: u64 = 2783;
pub const METHOD_CHILDREN_109: u64 = 2784;
pub const CLASS_CXXPSEUDODESTRUCTOREXPR: u64 = 2785;
pub const METHOD_GETBASE_1: u64 = 2786;
pub const METHOD_HASQUALIFIER: u64 = 2787;
pub const METHOD_GETQUALIFIERLOC_9: u64 = 2788;
pub const METHOD_GETQUALIFIER_12: u64 = 2789;
pub const METHOD_ISARROW_1: u64 = 2790;
pub const METHOD_GETOPERATORLOC_4: u64 = 2791;
pub const METHOD_GETSCOPETYPEINFO: u64 = 2792;
pub const METHOD_GETCOLONCOLONLOC: u64 = 2793;
pub const METHOD_GETTILDELOC: u64 = 2794;
pub const METHOD_GETDESTROYEDTYPEINFO: u64 = 2795;
pub const METHOD_GETDESTROYEDTYPEIDENTIFIER: u64 = 2796;
pub const METHOD_GETDESTROYEDTYPE_1: u64 = 2797;
pub const METHOD_GETDESTROYEDTYPELOC: u64 = 2798;
pub const METHOD_GETBEGINLOC_37: u64 = 2799;
pub const METHOD_GETENDLOC_36: u64 = 2800;
pub const METHOD_CHILDREN_28: u64 = 2801;
pub const CLASS_OSRETURNSRETAINEDONZEROATTR: u64 = 2802;
pub const CLASS_OSRETURNSRETAINEDONNONZEROATTR: u64 = 2803;
pub const CLASS_SPTRATTR: u64 = 2804;
pub const CLASS_OBJCBRIDGEDCASTEXPR: u64 = 2805;
pub const CLASS_CAPTUREDDECL: u64 = 2806;
pub const METHOD_GETBODY_1: u64 = 2807;
pub const METHOD_ISNOTHROW: u64 = 2808;
pub const METHOD_GETNUMPARAMS_2: u64 = 2809;
pub const METHOD_PARAMETERS_1: u64 = 2810;
pub const METHOD_GETCONTEXTPARAM: u64 = 2811;
pub const METHOD_GETCONTEXTPARAMPOSITION: u64 = 2812;
pub const METHOD_PARAM_BEGIN_2: u64 = 2813;
pub const METHOD_PARAM_END_2: u64 = 2814;
pub const CLASS_TYPEDEFDECL: u64 = 2815;
pub const METHOD_GETSOURCERANGE_30: u64 = 2816;
pub const CLASS_PRESERVEALLATTR: u64 = 2817;
pub const CLASS_OBJCOBJECTTYPELOC: u64 = 2818;
pub const CLASS_OMPDECLAREVARIANTATTR: u64 = 2819;
pub const CLASS_PARMVARDECL: u64 = 2820;
pub const METHOD_GETSOURCERANGE_21: u64 = 2821;
pub const METHOD_ISOBJCMETHODPARAMETER: u64 = 2822;
pub const METHOD_ISDESTROYEDINCALLEE: u64 = 2823;
pub const METHOD_GETFUNCTIONSCOPEDEPTH: u64 = 2824;
pub const METHOD_GETFUNCTIONSCOPEINDEX: u64 = 2825;
pub const METHOD_GETOBJCDECLQUALIFIER: u64 = 2826;
pub const METHOD_ISKNRPROMOTED: u64 = 2827;
pub const METHOD_ISEXPLICITOBJECTPARAMETER: u64 = 2828;
pub const METHOD_GETEXPLICITOBJECTPARAMTHISLOC: u64 = 2829;
pub const METHOD_GETDEFAULTARG: u64 = 2830;
pub const METHOD_GETDEFAULTARGRANGE: u64 = 2831;
pub const METHOD_GETUNINSTANTIATEDDEFAULTARG: u64 = 2832;
pub const METHOD_HASDEFAULTARG: u64 = 2833;
pub const METHOD_HASUNPARSEDDEFAULTARG: u64 = 2834;
pub const METHOD_HASUNINSTANTIATEDDEFAULTARG: u64 = 2835;
pub const METHOD_HASINHERITEDDEFAULTARG: u64 = 2836;
pub const METHOD_GETORIGINALTYPE_1: u64 = 2837;
pub const CLASS_OBJCEXPLICITPROTOCOLIMPLATTR: u64 = 2838;
pub const CLASS_OMPALLOCATEDECLATTR: u64 = 2839;
pub const CLASS_NSRETURNSAUTORELEASEDATTR: u64 = 2840;
pub const CLASS_FUNCTIONTYPE: u64 = 2841;
pub const METHOD_GETRETURNTYPE: u64 = 2842;
pub const METHOD_GETHASREGPARM: u64 = 2843;
pub const METHOD_GETREGPARMTYPE: u64 = 2844;
pub const METHOD_GETNORETURNATTR: u64 = 2845;
pub const METHOD_GETCMSENSCALLATTR: u64 = 2846;
pub const METHOD_GETCALLCONV: u64 = 2847;
pub const METHOD_GETEXTINFO: u64 = 2848;
pub const METHOD_ISCONST: u64 = 2849;
pub const METHOD_ISVOLATILE: u64 = 2850;
pub const METHOD_ISRESTRICT: u64 = 2851;
pub const CLASS_MICROMIPSATTR: u64 = 2852;
pub const CLASS_HLSLANNOTATIONATTR: u64 = 2853;
pub const CLASS_HIPMANAGEDATTR: u64 = 2854;
pub const CLASS_MACROQUALIFIEDTYPELOC: u64 = 2855;
pub const METHOD_GETINNERLOC: u64 = 2856;
pub const METHOD_GETMACROIDENTIFIER_1: u64 = 2857;
pub const METHOD_GETEXPANSIONLOC: u64 = 2858;
pub const METHOD_GETINNERTYPE_6: u64 = 2859;
pub const METHOD_GETLOCALSOURCERANGE_7: u64 = 2860;
pub const CLASS_ZEROCALLUSEDREGSATTR: u64 = 2861;
pub const CLASS_OBJCEXCEPTIONATTR: u64 = 2862;
pub const CLASS_NOTTAILCALLEDATTR: u64 = 2863;
pub const CLASS_OMPCANCELLATIONPOINTDIRECTIVE: u64 = 2864;
pub const CLASS_TARGETVERSIONATTR: u64 = 2865;
pub const CLASS_DEFAULTSTMT: u64 = 2866;
pub const METHOD_GETSUBSTMT_2: u64 = 2867;
pub const METHOD_GETDEFAULTLOC_1: u64 = 2868;
pub const METHOD_GETBEGINLOC_65: u64 = 2869;
pub const METHOD_GETENDLOC_64: u64 = 2870;
pub const METHOD_CHILDREN_55: u64 = 2871;
pub const CLASS_NOUWTABLEATTR: u64 = 2872;
pub const CLASS_NOUNIQUEADDRESSATTR: u64 = 2873;
pub const CLASS_VAARGEXPR: u64 = 2874;
pub const METHOD_GETSUBEXPR_10: u64 = 2875;
pub const METHOD_ISMICROSOFTABI: u64 = 2876;
pub const METHOD_GETWRITTENTYPEINFO: u64 = 2877;
pub const METHOD_GETBUILTINLOC_5: u64 = 2878;
pub const METHOD_GETRPARENLOC_27: u64 = 2879;
pub const METHOD_GETBEGINLOC_131: u64 = 2880;
pub const METHOD_GETENDLOC_130: u64 = 2881;
pub const METHOD_CHILDREN_117: u64 = 2882;
pub const CLASS_NOTHREADSAFETYANALYSISATTR: u64 = 2883;
pub const CLASS_NOSPLITSTACKATTR: u64 = 2884;
pub const CLASS_OBJCAVAILABILITYCHECKEXPR: u64 = 2885;
pub const CLASS_MSNOVTABLEATTR: u64 = 2886;
pub const CLASS_NSCONSUMESSELFATTR: u64 = 2887;
pub const CLASS_FUNCTIONRETURNTHUNKSATTR: u64 = 2888;
pub const CLASS_INTELOCLBICCATTR: u64 = 2889;
pub const CLASS_NOSPECULATIVELOADHARDENINGATTR: u64 = 2890;
pub const CLASS_TEMPLATETYPEPARMTYPE: u64 = 2891;
pub const METHOD_GETDEPTH: u64 = 2892;
pub const METHOD_GETINDEX_2: u64 = 2893;
pub const METHOD_ISPARAMETERPACK: u64 = 2894;
pub const METHOD_GETDECL_4: u64 = 2895;
pub const METHOD_GETIDENTIFIER_3: u64 = 2896;
pub const METHOD_ISSUGARED_38: u64 = 2897;
pub const METHOD_DESUGAR_38: u64 = 2898;
pub const CLASS_BLOCKEXPR: u64 = 2899;
pub const METHOD_GETBLOCKDECL: u64 = 2900;
pub const METHOD_GETCARETLOCATION_1: u64 = 2901;
pub const METHOD_GETBODY_4: u64 = 2902;
pub const METHOD_GETBEGINLOC_15: u64 = 2903;
pub const METHOD_GETENDLOC_14: u64 = 2904;
pub const METHOD_GETFUNCTIONTYPE: u64 = 2905;
pub const METHOD_CHILDREN_11: u64 = 2906;
pub const CLASS_SWIFTNEWTYPEATTR: u64 = 2907;
pub const CLASS_AVAILABILITYATTR: u64 = 2908;
pub const CLASS_OBJCDIRECTATTR: u64 = 2909;
pub const CLASS_SUBSTTEMPLATETYPEPARMTYPE: u64 = 2910;
pub const METHOD_GETREPLACEMENTTYPE: u64 = 2911;
pub const METHOD_GETASSOCIATEDDECL_1: u64 = 2912;
pub const METHOD_GETREPLACEDPARAMETER_1: u64 = 2913;
pub const METHOD_GETINDEX_1: u64 = 2914;
pub const METHOD_GETPACKINDEX: u64 = 2915;
pub const METHOD_ISSUGARED_36: u64 = 2916;
pub const METHOD_DESUGAR_36: u64 = 2917;
pub const CLASS_IBOUTLETATTR: u64 = 2918;
pub const CLASS_DLLIMPORTATTR: u64 = 2919;
pub const CLASS_MODEATTR: u64 = 2920;
pub const CLASS_UNNAMEDGLOBALCONSTANTDECL: u64 = 2921;
pub const METHOD_GETVALUE_3: u64 = 2922;
pub const CLASS_INHERITABLEPARAMATTR: u64 = 2923;
pub const CLASS_FLATTENATTR: u64 = 2924;
pub const CLASS_NOSANITIZEATTR: u64 = 2925;
pub const CLASS_OMPPARALLELMASTERTASKLOOPSIMDDIRECTIVE: u64 = 2926;
pub const CLASS_NORANDOMIZELAYOUTATTR: u64 = 2927;
pub const CLASS_PARENTYPE: u64 = 2928;
pub const METHOD_GETINNERTYPE: u64 = 2929;
pub const METHOD_ISSUGARED_30: u64 = 2930;
pub const METHOD_DESUGAR_30: u64 = 2931;
pub const CLASS_SYSVABIATTR: u64 = 2932;
pub const CLASS_NOMIPS16ATTR: u64 = 2933;
pub const CLASS_NODESTROYATTR: u64 = 2934;
pub const CLASS_POINTERTYPE: u64 = 2935;
pub const METHOD_GETPOINTEETYPE_4: u64 = 2936;
pub const METHOD_ISSUGARED_32: u64 = 2937;
pub const METHOD_DESUGAR_32: u64 = 2938;
pub const CLASS_OMPCANCELDIRECTIVE: u64 = 2939;
pub const CLASS_STMT: u64 = 2940;
pub const METHOD_GETSTMTCLASS: u64 = 2941;
pub const METHOD_GETSTMTCLASSNAME: u64 = 2942;
pub const METHOD_GETSOURCERANGE_49: u64 = 2943;
pub const METHOD_GETBEGINLOC_133: u64 = 2944;
pub const METHOD_GETENDLOC_132: u64 = 2945;
pub const METHOD_STRIPLABELLIKESTATEMENTS: u64 = 2946;
pub const METHOD_CHILDREN_105: u64 = 2947;
pub const METHOD_CHILD_BEGIN: u64 = 2948;
pub const METHOD_CHILD_END: u64 = 2949;
pub const CLASS_DEPENDENTSIZEDARRAYTYPELOC: u64 = 2950;
pub const CLASS_OBJCATSYNCHRONIZEDSTMT: u64 = 2951;
pub const CLASS_ATOMICEXPR: u64 = 2952;
pub const METHOD_GETPTR: u64 = 2953;
pub const METHOD_GETORDER: u64 = 2954;
pub const METHOD_GETSCOPE: u64 = 2955;
pub const METHOD_GETVAL1: u64 = 2956;
pub const METHOD_GETORDERFAIL: u64 = 2957;
pub const METHOD_GETVAL2: u64 = 2958;
pub const METHOD_GETWEAK: u64 = 2959;
pub const METHOD_GETVALUETYPE_1: u64 = 2960;
pub const METHOD_GETOP: u64 = 2961;
pub const METHOD_GETOPASSTRING: u64 = 2962;
pub const METHOD_GETNUMSUBEXPRS: u64 = 2963;
pub const METHOD_GETSUBEXPRS: u64 = 2964;
pub const METHOD_ISVOLATILE_3: u64 = 2965;
pub const METHOD_ISCMPXCHG: u64 = 2966;
pub const METHOD_ISOPENCL: u64 = 2967;
pub const METHOD_GETBUILTINLOC_1: u64 = 2968;
pub const METHOD_GETRPARENLOC_3: u64 = 2969;
pub const METHOD_GETBEGINLOC_11: u64 = 2970;
pub const METHOD_GETENDLOC_10: u64 = 2971;
pub const METHOD_CHILDREN_7: u64 = 2972;
pub const METHOD_GETSCOPEMODEL: u64 = 2973;
pub const CLASS_SWIFTOBJCMEMBERSATTR: u64 = 2974;
pub const CLASS_NOALIASATTR: u64 = 2975;
pub const CLASS_ATTRIBUTEDTYPELOC: u64 = 2976;
pub const METHOD_GETATTRKIND_1: u64 = 2977;
pub const METHOD_ISQUALIFIER_1: u64 = 2978;
pub const METHOD_GETMODIFIEDLOC: u64 = 2979;
pub const METHOD_GETATTR_1: u64 = 2980;
pub const METHOD_GETLOCALSOURCERANGE_8: u64 = 2981;
pub const METHOD_GETINNERTYPE_7: u64 = 2982;
pub const CLASS_PCSATTR: u64 = 2983;
pub const CLASS_NSRETURNSRETAINEDATTR: u64 = 2984;
pub const CLASS_LOCKRETURNEDATTR: u64 = 2985;
pub const CLASS_HLSLSHADERATTR: u64 = 2986;
pub const CLASS_STDCALLATTR: u64 = 2987;
pub const CLASS_OBJCRUNTIMENAMEATTR: u64 = 2988;
pub const CLASS_DEPENDENTSCOPEDECLREFEXPR: u64 = 2989;
pub const METHOD_GETNAMEINFO_5: u64 = 2990;
pub const METHOD_GETDECLNAME_1: u64 = 2991;
pub const METHOD_GETLOCATION_8: u64 = 2992;
pub const METHOD_GETQUALIFIERLOC_11: u64 = 2993;
pub const METHOD_GETQUALIFIER_14: u64 = 2994;
pub const METHOD_GETTEMPLATEKEYWORDLOC_4: u64 = 2995;
pub const METHOD_GETLANGLELOC_2: u64 = 2996;
pub const METHOD_GETRANGLELOC_2: u64 = 2997;
pub const METHOD_HASTEMPLATEKEYWORD_2: u64 = 2998;
pub const METHOD_HASEXPLICITTEMPLATEARGS_3: u64 = 2999;
pub const METHOD_GETTEMPLATEARGS_4: u64 = 3000;
pub const METHOD_GETNUMTEMPLATEARGS_2: u64 = 3001;
pub const METHOD_TEMPLATE_ARGUMENTS_4: u64 = 3002;
pub const METHOD_GETBEGINLOC_67: u64 = 3003;
pub const METHOD_GETENDLOC_66: u64 = 3004;
pub const METHOD_CHILDREN_57: u64 = 3005;
pub const CLASS_MATRIXTYPELOC: u64 = 3006;
pub const METHOD_GETATTRNAMELOC_1: u64 = 3007;
pub const METHOD_GETATTRROWOPERAND: u64 = 3008;
pub const METHOD_GETATTRCOLUMNOPERAND: u64 = 3009;
pub const METHOD_GETATTROPERANDPARENSRANGE_1: u64 = 3010;
pub const METHOD_GETLOCALSOURCERANGE_9: u64 = 3011;
pub const CLASS_MINSIZEATTR: u64 = 3012;
pub const CLASS_MAYALIASATTR: u64 = 3013;
pub const CLASS_MAYBEUNDEFATTR: u64 = 3014;
pub const CLASS_TYPEDEFTYPE: u64 = 3015;
pub const METHOD_GETDECL_5: u64 = 3016;
pub const METHOD_ISSUGARED_41: u64 = 3017;
pub const METHOD_DESUGAR_41: u64 = 3018;
pub const METHOD_TYPEMATCHESDECL: u64 = 3019;
pub const CLASS_TYPEDECL: u64 = 3020;
pub const METHOD_GETTYPEFORDECL: u64 = 3021;
pub const METHOD_GETBEGINLOC_3: u64 = 3022;
pub const METHOD_GETSOURCERANGE_29: u64 = 3023;
pub const CLASS_TLSMODELATTR: u64 = 3024;
pub const CLASS_MIPSSHORTCALLATTR: u64 = 3025;
pub const CLASS_NOPROFILEFUNCTIONATTR: u64 = 3026;
pub const CLASS_NSCONSUMEDATTR: u64 = 3027;
pub const CLASS_ANNOTATETYPEATTR: u64 = 3028;
pub const CLASS_MSVTORDISPATTR: u64 = 3029;
pub const CLASS_MSSTRUCTATTR: u64 = 3030;
pub const CLASS_AARCH64SVEPCSATTR: u64 = 3031;
pub const CLASS_HLSLNUMTHREADSATTR: u64 = 3032;
pub const CLASS_TRIVIALABIATTR: u64 = 3033;
pub const CLASS_MAXFIELDALIGNMENTATTR: u64 = 3034;
pub const CLASS_MSP430INTERRUPTATTR: u64 = 3035;
pub const CLASS_TYPE: u64 = 3036;
pub const METHOD_GETTYPECLASS: u64 = 3037;
pub const METHOD_ISFROMAST: u64 = 3038;
pub const METHOD_CONTAINSUNEXPANDEDPARAMETERPACK: u64 = 3039;
pub const METHOD_ISCANONICALUNQUALIFIED: u64 = 3040;
pub const METHOD_GETLOCALLYUNQUALIFIEDSINGLESTEPDESUGAREDTYPE: u64 = 3041;
pub const METHOD_ISSIZELESSTYPE: u64 = 3042;
pub const METHOD_ISSIZELESSBUILTINTYPE: u64 = 3043;
pub const METHOD_ISSIZELESSVECTORTYPE: u64 = 3044;
pub const METHOD_ISSVESIZELESSBUILTINTYPE: u64 = 3045;
pub const METHOD_ISRVVSIZELESSBUILTINTYPE: u64 = 3046;
pub const METHOD_ISWEBASSEMBLYEXTERNREFTYPE: u64 = 3047;
pub const METHOD_ISWEBASSEMBLYTABLETYPE: u64 = 3048;
pub const METHOD_ISSVEVLSBUILTINTYPE: u64 = 3049;
pub const METHOD_ISRVVVLSBUILTINTYPE: u64 = 3050;
pub const METHOD_ISINCOMPLETEOROBJECTTYPE: u64 = 3051;
pub const METHOD_ISOBJECTTYPE: u64 = 3052;
pub const METHOD_ISSTRUCTURALTYPE: u64 = 3053;
pub const METHOD_ISSTANDARDLAYOUTTYPE: u64 = 3054;
pub const METHOD_ISBUILTINTYPE: u64 = 3055;
pub const METHOD_ISPLACEHOLDERTYPE_1: u64 = 3056;
pub const METHOD_GETASPLACEHOLDERTYPE: u64 = 3057;
pub const METHOD_ISNONOVERLOADPLACEHOLDERTYPE_1: u64 = 3058;
pub const METHOD_ISINTEGERTYPE: u64 = 3059;
pub const METHOD_ISENUMERALTYPE: u64 = 3060;
pub const METHOD_ISSCOPEDENUMERALTYPE: u64 = 3061;
pub const METHOD_ISBOOLEANTYPE: u64 = 3062;
pub const METHOD_ISCHARTYPE: u64 = 3063;
pub const METHOD_ISWIDECHARTYPE: u64 = 3064;
pub const METHOD_ISCHAR8TYPE: u64 = 3065;
pub const METHOD_ISCHAR16TYPE: u64 = 3066;
pub const METHOD_ISCHAR32TYPE: u64 = 3067;
pub const METHOD_ISANYCHARACTERTYPE: u64 = 3068;
pub const METHOD_ISINTEGRALORENUMERATIONTYPE: u64 = 3069;
pub const METHOD_ISINTEGRALORUNSCOPEDENUMERATIONTYPE: u64 = 3070;
pub const METHOD_ISUNSCOPEDENUMERATIONTYPE: u64 = 3071;
pub const METHOD_ISREALFLOATINGTYPE: u64 = 3072;
pub const METHOD_ISCOMPLEXTYPE: u64 = 3073;
pub const METHOD_ISANYCOMPLEXTYPE: u64 = 3074;
pub const METHOD_ISFLOATINGTYPE: u64 = 3075;
pub const METHOD_ISHALFTYPE: u64 = 3076;
pub const METHOD_ISFLOAT16TYPE: u64 = 3077;
pub const METHOD_ISBFLOAT16TYPE: u64 = 3078;
pub const METHOD_ISFLOAT128TYPE: u64 = 3079;
pub const METHOD_ISIBM128TYPE: u64 = 3080;
pub const METHOD_ISREALTYPE: u64 = 3081;
pub const METHOD_ISARITHMETICTYPE: u64 = 3082;
pub const METHOD_ISVOIDTYPE: u64 = 3083;
pub const METHOD_ISSCALARTYPE: u64 = 3084;
pub const METHOD_ISAGGREGATETYPE: u64 = 3085;
pub const METHOD_ISFUNDAMENTALTYPE: u64 = 3086;
pub const METHOD_ISCOMPOUNDTYPE: u64 = 3087;
pub const METHOD_ISFUNCTIONTYPE: u64 = 3088;
pub const METHOD_ISFUNCTIONNOPROTOTYPE: u64 = 3089;
pub const METHOD_ISFUNCTIONPROTOTYPE: u64 = 3090;
pub const METHOD_ISPOINTERTYPE: u64 = 3091;
pub const METHOD_ISANYPOINTERTYPE: u64 = 3092;
pub const METHOD_ISBLOCKPOINTERTYPE: u64 = 3093;
pub const METHOD_ISVOIDPOINTERTYPE: u64 = 3094;
pub const METHOD_ISREFERENCETYPE: u64 = 3095;
pub const METHOD_ISLVALUEREFERENCETYPE: u64 = 3096;
pub const METHOD_ISRVALUEREFERENCETYPE: u64 = 3097;
pub const METHOD_ISOBJECTPOINTERTYPE: u64 = 3098;
pub const METHOD_ISFUNCTIONPOINTERTYPE_1: u64 = 3099;
pub const METHOD_ISFUNCTIONREFERENCETYPE: u64 = 3100;
pub const METHOD_ISMEMBERPOINTERTYPE: u64 = 3101;
pub const METHOD_ISMEMBERFUNCTIONPOINTERTYPE: u64 = 3102;
pub const METHOD_ISMEMBERDATAPOINTERTYPE: u64 = 3103;
pub const METHOD_ISARRAYTYPE: u64 = 3104;
pub const METHOD_ISCONSTANTARRAYTYPE: u64 = 3105;
pub const METHOD_ISINCOMPLETEARRAYTYPE: u64 = 3106;
pub const METHOD_ISVARIABLEARRAYTYPE: u64 = 3107;
pub const METHOD_ISDEPENDENTSIZEDARRAYTYPE: u64 = 3108;
pub const METHOD_ISRECORDTYPE: u64 = 3109;
pub const METHOD_ISCLASSTYPE: u64 = 3110;
pub const METHOD_ISSTRUCTURETYPE: u64 = 3111;
pub const METHOD_ISOBJCBOXABLERECORDTYPE: u64 = 3112;
pub const METHOD_ISINTERFACETYPE: u64 = 3113;
pub const METHOD_ISSTRUCTUREORCLASSTYPE: u64 = 3114;
pub const METHOD_ISUNIONTYPE: u64 = 3115;
pub const METHOD_ISCOMPLEXINTEGERTYPE: u64 = 3116;
pub const METHOD_ISVECTORTYPE: u64 = 3117;
pub const METHOD_ISEXTVECTORTYPE: u64 = 3118;
pub const METHOD_ISEXTVECTORBOOLTYPE: u64 = 3119;
pub const METHOD_ISMATRIXTYPE: u64 = 3120;
pub const METHOD_ISCONSTANTMATRIXTYPE: u64 = 3121;
pub const METHOD_ISDEPENDENTADDRESSSPACETYPE: u64 = 3122;
pub const METHOD_ISOBJCOBJECTPOINTERTYPE: u64 = 3123;
pub const METHOD_ISOBJCRETAINABLETYPE: u64 = 3124;
pub const METHOD_ISOBJCLIFETIMETYPE: u64 = 3125;
pub const METHOD_ISOBJCINDIRECTLIFETIMETYPE: u64 = 3126;
pub const METHOD_ISOBJCNSOBJECTTYPE: u64 = 3127;
pub const METHOD_ISOBJCINDEPENDENTCLASSTYPE: u64 = 3128;
pub const METHOD_ISOBJCOBJECTTYPE: u64 = 3129;
pub const METHOD_ISOBJCQUALIFIEDINTERFACETYPE: u64 = 3130;
pub const METHOD_ISOBJCQUALIFIEDIDTYPE: u64 = 3131;
pub const METHOD_ISOBJCQUALIFIEDCLASSTYPE: u64 = 3132;
pub const METHOD_ISOBJCOBJECTORINTERFACETYPE: u64 = 3133;
pub const METHOD_ISOBJCIDTYPE: u64 = 3134;
pub const METHOD_ISDECLTYPETYPE: u64 = 3135;
pub const METHOD_ISOBJCINERTUNSAFEUNRETAINEDTYPE: u64 = 3136;
pub const METHOD_ISOBJCCLASSTYPE: u64 = 3137;
pub const METHOD_ISOBJCCLASSORCLASSKINDOFTYPE: u64 = 3138;
pub const METHOD_ISOBJCSELTYPE: u64 = 3139;
pub const METHOD_ISOBJCBUILTINTYPE: u64 = 3140;
pub const METHOD_ISOBJCARCBRIDGABLETYPE: u64 = 3141;
pub const METHOD_ISCARCBRIDGABLETYPE: u64 = 3142;
pub const METHOD_ISTEMPLATETYPEPARMTYPE: u64 = 3143;
pub const METHOD_ISNULLPTRTYPE: u64 = 3144;
pub const METHOD_ISNOTHROWT: u64 = 3145;
pub const METHOD_ISALIGNVALT: u64 = 3146;
pub const METHOD_ISSTDBYTETYPE: u64 = 3147;
pub const METHOD_ISATOMICTYPE: u64 = 3148;
pub const METHOD_ISUNDEDUCEDAUTOTYPE: u64 = 3149;
pub const METHOD_ISTYPEDEFNAMETYPE: u64 = 3150;
pub const METHOD_ISOCLIMAGE1DROTYPE: u64 = 3151;
pub const METHOD_ISOCLIMAGE1DARRAYROTYPE: u64 = 3152;
pub const METHOD_ISOCLIMAGE1DBUFFERROTYPE: u64 = 3153;
pub const METHOD_ISOCLIMAGE2DROTYPE: u64 = 3154;
pub const METHOD_ISOCLIMAGE2DARRAYROTYPE: u64 = 3155;
pub const METHOD_ISOCLIMAGE2DDEPTHROTYPE: u64 = 3156;
pub const METHOD_ISOCLIMAGE2DARRAYDEPTHROTYPE: u64 = 3157;
pub const METHOD_ISOCLIMAGE2DMSAAROTYPE: u64 = 3158;
pub const METHOD_ISOCLIMAGE2DARRAYMSAAROTYPE: u64 = 3159;
pub const METHOD_ISOCLIMAGE2DMSAADEPTHROTYPE: u64 = 3160;
pub const METHOD_ISOCLIMAGE2DARRAYMSAADEPTHROTYPE: u64 = 3161;
pub const METHOD_ISOCLIMAGE3DROTYPE: u64 = 3162;
pub const METHOD_ISOCLIMAGE1DWOTYPE: u64 = 3163;
pub const METHOD_ISOCLIMAGE1DARRAYWOTYPE: u64 = 3164;
pub const METHOD_ISOCLIMAGE1DBUFFERWOTYPE: u64 = 3165;
pub const METHOD_ISOCLIMAGE2DWOTYPE: u64 = 3166;
pub const METHOD_ISOCLIMAGE2DARRAYWOTYPE: u64 = 3167;
pub const METHOD_ISOCLIMAGE2DDEPTHWOTYPE: u64 = 3168;
pub const METHOD_ISOCLIMAGE2DARRAYDEPTHWOTYPE: u64 = 3169;
pub const METHOD_ISOCLIMAGE2DMSAAWOTYPE: u64 = 3170;
pub const METHOD_ISOCLIMAGE2DARRAYMSAAWOTYPE: u64 = 3171;
pub const METHOD_ISOCLIMAGE2DMSAADEPTHWOTYPE: u64 = 3172;
pub const METHOD_ISOCLIMAGE2DARRAYMSAADEPTHWOTYPE: u64 = 3173;
pub const METHOD_ISOCLIMAGE3DWOTYPE: u64 = 3174;
pub const METHOD_ISOCLIMAGE1DRWTYPE: u64 = 3175;
pub const METHOD_ISOCLIMAGE1DARRAYRWTYPE: u64 = 3176;
pub const METHOD_ISOCLIMAGE1DBUFFERRWTYPE: u64 = 3177;
pub const METHOD_ISOCLIMAGE2DRWTYPE: u64 = 3178;
pub const METHOD_ISOCLIMAGE2DARRAYRWTYPE: u64 = 3179;
pub const METHOD_ISOCLIMAGE2DDEPTHRWTYPE: u64 = 3180;
pub const METHOD_ISOCLIMAGE2DARRAYDEPTHRWTYPE: u64 = 3181;
pub const METHOD_ISOCLIMAGE2DMSAARWTYPE: u64 = 3182;
pub const METHOD_ISOCLIMAGE2DARRAYMSAARWTYPE: u64 = 3183;
pub const METHOD_ISOCLIMAGE2DMSAADEPTHRWTYPE: u64 = 3184;
pub const METHOD_ISOCLIMAGE2DARRAYMSAADEPTHRWTYPE: u64 = 3185;
pub const METHOD_ISOCLIMAGE3DRWTYPE: u64 = 3186;
pub const METHOD_ISIMAGETYPE: u64 = 3187;
pub const METHOD_ISSAMPLERT: u64 = 3188;
pub const METHOD_ISEVENTT: u64 = 3189;
pub const METHOD_ISCLKEVENTT: u64 = 3190;
pub const METHOD_ISQUEUET: u64 = 3191;
pub const METHOD_ISRESERVEIDT: u64 = 3192;
pub const METHOD_ISOCLINTELSUBGROUPAVCMCEPAYLOADTYPE: u64 = 3193;
pub const METHOD_ISOCLINTELSUBGROUPAVCIMEPAYLOADTYPE: u64 = 3194;
pub const METHOD_ISOCLINTELSUBGROUPAVCREFPAYLOADTYPE: u64 = 3195;
pub const METHOD_ISOCLINTELSUBGROUPAVCSICPAYLOADTYPE: u64 = 3196;
pub const METHOD_ISOCLINTELSUBGROUPAVCMCERESULTTYPE: u64 = 3197;
pub const METHOD_ISOCLINTELSUBGROUPAVCIMERESULTTYPE: u64 = 3198;
pub const METHOD_ISOCLINTELSUBGROUPAVCREFRESULTTYPE: u64 = 3199;
pub const METHOD_ISOCLINTELSUBGROUPAVCSICRESULTTYPE: u64 = 3200;
pub const METHOD_ISOCLINTELSUBGROUPAVCIMERESULTSINGLEREFERENCESTREAMOUTTYPE: u64 = 3201;
pub const METHOD_ISOCLINTELSUBGROUPAVCIMERESULTDUALREFERENCESTREAMOUTTYPE: u64 = 3202;
pub const METHOD_ISOCLINTELSUBGROUPAVCIMESINGLEREFERENCESTREAMINTYPE: u64 = 3203;
pub const METHOD_ISOCLINTELSUBGROUPAVCIMEDUALREFERENCESTREAMINTYPE: u64 = 3204;
pub const METHOD_ISOCLINTELSUBGROUPAVCTYPE: u64 = 3205;
pub const METHOD_ISOCLEXTOPAQUETYPE: u64 = 3206;
pub const METHOD_ISPIPETYPE: u64 = 3207;
pub const METHOD_ISBITINTTYPE: u64 = 3208;
pub const METHOD_ISOPENCLSPECIFICTYPE: u64 = 3209;
pub const METHOD_ISOBJCARCIMPLICITLYUNRETAINEDTYPE: u64 = 3210;
pub const METHOD_ISCUDADEVICEBUILTINSURFACETYPE: u64 = 3211;
pub const METHOD_ISCUDADEVICEBUILTINTEXTURETYPE: u64 = 3212;
pub const METHOD_GETOBJCARCIMPLICITLIFETIME: u64 = 3213;
pub const METHOD_GETSCALARTYPEKIND: u64 = 3214;
pub const METHOD_GETDEPENDENCE: u64 = 3215;
pub const METHOD_CONTAINSERRORS: u64 = 3216;
pub const METHOD_ISDEPENDENTTYPE_1: u64 = 3217;
pub const METHOD_ISINSTANTIATIONDEPENDENTTYPE: u64 = 3218;
pub const METHOD_ISUNDEDUCEDTYPE: u64 = 3219;
pub const METHOD_ISVARIABLYMODIFIEDTYPE: u64 = 3220;
pub const METHOD_HASSIZEDVLATYPE: u64 = 3221;
pub const METHOD_HASUNNAMEDORLOCALTYPE: u64 = 3222;
pub const METHOD_ISOVERLOADABLETYPE: u64 = 3223;
pub const METHOD_ISELABORATEDTYPESPECIFIER: u64 = 3224;
pub const METHOD_CANDECAYTOPOINTERTYPE: u64 = 3225;
pub const METHOD_HASPOINTERREPRESENTATION: u64 = 3226;
pub const METHOD_HASOBJCPOINTERREPRESENTATION: u64 = 3227;
pub const METHOD_HASINTEGERREPRESENTATION: u64 = 3228;
pub const METHOD_HASSIGNEDINTEGERREPRESENTATION: u64 = 3229;
pub const METHOD_HASUNSIGNEDINTEGERREPRESENTATION: u64 = 3230;
pub const METHOD_HASFLOATINGREPRESENTATION: u64 = 3231;
pub const METHOD_GETASSTRUCTURETYPE: u64 = 3232;
pub const METHOD_GETASUNIONTYPE: u64 = 3233;
pub const METHOD_GETASCOMPLEXINTEGERTYPE: u64 = 3234;
pub const METHOD_GETASOBJCINTERFACETYPE: u64 = 3235;
pub const METHOD_GETASOBJCINTERFACEPOINTERTYPE: u64 = 3236;
pub const METHOD_GETASOBJCQUALIFIEDIDTYPE: u64 = 3237;
pub const METHOD_GETASOBJCQUALIFIEDCLASSTYPE: u64 = 3238;
pub const METHOD_GETASOBJCQUALIFIEDINTERFACETYPE: u64 = 3239;
pub const METHOD_GETASCXXRECORDDECL: u64 = 3240;
pub const METHOD_GETASRECORDDECL: u64 = 3241;
pub const METHOD_GETASTAGDECL: u64 = 3242;
pub const METHOD_GETPOINTEECXXRECORDDECL: u64 = 3243;
pub const METHOD_GETCONTAINEDDEDUCEDTYPE: u64 = 3244;
pub const METHOD_GETCONTAINEDAUTOTYPE: u64 = 3245;
pub const METHOD_HASAUTOFORTRAILINGRETURNTYPE: u64 = 3246;
pub const METHOD_GETASARRAYTYPEUNSAFE: u64 = 3247;
pub const METHOD_CASTASARRAYTYPEUNSAFE: u64 = 3248;
pub const METHOD_GETBASEELEMENTTYPEUNSAFE: u64 = 3249;
pub const METHOD_GETARRAYELEMENTTYPENOTYPEQUAL: u64 = 3250;
pub const METHOD_GETPOINTEEORARRAYELEMENTTYPE: u64 = 3251;
pub const METHOD_GETPOINTEETYPE_6: u64 = 3252;
pub const METHOD_GETUNQUALIFIEDDESUGAREDTYPE: u64 = 3253;
pub const METHOD_ISSIGNEDINTEGERTYPE: u64 = 3254;
pub const METHOD_ISUNSIGNEDINTEGERTYPE: u64 = 3255;
pub const METHOD_ISSIGNEDINTEGERORENUMERATIONTYPE: u64 = 3256;
pub const METHOD_ISUNSIGNEDINTEGERORENUMERATIONTYPE: u64 = 3257;
pub const METHOD_ISFIXEDPOINTTYPE: u64 = 3258;
pub const METHOD_ISFIXEDPOINTORINTEGERTYPE: u64 = 3259;
pub const METHOD_ISSATURATEDFIXEDPOINTTYPE: u64 = 3260;
pub const METHOD_ISUNSATURATEDFIXEDPOINTTYPE: u64 = 3261;
pub const METHOD_ISSIGNEDFIXEDPOINTTYPE: u64 = 3262;
pub const METHOD_ISUNSIGNEDFIXEDPOINTTYPE: u64 = 3263;
pub const METHOD_ISCONSTANTSIZETYPE: u64 = 3264;
pub const METHOD_ISSPECIFIERTYPE: u64 = 3265;
pub const METHOD_GETLINKAGE: u64 = 3266;
pub const METHOD_GETVISIBILITY: u64 = 3267;
pub const METHOD_ISVISIBILITYEXPLICIT: u64 = 3268;
pub const METHOD_GETLINKAGEANDVISIBILITY: u64 = 3269;
pub const METHOD_ISLINKAGEVALID_1: u64 = 3270;
pub const METHOD_GETNULLABILITY: u64 = 3271;
pub const METHOD_ACCEPTSOBJCTYPEPARAMS: u64 = 3272;
pub const METHOD_GETTYPECLASSNAME: u64 = 3273;
pub const METHOD_GETCANONICALTYPEINTERNAL: u64 = 3274;
pub const METHOD_GETCANONICALTYPEUNQUALIFIED: u64 = 3275;
pub const CLASS_RETURNTYPESTATEATTR: u64 = 3276;
pub const CLASS_OBJCBOXEDEXPR: u64 = 3277;
pub const CLASS_CONSTATTR: u64 = 3278;
pub const CLASS_MSINHERITANCEATTR: u64 = 3279;
pub const CLASS_MSCONSTEXPRATTR: u64 = 3280;
pub const CLASS_ADJUSTEDTYPE: u64 = 3281;
pub const METHOD_GETORIGINALTYPE: u64 = 3282;
pub const METHOD_GETADJUSTEDTYPE: u64 = 3283;
pub const METHOD_ISSUGARED: u64 = 3284;
pub const METHOD_DESUGAR: u64 = 3285;
pub const CLASS_SWIFTBRIDGEDTYPEDEFATTR: u64 = 3286;
pub const CLASS_OBJCMETHODFAMILYATTR: u64 = 3287;
pub const CLASS_LOCKSEXCLUDEDATTR: u64 = 3288;
pub const CLASS_BITINTTYPELOC: u64 = 3289;
pub const CLASS_OBJCENCODEEXPR: u64 = 3290;
pub const CLASS_HOTATTR: u64 = 3291;
pub const CLASS_OMPTHREADPRIVATEDECLATTR: u64 = 3292;
pub const CLASS_INTEGERLITERAL: u64 = 3293;
pub const METHOD_GETBEGINLOC_88: u64 = 3294;
pub const METHOD_GETENDLOC_87: u64 = 3295;
pub const METHOD_GETLOCATION_11: u64 = 3296;
pub const METHOD_CHILDREN_76: u64 = 3297;
pub const CLASS_MSALLOCATORATTR: u64 = 3298;
pub const CLASS_ENUMEXTENSIBILITYATTR: u64 = 3299;
pub const CLASS_CUDACONSTANTATTR: u64 = 3300;
pub const CLASS_NOSTACKPROTECTORATTR: u64 = 3301;
pub const CLASS_DIAGNOSEIFATTR: u64 = 3302;
pub const CLASS_INJECTEDCLASSNAMETYPE: u64 = 3303;
pub const METHOD_GETINJECTEDSPECIALIZATIONTYPE: u64 = 3304;
pub const METHOD_GETINJECTEDTST: u64 = 3305;
pub const METHOD_GETTEMPLATENAME_1: u64 = 3306;
pub const METHOD_GETDECL_1: u64 = 3307;
pub const METHOD_ISSUGARED_24: u64 = 3308;
pub const METHOD_DESUGAR_24: u64 = 3309;
pub const CLASS_PIPETYPE: u64 = 3310;
pub const METHOD_GETELEMENTTYPE_5: u64 = 3311;
pub const METHOD_ISSUGARED_31: u64 = 3312;
pub const METHOD_DESUGAR_31: u64 = 3313;
pub const METHOD_ISREADONLY: u64 = 3314;
pub const CLASS_MIGSERVERROUTINEATTR: u64 = 3315;
pub const CLASS_CXXMETHODDECL: u64 = 3316;
pub const METHOD_ISSTATIC: u64 = 3317;
pub const METHOD_ISINSTANCE: u64 = 3318;
pub const METHOD_ISEXPLICITOBJECTMEMBERFUNCTION: u64 = 3319;
pub const METHOD_ISIMPLICITOBJECTMEMBERFUNCTION: u64 = 3320;
pub const METHOD_ISCONST_1: u64 = 3321;
pub const METHOD_ISVOLATILE_1: u64 = 3322;
pub const METHOD_ISVIRTUAL: u64 = 3323;
pub const METHOD_ISCOPYASSIGNMENTOPERATOR: u64 = 3324;
pub const METHOD_ISMOVEASSIGNMENTOPERATOR: u64 = 3325;
pub const METHOD_GETCANONICALDECL_3: u64 = 3326;
pub const METHOD_GETMOSTRECENTDECL: u64 = 3327;
pub const METHOD_BEGIN_OVERRIDDEN_METHODS: u64 = 3328;
pub const METHOD_END_OVERRIDDEN_METHODS: u64 = 3329;
pub const METHOD_SIZE_OVERRIDDEN_METHODS: u64 = 3330;
pub const METHOD_OVERRIDDEN_METHODS: u64 = 3331;
pub const METHOD_GETPARENT: u64 = 3332;
pub const METHOD_GETTHISTYPE: u64 = 3333;
pub const METHOD_GETFUNCTIONOBJECTPARAMETERREFERENCETYPE: u64 = 3334;
pub const METHOD_GETFUNCTIONOBJECTPARAMETERTYPE: u64 = 3335;
pub const METHOD_GETNUMEXPLICITPARAMS: u64 = 3336;
pub const METHOD_GETMETHODQUALIFIERS: u64 = 3337;
pub const METHOD_GETREFQUALIFIER_1: u64 = 3338;
pub const METHOD_HASINLINEBODY: u64 = 3339;
pub const METHOD_ISLAMBDASTATICINVOKER: u64 = 3340;
pub const CLASS_RANDOMIZELAYOUTATTR: u64 = 3341;
pub const CLASS_COROWRAPPERATTR: u64 = 3342;
pub const CLASS_CLASSTEMPLATEPARTIALSPECIALIZATIONDECL: u64 = 3343;
pub const METHOD_GETTEMPLATEPARAMETERS: u64 = 3344;
pub const METHOD_HASASSOCIATEDCONSTRAINTS: u64 = 3345;
pub const METHOD_GETTEMPLATEARGSASWRITTEN: u64 = 3346;
pub const METHOD_GETINSTANTIATEDFROMMEMBER: u64 = 3347;
pub const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_1: u64 = 3348;
pub const METHOD_GETINJECTEDSPECIALIZATIONTYPE_1: u64 = 3349;
pub const CLASS_TYPENULLUNSPECIFIEDATTR: u64 = 3350;
pub const CLASS_CORORETURNTYPEATTR: u64 = 3351;
pub const CLASS_UNRESOLVEDUSINGTYPE: u64 = 3352;
pub const METHOD_GETDECL_6: u64 = 3353;
pub const METHOD_ISSUGARED_43: u64 = 3354;
pub const METHOD_DESUGAR_43: u64 = 3355;
pub const CLASS_ADDRLABELEXPR: u64 = 3356;
pub const METHOD_GETAMPAMPLOC: u64 = 3357;
pub const METHOD_GETLABELLOC: u64 = 3358;
pub const METHOD_GETBEGINLOC_4: u64 = 3359;
pub const METHOD_GETENDLOC_3: u64 = 3360;
pub const METHOD_GETLABEL: u64 = 3361;
pub const METHOD_CHILDREN: u64 = 3362;
pub const CLASS_CUDAINVALIDTARGETATTR: u64 = 3363;
pub const CLASS_M68KRTDATTR: u64 = 3364;
pub const CLASS_OMPDECLARETARGETDECLATTR: u64 = 3365;
pub const CLASS_LIFETIMEBOUNDATTR: u64 = 3366;
pub const CLASS_PARENLISTEXPR: u64 = 3367;
pub const METHOD_GETNUMEXPRS: u64 = 3368;
pub const METHOD_GETLPARENLOC_7: u64 = 3369;
pub const METHOD_GETRPARENLOC_20: u64 = 3370;
pub const METHOD_GETBEGINLOC_104: u64 = 3371;
pub const METHOD_GETENDLOC_103: u64 = 3372;
pub const METHOD_CHILDREN_92: u64 = 3373;
pub const CLASS_CARRIESDEPENDENCYATTR: u64 = 3374;
pub const CLASS_LEAFATTR: u64 = 3375;
pub const CLASS_ENUMTYPELOC: u64 = 3376;
pub const METHOD_GETDECL_11: u64 = 3377;
pub const CLASS_RISCVINTERRUPTATTR: u64 = 3378;
pub const CLASS_OVERLOADABLEATTR: u64 = 3379;
pub const CLASS_LAYOUTVERSIONATTR: u64 = 3380;
pub const CLASS_CMSENSENTRYATTR: u64 = 3381;
pub const CLASS_DESTRUCTORATTR: u64 = 3382;
pub const CLASS_DEPENDENTBITINTTYPE: u64 = 3383;
pub const METHOD_ISUNSIGNED_1: u64 = 3384;
pub const METHOD_ISSIGNED_1: u64 = 3385;
pub const METHOD_GETNUMBITSEXPR: u64 = 3386;
pub const METHOD_ISSUGARED_12: u64 = 3387;
pub const METHOD_DESUGAR_12: u64 = 3388;
pub const CLASS_OBJCDIRECTMEMBERSATTR: u64 = 3389;
pub const CLASS_IBOUTLETCOLLECTIONATTR: u64 = 3390;
pub const CLASS_CXXFORRANGESTMT: u64 = 3391;
pub const METHOD_GETINIT_2: u64 = 3392;
pub const METHOD_GETLOOPVARIABLE: u64 = 3393;
pub const METHOD_GETRANGEINIT: u64 = 3394;
pub const METHOD_GETRANGESTMT: u64 = 3395;
pub const METHOD_GETBEGINSTMT: u64 = 3396;
pub const METHOD_GETENDSTMT: u64 = 3397;
pub const METHOD_GETCOND_2: u64 = 3398;
pub const METHOD_GETINC: u64 = 3399;
pub const METHOD_GETLOOPVARSTMT: u64 = 3400;
pub const METHOD_GETBODY_5: u64 = 3401;
pub const METHOD_GETFORLOC: u64 = 3402;
pub const METHOD_GETCOAWAITLOC: u64 = 3403;
pub const METHOD_GETCOLONLOC_2: u64 = 3404;
pub const METHOD_GETRPARENLOC_6: u64 = 3405;
pub const METHOD_GETBEGINLOC_28: u64 = 3406;
pub const METHOD_GETENDLOC_27: u64 = 3407;
pub const METHOD_CHILDREN_22: u64 = 3408;
pub const CLASS_CONCEPTDECL: u64 = 3409;
pub const METHOD_GETCONSTRAINTEXPR: u64 = 3410;
pub const METHOD_GETSOURCERANGE_4: u64 = 3411;
pub const METHOD_ISTYPECONCEPT: u64 = 3412;
pub const METHOD_GETCANONICALDECL_6: u64 = 3413;
pub const CLASS_DISABLETAILCALLSATTR: u64 = 3414;
pub const CLASS_FORMATATTR: u64 = 3415;
pub const CLASS_REDECLARABLETEMPLATEDECL: u64 = 3416;
pub const METHOD_GETCANONICALDECL_16: u64 = 3417;
pub const METHOD_ISMEMBERSPECIALIZATION: u64 = 3418;
pub const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_3: u64 = 3419;
pub const CLASS_PARENTYPELOC: u64 = 3420;
pub const METHOD_GETLPARENLOC_13: u64 = 3421;
pub const METHOD_GETRPARENLOC_31: u64 = 3422;
pub const METHOD_GETLOCALSOURCERANGE_10: u64 = 3423;
pub const METHOD_GETINNERLOC_1: u64 = 3424;
pub const METHOD_GETINNERTYPE_8: u64 = 3425;
pub const CLASS_OMPTASKWAITDIRECTIVE: u64 = 3426;
pub const CLASS_WARNUNUSEDRESULTATTR: u64 = 3427;
pub const CLASS_DEPENDENTSIZEDARRAYTYPE: u64 = 3428;
pub const METHOD_GETSIZEEXPR_1: u64 = 3429;
pub const METHOD_GETBRACKETSRANGE: u64 = 3430;
pub const METHOD_GETLBRACKETLOC: u64 = 3431;
pub const METHOD_GETRBRACKETLOC: u64 = 3432;
pub const METHOD_ISSUGARED_14: u64 = 3433;
pub const METHOD_DESUGAR_14: u64 = 3434;
pub const CLASS_CXXCONSTCASTEXPR: u64 = 3435;
pub const CLASS_CALLEXPR: u64 = 3436;
pub const METHOD_GETCALLEE_1: u64 = 3437;
pub const METHOD_GETADLCALLKIND: u64 = 3438;
pub const METHOD_USESADL: u64 = 3439;
pub const METHOD_HASSTOREDFPFEATURES_1: u64 = 3440;
pub const METHOD_GETCALLEEDECL: u64 = 3441;
pub const METHOD_GETDIRECTCALLEE: u64 = 3442;
pub const METHOD_GETNUMARGS_3: u64 = 3443;
pub const METHOD_GETARGS_1: u64 = 3444;
pub const METHOD_ARGUMENTS_2: u64 = 3445;
pub const METHOD_ARG_BEGIN_2: u64 = 3446;
pub const METHOD_ARG_END_2: u64 = 3447;
pub const METHOD_GETSTOREDFPFEATURES_1: u64 = 3448;
pub const METHOD_GETFPFEATURES_1: u64 = 3449;
pub const METHOD_GETBUILTINCALLEE: u64 = 3450;
pub const METHOD_GETRPARENLOC_11: u64 = 3451;
pub const METHOD_GETBEGINLOC_48: u64 = 3452;
pub const METHOD_GETENDLOC_47: u64 = 3453;
pub const METHOD_ISCALLTOSTDMOVE: u64 = 3454;
pub const METHOD_CHILDREN_37: u64 = 3455;
pub const CLASS_FLAGENUMATTR: u64 = 3456;
pub const CLASS_CUDAHOSTATTR: u64 = 3457;
pub const CLASS_XRAYINSTRUMENTATTR: u64 = 3458;
pub const CLASS_ARRAYSUBSCRIPTEXPR: u64 = 3459;
pub const METHOD_GETLHS: u64 = 3460;
pub const METHOD_GETRHS: u64 = 3461;
pub const METHOD_GETBASE: u64 = 3462;
pub const METHOD_GETIDX: u64 = 3463;
pub const METHOD_GETBEGINLOC_7: u64 = 3464;
pub const METHOD_GETENDLOC_6: u64 = 3465;
pub const METHOD_GETRBRACKETLOC_2: u64 = 3466;
pub const METHOD_GETEXPRLOC: u64 = 3467;
pub const METHOD_CHILDREN_3: u64 = 3468;
pub const CLASS_DISABLESANITIZERINSTRUMENTATIONATTR: u64 = 3469;
pub const CLASS_GUARDEDVARATTR: u64 = 3470;
pub const CLASS_OBJCBRIDGEATTR: u64 = 3471;
pub const CLASS_GNUINLINEATTR: u64 = 3472;
pub const CLASS_WEAKIMPORTATTR: u64 = 3473;
pub const CLASS_FORMATARGATTR: u64 = 3474;
pub const CLASS_USINGTYPELOC: u64 = 3475;
pub const METHOD_GETUNDERLYINGTYPE_5: u64 = 3476;
pub const METHOD_GETFOUNDDECL_4: u64 = 3477;
pub const CLASS_EXTERNALSOURCESYMBOLATTR: u64 = 3478;
pub const CLASS_ENFORCETCBLEAFATTR: u64 = 3479;
pub const CLASS_OVERLOADEXPR: u64 = 3480;
pub const METHOD_GETNAMINGCLASS: u64 = 3481;
pub const METHOD_DECLS_BEGIN: u64 = 3482;
pub const METHOD_DECLS_END: u64 = 3483;
pub const METHOD_DECLS_1: u64 = 3484;
pub const METHOD_GETNUMDECLS: u64 = 3485;
pub const METHOD_GETNAMEINFO_7: u64 = 3486;
pub const METHOD_GETNAME_2: u64 = 3487;
pub const METHOD_GETNAMELOC: u64 = 3488;
pub const METHOD_GETQUALIFIER_16: u64 = 3489;
pub const METHOD_GETQUALIFIERLOC_15: u64 = 3490;
pub const METHOD_GETTEMPLATEKEYWORDLOC_6: u64 = 3491;
pub const METHOD_GETLANGLELOC_4: u64 = 3492;
pub const METHOD_GETRANGLELOC_4: u64 = 3493;
pub const METHOD_HASTEMPLATEKEYWORD_4: u64 = 3494;
pub const METHOD_HASEXPLICITTEMPLATEARGS_5: u64 = 3495;
pub const METHOD_GETTEMPLATEARGS_6: u64 = 3496;
pub const METHOD_GETNUMTEMPLATEARGS_4: u64 = 3497;
pub const METHOD_TEMPLATE_ARGUMENTS_6: u64 = 3498;
pub const CLASS_EXCLUDEFROMEXPLICITINSTANTIATIONATTR: u64 = 3499;
pub const CLASS_AVRINTERRUPTATTR: u64 = 3500;
pub const CLASS_SWIFTCALLATTR: u64 = 3501;
pub const CLASS_ENABLEIFATTR: u64 = 3502;
pub const CLASS_ANYX86NOCFCHECKATTR: u64 = 3503;
pub const CLASS_SETTYPESTATEATTR: u64 = 3504;
pub const CLASS_OSRETURNSRETAINEDATTR: u64 = 3505;
pub const CLASS_OWNERATTR: u64 = 3506;
pub const CLASS_NOMICROMIPSATTR: u64 = 3507;
pub const CLASS_DEPRECATEDATTR: u64 = 3508;
pub const CLASS_TESTTYPESTATEATTR: u64 = 3509;
pub const CLASS_CFAUDITEDTRANSFERATTR: u64 = 3510;
pub const CLASS_HLSLPARAMMODIFIERATTR: u64 = 3511;
pub const CLASS_OVERRIDEATTR: u64 = 3512;
pub const CLASS_DLLIMPORTSTATICLOCALATTR: u64 = 3513;
pub const CLASS_OMPFLUSHDIRECTIVE: u64 = 3514;
pub const CLASS_IMPLICITPARAMDECL: u64 = 3515;
pub const METHOD_GETPARAMETERKIND: u64 = 3516;
pub const CLASS_PREFERREDNAMEATTR: u64 = 3517;
pub const CLASS_ALWAYSDESTROYATTR: u64 = 3518;
pub const CLASS_BLOCKSATTR: u64 = 3519;
pub const CLASS_NODUPLICATEATTR: u64 = 3520;
pub const CLASS_OPENCLGENERICADDRESSSPACEATTR: u64 = 3521;
pub const CLASS_OSCONSUMEDATTR: u64 = 3522;
pub const CLASS_DLLEXPORTSTATICLOCALATTR: u64 = 3523;
pub const CLASS_ATTRIBUTEDTYPE: u64 = 3524;
pub const METHOD_GETATTRKIND: u64 = 3525;
pub const METHOD_GETMODIFIEDTYPE: u64 = 3526;
pub const METHOD_GETEQUIVALENTTYPE: u64 = 3527;
pub const METHOD_ISSUGARED_2: u64 = 3528;
pub const METHOD_DESUGAR_2: u64 = 3529;
pub const METHOD_ISQUALIFIER: u64 = 3530;
pub const METHOD_ISMSTYPESPEC: u64 = 3531;
pub const METHOD_ISWEBASSEMBLYFUNCREFSPEC: u64 = 3532;
pub const METHOD_ISCALLINGCONV: u64 = 3533;
pub const METHOD_GETIMMEDIATENULLABILITY: u64 = 3534;
pub const CLASS_VECTORTYPE: u64 = 3535;
pub const METHOD_GETELEMENTTYPE_6: u64 = 3536;
pub const METHOD_GETNUMELEMENTS: u64 = 3537;
pub const METHOD_ISSUGARED_46: u64 = 3538;
pub const METHOD_DESUGAR_46: u64 = 3539;
pub const METHOD_GETVECTORKIND_1: u64 = 3540;
pub const CLASS_OPENCLINTELREQDSUBGROUPSIZEATTR: u64 = 3541;
pub const CLASS_SUBSTTEMPLATETYPEPARMPACKTYPE: u64 = 3542;
pub const METHOD_GETIDENTIFIER_2: u64 = 3543;
pub const METHOD_GETASSOCIATEDDECL: u64 = 3544;
pub const METHOD_GETREPLACEDPARAMETER: u64 = 3545;
pub const METHOD_GETINDEX: u64 = 3546;
pub const METHOD_GETFINAL: u64 = 3547;
pub const METHOD_GETNUMARGS: u64 = 3548;
pub const METHOD_ISSUGARED_35: u64 = 3549;
pub const METHOD_DESUGAR_35: u64 = 3550;
pub const METHOD_GETARGUMENTPACK: u64 = 3551;
pub const CLASS_DEDUCEDTEMPLATESPECIALIZATIONTYPE: u64 = 3552;
pub const METHOD_GETTEMPLATENAME: u64 = 3553;
pub const CLASS_OBJCCATEGORYIMPLDECL: u64 = 3554;
pub const CLASS_ELABORATEDTYPE: u64 = 3555;
pub const METHOD_GETQUALIFIER_2: u64 = 3556;
pub const METHOD_GETNAMEDTYPE: u64 = 3557;
pub const METHOD_DESUGAR_18: u64 = 3558;
pub const METHOD_ISSUGARED_18: u64 = 3559;
pub const METHOD_GETOWNEDTAGDECL: u64 = 3560;
pub const CLASS_RECORDTYPE: u64 = 3561;
pub const METHOD_GETDECL_2: u64 = 3562;
pub const METHOD_HASCONSTFIELDS: u64 = 3563;
pub const METHOD_ISSUGARED_34: u64 = 3564;
pub const METHOD_DESUGAR_34: u64 = 3565;
pub const CLASS_OBJCSTRINGLITERAL: u64 = 3566;
pub const CLASS_BTFTAGATTRIBUTEDTYPE: u64 = 3567;
pub const METHOD_GETWRAPPEDTYPE: u64 = 3568;
pub const METHOD_GETATTR: u64 = 3569;
pub const METHOD_ISSUGARED_3: u64 = 3570;
pub const METHOD_DESUGAR_3: u64 = 3571;
pub const CLASS_DEPENDENTUNARYTRANSFORMTYPE: u64 = 3572;
pub const CLASS_OBJCOBJECTTYPE: u64 = 3573;
pub const CLASS_ERRORATTR: u64 = 3574;
pub const CLASS_ATOMICTYPE: u64 = 3575;
pub const METHOD_GETVALUETYPE: u64 = 3576;
pub const METHOD_ISSUGARED_1: u64 = 3577;
pub const METHOD_DESUGAR_1: u64 = 3578;
pub const CLASS_TYPEWITHKEYWORD: u64 = 3579;
pub const METHOD_GETKEYWORD_1: u64 = 3580;
...
pub const CLASS_DLLEXPORTATTR: u64 = 3589;
pub const CLASS_OBJCOBJECTTYPEIMPL: u64 = 3590;
...
pub const CLASS_DEPENDENTTEMPLATESPECIALIZATIONTYPE: u64 = 3596;
pub const METHOD_GETQUALIFIER_1: u64 = 3597;
pub const METHOD_GETIDENTIFIER_1: u64 = 3598;
pub const METHOD_TEMPLATE_ARGUMENTS: u64 = 3599;
pub const METHOD_ISSUGARED_16: u64 = 3600;
pub const METHOD_DESUGAR_16: u64 = 3601;
pub const CLASS_OMPTASKYIELDDIRECTIVE: u64 = 3602;
pub const CLASS_MATRIXTYPE: u64 = 3603;
pub const METHOD_GETELEMENTTYPE_4: u64 = 3604;
pub const METHOD_ISSUGARED_27: u64 = 3605;
pub const METHOD_DESUGAR_27: u64 = 3606;
pub const CLASS_CHARACTERLITERAL: u64 = 3607;
pub const METHOD_GETLOCATION_6: u64 = 3608;
pub const METHOD_GETKIND_3: u64 = 3609;
pub const METHOD_GETBEGINLOC_51: u64 = 3610;
pub const METHOD_GETENDLOC_50: u64 = 3611;
pub const METHOD_GETVALUE_6: u64 = 3612;
pub const METHOD_CHILDREN_41: u64 = 3613;
pub const CLASS_DECLTYPETYPE: u64 = 3614;
pub const METHOD_GETUNDERLYINGEXPR: u64 = 3615;
pub const METHOD_GETUNDERLYINGTYPE: u64 = 3616;
pub const METHOD_DESUGAR_9: u64 = 3617;
pub const METHOD_ISSUGARED_9: u64 = 3618;
pub const CLASS_MACROQUALIFIEDTYPE: u64 = 3619;
pub const METHOD_GETMACROIDENTIFIER: u64 = 3620;
pub const METHOD_GETUNDERLYINGTYPE_1: u64 = 3621;
pub const METHOD_GETMODIFIEDTYPE_1: u64 = 3622;
pub const METHOD_ISSUGARED_26: u64 = 3623;
pub const METHOD_DESUGAR_26: u64 = 3624;
pub const CLASS_TYPEOFEXPRTYPE: u64 = 3625;
pub const METHOD_GETUNDERLYINGEXPR_1: u64 = 3626;
pub const METHOD_GETKIND_1: u64 = 3627;
pub const METHOD_DESUGAR_39: u64 = 3628;
pub const METHOD_ISSUGARED_39: u64 = 3629;
pub const CLASS_RVALUEREFERENCETYPE: u64 = 3630;
pub const METHOD_ISSUGARED_33: u64 = 3631;
pub const METHOD_DESUGAR_33: u64 = 3632;
pub const CLASS_USINGTYPE: u64 = 3633;
pub const METHOD_GETFOUNDDECL: u64 = 3634;
pub const METHOD_GETUNDERLYINGTYPE_3: u64 = 3635;
pub const METHOD_ISSUGARED_44: u64 = 3636;
pub const METHOD_DESUGAR_44: u64 = 3637;
pub const METHOD_TYPEMATCHESDECL_1: u64 = 3638;
pub const CLASS_CONSUMABLESETONREADATTR: u64 = 3639;
pub const CLASS_DEPENDENTDECLTYPETYPE: u64 = 3640;
pub const CLASS_FUNCTIONPROTOTYPE: u64 = 3641;
pub const METHOD_GETNUMPARAMS: u64 = 3642;
pub const METHOD_GETPARAMTYPES: u64 = 3643;
pub const METHOD_GETEXTPROTOINFO: u64 = 3644;
pub const METHOD_GETEXCEPTIONSPECTYPE: u64 = 3645;
pub const METHOD_HASEXCEPTIONSPEC: u64 = 3646;
pub const METHOD_HASDYNAMICEXCEPTIONSPEC: u64 = 3647;
pub const METHOD_HASNOEXCEPTEXCEPTIONSPEC: u64 = 3648;
pub const METHOD_HASDEPENDENTEXCEPTIONSPEC: u64 = 3649;
pub const METHOD_HASINSTANTIATIONDEPENDENTEXCEPTIONSPEC: u64 = 3650;
pub const METHOD_GETEXCEPTIONSPECINFO: u64 = 3651;
pub const METHOD_GETNUMEXCEPTIONS: u64 = 3652;
pub const METHOD_GETNOEXCEPTEXPR: u64 = 3653;
pub const METHOD_GETEXCEPTIONSPECDECL: u64 = 3654;
pub const METHOD_GETEXCEPTIONSPECTEMPLATE: u64 = 3655;
pub const METHOD_CANTHROW: u64 = 3656;
pub const METHOD_ISVARIADIC: u64 = 3657;
pub const METHOD_GETELLIPSISLOC: u64 = 3658;
pub const METHOD_ISTEMPLATEVARIADIC: u64 = 3659;
pub const METHOD_HASTRAILINGRETURN: u64 = 3660;
pub const METHOD_GETMETHODQUALS: u64 = 3661;
pub const METHOD_GETREFQUALIFIER: u64 = 3662;
pub const METHOD_PARAM_TYPES: u64 = 3663;
pub const METHOD_PARAM_TYPE_BEGIN: u64 = 3664;
pub const METHOD_PARAM_TYPE_END: u64 = 3665;
pub const METHOD_EXCEPTIONS: u64 = 3666;
pub const METHOD_EXCEPTION_BEGIN: u64 = 3667;
pub const METHOD_EXCEPTION_END: u64 = 3668;
pub const METHOD_HASEXTPARAMETERINFOS: u64 = 3669;
pub const METHOD_GETEXTPARAMETERINFOS: u64 = 3670;
pub const METHOD_GETEXTPARAMETERINFOSORNULL: u64 = 3671;
pub const METHOD_GETAARCH64SMEATTRIBUTES: u64 = 3672;
pub const METHOD_ISSUGARED_22: u64 = 3673;
pub const METHOD_DESUGAR_22: u64 = 3674;
pub const CLASS_FALLTHROUGHATTR: u64 = 3675;
pub const CLASS_IBACTIONATTR: u64 = 3676;
pub const CLASS_FUNCTIONNOPROTOTYPE: u64 = 3677;
pub const METHOD_ISSUGARED_21: u64 = 3678;
pub const METHOD_DESUGAR_21: u64 = 3679;
pub const CLASS_DEPENDENTSIZEDMATRIXTYPE: u64 = 3680;
pub const METHOD_GETROWEXPR: u64 = 3681;
pub const METHOD_GETCOLUMNEXPR: u64 = 3682;
pub const METHOD_GETATTRIBUTELOC_2: u64 = 3683;
pub const CLASS_OBJCBOXABLEATTR: u64 = 3684;
pub const CLASS_DEPENDENTADDRESSSPACETYPE: u64 = 3685;
pub const METHOD_GETADDRSPACEEXPR: u64 = 3686;
pub const METHOD_GETPOINTEETYPE_2: u64 = 3687;
pub const METHOD_GETATTRIBUTELOC: u64 = 3688;
pub const METHOD_ISSUGARED_11: u64 = 3689;
pub const METHOD_DESUGAR_11: u64 = 3690;
pub const CLASS_LABELDECL: u64 = 3691;
pub const METHOD_GETSTMT: u64 = 3692;
pub const METHOD_ISGNULOCAL: u64 = 3693;
pub const METHOD_GETSOURCERANGE_16: u64 = 3694;
pub const METHOD_ISMSASMLABEL: u64 = 3695;
pub const METHOD_ISRESOLVEDMSASMLABEL: u64 = 3696;
pub const METHOD_GETMSASMLABEL: u64 = 3697;
pub const CLASS_VARIABLEARRAYTYPE: u64 = 3698;
pub const METHOD_GETSIZEEXPR_4: u64 = 3699;
pub const METHOD_GETBRACKETSRANGE_1: u64 = 3700;
pub const METHOD_GETLBRACKETLOC_1: u64 = 3701;
pub const METHOD_GETRBRACKETLOC_1: u64 = 3702;
pub const METHOD_ISSUGARED_45: u64 = 3703;
pub const METHOD_DESUGAR_45: u64 = 3704;
pub const CLASS_BTFDECLTAGATTR: u64 = 3705;
pub const CLASS_MEMBERPOINTERTYPE: u64 = 3706;
pub const METHOD_GETPOINTEETYPE_3: u64 = 3707;
pub const METHOD_ISMEMBERFUNCTIONPOINTER: u64 = 3708;
pub const METHOD_ISMEMBERDATAPOINTER: u64 = 3709;
pub const METHOD_GETCLASS: u64 = 3710;
pub const METHOD_GETMOSTRECENTCXXRECORDDECL: u64 = 3711;
pub const METHOD_ISSUGARED_28: u64 = 3712;
pub const METHOD_DESUGAR_28: u64 = 3713;
pub const CLASS_SYCLSPECIALCLASSATTR: u64 = 3714;
pub const CLASS_ARGUMENTWITHTYPETAGATTR: u64 = 3715;
pub const CLASS_REFERENCETYPE: u64 = 3716;
pub const METHOD_ISSPELLEDASLVALUE: u64 = 3717;
pub const METHOD_ISINNERREF: u64 = 3718;
pub const METHOD_GETPOINTEETYPEASWRITTEN: u64 = 3719;
pub const METHOD_GETPOINTEETYPE_5: u64 = 3720;
pub const CLASS_CXXFUNCTIONALCASTEXPR: u64 = 3721;
pub const METHOD_GETLPARENLOC_2: u64 = 3722;
pub const METHOD_GETRPARENLOC_7: u64 = 3723;
pub const METHOD_ISLISTINITIALIZATION_1: u64 = 3724;
pub const METHOD_GETBEGINLOC_29: u64 = 3725;
pub const METHOD_GETENDLOC_28: u64 = 3726;
pub const CLASS_OPENCLPRIVATEADDRESSSPACEATTR: u64 = 3727;
pub const CLASS_LVALUEREFERENCETYPE: u64 = 3728;
pub const METHOD_ISSUGARED_25: u64 = 3729;
pub const METHOD_DESUGAR_25: u64 = 3730;
pub const CLASS_SCOPEDLOCKABLEATTR: u64 = 3731;
pub const CLASS_DEPENDENTSIZEDMATRIXTYPELOC: u64 = 3732;
pub const CLASS_PIPETYPELOC: u64 = 3733;
pub const METHOD_GETVALUELOC_1: u64 = 3734;
pub const METHOD_GETLOCALSOURCERANGE_11: u64 = 3735;
pub const METHOD_GETKWLOC_1: u64 = 3736;
pub const METHOD_GETINNERTYPE_9: u64 = 3737;
pub const CLASS_DEPENDENTVECTORTYPELOC: u64 = 3738;
pub const METHOD_GETNAMELOC_4: u64 = 3739;
pub const METHOD_GETLOCALSOURCERANGE_12: u64 = 3740;
pub const METHOD_GETELEMENTLOC_2: u64 = 3741;
pub const METHOD_GETINNERTYPE_10: u64 = 3742;
pub const CLASS_CONSTANTMATRIXTYPELOC: u64 = 3743;
pub const CLASS_DEDUCEDTYPELOC: u64 = 3744;
pub const CLASS_ANNOTATEATTR: u64 = 3745;
pub const CLASS_TYPEOFTYPELOC: u64 = 3746;
pub const METHOD_GETUNMODIFIEDTYPE_1: u64 = 3747;
pub const METHOD_GETUNMODIFIEDTINFO: u64 = 3748;
pub const CLASS_DEPENDENTNAMETYPELOC: u64 = 3749;
pub const METHOD_GETELABORATEDKEYWORDLOC: u64 = 3750;
pub const METHOD_GETQUALIFIERLOC_16: u64 = 3751;
pub const METHOD_GETNAMELOC_5: u64 = 3752;
pub const METHOD_GETLOCALSOURCERANGE_13: u64 = 3753;
pub const CLASS_CXXREINTERPRETCASTEXPR: u64 = 3754;
pub const CLASS_DEPENDENTSIZEDEXTVECTORTYPELOC: u64 = 3755;
pub const METHOD_GETNAMELOC_6: u64 = 3756;
pub const METHOD_GETLOCALSOURCERANGE_14: u64 = 3757;
pub const METHOD_GETELEMENTLOC_3: u64 = 3758;
pub const METHOD_GETINNERTYPE_11: u64 = 3759;
pub const CLASS_OBJCOBJECTPOINTERTYPELOC: u64 = 3760;
pub const CLASS_FUNCTIONPROTOTYPELOC: u64 = 3761;
pub const CLASS_CAPABILITYATTR: u64 = 3762;
pub const CLASS_UNRESOLVEDUSINGTYPELOC: u64 = 3763;
pub const METHOD_GETDECL_12: u64 = 3764;
pub const CLASS_QUALIFIEDTYPELOC: u64 = 3765;
pub const METHOD_GETLOCALSOURCERANGE_15: u64 = 3766;
pub const METHOD_GETUNQUALIFIEDLOC: u64 = 3767;
pub const METHOD_GETNEXTTYPELOC: u64 = 3768;
pub const METHOD_GETLOCALDATASIZE: u64 = 3769;
pub const METHOD_GETLOCALDATAALIGNMENT: u64 = 3770;
pub const CLASS_ALIGNMAC68KATTR: u64 = 3771;
pub const CLASS_BTFTAGATTRIBUTEDTYPELOC: u64 = 3772;
pub const METHOD_GETWRAPPEDLOC: u64 = 3773;
pub const METHOD_GETATTR_2: u64 = 3774;
pub const METHOD_GETLOCALSOURCERANGE_16: u64 = 3775;
pub const METHOD_GETINNERTYPE_12: u64 = 3776;
pub const CLASS_FUNCTIONTYPELOC: u64 = 3777;
pub const METHOD_GETLOCALRANGEBEGIN: u64 = 3778;
pub const METHOD_GETLOCALRANGEEND: u64 = 3779;
pub const METHOD_GETLPARENLOC_14: u64 = 3780;
pub const METHOD_GETRPARENLOC_32: u64 = 3781;
pub const METHOD_GETPARENSRANGE_1: u64 = 3782;
pub const METHOD_GETEXCEPTIONSPECRANGE: u64 = 3783;
pub const METHOD_GETPARAMS: u64 = 3784;
pub const METHOD_GETPARMARRAY: u64 = 3785;
pub const METHOD_GETNUMPARAMS_4: u64 = 3786;
pub const METHOD_GETRETURNLOC_1: u64 = 3787;
pub const METHOD_GETLOCALSOURCERANGE_17: u64 = 3788;
pub const METHOD_GETEXTRALOCALDATASIZE_2: u64 = 3789;
pub const METHOD_GETEXTRALOCALDATAALIGNMENT_2: u64 = 3790;
pub const METHOD_GETINNERTYPE_13: u64 = 3791;
pub const CLASS_SWIFTASYNCNAMEATTR: u64 = 3792;
pub const CLASS_DEPENDENTTEMPLATESPECIALIZATIONTYPELOC: u64 = 3793;
pub const METHOD_GETELABORATEDKEYWORDLOC_1: u64 = 3794;
pub const METHOD_GETQUALIFIERLOC_17: u64 = 3795;
pub const METHOD_GETTEMPLATEKEYWORDLOC_8: u64 = 3796;
pub const METHOD_GETTEMPLATENAMELOC_1: u64 = 3797;
pub const METHOD_GETLANGLELOC_6: u64 = 3798;
pub const METHOD_GETRANGLELOC_6: u64 = 3799;
pub const METHOD_GETNUMARGS_6: u64 = 3800;
pub const METHOD_GETLOCALSOURCERANGE_18: u64 = 3801;
pub const METHOD_GETEXTRALOCALDATASIZE_3: u64 = 3802;
pub const METHOD_GETEXTRALOCALDATAALIGNMENT_3: u64 = 3803;
pub const CLASS_OMPDISPATCHDIRECTIVE: u64 = 3804;
pub const CLASS_SWIFTNAMEATTR: u64 = 3805;
pub const CLASS_VARIABLEARRAYTYPELOC: u64 = 3806;
pub const CLASS_MSDEPENDENTEXISTSSTMT: u64 = 3807;
pub const METHOD_GETKEYWORDLOC_3: u64 = 3808;
pub const METHOD_ISIFEXISTS: u64 = 3809;
pub const METHOD_ISIFNOTEXISTS: u64 = 3810;
pub const METHOD_GETQUALIFIERLOC_12: u64 = 3811;
pub const METHOD_GETNAMEINFO_6: u64 = 3812;
pub const METHOD_GETSUBSTMT_4: u64 = 3813;
pub const METHOD_GETBEGINLOC_92: u64 = 3814;
pub const METHOD_GETENDLOC_91: u64 = 3815;
pub const METHOD_CHILDREN_80: u64 = 3816;
pub const CLASS_UNARYTRANSFORMTYPELOC: u64 = 3817;
pub const METHOD_GETKWLOC_2: u64 = 3818;
pub const METHOD_GETLPARENLOC_15: u64 = 3819;
pub const METHOD_GETRPARENLOC_33: u64 = 3820;
pub const METHOD_GETUNDERLYINGTINFO: u64 = 3821;
pub const METHOD_GETLOCALSOURCERANGE_19: u64 = 3822;
pub const METHOD_GETPARENSRANGE_2: u64 = 3823;
pub const CLASS_VALUESTMT: u64 = 3824;
pub const METHOD_GETEXPRSTMT: u64 = 3825;
pub const CLASS_COROUTINESUSPENDEXPR: u64 = 3826;
pub const METHOD_GETCOMMONEXPR_1: u64 = 3827;
pub const METHOD_GETOPAQUEVALUE_1: u64 = 3828;
pub const METHOD_GETREADYEXPR: u64 = 3829;
pub const METHOD_GETSUSPENDEXPR: u64 = 3830;
pub const METHOD_GETRESUMEEXPR: u64 = 3831;
pub const METHOD_GETOPERAND_2: u64 = 3832;
pub const METHOD_GETKEYWORDLOC_1: u64 = 3833;
pub const METHOD_GETBEGINLOC_62: u64 = 3834;
pub const METHOD_GETENDLOC_61: u64 = 3835;
pub const METHOD_CHILDREN_52: u64 = 3836;
pub const CLASS_CODEMODELATTR: u64 = 3837;
pub const CLASS_UNQUALTYPELOC: u64 = 3838;
pub const METHOD_GETTYPEPTR: u64 = 3839;
pub const METHOD_GETTYPELOCCLASS: u64 = 3840;
pub const CLASS_INCOMPLETEARRAYTYPELOC: u64 = 3841;
pub const CLASS_WEAKREFATTR: u64 = 3842;
pub const CLASS_TYPELOC: u64 = 3843;
pub const METHOD_GETTYPELOCCLASS_1: u64 = 3844;
pub const METHOD_ISNULL: u64 = 3845;
pub const METHOD_GETTYPE_2: u64 = 3846;
pub const METHOD_GETTYPEPTR_1: u64 = 3847;
pub const METHOD_GETOPAQUEDATA: u64 = 3848;
pub const METHOD_GETBEGINLOC_134: u64 = 3849;
pub const METHOD_GETENDLOC_133: u64 = 3850;
pub const METHOD_GETSOURCERANGE_50: u64 = 3851;
pub const METHOD_GETLOCALSOURCERANGE_20: u64 = 3852;
pub const METHOD_GETFULLDATASIZE: u64 = 3853;
pub const METHOD_GETNEXTTYPELOC_1: u64 = 3854;
pub const METHOD_GETUNQUALIFIEDLOC_1: u64 = 3855;
pub const METHOD_IGNOREPARENS_1: u64 = 3856;
pub const METHOD_FINDEXPLICITQUALIFIERLOC: u64 = 3857;
pub const METHOD_GETCONTAINEDAUTOTYPELOC: u64 = 3858;
pub const METHOD_FINDNULLABILITYLOC: u64 = 3859;
pub const CLASS_TYPEOFEXPRTYPELOC: u64 = 3860;
pub const METHOD_GETUNDERLYINGEXPR_3: u64 = 3861;
pub const METHOD_GETLOCALSOURCERANGE_21: u64 = 3862;
pub const CLASS_ARCWEAKREFUNAVAILABLEATTR: u64 = 3863;
pub const CLASS_OBJCTYPEPARAMTYPE: u64 = 3864;
pub const CLASS_SYCLKERNELATTR: u64 = 3865;
pub const CLASS_ELABORATEDTYPELOC: u64 = 3866;
pub const METHOD_GETELABORATEDKEYWORDLOC_2: u64 = 3867;
pub const METHOD_GETQUALIFIERLOC_18: u64 = 3868;
pub const METHOD_GETLOCALSOURCERANGE_22: u64 = 3869;
pub const METHOD_GETNAMEDTYPELOC: u64 = 3870;
pub const METHOD_GETINNERTYPE_14: u64 = 3871;
pub const METHOD_ISEMPTY_1: u64 = 3872;
pub const METHOD_GETLOCALDATAALIGNMENT_1: u64 = 3873;
pub const METHOD_GETLOCALDATASIZE_1: u64 = 3874;
pub const CLASS_BREAKSTMT: u64 = 3875;
pub const METHOD_GETBREAKLOC: u64 = 3876;
pub const METHOD_GETBEGINLOC_16: u64 = 3877;
pub const METHOD_GETENDLOC_15: u64 = 3878;
pub const METHOD_CHILDREN_12: u64 = 3879;
pub const CLASS_OMPDISTRIBUTESIMDDIRECTIVE: u64 = 3880;
pub const CLASS_CPUSPECIFICATTR: u64 = 3881;
pub const CLASS_RECORDTYPELOC: u64 = 3882;
pub const METHOD_GETDECL_13: u64 = 3883;
pub const CLASS_OMPMASKEDTASKLOOPDIRECTIVE: u64 = 3884;
pub const CLASS_LVALUEREFERENCETYPELOC: u64 = 3885;
pub const METHOD_GETAMPLOC: u64 = 3886;
pub const CLASS_RVALUEREFERENCETYPELOC: u64 = 3887;
pub const METHOD_GETAMPAMPLOC_1: u64 = 3888;
pub const CLASS_ADJUSTEDTYPELOC: u64 = 3889;
pub const METHOD_GETORIGINALLOC: u64 = 3890;
pub const METHOD_GETINNERTYPE_15: u64 = 3891;
pub const METHOD_GETLOCALSOURCERANGE_23: u64 = 3892;
pub const METHOD_GETLOCALDATASIZE_2: u64 = 3893;
pub const CLASS_PRAGMACLANGBSSSECTIONATTR: u64 = 3894;
pub const CLASS_ACQUIREDAFTERATTR: u64 = 3895;
pub const CLASS_OBJCINTERFACETYPELOC: u64 = 3896;
pub const CLASS_SWITCHSTMT: u64 = 3897;
pub const METHOD_HASINITSTORAGE_1: u64 = 3898;
pub const METHOD_HASVARSTORAGE_1: u64 = 3899;
pub const METHOD_GETCOND_8: u64 = 3900;
pub const METHOD_GETBODY_11: u64 = 3901;
pub const METHOD_GETINIT_6: u64 = 3902;
pub const METHOD_GETCONDITIONVARIABLE_2: u64 = 3903;
pub const METHOD_GETCONDITIONVARIABLEDECLSTMT_2: u64 = 3904;
pub const METHOD_GETSWITCHCASELIST: u64 = 3905;
pub const METHOD_GETSWITCHLOC: u64 = 3906;
pub const METHOD_GETLPARENLOC_10: u64 = 3907;
pub const METHOD_GETRPARENLOC_25: u64 = 3908;
pub const METHOD_ISALLENUMCASESCOVERED: u64 = 3909;
pub const METHOD_GETBEGINLOC_123: u64 = 3910;
pub const METHOD_GETENDLOC_122: u64 = 3911;
pub const METHOD_CHILDREN_110: u64 = 3912;
pub const CLASS_AUTOTYPELOC: u64 = 3913;
pub const METHOD_GETAUTOKEYWORD: u64 = 3914;
pub const METHOD_ISDECLTYPEAUTO_1: u64 = 3915;
pub const METHOD_GETRPARENLOC_34: u64 = 3916;
pub const METHOD_ISCONSTRAINED_1: u64 = 3917;
pub const METHOD_GETCONCEPTREFERENCE_1: u64 = 3918;
pub const METHOD_GETNESTEDNAMESPECIFIERLOC_1: u64 = 3919;
pub const METHOD_GETTEMPLATEKWLOC_1: u64 = 3920;
pub const METHOD_GETCONCEPTNAMELOC_1: u64 = 3921;
pub const METHOD_GETFOUNDDECL_5: u64 = 3922;
pub const METHOD_GETNAMEDCONCEPT_1: u64 = 3923;
pub const METHOD_GETCONCEPTNAMEINFO_1: u64 = 3924;
pub const METHOD_HASEXPLICITTEMPLATEARGS_6: u64 = 3925;
pub const METHOD_GETLANGLELOC_7: u64 = 3926;
pub const METHOD_GETRANGLELOC_7: u64 = 3927;
pub const METHOD_GETNUMARGS_7: u64 = 3928;
pub const METHOD_GETLOCALSOURCERANGE_24: u64 = 3929;
pub const CLASS_SWIFTATTRATTR: u64 = 3930;
pub const CLASS_DEPENDENTNAMETYPE: u64 = 3931;
pub const METHOD_GETQUALIFIER: u64 = 3932;
pub const METHOD_GETIDENTIFIER: u64 = 3933;
pub const METHOD_ISSUGARED_13: u64 = 3934;
pub const METHOD_DESUGAR_13: u64 = 3935;
pub const CLASS_TYPESPECTYPELOC: u64 = 3936;
pub const METHOD_GETNAMELOC_7: u64 = 3937;
pub const METHOD_GETLOCALSOURCERANGE_25: u64 = 3938;
pub const CLASS_DEDUCEDTYPE: u64 = 3939;
pub const METHOD_ISSUGARED_10: u64 = 3940;
pub const METHOD_DESUGAR_10: u64 = 3941;
pub const METHOD_GETDEDUCEDTYPE: u64 = 3942;
pub const METHOD_ISDEDUCED: u64 = 3943;
pub const CLASS_DEDUCEDTEMPLATESPECIALIZATIONTYPELOC: u64 = 3944;
pub const METHOD_GETTEMPLATENAMELOC_2: u64 = 3945;
pub const CLASS_POINTERATTR: u64 = 3946;
pub const CLASS_SUBSTTEMPLATETYPEPARMPACKTYPELOC: u64 = 3947;
pub const CLASS_PACKEXPANSIONTYPELOC: u64 = 3948;
pub const METHOD_GETELLIPSISLOC_7: u64 = 3949;
pub const METHOD_GETLOCALSOURCERANGE_26: u64 = 3950;
pub const METHOD_GETPATTERNLOC: u64 = 3951;
pub const METHOD_GETINNERTYPE_16: u64 = 3952;
pub const CLASS_TEMPLATETYPEPARMTYPELOC: u64 = 3953;
pub const METHOD_GETDECL_14: u64 = 3954;
pub const CLASS_MEMBERPOINTERTYPELOC: u64 = 3955;
pub const METHOD_GETSTARLOC_2: u64 = 3956;
pub const METHOD_GETCLASS_1: u64 = 3957;
pub const METHOD_GETCLASSTINFO: u64 = 3958;
pub const METHOD_GETLOCALSOURCERANGE_27: u64 = 3959;
pub const CLASS_SUBSTTEMPLATETYPEPARMTYPELOC: u64 = 3960;
pub const CLASS_PRAGMADETECTMISMATCHDECL: u64 = 3961;
pub const METHOD_GETNAME: u64 = 3962;
pub const METHOD_GETVALUE_1: u64 = 3963;
pub const CLASS_HLSLRESOURCEBINDINGATTR: u64 = 3964;
