...
pub fn build_data_model() -> GraphBuffer {
  ...
  g.add_edge((CLASS_REQUIRESEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_ISSATISFIED, "clang::RequiresExpr::isSatisfied"),
  ...
  g.add_edge((CLASS_TYPETRAITEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETVALUE_9, "clang::TypeTraitExpr::getValue"),
  ...
  g.add_edge((CLASS_ARRAYTYPETRAITEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETVALUE_10, "clang::ArrayTypeTraitExpr::getValue"),
  ...
  g.add_edge((CLASS_LAMBDAEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_CAPTURE_BEGIN_1, "clang::LambdaExpr::capture_begin"),
      add_named_node(&mut g, METHOD_CAPTURE_END_1, "clang::LambdaExpr::capture_end"),
  ...
  g.add_edge((CLASS_CALLEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_ARG_BEGIN, "clang::CallExpr::arg_begin"),
      add_named_node(&mut g, METHOD_ARG_END, "clang::CallExpr::arg_end"),
  ...
  g.add_edge((CLASS_CAPTUREDDECL, META_SUBCLASS, CLASS_DECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_PARAM_BEGIN, "clang::CapturedDecl::param_begin"),
      add_named_node(&mut g, METHOD_PARAM_END, "clang::CapturedDecl::param_end"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_BLOCKDECL, META_SUBCLASS, CLASS_DECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_PARAM_BEGIN_1, "clang::BlockDecl::param_begin"),
      add_named_node(&mut g, METHOD_PARAM_END_1, "clang::BlockDecl::param_end"),
  ...
  g.add_edge((CLASS_DECL, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETASTCONTEXT, "clang::Decl::getASTContext"),
  ...
  g.add_edge((CLASS_BUILTINTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETNAMELOC_2, "clang::BuiltinTypeLoc::getNameLoc"),
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE, "clang::BuiltinTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_DEPENDENTNAMETYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETNAMELOC_3, "clang::DependentNameTypeLoc::getNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_1, "clang::DependentNameTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETUNDERLYINGEXPR_2, "clang::TypeOfExprTypeLoc::getUnderlyingExpr"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_2, "clang::TypeOfExprTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETUNDERLYINGEXPR_3, "clang::DecltypeTypeLoc::getUnderlyingExpr"),
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_3, "clang::DecltypeTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_9, "clang::TemplateTypeParmTypeLoc::getDecl"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_FUNCTIONDECL, META_SUBCLASS, CLASS_DECLARATORDECL));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_PARAM_BEGIN_2, "clang::FunctionDecl::param_begin"),
      add_named_node(&mut g, METHOD_PARAM_END_2, "clang::FunctionDecl::param_end"),
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_10, "clang::UnresolvedUsingTypeLoc::getDecl"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_FUNCTIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLPARENLOC_12, "clang::FunctionTypeLoc::getLParenLoc"),
      add_named_node(&mut g, METHOD_GETRPARENLOC_30, "clang::FunctionTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETPARENSRANGE, "clang::FunctionTypeLoc::getParensRange"),
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_4, "clang::FunctionTypeLoc::getLocalSourceRange"),
      ...
      add_named_node(&mut g, METHOD_GETINNERTYPE_1, "clang::FunctionTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETKWLOC, "clang::UnaryTransformTypeLoc::getKWLoc"),
      add_named_node(&mut g, METHOD_GETLPARENLOC_13, "clang::UnaryTransformTypeLoc::getLParenLoc"),
      add_named_node(&mut g, METHOD_GETRPARENLOC_31, "clang::UnaryTransformTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETUNDERLYINGTINFO, "clang::UnaryTransformTypeLoc::getUnderlyingTInfo"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_5, "clang::UnaryTransformTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETPARENSRANGE_1, "clang::UnaryTransformTypeLoc::getParensRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_DEPENDENTADDRESSSPACETYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_6, "clang::DependentAddressSpaceTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_2, "clang::DependentAddressSpaceTypeLoc::getInnerType"),
  ...
  g.add_edge((CLASS_CONCEPTSPECIALIZATIONEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_ISSATISFIED_1, "clang::ConceptSpecializationExpr::isSatisfied"),
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETTEMPLATENAMELOC, "clang::DeducedTemplateSpecializationTypeLoc::getTemplateNameLoc"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETNAMELOC_4, "clang::TypeSpecTypeLoc::getNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_7, "clang::TypeSpecTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_MACROQUALIFIEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETINNERTYPE_3, "clang::MacroQualifiedTypeLoc::getInnerType"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_8, "clang::MacroQualifiedTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_ADJUSTEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETINNERTYPE_4, "clang::AdjustedTypeLoc::getInnerType"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_9, "clang::AdjustedTypeLoc::getLocalSourceRange"),
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETNAMELOC_5, "clang::DependentSizedExtVectorTypeLoc::getNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_10, "clang::DependentSizedExtVectorTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETELEMENTLOC, "clang::DependentSizedExtVectorTypeLoc::getElementLoc"),
  ...
  g.add_edge((CLASS_CXXUNRESOLVEDCONSTRUCTEXPR, META_SUBCLASS, CLASS_EXPR));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_ARG_BEGIN_2, "clang::CXXUnresolvedConstructExpr::arg_begin"),
      add_named_node(&mut g, METHOD_ARG_END_2, "clang::CXXUnresolvedConstructExpr::arg_end"),
  ...
  g.add_edge((CLASS_PIPETYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETINNERTYPE_6, "clang::PipeTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_12, "clang::QualifiedTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_TEMPLATESPECIALIZATIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETTEMPLATENAMELOC_1, "clang::TemplateSpecializationTypeLoc::getTemplateNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_13, "clang::TemplateSpecializationTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATASIZE_2, "clang::TemplateSpecializationTypeLoc::getExtraLocalDataSize"),
      add_named_node(&mut g, METHOD_GETEXTRALOCALDATAALIGNMENT_2, "clang::TemplateSpecializationTypeLoc::getExtraLocalDataAlignment"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETASTCONTEXT_1, "clang::TranslationUnitDecl::getASTContext"),
  ...
  g.add_edge((CLASS_MATRIXTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_14, "clang::MatrixTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_ATTRIBUTEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_15, "clang::AttributedTypeLoc::getLocalSourceRange"),
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_12, "clang::InjectedClassNameTypeLoc::getDecl"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETNAMELOC_6, "clang::VectorTypeLoc::getNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_16, "clang::VectorTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETELEMENTLOC_1, "clang::VectorTypeLoc::getElementLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_8, "clang::VectorTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_TYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_17, "clang::TypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_ATOMICTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_18, "clang::AtomicTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETKWLOC_2, "clang::AtomicTypeLoc::getKWLoc"),
      add_named_node(&mut g, METHOD_GETLPARENLOC_14, "clang::AtomicTypeLoc::getLParenLoc"),
      add_named_node(&mut g, METHOD_GETRPARENLOC_32, "clang::AtomicTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETPARENSRANGE_2, "clang::AtomicTypeLoc::getParensRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_9, "clang::AtomicTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETNAMELOC_7, "clang::DependentVectorTypeLoc::getNameLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_19, "clang::DependentVectorTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_ARRAYTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETELEMENTLOC_3, "clang::ArrayTypeLoc::getElementLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_20, "clang::ArrayTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_11, "clang::ArrayTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_DEPENDENTTEMPLATESPECIALIZATIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETTEMPLATENAMELOC_2, "clang::DependentTemplateSpecializationTypeLoc::getTemplateNameLoc"),
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_21, "clang::DependentTemplateSpecializationTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_BTFTAGATTRIBUTEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_22, "clang::BTFTagAttributedTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_PACKEXPANSIONTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_23, "clang::PackExpansionTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETPATTERNLOC, "clang::PackExpansionTypeLoc::getPatternLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_13, "clang::PackExpansionTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_ELABORATEDTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_24, "clang::ElaboratedTypeLoc::getLocalSourceRange"),
  ...
  g.add_edge((CLASS_AUTOTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETRPARENLOC_33, "clang::AutoTypeLoc::getRParenLoc"),
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_25, "clang::AutoTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  g.add_edge((CLASS_MEMBERPOINTERTYPELOC, META_CLASS, META_CLANG_AST_NODE));
  {
    let methods = Vec::from([
      ...
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_26, "clang::MemberPointerTypeLoc::getLocalSourceRange"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETLPARENLOC_15, "clang::ParenTypeLoc::getLParenLoc"),
      add_named_node(&mut g, METHOD_GETRPARENLOC_34, "clang::ParenTypeLoc::getRParenLoc"),
      add_named_node(&mut g, METHOD_GETLOCALSOURCERANGE_27, "clang::ParenTypeLoc::getLocalSourceRange"),
      add_named_node(&mut g, METHOD_GETINNERLOC_1, "clang::ParenTypeLoc::getInnerLoc"),
      add_named_node(&mut g, METHOD_GETINNERTYPE_16, "clang::ParenTypeLoc::getInnerType"),
    ]);
    let methods = set_node(&mut g, META_CLANG_AST_METHOD, next_id(), next_id(), methods);
  ...
  {
    let methods = Vec::from([
      add_named_node(&mut g, METHOD_GETDECL_14, "clang::TagTypeLoc::getDecl"),
...
const TRUE_: u64 = 0;
const FALSE_: u64 = 1;
const META_CLASS: u64 = 2;
const META_SUBCLASS: u64 = 3;
const META_METHOD: u64 = 4;
const META_DOMAIN: u64 = 5;
const META_RANGE: u64 = 6;
const META_CLANG_AST_NODE: u64 = 7;
const META_CLANG_AST_METHOD: u64 = 8;
const META_CLANG_AST_ENUM: u64 = 9;
const META_CLANG_AST_ENUM_ENUMERATORS: u64 = 10;
const META_CLANG_AST_ENUM_CONSTANT: u64 = 11;
const BUILTIN_STRING_CLASS: u64 = 12;
const BUILTIN_U64_CLASS: u64 = 13;
const BUILTIN_I64_CLASS: u64 = 14;
const BUILTIN_DOUBLE_CLASS: u64 = 15;
const BUILTIN_LIST_CLASS: u64 = 16;
const BUILTIN_LIST_SIZE: u64 = 17;
const BUILTIN_LIST_ITEM_CLASS: u64 = 18;
const BUILTIN_SET_CLASS: u64 = 19;
const BUILTIN_SET_SIZE: u64 = 20;
const BUILTIN_SET_ITEM: u64 = 21;
const BUILTIN_SET_ITEM_CLASS: u64 = 22;
const INVALID_FILE: u64 = 23;
const INVALID_SOURCE_LOCATION: u64 = 24;
const FILE_CLASS: u64 = 25;
const FILE_NAME: u64 = 26;
const FILE_CONTENT: u64 = 27;
const SOURCE_LOCATION_CLASS: u64 = 28;
const SOURCE_LOCATION_IS_FILE: u64 = 29;
const SOURCE_LOCATION_FILE: u64 = 30;
const SOURCE_LOCATION_LINE: u64 = 31;
const SOURCE_LOCATION_COLUMN: u64 = 32;
const SOURCE_LOCATION_EXPANSION_LOC: u64 = 33;
const SOURCE_LOCATION_SPELLING_LOC: u64 = 34;
const SOURCE_RANGE_CLASS: u64 = 35;
const SOURCE_RANGE_BEGIN: u64 = 36;
const SOURCE_RANGE_END: u64 = 37;
const QUALTYPE_CLASS: u64 = 38;
const QUALTYPE_IS_CONST: u64 = 39;
const QUALTYPE_IS_VOLATILE: u64 = 40;
const QUALTYPE_IS_RESTRICT: u64 = 41;
const QUALTYPE_TYPE: u64 = 42;
const USR: u64 = 43;
const CLASS_CFG: u64 = 44;
const CFG: u64 = 45;
const CFG_NODES: u64 = 46;
const CFG_ENTRY: u64 = 47;
const CFG_EXIT: u64 = 48;
const CFG_INDIRECT_GOTO_BLOCK: u64 = 49;
const CFG_TRY_BLOCKS: u64 = 50;
const CFG_IS_LINEAR: u64 = 51;
const CLASS_CFGBLOCK: u64 = 52;
const CFG_BLOCK_PARENT: u64 = 53;
const CFG_BLOCK_SUCCS: u64 = 54;
const CFG_BLOCK_PREDS: u64 = 55;
const CFG_BLOCK_LABEL: u64 = 56;
const CFG_BLOCK_TERMINATOR_STMT: u64 = 57;
const CFG_BLOCK_TERMINATOR_KIND: u64 = 58;
const CFG_BLOCK_TERMINATOR_CONDITION: u64 = 59;
const CFG_BLOCK_LOOP_TARGET: u64 = 60;
const CFG_BLOCK_HAS_NO_RETURN_ELEMENT: u64 = 61;
const CLASS_CFGELEMENT: u64 = 62;
const CLASS_CFGCLEANUPFUNCTION: u64 = 63;
const CLASS_CFGIMPLICITDTOR: u64 = 64;
const CLASS_CFGINITIALIZER: u64 = 65;
const CLASS_CFGLIFETIMEENDS: u64 = 66;
const CLASS_CFGLOOPEXIT: u64 = 67;
const CLASS_CFGNEWALLOCATOR: u64 = 68;
const CLASS_CFGSCOPEBEGIN: u64 = 69;
const CLASS_CFGSCOPEEND: u64 = 70;
const CLASS_CFGSTMT: u64 = 71;
const CLASS_CFGAUTOMATICOBJDTOR: u64 = 72;
const CLASS_CFGBASEDTOR: u64 = 73;
const CLASS_CFGDELETEDTOR: u64 = 74;
const CLASS_CFGMEMBERDTOR: u64 = 75;
const CLASS_CFGTEMPORARYDTOR: u64 = 76;
const CLASS_CFGCXXRECORDTYPEDCALL: u64 = 77;
const CLASS_CFGCONSTRUCTOR: u64 = 78;
const CFG_ELEMENT_TRIGGER_STMT: u64 = 79;
const CFG_ELEMENT_VAR_DECL: u64 = 80;
const CFG_ELEMENT_ALLOC_EXPR: u64 = 81;
const CFG_ELEMENT_LOOP_STMT: u64 = 82;
const CFG_ELEMENT_STMT: u64 = 83;
const CFG_ELEMENT_CTOR_CONTEXT: u64 = 84;
const CFG_ELEMENT_DTOR_DECL: u64 = 85;
const CFG_ELEMENT_IS_NO_RETURN: u64 = 86;
const CFG_ELEMENT_INIT: u64 = 87;
const CFG_ELEMENT_CXX_RECORD_DECL: u64 = 88;
const CFG_ELEMENT_DELETE_EXPR: u64 = 89;
const CFG_ELEMENT_BASE_SPECIFIER: u64 = 90;
const CFG_ELEMENT_FIELD_DECL: u64 = 91;
const CFG_ELEMENT_BIND_TEMPORARY_EXPR: u64 = 92;
const CFG_ELEMENT_FUNCTION_DECL: u64 = 93;
const CLASS_OBJCBOXEDEXPR: u64 = 94;
const CLASS_OBJCPROTOCOLEXPR: u64 = 95;
const CLASS_OBJCSUBSCRIPTREFEXPR: u64 = 96;
const CLASS_OMPMASTERTASKLOOPSIMDDIRECTIVE: u64 = 97;
const CLASS_EXPR: u64 = 98;
const METHOD_GETTYPE_1: u64 = 99;
const METHOD_GETDEPENDENCE_1: u64 = 100;
const METHOD_ISVALUEDEPENDENT: u64 = 101;
const METHOD_ISTYPEDEPENDENT: u64 = 102;
const METHOD_ISINSTANTIATIONDEPENDENT: u64 = 103;
const METHOD_CONTAINSUNEXPANDEDPARAMETERPACK_1: u64 = 104;
const METHOD_CONTAINSERRORS_1: u64 = 105;
const METHOD_GETEXPRLOC_14: u64 = 106;
const METHOD_ISREADIFDISCARDEDINCPLUSPLUS11: u64 = 107;
const METHOD_ISLVALUE: u64 = 108;
const METHOD_ISPRVALUE: u64 = 109;
const METHOD_ISXVALUE: u64 = 110;
const METHOD_ISGLVALUE: u64 = 111;
const METHOD_GETVALUEKIND: u64 = 112;
const METHOD_GETOBJECTKIND: u64 = 113;
const METHOD_ISORDINARYORBITFIELDOBJECT: u64 = 114;
const METHOD_REFERSTOBITFIELD: u64 = 115;
const METHOD_GETSOURCEBITFIELD: u64 = 116;
const METHOD_GETREFERENCEDDECLOFCALLEE: u64 = 117;
const METHOD_GETOBJCPROPERTY: u64 = 118;
const METHOD_ISOBJCSELFEXPR: u64 = 119;
const METHOD_REFERSTOVECTORELEMENT: u64 = 120;
const METHOD_REFERSTOMATRIXELEMENT: u64 = 121;
const METHOD_REFERSTOGLOBALREGISTERVAR: u64 = 122;
const METHOD_HASPLACEHOLDERTYPE: u64 = 123;
const METHOD_IGNOREUNLESSSPELLEDINSOURCE: u64 = 124;
const METHOD_IGNOREIMPCASTS: u64 = 125;
const METHOD_IGNORECASTS: u64 = 126;
const METHOD_IGNOREIMPLICIT: u64 = 127;
const METHOD_IGNOREIMPLICITASWRITTEN: u64 = 128;
const METHOD_IGNOREPARENS: u64 = 129;
const METHOD_IGNOREPARENIMPCASTS: u64 = 130;
const METHOD_IGNOREPARENCASTS: u64 = 131;
const METHOD_IGNORECONVERSIONOPERATORSINGLESTEP: u64 = 132;
const METHOD_IGNOREPARENLVALUECASTS: u64 = 133;
const METHOD_IGNOREPARENBASECASTS: u64 = 134;
const METHOD_ISDEFAULTARGUMENT: u64 = 135;
const METHOD_ISIMPLICITCXXTHIS: u64 = 136;
const METHOD_GETBESTDYNAMICCLASSTYPE: u64 = 137;
const METHOD_GETBESTDYNAMICCLASSTYPEEXPR: u64 = 138;
const METHOD_SKIPRVALUESUBOBJECTADJUSTMENTS: u64 = 139;
const CLASS_SWITCHSTMT: u64 = 140;
const METHOD_HASINITSTORAGE_1: u64 = 141;
const METHOD_HASVARSTORAGE_1: u64 = 142;
const METHOD_GETCOND_8: u64 = 143;
const METHOD_GETBODY_11: u64 = 144;
const METHOD_GETINIT_6: u64 = 145;
const METHOD_GETCONDITIONVARIABLE_2: u64 = 146;
const METHOD_GETCONDITIONVARIABLEDECLSTMT_2: u64 = 147;
const METHOD_GETSWITCHCASELIST: u64 = 148;
const METHOD_GETSWITCHLOC: u64 = 149;
const METHOD_GETLPARENLOC_10: u64 = 150;
const METHOD_GETRPARENLOC_25: u64 = 151;
const METHOD_ISALLENUMCASESCOVERED: u64 = 152;
const METHOD_GETBEGINLOC_123: u64 = 153;
const METHOD_GETENDLOC_122: u64 = 154;
const METHOD_CHILDREN_110: u64 = 155;
const CLASS_OMPPARALLELMASTERTASKLOOPSIMDDIRECTIVE: u64 = 156;
const CLASS_OMPMASTERTASKLOOPDIRECTIVE: u64 = 157;
const CLASS_SWITCHCASE: u64 = 158;
const METHOD_GETNEXTSWITCHCASE: u64 = 159;
const METHOD_GETKEYWORDLOC_4: u64 = 160;
const METHOD_GETCOLONLOC_3: u64 = 161;
const METHOD_GETSUBSTMT_6: u64 = 162;
const METHOD_GETBEGINLOC_122: u64 = 163;
const METHOD_GETENDLOC_121: u64 = 164;
const CLASS_MSASMSTMT: u64 = 165;
const METHOD_GETLBRACELOC_2: u64 = 166;
const METHOD_GETENDLOC_90: u64 = 167;
const METHOD_HASBRACES_2: u64 = 168;
const METHOD_GETASMSTRING_2: u64 = 169;
const METHOD_GETALLCONSTRAINTS: u64 = 170;
const METHOD_GETCLOBBERS: u64 = 171;
const METHOD_GETALLEXPRS: u64 = 172;
const METHOD_GETBEGINLOC_91: u64 = 173;
const METHOD_CHILDREN_79: u64 = 174;
const CLASS_ASMSTMT: u64 = 175;
const METHOD_GETASMLOC_1: u64 = 176;
const METHOD_ISSIMPLE: u64 = 177;
const METHOD_ISVOLATILE_2: u64 = 178;
const METHOD_GETBEGINLOC_10: u64 = 179;
const METHOD_GETENDLOC_9: u64 = 180;
const METHOD_GETNUMOUTPUTS: u64 = 181;
const METHOD_GETNUMPLUSOPERANDS: u64 = 182;
const METHOD_GETNUMINPUTS: u64 = 183;
const METHOD_GETNUMCLOBBERS: u64 = 184;
const METHOD_BEGIN_INPUTS: u64 = 185;
const METHOD_END_INPUTS: u64 = 186;
const METHOD_INPUTS: u64 = 187;
const METHOD_BEGIN_OUTPUTS: u64 = 188;
const METHOD_END_OUTPUTS: u64 = 189;
const METHOD_OUTPUTS: u64 = 190;
const METHOD_CHILDREN_6: u64 = 191;
const CLASS_CHOOSEEXPR: u64 = 192;
const METHOD_ISCONDITIONTRUE: u64 = 193;
const METHOD_ISCONDITIONDEPENDENT: u64 = 194;
const METHOD_GETCHOSENSUBEXPR: u64 = 195;
const METHOD_GETCOND_3: u64 = 196;
const METHOD_GETLHS_5: u64 = 197;
const METHOD_GETRHS_5: u64 = 198;
const METHOD_GETBUILTINLOC_2: u64 = 199;
const METHOD_GETRPARENLOC_12: u64 = 200;
const METHOD_GETBEGINLOC_52: u64 = 201;
const METHOD_GETENDLOC_51: u64 = 202;
const METHOD_CHILDREN_42: u64 = 203;
const CLASS_OBJCIVARREFEXPR: u64 = 204;
const CLASS_CAPTUREDSTMT: u64 = 205;
const METHOD_GETCAPTUREDSTMT: u64 = 206;
const METHOD_GETCAPTUREDDECL: u64 = 207;
const METHOD_GETCAPTUREDREGIONKIND: u64 = 208;
const METHOD_GETCAPTUREDRECORDDECL: u64 = 209;
const METHOD_CAPTURES_2: u64 = 210;
const METHOD_CAPTURE_BEGIN: u64 = 211;
const METHOD_CAPTURE_END: u64 = 212;
const METHOD_CAPTURE_SIZE: u64 = 213;
const METHOD_CAPTURE_INITS: u64 = 214;
const METHOD_CAPTURE_INIT_BEGIN: u64 = 215;
const METHOD_CAPTURE_INIT_END: u64 = 216;
const METHOD_GETBEGINLOC_49: u64 = 217;
const METHOD_GETENDLOC_48: u64 = 218;
const METHOD_GETSOURCERANGE_47: u64 = 219;
const METHOD_CHILDREN_38: u64 = 220;
const CLASS_CXXTRYSTMT: u64 = 221;
const METHOD_GETBEGINLOC_44: u64 = 222;
const METHOD_GETTRYLOC: u64 = 223;
const METHOD_GETENDLOC_43: u64 = 224;
const METHOD_GETTRYBLOCK: u64 = 225;
const METHOD_GETNUMHANDLERS: u64 = 226;
const METHOD_CHILDREN_33: u64 = 227;
const CLASS_CXXFORRANGESTMT: u64 = 228;
const METHOD_GETINIT_2: u64 = 229;
const METHOD_GETLOOPVARIABLE: u64 = 230;
const METHOD_GETRANGEINIT: u64 = 231;
const METHOD_GETRANGESTMT: u64 = 232;
const METHOD_GETBEGINSTMT: u64 = 233;
const METHOD_GETENDSTMT: u64 = 234;
const METHOD_GETCOND_2: u64 = 235;
const METHOD_GETINC: u64 = 236;
const METHOD_GETLOOPVARSTMT: u64 = 237;
const METHOD_GETBODY_5: u64 = 238;
const METHOD_GETFORLOC: u64 = 239;
const METHOD_GETCOAWAITLOC: u64 = 240;
const METHOD_GETCOLONLOC_2: u64 = 241;
const METHOD_GETRPARENLOC_6: u64 = 242;
const METHOD_GETBEGINLOC_28: u64 = 243;
const METHOD_GETENDLOC_27: u64 = 244;
const METHOD_CHILDREN_22: u64 = 245;
const CLASS_OMPITERATOREXPR: u64 = 246;
const CLASS_OMPCANONICALLOOP: u64 = 247;
const CLASS_OMPTILEDIRECTIVE: u64 = 248;
const CLASS_OMPLOOPTRANSFORMATIONDIRECTIVE: u64 = 249;
const CLASS_OBJCATTHROWSTMT: u64 = 250;
const CLASS_BINARYCONDITIONALOPERATOR: u64 = 251;
const METHOD_GETCOMMON: u64 = 252;
const METHOD_GETOPAQUEVALUE: u64 = 253;
const METHOD_GETCOND_1: u64 = 254;
const METHOD_GETTRUEEXPR_1: u64 = 255;
const METHOD_GETFALSEEXPR_1: u64 = 256;
const METHOD_GETBEGINLOC_13: u64 = 257;
const METHOD_GETENDLOC_12: u64 = 258;
const METHOD_CHILDREN_9: u64 = 259;
const CLASS_MEMBEREXPR: u64 = 260;
const METHOD_GETBASE_6: u64 = 261;
const METHOD_GETMEMBERDECL: u64 = 262;
const METHOD_GETFOUNDDECL_3: u64 = 263;
const METHOD_HASQUALIFIER_2: u64 = 264;
const METHOD_GETQUALIFIERLOC_14: u64 = 265;
const METHOD_GETQUALIFIER_15: u64 = 266;
const METHOD_GETTEMPLATEKEYWORDLOC_5: u64 = 267;
const METHOD_GETLANGLELOC_3: u64 = 268;
const METHOD_GETRANGLELOC_3: u64 = 269;
const METHOD_HASTEMPLATEKEYWORD_3: u64 = 270;
const METHOD_HASEXPLICITTEMPLATEARGS_4: u64 = 271;
const METHOD_GETTEMPLATEARGS_5: u64 = 272;
const METHOD_GETNUMTEMPLATEARGS_3: u64 = 273;
const METHOD_TEMPLATE_ARGUMENTS_5: u64 = 274;
const METHOD_GETMEMBERNAMEINFO_1: u64 = 275;
const METHOD_GETOPERATORLOC_6: u64 = 276;
const METHOD_ISARROW_4: u64 = 277;
const METHOD_GETMEMBERLOC_2: u64 = 278;
const METHOD_GETBEGINLOC_97: u64 = 279;
const METHOD_GETENDLOC_96: u64 = 280;
const METHOD_GETEXPRLOC_9: u64 = 281;
const METHOD_ISIMPLICITACCESS_2: u64 = 282;
const METHOD_HADMULTIPLECANDIDATES_2: u64 = 283;
const METHOD_ISNONODRUSE_1: u64 = 284;
const METHOD_CHILDREN_85: u64 = 285;
const CLASS_OMPPARALLELFORDIRECTIVE: u64 = 286;
const CLASS_OBJCPROPERTYREFEXPR: u64 = 287;
const CLASS_OMPTASKLOOPSIMDDIRECTIVE: u64 = 288;
const CLASS_OMPEXECUTABLEDIRECTIVE: u64 = 289;
const CLASS_OMPPARALLELMASKEDTASKLOOPDIRECTIVE: u64 = 290;
const CLASS_CXXDEFAULTINITEXPR: u64 = 291;
const METHOD_HASREWRITTENINIT_1: u64 = 292;
const METHOD_GETFIELD: u64 = 293;
const METHOD_GETEXPR_1: u64 = 294;
const METHOD_GETREWRITTENEXPR_1: u64 = 295;
const METHOD_GETUSEDCONTEXT_1: u64 = 296;
const METHOD_GETUSEDLOCATION_1: u64 = 297;
const METHOD_GETBEGINLOC_24: u64 = 298;
const METHOD_GETENDLOC_23: u64 = 299;
const METHOD_CHILDREN_18: u64 = 300;
const CLASS_CXXSCALARVALUEINITEXPR: u64 = 301;
const METHOD_GETTYPESOURCEINFO_2: u64 = 302;
const METHOD_GETRPARENLOC_9: u64 = 303;
const METHOD_GETBEGINLOC_39: u64 = 304;
const METHOD_GETENDLOC_38: u64 = 305;
const METHOD_CHILDREN_29: u64 = 306;
const CLASS_VALUESTMT: u64 = 307;
const METHOD_GETEXPRSTMT: u64 = 308;
const CLASS_SYCLUNIQUESTABLENAMEEXPR: u64 = 309;
const METHOD_GETTYPESOURCEINFO_8: u64 = 310;
const METHOD_GETBEGINLOC_114: u64 = 311;
const METHOD_GETENDLOC_113: u64 = 312;
const METHOD_GETLOCATION_14: u64 = 313;
const METHOD_GETLPARENLOCATION: u64 = 314;
const METHOD_GETRPARENLOCATION: u64 = 315;
const METHOD_CHILDREN_101: u64 = 316;
const CLASS_OMPSINGLEDIRECTIVE: u64 = 317;
const CLASS_OMPTARGETUPDATEDIRECTIVE: u64 = 318;
const CLASS_OMPDISTRIBUTEPARALLELFORDIRECTIVE: u64 = 319;
const CLASS_OMPTASKLOOPDIRECTIVE: u64 = 320;
const CLASS_OMPDISTRIBUTEDIRECTIVE: u64 = 321;
const CLASS_COROUTINEBODYSTMT: u64 = 322;
const METHOD_HASDEPENDENTPROMISETYPE: u64 = 323;
const METHOD_GETBODY_6: u64 = 324;
const METHOD_GETPROMISEDECLSTMT: u64 = 325;
const METHOD_GETPROMISEDECL: u64 = 326;
const METHOD_GETINITSUSPENDSTMT: u64 = 327;
const METHOD_GETFINALSUSPENDSTMT: u64 = 328;
const METHOD_GETEXCEPTIONHANDLER: u64 = 329;
const METHOD_GETFALLTHROUGHHANDLER: u64 = 330;
const METHOD_GETALLOCATE: u64 = 331;
const METHOD_GETDEALLOCATE: u64 = 332;
const METHOD_GETRESULTDECL: u64 = 333;
const METHOD_GETRETURNVALUEINIT: u64 = 334;
const METHOD_GETRETURNVALUE: u64 = 335;
const METHOD_GETRETURNSTMT: u64 = 336;
const METHOD_GETRETURNSTMTONALLOCFAILURE: u64 = 337;
const METHOD_GETPARAMMOVES: u64 = 338;
const METHOD_GETBEGINLOC_61: u64 = 339;
const METHOD_GETENDLOC_60: u64 = 340;
const METHOD_CHILDREN_51: u64 = 341;
const METHOD_CHILDRENEXCLBODY: u64 = 342;
const CLASS_OMPTARGETDIRECTIVE: u64 = 343;
const CLASS_CXXTHROWEXPR: u64 = 344;
const METHOD_GETSUBEXPR_3: u64 = 345;
const METHOD_GETTHROWLOC: u64 = 346;
const METHOD_ISTHROWNVARIABLEINSCOPE: u64 = 347;
const METHOD_GETBEGINLOC_43: u64 = 348;
const METHOD_GETENDLOC_42: u64 = 349;
const METHOD_CHILDREN_32: u64 = 350;
const CLASS_UNARYOPERATOR: u64 = 351;
const METHOD_GETOPCODE_2: u64 = 352;
const METHOD_GETSUBEXPR_9: u64 = 353;
const METHOD_GETOPERATORLOC_10: u64 = 354;
const METHOD_CANOVERFLOW: u64 = 355;
const METHOD_ISPREFIX: u64 = 356;
const METHOD_ISPOSTFIX: u64 = 357;
const METHOD_ISINCREMENTOP: u64 = 358;
const METHOD_ISDECREMENTOP: u64 = 359;
const METHOD_ISINCREMENTDECREMENTOP: u64 = 360;
const METHOD_ISARITHMETICOP: u64 = 361;
const METHOD_GETBEGINLOC_127: u64 = 362;
const METHOD_GETENDLOC_126: u64 = 363;
const METHOD_GETEXPRLOC_12: u64 = 364;
const METHOD_CHILDREN_114: u64 = 365;
const METHOD_HASSTOREDFPFEATURES_4: u64 = 366;
const METHOD_GETSTOREDFPFEATURES_4: u64 = 367;
const METHOD_GETFPOPTIONSOVERRIDE: u64 = 368;
const CLASS_OMPTARGETDATADIRECTIVE: u64 = 369;
const CLASS_OMPTARGETTEAMSDISTRIBUTEPARALLELFORDIRECTIVE: u64 = 370;
const CLASS_OMPTARGETENTERDATADIRECTIVE: u64 = 371;
const CLASS_OMPTASKYIELDDIRECTIVE: u64 = 372;
const CLASS_OMPTEAMSGENERICLOOPDIRECTIVE: u64 = 373;
const CLASS_OMPATOMICDIRECTIVE: u64 = 374;
const CLASS_OBJCDICTIONARYLITERAL: u64 = 375;
const CLASS_FULLEXPR: u64 = 376;
const METHOD_GETSUBEXPR_5: u64 = 377;
const CLASS_OMPDISPATCHDIRECTIVE: u64 = 378;
const CLASS_OMPTEAMSDIRECTIVE: u64 = 379;
const CLASS_CXXDEFAULTARGEXPR: u64 = 380;
const METHOD_GETPARAM: u64 = 381;
const METHOD_HASREWRITTENINIT: u64 = 382;
const METHOD_GETEXPR: u64 = 383;
const METHOD_GETREWRITTENEXPR: u64 = 384;
const METHOD_GETADJUSTEDREWRITTENEXPR: u64 = 385;
const METHOD_GETUSEDCONTEXT: u64 = 386;
const METHOD_GETUSEDLOCATION: u64 = 387;
const METHOD_GETBEGINLOC_23: u64 = 388;
const METHOD_GETENDLOC_22: u64 = 389;
const METHOD_GETEXPRLOC_2: u64 = 390;
const METHOD_CHILDREN_17: u64 = 391;
const CLASS_INDIRECTGOTOSTMT: u64 = 392;
const METHOD_GETGOTOLOC_1: u64 = 393;
const METHOD_GETSTARLOC: u64 = 394;
const METHOD_GETTARGET: u64 = 395;
const METHOD_GETCONSTANTTARGET: u64 = 396;
const METHOD_GETBEGINLOC_86: u64 = 397;
const METHOD_GETENDLOC_85: u64 = 398;
const METHOD_CHILDREN_74: u64 = 399;
const CLASS_OMPTARGETEXITDATADIRECTIVE: u64 = 400;
const CLASS_CXXTYPEIDEXPR: u64 = 401;
const METHOD_ISPOTENTIALLYEVALUATED: u64 = 402;
const METHOD_ISTYPEOPERAND: u64 = 403;
const METHOD_GETTYPEOPERANDSOURCEINFO: u64 = 404;
const METHOD_GETEXPROPERAND: u64 = 405;
const METHOD_GETBEGINLOC_45: u64 = 406;
const METHOD_GETENDLOC_44: u64 = 407;
const METHOD_GETSOURCERANGE_45: u64 = 408;
const METHOD_CHILDREN_34: u64 = 409;
const CLASS_OMPTEAMSDISTRIBUTEPARALLELFORSIMDDIRECTIVE: u64 = 410;
const CLASS_ADDRLABELEXPR: u64 = 411;
const METHOD_GETAMPAMPLOC: u64 = 412;
const METHOD_GETLABELLOC: u64 = 413;
const METHOD_GETBEGINLOC_4: u64 = 414;
const METHOD_GETENDLOC_3: u64 = 415;
const METHOD_GETLABEL: u64 = 416;
const METHOD_CHILDREN: u64 = 417;
const CLASS_DECLREFEXPR: u64 = 418;
const METHOD_GETDECL_7: u64 = 419;
const METHOD_GETNAMEINFO_4: u64 = 420;
const METHOD_GETLOCATION_7: u64 = 421;
const METHOD_GETBEGINLOC_63: u64 = 422;
const METHOD_GETENDLOC_62: u64 = 423;
const METHOD_HASQUALIFIER_1: u64 = 424;
const METHOD_GETQUALIFIERLOC_10: u64 = 425;
const METHOD_GETQUALIFIER_13: u64 = 426;
const METHOD_GETFOUNDDECL_2: u64 = 427;
const METHOD_HASTEMPLATEKWANDARGSINFO: u64 = 428;
const METHOD_GETTEMPLATEKEYWORDLOC_3: u64 = 429;
const METHOD_GETLANGLELOC_1: u64 = 430;
const METHOD_GETRANGLELOC_1: u64 = 431;
const METHOD_HASTEMPLATEKEYWORD_1: u64 = 432;
const METHOD_HASEXPLICITTEMPLATEARGS_2: u64 = 433;
const METHOD_GETTEMPLATEARGS_3: u64 = 434;
const METHOD_GETNUMTEMPLATEARGS_1: u64 = 435;
const METHOD_TEMPLATE_ARGUMENTS_3: u64 = 436;
const METHOD_HADMULTIPLECANDIDATES_1: u64 = 437;
const METHOD_ISNONODRUSE: u64 = 438;
const METHOD_REFERSTOENCLOSINGVARIABLEORCAPTURE: u64 = 439;
const METHOD_ISIMMEDIATEESCALATING_2: u64 = 440;
const METHOD_ISCAPTUREDBYCOPYINLAMBDAWITHEXPLICITOBJECTPARAMETER: u64 = 441;
const METHOD_CHILDREN_53: u64 = 442;
const CLASS_OMPINTEROPDIRECTIVE: u64 = 443;
const CLASS_OBJCARRAYLITERAL: u64 = 444;
const CLASS_OMPDISTRIBUTESIMDDIRECTIVE: u64 = 445;
const CLASS_OBJCINDIRECTCOPYRESTOREEXPR: u64 = 446;
const CLASS_OBJCATTRYSTMT: u64 = 447;
const CLASS_OMPSECTIONSDIRECTIVE: u64 = 448;
const CLASS_OMPLOOPBASEDDIRECTIVE: u64 = 449;
const CLASS_REQUIRESEXPR: u64 = 450;
const METHOD_GETLOCALPARAMETERS: u64 = 451;
const METHOD_GETBODY_10: u64 = 452;
const METHOD_GETREQUIREMENTS: u64 = 453;
const METHOD_ISSATISFIED: u64 = 454;
const METHOD_GETREQUIRESKWLOC: u64 = 455;
const METHOD_GETLPARENLOC_8: u64 = 456;
const METHOD_GETRPARENLOC_21: u64 = 457;
const METHOD_GETRBRACELOC_5: u64 = 458;
const METHOD_GETBEGINLOC_108: u64 = 459;
const METHOD_GETENDLOC_107: u64 = 460;
const METHOD_CHILDREN_95: u64 = 461;
const CLASS_OMPSECTIONDIRECTIVE: u64 = 462;
const CLASS_OMPLOOPDIRECTIVE: u64 = 463;
const CLASS_OMPARRAYSECTIONEXPR: u64 = 464;
const CLASS_CASESTMT: u64 = 465;
const METHOD_CASESTMTISGNURANGE: u64 = 466;
const METHOD_GETCASELOC: u64 = 467;
const METHOD_GETELLIPSISLOC_5: u64 = 468;
const METHOD_GETLHS_4: u64 = 469;
const METHOD_GETRHS_4: u64 = 470;
const METHOD_GETSUBSTMT_1: u64 = 471;
const METHOD_GETBEGINLOC_50: u64 = 472;
const METHOD_GETENDLOC_49: u64 = 473;
const METHOD_CHILDREN_39: u64 = 474;
const CLASS_OMPPARALLELGENERICLOOPDIRECTIVE: u64 = 475;
const CLASS_OMPUNROLLDIRECTIVE: u64 = 476;
const CLASS_INTEGERLITERAL: u64 = 477;
const METHOD_GETBEGINLOC_88: u64 = 478;
const METHOD_GETENDLOC_87: u64 = 479;
const METHOD_GETLOCATION_11: u64 = 480;
const METHOD_CHILDREN_76: u64 = 481;
const CLASS_EXPRWITHCLEANUPS: u64 = 482;
const METHOD_GETOBJECTS: u64 = 483;
const METHOD_GETNUMOBJECTS: u64 = 484;
const METHOD_CLEANUPSHAVESIDEEFFECTS: u64 = 485;
const METHOD_GETBEGINLOC_71: u64 = 486;
const METHOD_GETENDLOC_70: u64 = 487;
const METHOD_CHILDREN_61: u64 = 488;
const CLASS_OMPTARGETTEAMSGENERICLOOPDIRECTIVE: u64 = 489;
const CLASS_STMTEXPR: u64 = 490;
const METHOD_GETSUBSTMT_5: u64 = 491;
const METHOD_GETBEGINLOC_118: u64 = 492;
const METHOD_GETENDLOC_117: u64 = 493;
const METHOD_GETLPARENLOC_9: u64 = 494;
const METHOD_GETRPARENLOC_24: u64 = 495;
const METHOD_GETTEMPLATEDEPTH_1: u64 = 496;
const METHOD_CHILDREN_106: u64 = 497;
const CLASS_OMPGENERICLOOPDIRECTIVE: u64 = 498;
const CLASS_OMPMETADIRECTIVE: u64 = 499;
const CLASS_OMPSCANDIRECTIVE: u64 = 500;
const CLASS_OMPTEAMSDISTRIBUTEPARALLELFORDIRECTIVE: u64 = 501;
const CLASS_IFSTMT: u64 = 502;
const METHOD_HASINITSTORAGE: u64 = 503;
const METHOD_HASVARSTORAGE: u64 = 504;
const METHOD_HASELSESTORAGE: u64 = 505;
const METHOD_GETCOND_7: u64 = 506;
const METHOD_GETTHEN: u64 = 507;
const METHOD_GETELSE: u64 = 508;
const METHOD_GETCONDITIONVARIABLE_1: u64 = 509;
const METHOD_GETCONDITIONVARIABLEDECLSTMT_1: u64 = 510;
const METHOD_GETINIT_5: u64 = 511;
const METHOD_GETIFLOC: u64 = 512;
const METHOD_GETELSELOC: u64 = 513;
const METHOD_ISCONSTEVAL_1: u64 = 514;
const METHOD_ISNONNEGATEDCONSTEVAL: u64 = 515;
const METHOD_ISNEGATEDCONSTEVAL: u64 = 516;
const METHOD_ISCONSTEXPR_2: u64 = 517;
const METHOD_GETSTATEMENTKIND: u64 = 518;
const METHOD_ISOBJCAVAILABILITYCHECK: u64 = 519;
const METHOD_GETBEGINLOC_82: u64 = 520;
const METHOD_GETENDLOC_81: u64 = 521;
const METHOD_GETLPARENLOC_6: u64 = 522;
const METHOD_GETRPARENLOC_18: u64 = 523;
const METHOD_CHILDREN_71: u64 = 524;
const CLASS_ARRAYSUBSCRIPTEXPR: u64 = 525;
const METHOD_GETLHS: u64 = 526;
const METHOD_GETRHS: u64 = 527;
const METHOD_GETBASE: u64 = 528;
const METHOD_GETIDX: u64 = 529;
const METHOD_GETBEGINLOC_7: u64 = 530;
const METHOD_GETENDLOC_6: u64 = 531;
const METHOD_GETRBRACKETLOC_2: u64 = 532;
const METHOD_GETEXPRLOC: u64 = 533;
const METHOD_CHILDREN_3: u64 = 534;
const CLASS_OMPTARGETTEAMSDISTRIBUTEPARALLELFORSIMDDIRECTIVE: u64 = 535;
const CLASS_FORSTMT: u64 = 536;
const METHOD_GETCONDITIONVARIABLE: u64 = 537;
const METHOD_GETCONDITIONVARIABLEDECLSTMT: u64 = 538;
const METHOD_GETINIT_4: u64 = 539;
const METHOD_GETCOND_6: u64 = 540;
const METHOD_GETINC_1: u64 = 541;
const METHOD_GETBODY_8: u64 = 542;
const METHOD_GETFORLOC_1: u64 = 543;
const METHOD_GETLPARENLOC_5: u64 = 544;
const METHOD_GETRPARENLOC_15: u64 = 545;
const METHOD_GETBEGINLOC_76: u64 = 546;
const METHOD_GETENDLOC_75: u64 = 547;
const METHOD_CHILDREN_66: u64 = 548;
const CLASS_OMPTARGETPARALLELFORSIMDDIRECTIVE: u64 = 549;
const CLASS_OMPTARGETPARALLELGENERICLOOPDIRECTIVE: u64 = 550;
const CLASS_COMPOUNDLITERALEXPR: u64 = 551;
const METHOD_GETINITIALIZER_1: u64 = 552;
const METHOD_ISFILESCOPE: u64 = 553;
const METHOD_GETLPARENLOC_4: u64 = 554;
const METHOD_GETTYPESOURCEINFO_5: u64 = 555;
const METHOD_GETBEGINLOC_53: u64 = 556;
const METHOD_GETENDLOC_52: u64 = 557;
const METHOD_CHILDREN_43: u64 = 558;
const CLASS_DEFAULTSTMT: u64 = 559;
const METHOD_GETSUBSTMT_2: u64 = 560;
const METHOD_GETDEFAULTLOC_1: u64 = 561;
const METHOD_GETBEGINLOC_65: u64 = 562;
const METHOD_GETENDLOC_64: u64 = 563;
const METHOD_CHILDREN_55: u64 = 564;
const CLASS_TYPETRAITEXPR: u64 = 565;
const METHOD_GETTRAIT_2: u64 = 566;
const METHOD_GETVALUE_9: u64 = 567;
const METHOD_GETNUMARGS_4: u64 = 568;
const METHOD_GETARGS_2: u64 = 569;
const METHOD_GETBEGINLOC_124: u64 = 570;
const METHOD_GETENDLOC_123: u64 = 571;
const METHOD_CHILDREN_111: u64 = 572;
const CLASS_COROUTINESUSPENDEXPR: u64 = 573;
const METHOD_GETCOMMONEXPR_1: u64 = 574;
const METHOD_GETOPAQUEVALUE_1: u64 = 575;
const METHOD_GETREADYEXPR: u64 = 576;
const METHOD_GETSUSPENDEXPR: u64 = 577;
const METHOD_GETRESUMEEXPR: u64 = 578;
const METHOD_GETOPERAND_2: u64 = 579;
const METHOD_GETKEYWORDLOC_1: u64 = 580;
const METHOD_GETBEGINLOC_62: u64 = 581;
const METHOD_GETENDLOC_61: u64 = 582;
const METHOD_CHILDREN_52: u64 = 583;
const CLASS_INITLISTEXPR: u64 = 584;
const METHOD_GETNUMINITS: u64 = 585;
const METHOD_GETINITS: u64 = 586;
const METHOD_INITS_1: u64 = 587;
const METHOD_GETARRAYFILLER_1: u64 = 588;
const METHOD_HASARRAYFILLER: u64 = 589;
const METHOD_HASDESIGNATEDINIT: u64 = 590;
const METHOD_GETINITIALIZEDFIELDINUNION_1: u64 = 591;
const METHOD_ISEXPLICIT_3: u64 = 592;
const METHOD_ISSTRINGLITERALINIT: u64 = 593;
const METHOD_ISTRANSPARENT: u64 = 594;
const METHOD_GETLBRACELOC_1: u64 = 595;
const METHOD_GETRBRACELOC_4: u64 = 596;
const METHOD_ISSEMANTICFORM: u64 = 597;
const METHOD_GETSEMANTICFORM_1: u64 = 598;
const METHOD_ISSYNTACTICFORM: u64 = 599;
const METHOD_GETSYNTACTICFORM: u64 = 600;
const METHOD_HADARRAYRANGEDESIGNATOR: u64 = 601;
const METHOD_GETBEGINLOC_87: u64 = 602;
const METHOD_GETENDLOC_86: u64 = 603;
const METHOD_CHILDREN_75: u64 = 604;
const METHOD_BEGIN: u64 = 605;
const METHOD_END: u64 = 606;
const METHOD_RBEGIN: u64 = 607;
const METHOD_REND: u64 = 608;
const CLASS_FUNCTIONPARMPACKEXPR: u64 = 609;
const METHOD_GETPARAMETERPACK: u64 = 610;
const METHOD_GETPARAMETERPACKLOCATION: u64 = 611;
const METHOD_BEGIN_1: u64 = 612;
const METHOD_END_1: u64 = 613;
const METHOD_GETNUMEXPANSIONS_2: u64 = 614;
const METHOD_GETBEGINLOC_77: u64 = 615;
const METHOD_GETENDLOC_76: u64 = 616;
const METHOD_CHILDREN_67: u64 = 617;
const CLASS_SIZEOFPACKEXPR: u64 = 618;
const METHOD_GETOPERATORLOC_8: u64 = 619;
const METHOD_GETPACKLOC: u64 = 620;
const METHOD_GETRPARENLOC_23: u64 = 621;
const METHOD_GETPACK: u64 = 622;
const METHOD_GETPACKLENGTH: u64 = 623;
const METHOD_ISPARTIALLYSUBSTITUTED: u64 = 624;
const METHOD_GETPARTIALARGUMENTS: u64 = 625;
const METHOD_GETBEGINLOC_116: u64 = 626;
const METHOD_GETENDLOC_115: u64 = 627;
const METHOD_CHILDREN_103: u64 = 628;
const CLASS_SUBSTNONTYPETEMPLATEPARMPACKEXPR: u64 = 629;
const METHOD_GETASSOCIATEDDECL_3: u64 = 630;
const METHOD_GETINDEX_5: u64 = 631;
const METHOD_GETPARAMETERPACK_1: u64 = 632;
const METHOD_GETPARAMETERPACKLOCATION_1: u64 = 633;
const METHOD_GETARGUMENTPACK_1: u64 = 634;
const METHOD_GETBEGINLOC_121: u64 = 635;
const METHOD_GETENDLOC_120: u64 = 636;
const METHOD_CHILDREN_109: u64 = 637;
const CLASS_PACKEXPANSIONEXPR: u64 = 638;
const METHOD_GETPATTERN_2: u64 = 639;
const METHOD_GETELLIPSISLOC_6: u64 = 640;
const METHOD_GETNUMEXPANSIONS_3: u64 = 641;
const METHOD_GETBEGINLOC_102: u64 = 642;
const METHOD_GETENDLOC_101: u64 = 643;
const METHOD_CHILDREN_90: u64 = 644;
const CLASS_DESIGNATEDINITUPDATEEXPR: u64 = 645;
const METHOD_GETBEGINLOC_69: u64 = 646;
const METHOD_GETENDLOC_68: u64 = 647;
const METHOD_GETBASE_2: u64 = 648;
const METHOD_GETUPDATER: u64 = 649;
const METHOD_CHILDREN_59: u64 = 650;
const CLASS_LABELSTMT: u64 = 651;
const METHOD_GETIDENTLOC: u64 = 652;
const METHOD_GETDECL_8: u64 = 653;
const METHOD_GETNAME_1: u64 = 654;
const METHOD_GETSUBSTMT_3: u64 = 655;
const METHOD_GETBEGINLOC_89: u64 = 656;
const METHOD_GETENDLOC_88: u64 = 657;
const METHOD_CHILDREN_77: u64 = 658;
const METHOD_ISSIDEENTRY: u64 = 659;
const CLASS_EXPRESSIONTRAITEXPR: u64 = 660;
const METHOD_GETBEGINLOC_72: u64 = 661;
const METHOD_GETENDLOC_71: u64 = 662;
const METHOD_GETTRAIT_1: u64 = 663;
const METHOD_GETQUERIEDEXPRESSION: u64 = 664;
const METHOD_GETVALUE_7: u64 = 665;
const METHOD_CHILDREN_62: u64 = 666;
const CLASS_ARRAYTYPETRAITEXPR: u64 = 667;
const METHOD_GETBEGINLOC_8: u64 = 668;
const METHOD_GETENDLOC_7: u64 = 669;
const METHOD_GETTRAIT: u64 = 670;
const METHOD_GETQUERIEDTYPE: u64 = 671;
const METHOD_GETQUERIEDTYPESOURCEINFO: u64 = 672;
const METHOD_GETVALUE_10: u64 = 673;
const METHOD_GETDIMENSIONEXPRESSION: u64 = 674;
const METHOD_CHILDREN_4: u64 = 675;
const CLASS_CXXPSEUDODESTRUCTOREXPR: u64 = 676;
const METHOD_GETBASE_1: u64 = 677;
const METHOD_HASQUALIFIER: u64 = 678;
const METHOD_GETQUALIFIERLOC_9: u64 = 679;
const METHOD_GETQUALIFIER_12: u64 = 680;
const METHOD_ISARROW_1: u64 = 681;
const METHOD_GETOPERATORLOC_4: u64 = 682;
const METHOD_GETSCOPETYPEINFO: u64 = 683;
const METHOD_GETCOLONCOLONLOC: u64 = 684;
const METHOD_GETTILDELOC: u64 = 685;
const METHOD_GETDESTROYEDTYPEINFO: u64 = 686;
const METHOD_GETDESTROYEDTYPEIDENTIFIER: u64 = 687;
const METHOD_GETDESTROYEDTYPE_1: u64 = 688;
const METHOD_GETDESTROYEDTYPELOC: u64 = 689;
const METHOD_GETBEGINLOC_37: u64 = 690;
const METHOD_GETENDLOC_36: u64 = 691;
const METHOD_CHILDREN_28: u64 = 692;
const CLASS_CXXNEWEXPR: u64 = 693;
const METHOD_GETALLOCATEDTYPE: u64 = 694;
const METHOD_GETALLOCATEDTYPESOURCEINFO: u64 = 695;
const METHOD_SHOULDNULLCHECKALLOCATION: u64 = 696;
const METHOD_GETOPERATORNEW: u64 = 697;
const METHOD_GETOPERATORDELETE_2: u64 = 698;
const METHOD_ISARRAY: u64 = 699;
const METHOD_GETARRAYSIZE_1: u64 = 700;
const METHOD_GETNUMPLACEMENTARGS: u64 = 701;
const METHOD_ISPARENTYPEID: u64 = 702;
const METHOD_GETTYPEIDPARENS: u64 = 703;
const METHOD_ISGLOBALNEW: u64 = 704;
const METHOD_HASINITIALIZER: u64 = 705;
const METHOD_GETINITIALIZATIONSTYLE: u64 = 706;
const METHOD_GETINITIALIZER: u64 = 707;
const METHOD_GETCONSTRUCTEXPR: u64 = 708;
const METHOD_PASSALIGNMENT: u64 = 709;
const METHOD_DOESUSUALARRAYDELETEWANTSIZE_1: u64 = 710;
const METHOD_PLACEMENT_ARGUMENTS: u64 = 711;
const METHOD_PLACEMENT_ARG_BEGIN: u64 = 712;
const METHOD_PLACEMENT_ARG_END: u64 = 713;
const METHOD_RAW_ARG_BEGIN: u64 = 714;
const METHOD_RAW_ARG_END: u64 = 715;
const METHOD_GETBEGINLOC_32: u64 = 716;
const METHOD_GETENDLOC_31: u64 = 717;
const METHOD_GETDIRECTINITRANGE: u64 = 718;
const METHOD_GETSOURCERANGE_39: u64 = 719;
const METHOD_CHILDREN_24: u64 = 720;
const CLASS_LAMBDAEXPR: u64 = 721;
const METHOD_GETCAPTUREDEFAULT: u64 = 722;
const METHOD_GETCAPTUREDEFAULTLOC: u64 = 723;
const METHOD_CAPTURES_3: u64 = 724;
const METHOD_CAPTURE_BEGIN_1: u64 = 725;
const METHOD_CAPTURE_END_1: u64 = 726;
const METHOD_CAPTURE_SIZE_1: u64 = 727;
const METHOD_EXPLICIT_CAPTURES: u64 = 728;
const METHOD_EXPLICIT_CAPTURE_BEGIN: u64 = 729;
const METHOD_EXPLICIT_CAPTURE_END: u64 = 730;
const METHOD_IMPLICIT_CAPTURES: u64 = 731;
const METHOD_IMPLICIT_CAPTURE_BEGIN: u64 = 732;
const METHOD_IMPLICIT_CAPTURE_END: u64 = 733;
const METHOD_CAPTURE_INITS_1: u64 = 734;
const METHOD_CAPTURE_INIT_BEGIN_1: u64 = 735;
const METHOD_CAPTURE_INIT_END_1: u64 = 736;
const METHOD_GETINTRODUCERRANGE: u64 = 737;
const METHOD_GETLAMBDACLASS: u64 = 738;
const METHOD_GETCALLOPERATOR: u64 = 739;
const METHOD_GETDEPENDENTCALLOPERATOR: u64 = 740;
const METHOD_GETTEMPLATEPARAMETERLIST: u64 = 741;
const METHOD_GETEXPLICITTEMPLATEPARAMETERS: u64 = 742;
const METHOD_GETTRAILINGREQUIRESCLAUSE_1: u64 = 743;
const METHOD_ISGENERICLAMBDA_1: u64 = 744;
const METHOD_GETBODY_9: u64 = 745;
const METHOD_GETCOMPOUNDSTMTBODY: u64 = 746;
const METHOD_ISMUTABLE_1: u64 = 747;
const METHOD_HASEXPLICITPARAMETERS: u64 = 748;
const METHOD_HASEXPLICITRESULTTYPE: u64 = 749;
const METHOD_GETBEGINLOC_90: u64 = 750;
const METHOD_GETENDLOC_89: u64 = 751;
const METHOD_CHILDREN_78: u64 = 752;
const CLASS_CXXDYNAMICCASTEXPR: u64 = 753;
const METHOD_ISALWAYSNULL: u64 = 754;
const CLASS_CXXINHERITEDCTORINITEXPR: u64 = 755;
const METHOD_GETCONSTRUCTOR_1: u64 = 756;
const METHOD_CONSTRUCTSVBASE: u64 = 757;
const METHOD_GETCONSTRUCTIONKIND_1: u64 = 758;
const METHOD_INHERITEDFROMVBASE: u64 = 759;
const METHOD_GETLOCATION_3: u64 = 760;
const METHOD_GETBEGINLOC_30: u64 = 761;
const METHOD_GETENDLOC_29: u64 = 762;
const METHOD_CHILDREN_23: u64 = 763;
const CLASS_PREDEFINEDEXPR: u64 = 764;
const METHOD_GETIDENTKIND: u64 = 765;
const METHOD_ISTRANSPARENT_1: u64 = 766;
const METHOD_GETLOCATION_13: u64 = 767;
const METHOD_GETFUNCTIONNAME: u64 = 768;
const METHOD_GETIDENTKINDNAME: u64 = 769;
const METHOD_GETBEGINLOC_105: u64 = 770;
const METHOD_GETENDLOC_104: u64 = 771;
const METHOD_CHILDREN_93: u64 = 772;
const CLASS_CXXTHISEXPR: u64 = 773;
const METHOD_GETLOCATION_5: u64 = 774;
const METHOD_GETBEGINLOC_42: u64 = 775;
const METHOD_GETENDLOC_41: u64 = 776;
const METHOD_ISIMPLICIT_1: u64 = 777;
const METHOD_CHILDREN_31: u64 = 778;
const CLASS_VAARGEXPR: u64 = 779;
const METHOD_GETSUBEXPR_10: u64 = 780;
const METHOD_ISMICROSOFTABI: u64 = 781;
const METHOD_GETWRITTENTYPEINFO: u64 = 782;
const METHOD_GETBUILTINLOC_5: u64 = 783;
const METHOD_GETRPARENLOC_27: u64 = 784;
const METHOD_GETBEGINLOC_131: u64 = 785;
const METHOD_GETENDLOC_130: u64 = 786;
const METHOD_CHILDREN_117: u64 = 787;
const CLASS_OMPSIMDDIRECTIVE: u64 = 788;
const CLASS_SEHTRYSTMT: u64 = 789;
const METHOD_GETBEGINLOC_113: u64 = 790;
const METHOD_GETTRYLOC_1: u64 = 791;
const METHOD_GETENDLOC_112: u64 = 792;
const METHOD_GETISCXXTRY: u64 = 793;
const METHOD_GETTRYBLOCK_1: u64 = 794;
const METHOD_GETHANDLER: u64 = 795;
const METHOD_GETEXCEPTHANDLER: u64 = 796;
const METHOD_GETFINALLYHANDLER: u64 = 797;
const METHOD_CHILDREN_100: u64 = 798;
const CLASS_CXXNULLPTRLITERALEXPR: u64 = 799;
const METHOD_GETBEGINLOC_34: u64 = 800;
const METHOD_GETENDLOC_33: u64 = 801;
const METHOD_GETLOCATION_4: u64 = 802;
const METHOD_CHILDREN_26: u64 = 803;
const CLASS_CXXREWRITTENBINARYOPERATOR: u64 = 804;
const METHOD_GETSEMANTICFORM: u64 = 805;
const METHOD_GETDECOMPOSEDFORM: u64 = 806;
const METHOD_ISREVERSED: u64 = 807;
const METHOD_GETOPERATOR_2: u64 = 808;
const METHOD_GETOPCODE_1: u64 = 809;
const METHOD_GETOPCODESTR_1: u64 = 810;
const METHOD_ISCOMPARISONOP_2: u64 = 811;
const METHOD_ISASSIGNMENTOP_2: u64 = 812;
const METHOD_GETLHS_3: u64 = 813;
const METHOD_GETRHS_3: u64 = 814;
const METHOD_GETOPERATORLOC_5: u64 = 815;
const METHOD_GETEXPRLOC_5: u64 = 816;
const METHOD_GETBEGINLOC_38: u64 = 817;
const METHOD_GETENDLOC_37: u64 = 818;
const METHOD_GETSOURCERANGE_43: u64 = 819;
const CLASS_OVERLOADEXPR: u64 = 820;
const METHOD_GETNAMINGCLASS: u64 = 821;
const METHOD_DECLS_BEGIN: u64 = 822;
const METHOD_DECLS_END: u64 = 823;
const METHOD_DECLS_1: u64 = 824;
const METHOD_GETNUMDECLS: u64 = 825;
const METHOD_GETNAMEINFO_7: u64 = 826;
const METHOD_GETNAME_2: u64 = 827;
const METHOD_GETNAMELOC: u64 = 828;
const METHOD_GETQUALIFIER_16: u64 = 829;
const METHOD_GETQUALIFIERLOC_15: u64 = 830;
const METHOD_GETTEMPLATEKEYWORDLOC_6: u64 = 831;
const METHOD_GETLANGLELOC_4: u64 = 832;
const METHOD_GETRANGLELOC_4: u64 = 833;
const METHOD_HASTEMPLATEKEYWORD_4: u64 = 834;
const METHOD_HASEXPLICITTEMPLATEARGS_5: u64 = 835;
const METHOD_GETTEMPLATEARGS_6: u64 = 836;
const METHOD_GETNUMTEMPLATEARGS_4: u64 = 837;
const METHOD_TEMPLATE_ARGUMENTS_6: u64 = 838;
const CLASS_DECLSTMT: u64 = 839;
const METHOD_ISSINGLEDECL: u64 = 840;
const METHOD_GETSINGLEDECL: u64 = 841;
const METHOD_GETDECLGROUP: u64 = 842;
const METHOD_GETENDLOC_63: u64 = 843;
const METHOD_GETBEGINLOC_64: u64 = 844;
const METHOD_CHILDREN_54: u64 = 845;
const METHOD_DECLS: u64 = 846;
const METHOD_DECL_BEGIN: u64 = 847;
const METHOD_DECL_END: u64 = 848;
const CLASS_ATOMICEXPR: u64 = 849;
const METHOD_GETPTR: u64 = 850;
const METHOD_GETORDER: u64 = 851;
const METHOD_GETSCOPE: u64 = 852;
const METHOD_GETVAL1: u64 = 853;
const METHOD_GETORDERFAIL: u64 = 854;
const METHOD_GETVAL2: u64 = 855;
const METHOD_GETWEAK: u64 = 856;
const METHOD_GETVALUETYPE_1: u64 = 857;
const METHOD_GETOP: u64 = 858;
const METHOD_GETOPASSTRING: u64 = 859;
const METHOD_GETNUMSUBEXPRS: u64 = 860;
const METHOD_GETSUBEXPRS: u64 = 861;
const METHOD_ISVOLATILE_3: u64 = 862;
const METHOD_ISCMPXCHG: u64 = 863;
const METHOD_ISOPENCL: u64 = 864;
const METHOD_GETBUILTINLOC_1: u64 = 865;
const METHOD_GETRPARENLOC_3: u64 = 866;
const METHOD_GETBEGINLOC_11: u64 = 867;
const METHOD_GETENDLOC_10: u64 = 868;
const METHOD_CHILDREN_7: u64 = 869;
const METHOD_GETSCOPEMODEL: u64 = 870;
const CLASS_ASTYPEEXPR: u64 = 871;
const METHOD_GETSRCEXPR: u64 = 872;
const METHOD_GETBUILTINLOC: u64 = 873;
const METHOD_GETRPARENLOC_2: u64 = 874;
const METHOD_GETBEGINLOC_9: u64 = 875;
const METHOD_GETENDLOC_8: u64 = 876;
const METHOD_CHILDREN_5: u64 = 877;
const CLASS_EXTVECTORELEMENTEXPR: u64 = 878;
const METHOD_GETBASE_3: u64 = 879;
const METHOD_GETACCESSOR: u64 = 880;
const METHOD_GETACCESSORLOC: u64 = 881;
const METHOD_GETNUMELEMENTS_1: u64 = 882;
const METHOD_CONTAINSDUPLICATEELEMENTS: u64 = 883;
const METHOD_GETBEGINLOC_73: u64 = 884;
const METHOD_GETENDLOC_72: u64 = 885;
const METHOD_ISARROW_2: u64 = 886;
const METHOD_CHILDREN_63: u64 = 887;
const CLASS_PARENLISTEXPR: u64 = 888;
const METHOD_GETNUMEXPRS: u64 = 889;
const METHOD_GETLPARENLOC_7: u64 = 890;
const METHOD_GETRPARENLOC_20: u64 = 891;
const METHOD_GETBEGINLOC_104: u64 = 892;
const METHOD_GETENDLOC_103: u64 = 893;
const METHOD_CHILDREN_92: u64 = 894;
const CLASS_IMPLICITVALUEINITEXPR: u64 = 895;
const METHOD_GETBEGINLOC_85: u64 = 896;
const METHOD_GETENDLOC_84: u64 = 897;
const METHOD_CHILDREN_73: u64 = 898;
const CLASS_NOINITEXPR: u64 = 899;
const METHOD_GETBEGINLOC_98: u64 = 900;
const METHOD_GETENDLOC_97: u64 = 901;
const METHOD_CHILDREN_86: u64 = 902;
const CLASS_CONDITIONALOPERATOR: u64 = 903;
const METHOD_GETCOND_4: u64 = 904;
const METHOD_GETTRUEEXPR_2: u64 = 905;
const METHOD_GETFALSEEXPR_2: u64 = 906;
const METHOD_GETLHS_6: u64 = 907;
const METHOD_GETRHS_6: u64 = 908;
const METHOD_GETBEGINLOC_56: u64 = 909;
const METHOD_GETENDLOC_55: u64 = 910;
const METHOD_CHILDREN_46: u64 = 911;
const CLASS_CASTEXPR: u64 = 912;
const METHOD_GETCASTKIND: u64 = 913;
const METHOD_GETCASTKINDNAME: u64 = 914;
const METHOD_GETSUBEXPR_4: u64 = 915;
const METHOD_GETSUBEXPRASWRITTEN: u64 = 916;
const METHOD_GETCONVERSIONFUNCTION: u64 = 917;
const METHOD_PATH_EMPTY: u64 = 918;
const METHOD_PATH_SIZE: u64 = 919;
const METHOD_PATH_BEGIN: u64 = 920;
const METHOD_PATH_END: u64 = 921;
const METHOD_PATH: u64 = 922;
const METHOD_GETTARGETUNIONFIELD: u64 = 923;
const METHOD_HASSTOREDFPFEATURES_2: u64 = 924;
const METHOD_GETSTOREDFPFEATURES_2: u64 = 925;
const METHOD_GETFPFEATURES_2: u64 = 926;
const METHOD_CHANGESVOLATILEQUALIFICATION: u64 = 927;
const METHOD_CHILDREN_40: u64 = 928;
const CLASS_OBJCBRIDGEDCASTEXPR: u64 = 929;
const CLASS_CXXNAMEDCASTEXPR: u64 = 930;
const METHOD_GETCASTNAME: u64 = 931;
const METHOD_GETOPERATORLOC_2: u64 = 932;
const METHOD_GETRPARENLOC_8: u64 = 933;
const METHOD_GETBEGINLOC_31: u64 = 934;
const METHOD_GETENDLOC_30: u64 = 935;
const METHOD_GETANGLEBRACKETS: u64 = 936;
const CLASS_CXXREINTERPRETCASTEXPR: u64 = 937;
const CLASS_CXXSTATICCASTEXPR: u64 = 938;
const CLASS_IMPLICITCASTEXPR: u64 = 939;
const METHOD_ISPARTOFEXPLICITCAST: u64 = 940;
const METHOD_GETBEGINLOC_84: u64 = 941;
const METHOD_GETENDLOC_83: u64 = 942;
const CLASS_OMPPARALLELFORSIMDDIRECTIVE: u64 = 943;
const CLASS_CALLEXPR: u64 = 944;
const METHOD_GETCALLEE_1: u64 = 945;
const METHOD_GETADLCALLKIND: u64 = 946;
const METHOD_USESADL: u64 = 947;
const METHOD_HASSTOREDFPFEATURES_1: u64 = 948;
const METHOD_GETCALLEEDECL: u64 = 949;
const METHOD_GETDIRECTCALLEE: u64 = 950;
const METHOD_GETNUMARGS_3: u64 = 951;
const METHOD_GETARGS_1: u64 = 952;
const METHOD_ARGUMENTS_2: u64 = 953;
const METHOD_ARG_BEGIN: u64 = 954;
const METHOD_ARG_END: u64 = 955;
const METHOD_GETSTOREDFPFEATURES_1: u64 = 956;
const METHOD_GETFPFEATURES_1: u64 = 957;
const METHOD_GETBUILTINCALLEE: u64 = 958;
const METHOD_GETRPARENLOC_11: u64 = 959;
const METHOD_GETBEGINLOC_48: u64 = 960;
const METHOD_GETENDLOC_47: u64 = 961;
const METHOD_ISCALLTOSTDMOVE: u64 = 962;
const METHOD_CHILDREN_37: u64 = 963;
const CLASS_OMPCRITICALDIRECTIVE: u64 = 964;
const CLASS_USERDEFINEDLITERAL: u64 = 965;
const METHOD_GETLITERALOPERATORKIND: u64 = 966;
const METHOD_GETCOOKEDLITERAL: u64 = 967;
const METHOD_GETBEGINLOC_130: u64 = 968;
const METHOD_GETENDLOC_129: u64 = 969;
const METHOD_GETUDSUFFIXLOC: u64 = 970;
const METHOD_GETUDSUFFIX: u64 = 971;
const CLASS_CUDAKERNELCALLEXPR: u64 = 972;
const METHOD_GETCONFIG: u64 = 973;
const CLASS_CXXMEMBERCALLEXPR: u64 = 974;
const METHOD_GETIMPLICITOBJECTARGUMENT: u64 = 975;
const METHOD_GETOBJECTTYPE: u64 = 976;
const METHOD_GETMETHODDECL: u64 = 977;
const METHOD_GETRECORDDECL: u64 = 978;
const METHOD_GETEXPRLOC_3: u64 = 979;
const CLASS_SEHFINALLYSTMT: u64 = 980;
const METHOD_GETBEGINLOC_111: u64 = 981;
const METHOD_GETFINALLYLOC: u64 = 982;
const METHOD_GETENDLOC_110: u64 = 983;
const METHOD_GETBLOCK_1: u64 = 984;
const METHOD_CHILDREN_98: u64 = 985;
const CLASS_CXXOPERATORCALLEXPR: u64 = 986;
const METHOD_GETOPERATOR_1: u64 = 987;
const METHOD_ISASSIGNMENTOP_1: u64 = 988;
const METHOD_ISCOMPARISONOP_1: u64 = 989;
const METHOD_ISINFIXBINARYOP: u64 = 990;
const METHOD_GETOPERATORLOC_3: u64 = 991;
const METHOD_GETEXPRLOC_4: u64 = 992;
const METHOD_GETBEGINLOC_35: u64 = 993;
const METHOD_GETENDLOC_34: u64 = 994;
const METHOD_GETSOURCERANGE_41: u64 = 995;
const CLASS_IMAGINARYLITERAL: u64 = 996;
const METHOD_GETSUBEXPR_6: u64 = 997;
const METHOD_GETBEGINLOC_83: u64 = 998;
const METHOD_GETENDLOC_82: u64 = 999;
const METHOD_CHILDREN_72: u64 = 1000;
const CLASS_COMPOUNDSTMT: u64 = 1001;
const METHOD_BODY_EMPTY: u64 = 1002;
const METHOD_SIZE: u64 = 1003;
const METHOD_HASSTOREDFPFEATURES_3: u64 = 1004;
const METHOD_GETSTOREDFPFEATURES_3: u64 = 1005;
const METHOD_BODY: u64 = 1006;
const METHOD_BODY_BEGIN: u64 = 1007;
const METHOD_BODY_END: u64 = 1008;
const METHOD_BODY_FRONT: u64 = 1009;
const METHOD_BODY_BACK: u64 = 1010;
const METHOD_BODY_RBEGIN: u64 = 1011;
const METHOD_BODY_REND: u64 = 1012;
const METHOD_GETSTMTEXPRRESULT: u64 = 1013;
const METHOD_GETBEGINLOC_54: u64 = 1014;
const METHOD_GETENDLOC_53: u64 = 1015;
const METHOD_GETLBRACLOC: u64 = 1016;
const METHOD_GETRBRACLOC: u64 = 1017;
const METHOD_CHILDREN_44: u64 = 1018;
const CLASS_NULLSTMT: u64 = 1019;
const METHOD_GETSEMILOC: u64 = 1020;
const METHOD_HASLEADINGEMPTYMACRO: u64 = 1021;
const METHOD_GETBEGINLOC_99: u64 = 1022;
const METHOD_GETENDLOC_98: u64 = 1023;
const METHOD_CHILDREN_87: u64 = 1024;
const CLASS_OMPPARALLELSECTIONSDIRECTIVE: u64 = 1025;
const CLASS_UNRESOLVEDUSINGTYPENAMEDECL: u64 = 1026;
const METHOD_GETUSINGLOC: u64 = 1027;
const METHOD_GETTYPENAMELOC: u64 = 1028;
const METHOD_GETQUALIFIERLOC_3: u64 = 1029;
const METHOD_GETQUALIFIER_6: u64 = 1030;
const METHOD_GETNAMEINFO_1: u64 = 1031;
const METHOD_ISPACKEXPANSION_3: u64 = 1032;
const METHOD_GETELLIPSISLOC_2: u64 = 1033;
const METHOD_GETCANONICALDECL_21: u64 = 1034;
const CLASS_CXXMETHODDECL: u64 = 1035;
const METHOD_ISSTATIC: u64 = 1036;
const METHOD_ISINSTANCE: u64 = 1037;
const METHOD_ISEXPLICITOBJECTMEMBERFUNCTION: u64 = 1038;
const METHOD_ISIMPLICITOBJECTMEMBERFUNCTION: u64 = 1039;
const METHOD_ISCONST_1: u64 = 1040;
const METHOD_ISVOLATILE_1: u64 = 1041;
const METHOD_ISVIRTUAL: u64 = 1042;
const METHOD_ISCOPYASSIGNMENTOPERATOR: u64 = 1043;
const METHOD_ISMOVEASSIGNMENTOPERATOR: u64 = 1044;
const METHOD_GETCANONICALDECL_3: u64 = 1045;
const METHOD_GETMOSTRECENTDECL: u64 = 1046;
const METHOD_BEGIN_OVERRIDDEN_METHODS: u64 = 1047;
const METHOD_END_OVERRIDDEN_METHODS: u64 = 1048;
const METHOD_SIZE_OVERRIDDEN_METHODS: u64 = 1049;
const METHOD_OVERRIDDEN_METHODS: u64 = 1050;
const METHOD_GETPARENT: u64 = 1051;
const METHOD_GETTHISTYPE: u64 = 1052;
const METHOD_GETFUNCTIONOBJECTPARAMETERREFERENCETYPE: u64 = 1053;
const METHOD_GETFUNCTIONOBJECTPARAMETERTYPE: u64 = 1054;
const METHOD_GETNUMEXPLICITPARAMS: u64 = 1055;
const METHOD_GETMETHODQUALIFIERS: u64 = 1056;
const METHOD_GETREFQUALIFIER_1: u64 = 1057;
const METHOD_HASINLINEBODY: u64 = 1058;
const METHOD_ISLAMBDASTATICINVOKER: u64 = 1059;
const CLASS_USINGDIRECTIVEDECL: u64 = 1060;
const METHOD_GETQUALIFIERLOC_6: u64 = 1061;
const METHOD_GETQUALIFIER_9: u64 = 1062;
const METHOD_GETNOMINATEDNAMESPACEASWRITTEN: u64 = 1063;
const METHOD_GETNOMINATEDNAMESPACE: u64 = 1064;
const METHOD_GETCOMMONANCESTOR: u64 = 1065;
const METHOD_GETUSINGLOC_3: u64 = 1066;
const METHOD_GETNAMESPACEKEYLOCATION: u64 = 1067;
const METHOD_GETIDENTLOCATION: u64 = 1068;
const METHOD_GETSOURCERANGE_33: u64 = 1069;
const CLASS_CXXFUNCTIONALCASTEXPR: u64 = 1070;
const METHOD_GETLPARENLOC_2: u64 = 1071;
const METHOD_GETRPARENLOC_7: u64 = 1072;
const METHOD_ISLISTINITIALIZATION_1: u64 = 1073;
const METHOD_GETBEGINLOC_29: u64 = 1074;
const METHOD_GETENDLOC_28: u64 = 1075;
const CLASS_NAMESPACEALIASDECL: u64 = 1076;
const METHOD_GETCANONICALDECL_14: u64 = 1077;
const METHOD_GETQUALIFIERLOC_1: u64 = 1078;
const METHOD_GETQUALIFIER_4: u64 = 1079;
const METHOD_GETNAMESPACE: u64 = 1080;
const METHOD_GETALIASLOC: u64 = 1081;
const METHOD_GETNAMESPACELOC: u64 = 1082;
const METHOD_GETTARGETNAMELOC: u64 = 1083;
const METHOD_GETALIASEDNAMESPACE: u64 = 1084;
const METHOD_GETSOURCERANGE_18: u64 = 1085;
const CLASS_USINGDECL: u64 = 1086;
const METHOD_GETUSINGLOC_2: u64 = 1087;
const METHOD_GETQUALIFIERLOC_5: u64 = 1088;
const METHOD_GETQUALIFIER_8: u64 = 1089;
const METHOD_GETNAMEINFO_3: u64 = 1090;
const METHOD_ISACCESSDECLARATION_1: u64 = 1091;
const METHOD_HASTYPENAME: u64 = 1092;
const METHOD_GETSOURCERANGE_32: u64 = 1093;
const METHOD_GETCANONICALDECL_23: u64 = 1094;
const CLASS_CXXADDRSPACECASTEXPR: u64 = 1095;
const CLASS_TEMPLATETYPEPARMDECL: u64 = 1096;
const METHOD_WASDECLAREDWITHTYPENAME: u64 = 1097;
const METHOD_GETDEFAULTARGSTORAGE_2: u64 = 1098;
const METHOD_HASDEFAULTARGUMENT_2: u64 = 1099;
const METHOD_GETDEFAULTARGUMENT_2: u64 = 1100;
const METHOD_GETDEFAULTARGUMENTINFO: u64 = 1101;
const METHOD_GETDEFAULTARGUMENTLOC_2: u64 = 1102;
const METHOD_DEFAULTARGUMENTWASINHERITED_2: u64 = 1103;
const METHOD_GETDEPTH_1: u64 = 1104;
const METHOD_GETINDEX_3: u64 = 1105;
const METHOD_ISPARAMETERPACK_4: u64 = 1106;
const METHOD_ISPACKEXPANSION_2: u64 = 1107;
const METHOD_ISEXPANDEDPARAMETERPACK_2: u64 = 1108;
const METHOD_GETNUMEXPANSIONPARAMETERS: u64 = 1109;
const METHOD_GETTYPECONSTRAINT: u64 = 1110;
const METHOD_HASTYPECONSTRAINT: u64 = 1111;
const METHOD_GETSOURCERANGE_26: u64 = 1112;
const CLASS_ACCESSSPECDECL: u64 = 1113;
const METHOD_GETACCESSSPECIFIERLOC: u64 = 1114;
const METHOD_GETCOLONLOC: u64 = 1115;
const METHOD_GETSOURCERANGE: u64 = 1116;
const CLASS_CLASSTEMPLATEDECL: u64 = 1117;
const METHOD_GETTEMPLATEDDECL: u64 = 1118;
const METHOD_ISTHISDECLARATIONADEFINITION: u64 = 1119;
const METHOD_GETCANONICALDECL_5: u64 = 1120;
const METHOD_GETPREVIOUSDECL_1: u64 = 1121;
const METHOD_GETMOSTRECENTDECL_2: u64 = 1122;
const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE: u64 = 1123;
const METHOD_SPECIALIZATIONS: u64 = 1124;
const METHOD_SPEC_BEGIN: u64 = 1125;
const METHOD_SPEC_END: u64 = 1126;
const CLASS_RECORDDECL: u64 = 1127;
const METHOD_GETPREVIOUSDECL_5: u64 = 1128;
const METHOD_GETMOSTRECENTDECL_7: u64 = 1129;
const METHOD_HASFLEXIBLEARRAYMEMBER: u64 = 1130;
const METHOD_ISANONYMOUSSTRUCTORUNION_1: u64 = 1131;
const METHOD_HASOBJECTMEMBER: u64 = 1132;
const METHOD_HASVOLATILEMEMBER: u64 = 1133;
const METHOD_HASLOADEDFIELDSFROMEXTERNALSTORAGE: u64 = 1134;
const METHOD_ISNONTRIVIALTOPRIMITIVEDEFAULTINITIALIZE: u64 = 1135;
const METHOD_ISNONTRIVIALTOPRIMITIVECOPY: u64 = 1136;
const METHOD_ISNONTRIVIALTOPRIMITIVEDESTROY: u64 = 1137;
const METHOD_HASNONTRIVIALTOPRIMITIVEDEFAULTINITIALIZECUNION: u64 = 1138;
const METHOD_HASNONTRIVIALTOPRIMITIVEDESTRUCTCUNION: u64 = 1139;
const METHOD_HASNONTRIVIALTOPRIMITIVECOPYCUNION: u64 = 1140;
const METHOD_CANPASSINREGISTERS: u64 = 1141;
const METHOD_GETARGPASSINGRESTRICTIONS: u64 = 1142;
const METHOD_ISPARAMDESTROYEDINCALLEE: u64 = 1143;
const METHOD_ISRANDOMIZED: u64 = 1144;
const METHOD_ISINJECTEDCLASSNAME: u64 = 1145;
const METHOD_ISLAMBDA_1: u64 = 1146;
const METHOD_ISCAPTUREDRECORD: u64 = 1147;
const METHOD_GETDEFINITION_3: u64 = 1148;
const METHOD_ISORCONTAINSUNION: u64 = 1149;
const METHOD_FIELDS: u64 = 1150;
const METHOD_FIELD_BEGIN: u64 = 1151;
const METHOD_FIELD_END: u64 = 1152;
const METHOD_FIELD_EMPTY: u64 = 1153;
const METHOD_FINDFIRSTNAMEDDATAMEMBER: u64 = 1154;
const CLASS_OMPTHREADPRIVATEDECL: u64 = 1155;
const CLASS_VARTEMPLATEDECL: u64 = 1156;
const METHOD_GETTEMPLATEDDECL_4: u64 = 1157;
const METHOD_ISTHISDECLARATIONADEFINITION_5: u64 = 1158;
const METHOD_GETCANONICALDECL_28: u64 = 1159;
const METHOD_GETPREVIOUSDECL_7: u64 = 1160;
const METHOD_GETMOSTRECENTDECL_8: u64 = 1161;
const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_5: u64 = 1162;
const METHOD_SPECIALIZATIONS_2: u64 = 1163;
const METHOD_SPEC_BEGIN_1: u64 = 1164;
const METHOD_SPEC_END_1: u64 = 1165;
const CLASS_LINKAGESPECDECL: u64 = 1166;
const METHOD_GETLANGUAGE: u64 = 1167;
const METHOD_HASBRACES_1: u64 = 1168;
const METHOD_GETEXTERNLOC_1: u64 = 1169;
const METHOD_GETRBRACELOC_2: u64 = 1170;
const METHOD_GETENDLOC_2: u64 = 1171;
const METHOD_GETSOURCERANGE_17: u64 = 1172;
const CLASS_CONCEPTDECL: u64 = 1173;
const METHOD_GETCONSTRAINTEXPR: u64 = 1174;
const METHOD_GETSOURCERANGE_4: u64 = 1175;
const METHOD_ISTYPECONCEPT: u64 = 1176;
const METHOD_GETCANONICALDECL_6: u64 = 1177;
const CLASS_CAPTUREDDECL: u64 = 1178;
const METHOD_GETBODY_1: u64 = 1179;
const METHOD_ISNOTHROW: u64 = 1180;
const METHOD_GETNUMPARAMS_2: u64 = 1181;
const METHOD_PARAMETERS_1: u64 = 1182;
const METHOD_GETCONTEXTPARAM: u64 = 1183;
const METHOD_GETCONTEXTPARAMPOSITION: u64 = 1184;
const METHOD_PARAM_BEGIN: u64 = 1185;
const METHOD_PARAM_END: u64 = 1186;
const CLASS_UNRESOLVEDLOOKUPEXPR: u64 = 1187;
const METHOD_REQUIRESADL: u64 = 1188;
const METHOD_ISOVERLOADED: u64 = 1189;
const METHOD_GETNAMINGCLASS_1: u64 = 1190;
const METHOD_GETBEGINLOC_128: u64 = 1191;
const METHOD_GETENDLOC_127: u64 = 1192;
const METHOD_CHILDREN_115: u64 = 1193;
const CLASS_TAGDECL: u64 = 1194;
const METHOD_GETBRACERANGE: u64 = 1195;
const METHOD_GETINNERLOCSTART_1: u64 = 1196;
const METHOD_GETOUTERLOCSTART_1: u64 = 1197;
const METHOD_GETSOURCERANGE_23: u64 = 1198;
const METHOD_GETCANONICALDECL_17: u64 = 1199;
const METHOD_ISTHISDECLARATIONADEFINITION_3: u64 = 1200;
const METHOD_ISCOMPLETEDEFINITION: u64 = 1201;
const METHOD_ISCOMPLETEDEFINITIONREQUIRED: u64 = 1202;
const METHOD_ISBEINGDEFINED_1: u64 = 1203;
const METHOD_ISEMBEDDEDINDECLARATOR: u64 = 1204;
const METHOD_ISFREESTANDING: u64 = 1205;
const METHOD_MAYHAVEOUTOFDATEDEF: u64 = 1206;
const METHOD_ISDEPENDENTTYPE: u64 = 1207;
const METHOD_ISTHISDECLARATIONADEMOTEDDEFINITION: u64 = 1208;
const METHOD_GETDEFINITION_4: u64 = 1209;
const METHOD_GETKINDNAME: u64 = 1210;
const METHOD_GETTAGKIND: u64 = 1211;
const METHOD_ISSTRUCT: u64 = 1212;
const METHOD_ISINTERFACE: u64 = 1213;
const METHOD_ISCLASS: u64 = 1214;
const METHOD_ISUNION: u64 = 1215;
const METHOD_ISENUM: u64 = 1216;
const METHOD_HASNAMEFORLINKAGE: u64 = 1217;
const METHOD_GETTYPEDEFNAMEFORANONDECL: u64 = 1218;
const METHOD_GETQUALIFIER_5: u64 = 1219;
const METHOD_GETQUALIFIERLOC_2: u64 = 1220;
const METHOD_GETNUMTEMPLATEPARAMETERLISTS_1: u64 = 1221;
const CLASS_USINGSHADOWDECL: u64 = 1222;
const METHOD_GETCANONICALDECL_26: u64 = 1223;
const METHOD_GETTARGETDECL: u64 = 1224;
const METHOD_GETINTRODUCER_1: u64 = 1225;
const METHOD_GETNEXTUSINGSHADOWDECL: u64 = 1226;
const CLASS_FUNCTIONTEMPLATEDECL: u64 = 1227;
const METHOD_GETTEMPLATEDDECL_1: u64 = 1228;
const METHOD_ISTHISDECLARATIONADEFINITION_2: u64 = 1229;
const METHOD_GETCANONICALDECL_12: u64 = 1230;
const METHOD_GETPREVIOUSDECL_4: u64 = 1231;
const METHOD_GETMOSTRECENTDECL_5: u64 = 1232;
const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_2: u64 = 1233;
const METHOD_SPECIALIZATIONS_1: u64 = 1234;
const METHOD_SPEC_BEGIN_2: u64 = 1235;
const METHOD_SPEC_END_2: u64 = 1236;
const METHOD_ISABBREVIATED: u64 = 1237;
const CLASS_TYPEDECL: u64 = 1238;
const METHOD_GETTYPEFORDECL: u64 = 1239;
const METHOD_GETBEGINLOC_3: u64 = 1240;
const METHOD_GETSOURCERANGE_29: u64 = 1241;
const CLASS_OBJCPROPERTYDECL: u64 = 1242;
const CLASS_OBJCCOMPATIBLEALIASDECL: u64 = 1243;
const CLASS_OBJCIMPLDECL: u64 = 1244;
const CLASS_FRIENDTEMPLATEDECL: u64 = 1245;
const METHOD_GETFRIENDTYPE_1: u64 = 1246;
const METHOD_GETFRIENDDECL_1: u64 = 1247;
const METHOD_GETFRIENDLOC_1: u64 = 1248;
const METHOD_GETNUMTEMPLATEPARAMETERS: u64 = 1249;
const CLASS_OBJCCONTAINERDECL: u64 = 1250;
const CLASS_LIFETIMEEXTENDEDTEMPORARYDECL: u64 = 1251;
const METHOD_GETEXTENDINGDECL: u64 = 1252;
const METHOD_GETSTORAGEDURATION: u64 = 1253;
const METHOD_GETTEMPORARYEXPR: u64 = 1254;
const METHOD_GETMANGLINGNUMBER: u64 = 1255;
const METHOD_GETVALUE: u64 = 1256;
const METHOD_CHILDRENEXPR: u64 = 1257;
const CLASS_NAMEDDECL: u64 = 1258;
const METHOD_GETIDENTIFIER_4: u64 = 1259;
const METHOD_GETNAME_3: u64 = 1260;
const METHOD_GETNAMEASSTRING: u64 = 1261;
const METHOD_GETDECLNAME: u64 = 1262;
const METHOD_GETQUALIFIEDNAMEASSTRING: u64 = 1263;
const METHOD_HASLINKAGE: u64 = 1264;
const METHOD_ISCXXCLASSMEMBER: u64 = 1265;
const METHOD_ISCXXINSTANCEMEMBER: u64 = 1266;
const METHOD_GETLINKAGEINTERNAL: u64 = 1267;
const METHOD_GETFORMALLINKAGE: u64 = 1268;
const METHOD_HASEXTERNALFORMALLINKAGE: u64 = 1269;
const METHOD_ISEXTERNALLYVISIBLE: u64 = 1270;
const METHOD_ISEXTERNALLYDECLARABLE: u64 = 1271;
const METHOD_GETVISIBILITY_1: u64 = 1272;
const METHOD_GETLINKAGEANDVISIBILITY_1: u64 = 1273;
const METHOD_ISLINKAGEVALID: u64 = 1274;
const METHOD_HASLINKAGEBEENCOMPUTED: u64 = 1275;
const METHOD_GETUNDERLYINGDECL: u64 = 1276;
const METHOD_GETMOSTRECENTDECL_6: u64 = 1277;
const METHOD_GETOBJCFSTRINGFORMATTINGFAMILY: u64 = 1278;
const CLASS_BUILTINTEMPLATEDECL: u64 = 1279;
const METHOD_GETSOURCERANGE_2: u64 = 1280;
const METHOD_GETBUILTINTEMPLATEKIND: u64 = 1281;
const CLASS_FRIENDDECL: u64 = 1282;
const METHOD_GETFRIENDTYPE: u64 = 1283;
const METHOD_GETFRIENDTYPENUMTEMPLATEPARAMETERLISTS: u64 = 1284;
const METHOD_GETFRIENDDECL: u64 = 1285;
const METHOD_GETFRIENDLOC: u64 = 1286;
const METHOD_GETSOURCERANGE_12: u64 = 1287;
const METHOD_ISUNSUPPORTEDFRIEND: u64 = 1288;
const CLASS_EXTERNCCONTEXTDECL: u64 = 1289;
const CLASS_BLOCKDECL: u64 = 1290;
const METHOD_GETCARETLOCATION: u64 = 1291;
const METHOD_ISVARIADIC_1: u64 = 1292;
const METHOD_GETCOMPOUNDBODY: u64 = 1293;
const METHOD_GETBODY: u64 = 1294;
const METHOD_GETSIGNATUREASWRITTEN: u64 = 1295;
const METHOD_PARAMETERS: u64 = 1296;
const METHOD_PARAM_EMPTY: u64 = 1297;
const METHOD_PARAM_BEGIN_1: u64 = 1298;
const METHOD_PARAM_END_1: u64 = 1299;
const METHOD_PARAM_SIZE: u64 = 1300;
const METHOD_GETNUMPARAMS_1: u64 = 1301;
const METHOD_HASCAPTURES: u64 = 1302;
const METHOD_GETNUMCAPTURES: u64 = 1303;
const METHOD_CAPTURES: u64 = 1304;
const METHOD_CAPTURE_BEGIN_2: u64 = 1305;
const METHOD_CAPTURE_END_2: u64 = 1306;
const METHOD_CAPTURESCXXTHIS: u64 = 1307;
const METHOD_BLOCKMISSINGRETURNTYPE: u64 = 1308;
const METHOD_ISCONVERSIONFROMLAMBDA: u64 = 1309;
const METHOD_DOESNOTESCAPE: u64 = 1310;
const METHOD_CANAVOIDCOPYTOHEAP: u64 = 1311;
const METHOD_GETBLOCKMANGLINGNUMBER: u64 = 1312;
const METHOD_GETBLOCKMANGLINGCONTEXTDECL: u64 = 1313;
const METHOD_GETSOURCERANGE_1: u64 = 1314;
const CLASS_REQUIRESEXPRBODYDECL: u64 = 1315;
const CLASS_BASEUSINGDECL: u64 = 1316;
const METHOD_SHADOWS: u64 = 1317;
const METHOD_SHADOW_BEGIN: u64 = 1318;
const METHOD_SHADOW_END: u64 = 1319;
const METHOD_SHADOW_SIZE: u64 = 1320;
const CLASS_OBJCINTERFACEDECL: u64 = 1321;
const CLASS_STATICASSERTDECL: u64 = 1322;
const METHOD_GETASSERTEXPR: u64 = 1323;
const METHOD_GETMESSAGE: u64 = 1324;
const METHOD_ISFAILED: u64 = 1325;
const METHOD_GETRPARENLOC_1: u64 = 1326;
const METHOD_GETSOURCERANGE_22: u64 = 1327;
const CLASS_TYPEDEFNAMEDECL: u64 = 1328;
const METHOD_ISMODED: u64 = 1329;
const METHOD_GETTYPESOURCEINFO_1: u64 = 1330;
const METHOD_GETUNDERLYINGTYPE_4: u64 = 1331;
const METHOD_GETCANONICALDECL_20: u64 = 1332;
const METHOD_ISTRANSPARENTTAG: u64 = 1333;
const CLASS_CXXRECORDDECL: u64 = 1334;
const METHOD_GETCANONICALDECL_4: u64 = 1335;
const METHOD_GETPREVIOUSDECL: u64 = 1336;
const METHOD_GETMOSTRECENTDECL_1: u64 = 1337;
const METHOD_GETMOSTRECENTNONINJECTEDDECL: u64 = 1338;
const METHOD_GETDEFINITION: u64 = 1339;
const METHOD_HASDEFINITION: u64 = 1340;
const METHOD_ISDYNAMICCLASS: u64 = 1341;
const METHOD_MAYBEDYNAMICCLASS: u64 = 1342;
const METHOD_MAYBENONDYNAMICCLASS: u64 = 1343;
const METHOD_ISPARSINGBASESPECIFIERS: u64 = 1344;
const METHOD_GETODRHASH: u64 = 1345;
const METHOD_GETNUMBASES: u64 = 1346;
const METHOD_BASES: u64 = 1347;
const METHOD_BASES_BEGIN: u64 = 1348;
const METHOD_BASES_END: u64 = 1349;
const METHOD_GETNUMVBASES: u64 = 1350;
const METHOD_VBASES: u64 = 1351;
const METHOD_VBASES_BEGIN: u64 = 1352;
const METHOD_VBASES_END: u64 = 1353;
const METHOD_HASANYDEPENDENTBASES: u64 = 1354;
const METHOD_METHODS: u64 = 1355;
const METHOD_METHOD_BEGIN: u64 = 1356;
const METHOD_METHOD_END: u64 = 1357;
const METHOD_CTORS: u64 = 1358;
const METHOD_CTOR_BEGIN: u64 = 1359;
const METHOD_CTOR_END: u64 = 1360;
const METHOD_FRIENDS: u64 = 1361;
const METHOD_FRIEND_BEGIN: u64 = 1362;
const METHOD_FRIEND_END: u64 = 1363;
const METHOD_HASFRIENDS: u64 = 1364;
const METHOD_DEFAULTEDCOPYCONSTRUCTORISDELETED: u64 = 1365;
const METHOD_DEFAULTEDMOVECONSTRUCTORISDELETED: u64 = 1366;
const METHOD_DEFAULTEDDESTRUCTORISDELETED: u64 = 1367;
const METHOD_HASSIMPLECOPYCONSTRUCTOR: u64 = 1368;
const METHOD_HASSIMPLEMOVECONSTRUCTOR: u64 = 1369;
const METHOD_HASSIMPLECOPYASSIGNMENT: u64 = 1370;
const METHOD_HASSIMPLEMOVEASSIGNMENT: u64 = 1371;
const METHOD_HASSIMPLEDESTRUCTOR: u64 = 1372;
const METHOD_HASDEFAULTCONSTRUCTOR: u64 = 1373;
const METHOD_NEEDSIMPLICITDEFAULTCONSTRUCTOR: u64 = 1374;
const METHOD_HASUSERDECLAREDCONSTRUCTOR: u64 = 1375;
const METHOD_HASUSERPROVIDEDDEFAULTCONSTRUCTOR: u64 = 1376;
const METHOD_HASUSERDECLAREDCOPYCONSTRUCTOR: u64 = 1377;
const METHOD_NEEDSIMPLICITCOPYCONSTRUCTOR: u64 = 1378;
const METHOD_NEEDSOVERLOADRESOLUTIONFORCOPYCONSTRUCTOR: u64 = 1379;
const METHOD_IMPLICITCOPYCONSTRUCTORHASCONSTPARAM: u64 = 1380;
const METHOD_HASCOPYCONSTRUCTORWITHCONSTPARAM: u64 = 1381;
const METHOD_HASUSERDECLAREDMOVEOPERATION: u64 = 1382;
const METHOD_HASUSERDECLAREDMOVECONSTRUCTOR: u64 = 1383;
const METHOD_HASMOVECONSTRUCTOR: u64 = 1384;
const METHOD_NEEDSIMPLICITMOVECONSTRUCTOR: u64 = 1385;
const METHOD_NEEDSOVERLOADRESOLUTIONFORMOVECONSTRUCTOR: u64 = 1386;
const METHOD_HASUSERDECLAREDCOPYASSIGNMENT: u64 = 1387;
const METHOD_NEEDSIMPLICITCOPYASSIGNMENT: u64 = 1388;
const METHOD_NEEDSOVERLOADRESOLUTIONFORCOPYASSIGNMENT: u64 = 1389;
const METHOD_IMPLICITCOPYASSIGNMENTHASCONSTPARAM: u64 = 1390;
const METHOD_HASCOPYASSIGNMENTWITHCONSTPARAM: u64 = 1391;
const METHOD_HASUSERDECLAREDMOVEASSIGNMENT: u64 = 1392;
const METHOD_HASMOVEASSIGNMENT: u64 = 1393;
const METHOD_NEEDSIMPLICITMOVEASSIGNMENT: u64 = 1394;
const METHOD_NEEDSOVERLOADRESOLUTIONFORMOVEASSIGNMENT: u64 = 1395;
const METHOD_HASUSERDECLAREDDESTRUCTOR: u64 = 1396;
const METHOD_NEEDSIMPLICITDESTRUCTOR: u64 = 1397;
const METHOD_NEEDSOVERLOADRESOLUTIONFORDESTRUCTOR: u64 = 1398;
const METHOD_ISLAMBDA: u64 = 1399;
const METHOD_ISGENERICLAMBDA: u64 = 1400;
const METHOD_LAMBDAISDEFAULTCONSTRUCTIBLEANDASSIGNABLE: u64 = 1401;
const METHOD_GETLAMBDACALLOPERATOR: u64 = 1402;
const METHOD_GETDEPENDENTLAMBDACALLOPERATOR: u64 = 1403;
const METHOD_GETLAMBDASTATICINVOKER: u64 = 1404;
const METHOD_GETGENERICLAMBDATEMPLATEPARAMETERLIST: u64 = 1405;
const METHOD_GETLAMBDAEXPLICITTEMPLATEPARAMETERS: u64 = 1406;
const METHOD_GETLAMBDACAPTUREDEFAULT: u64 = 1407;
const METHOD_ISCAPTURELESSLAMBDA: u64 = 1408;
const METHOD_CAPTURES_1: u64 = 1409;
const METHOD_CAPTURES_BEGIN: u64 = 1410;
const METHOD_CAPTURES_END: u64 = 1411;
const METHOD_CAPTURE_SIZE_2: u64 = 1412;
const METHOD_CONVERSION_BEGIN: u64 = 1413;
const METHOD_CONVERSION_END: u64 = 1414;
const METHOD_GETVISIBLECONVERSIONFUNCTIONS: u64 = 1415;
const METHOD_ISAGGREGATE: u64 = 1416;
const METHOD_HASINCLASSINITIALIZER: u64 = 1417;
const METHOD_HASUNINITIALIZEDREFERENCEMEMBER: u64 = 1418;
const METHOD_ISPOD: u64 = 1419;
const METHOD_ISCLIKE: u64 = 1420;
const METHOD_ISEMPTY: u64 = 1421;
const METHOD_HASINITMETHOD: u64 = 1422;
const METHOD_HASPRIVATEFIELDS: u64 = 1423;
const METHOD_HASPROTECTEDFIELDS: u64 = 1424;
const METHOD_HASDIRECTFIELDS: u64 = 1425;
const METHOD_ISPOLYMORPHIC: u64 = 1426;
const METHOD_ISABSTRACT: u64 = 1427;
const METHOD_ISSTANDARDLAYOUT: u64 = 1428;
const METHOD_ISCXX11STANDARDLAYOUT: u64 = 1429;
const METHOD_HASMUTABLEFIELDS: u64 = 1430;
const METHOD_HASVARIANTMEMBERS: u64 = 1431;
const METHOD_HASTRIVIALDEFAULTCONSTRUCTOR: u64 = 1432;
const METHOD_HASNONTRIVIALDEFAULTCONSTRUCTOR: u64 = 1433;
const METHOD_HASCONSTEXPRNONCOPYMOVECONSTRUCTOR: u64 = 1434;
const METHOD_DEFAULTEDDEFAULTCONSTRUCTORISCONSTEXPR: u64 = 1435;
const METHOD_HASCONSTEXPRDEFAULTCONSTRUCTOR: u64 = 1436;
const METHOD_HASTRIVIALCOPYCONSTRUCTOR: u64 = 1437;
const METHOD_HASTRIVIALCOPYCONSTRUCTORFORCALL: u64 = 1438;
const METHOD_HASNONTRIVIALCOPYCONSTRUCTOR: u64 = 1439;
const METHOD_HASNONTRIVIALCOPYCONSTRUCTORFORCALL: u64 = 1440;
const METHOD_HASTRIVIALMOVECONSTRUCTOR: u64 = 1441;
const METHOD_HASTRIVIALMOVECONSTRUCTORFORCALL: u64 = 1442;
const METHOD_HASNONTRIVIALMOVECONSTRUCTOR: u64 = 1443;
const METHOD_HASNONTRIVIALMOVECONSTRUCTORFORCALL: u64 = 1444;
const METHOD_HASTRIVIALCOPYASSIGNMENT: u64 = 1445;
const METHOD_HASNONTRIVIALCOPYASSIGNMENT: u64 = 1446;
const METHOD_HASTRIVIALMOVEASSIGNMENT: u64 = 1447;
const METHOD_HASNONTRIVIALMOVEASSIGNMENT: u64 = 1448;
const METHOD_DEFAULTEDDESTRUCTORISCONSTEXPR: u64 = 1449;
const METHOD_HASCONSTEXPRDESTRUCTOR: u64 = 1450;
const METHOD_HASTRIVIALDESTRUCTOR: u64 = 1451;
const METHOD_HASTRIVIALDESTRUCTORFORCALL: u64 = 1452;
const METHOD_HASNONTRIVIALDESTRUCTOR: u64 = 1453;
const METHOD_HASNONTRIVIALDESTRUCTORFORCALL: u64 = 1454;
const METHOD_ALLOWCONSTDEFAULTINIT: u64 = 1455;
const METHOD_HASIRRELEVANTDESTRUCTOR: u64 = 1456;
const METHOD_HASNONLITERALTYPEFIELDSORBASES: u64 = 1457;
const METHOD_HASINHERITEDCONSTRUCTOR: u64 = 1458;
const METHOD_HASINHERITEDASSIGNMENT: u64 = 1459;
const METHOD_ISTRIVIALLYCOPYABLE: u64 = 1460;
const METHOD_ISTRIVIALLYCOPYCONSTRUCTIBLE: u64 = 1461;
const METHOD_ISTRIVIAL: u64 = 1462;
const METHOD_ISLITERAL: u64 = 1463;
const METHOD_ISSTRUCTURAL: u64 = 1464;
const METHOD_GETINSTANTIATEDFROMMEMBERCLASS: u64 = 1465;
const METHOD_GETMEMBERSPECIALIZATIONINFO: u64 = 1466;
const METHOD_GETDESCRIBEDCLASSTEMPLATE: u64 = 1467;
const METHOD_GETTEMPLATESPECIALIZATIONKIND: u64 = 1468;
const METHOD_GETTEMPLATEINSTANTIATIONPATTERN: u64 = 1469;
const METHOD_GETDESTRUCTOR: u64 = 1470;
const METHOD_ISANYDESTRUCTORNORETURN: u64 = 1471;
const METHOD_ISLOCALCLASS: u64 = 1472;
const METHOD_MAYBEABSTRACT: u64 = 1473;
const METHOD_ISEFFECTIVELYFINAL: u64 = 1474;
const METHOD_GETLAMBDAMANGLINGNUMBER: u64 = 1475;
const METHOD_HASKNOWNLAMBDAINTERNALLINKAGE: u64 = 1476;
const METHOD_GETLAMBDACONTEXTDECL: u64 = 1477;
const METHOD_GETLAMBDAINDEXINCONTEXT: u64 = 1478;
const METHOD_GETLAMBDANUMBERING: u64 = 1479;
const METHOD_GETDEVICELAMBDAMANGLINGNUMBER: u64 = 1480;
const METHOD_GETMSINHERITANCEMODEL: u64 = 1481;
const METHOD_CALCULATEINHERITANCEMODEL: u64 = 1482;
const METHOD_NULLFIELDOFFSETISZERO: u64 = 1483;
const METHOD_GETMSVTORDISPMODE: u64 = 1484;
const METHOD_ISDEPENDENTLAMBDA: u64 = 1485;
const METHOD_ISNEVERDEPENDENTLAMBDA: u64 = 1486;
const METHOD_GETLAMBDADEPENDENCYKIND: u64 = 1487;
const METHOD_GETLAMBDATYPEINFO: u64 = 1488;
const METHOD_ISINTERFACELIKE: u64 = 1489;
const CLASS_TEMPLATETEMPLATEPARMDECL: u64 = 1490;
const METHOD_ISPARAMETERPACK_3: u64 = 1491;
const METHOD_ISPACKEXPANSION_1: u64 = 1492;
const METHOD_ISEXPANDEDPARAMETERPACK_1: u64 = 1493;
const METHOD_GETNUMEXPANSIONTEMPLATEPARAMETERS: u64 = 1494;
const METHOD_GETDEFAULTARGSTORAGE_1: u64 = 1495;
const METHOD_HASDEFAULTARGUMENT_1: u64 = 1496;
const METHOD_GETDEFAULTARGUMENT_1: u64 = 1497;
const METHOD_GETDEFAULTARGUMENTLOC_1: u64 = 1498;
const METHOD_DEFAULTARGUMENTWASINHERITED_1: u64 = 1499;
const METHOD_GETSOURCERANGE_25: u64 = 1500;
const CLASS_TOPLEVELSTMTDECL: u64 = 1501;
const METHOD_GETSOURCERANGE_27: u64 = 1502;
const METHOD_GETSTMT_1: u64 = 1503;
const METHOD_ISSEMIMISSING: u64 = 1504;
const CLASS_BINDINGDECL: u64 = 1505;
const METHOD_GETBINDING: u64 = 1506;
const METHOD_GETDECOMPOSEDDECL: u64 = 1507;
const METHOD_GETHOLDINGVAR: u64 = 1508;
const CLASS_DECL: u64 = 1509;
const METHOD_GETSOURCERANGE_5: u64 = 1510;
const METHOD_GETBEGINLOC: u64 = 1511;
const METHOD_GETENDLOC: u64 = 1512;
const METHOD_GETLOCATION: u64 = 1513;
const METHOD_GETKIND_6: u64 = 1514;
const METHOD_GETDECLKINDNAME: u64 = 1515;
const METHOD_GETNEXTDECLINCONTEXT: u64 = 1516;
const METHOD_GETDECLCONTEXT: u64 = 1517;
const METHOD_GETNONTRANSPARENTDECLCONTEXT: u64 = 1518;
const METHOD_GETNONCLOSURECONTEXT: u64 = 1519;
const METHOD_GETTRANSLATIONUNITDECL: u64 = 1520;
const METHOD_ISINANONYMOUSNAMESPACE: u64 = 1521;
const METHOD_ISINSTDNAMESPACE: u64 = 1522;
const METHOD_ISFILECONTEXTDECL: u64 = 1523;
const METHOD_GETASTCONTEXT: u64 = 1524;
const METHOD_GETLANGOPTS: u64 = 1525;
const METHOD_GETACCESS: u64 = 1526;
const METHOD_GETACCESSUNSAFE: u64 = 1527;
const METHOD_HASATTRS: u64 = 1528;
const METHOD_GETATTRS: u64 = 1529;
const METHOD_ATTRS: u64 = 1530;
const METHOD_ATTR_BEGIN: u64 = 1531;
const METHOD_ATTR_END: u64 = 1532;
const METHOD_GETMAXALIGNMENT: u64 = 1533;
const METHOD_ISINVALIDDECL: u64 = 1534;
const METHOD_ISIMPLICIT: u64 = 1535;
const METHOD_ISREFERENCED: u64 = 1536;
const METHOD_ISTHISDECLARATIONREFERENCED: u64 = 1537;
const METHOD_ISTOPLEVELDECLINOBJCCONTAINER: u64 = 1538;
const METHOD_GETEXTERNALSOURCESYMBOLATTR: u64 = 1539;
const METHOD_ISMODULEPRIVATE: u64 = 1540;
const METHOD_ISINEXPORTDECLCONTEXT: u64 = 1541;
const METHOD_ISINVISIBLEOUTSIDETHEOWNINGMODULE: u64 = 1542;
const METHOD_ISINANOTHERMODULEUNIT: u64 = 1543;
const METHOD_ISDISCARDEDINGLOBALMODULEFRAGMENT: u64 = 1544;
const METHOD_SHOULDSKIPCHECKINGODR: u64 = 1545;
const METHOD_HASDEFININGATTR: u64 = 1546;
const METHOD_GETDEFININGATTR: u64 = 1547;
const METHOD_GETVERSIONINTRODUCED: u64 = 1548;
const METHOD_ISWEAKIMPORTED: u64 = 1549;
const METHOD_ISFROMASTFILE: u64 = 1550;
const METHOD_GETGLOBALID: u64 = 1551;
const METHOD_GETOWNINGMODULEID: u64 = 1552;
const METHOD_GETIMPORTEDOWNINGMODULE: u64 = 1553;
const METHOD_GETLOCALOWNINGMODULE: u64 = 1554;
const METHOD_HASOWNINGMODULE: u64 = 1555;
const METHOD_GETOWNINGMODULE: u64 = 1556;
const METHOD_ISUNCONDITIONALLYVISIBLE: u64 = 1557;
const METHOD_ISREACHABLE: u64 = 1558;
const METHOD_GETMODULEOWNERSHIPKIND: u64 = 1559;
const METHOD_GETIDENTIFIERNAMESPACE: u64 = 1560;
const METHOD_HASTAGIDENTIFIERNAMESPACE: u64 = 1561;
const METHOD_GETLEXICALDECLCONTEXT: u64 = 1562;
const METHOD_ISOUTOFLINE: u64 = 1563;
const METHOD_ISTEMPLATED: u64 = 1564;
const METHOD_GETTEMPLATEDEPTH: u64 = 1565;
const METHOD_ISDEFINEDOUTSIDEFUNCTIONORMETHOD: u64 = 1566;
const METHOD_ISINLOCALSCOPEFORINSTANTIATION: u64 = 1567;
const METHOD_GETCANONICALDECL_7: u64 = 1568;
const METHOD_ISCANONICALDECL: u64 = 1569;
const METHOD_REDECLS: u64 = 1570;
const METHOD_REDECLS_BEGIN: u64 = 1571;
const METHOD_REDECLS_END: u64 = 1572;
const METHOD_GETPREVIOUSDECL_2: u64 = 1573;
const METHOD_ISFIRSTDECL: u64 = 1574;
const METHOD_GETMOSTRECENTDECL_3: u64 = 1575;
const METHOD_GETBODY_2: u64 = 1576;
const METHOD_HASBODY: u64 = 1577;
const METHOD_GETBODYRBRACE: u64 = 1578;
const METHOD_ISTEMPLATEPARAMETER: u64 = 1579;
const METHOD_ISTEMPLATEPARAMETERPACK: u64 = 1580;
const METHOD_ISPARAMETERPACK_1: u64 = 1581;
const METHOD_ISTEMPLATEDECL: u64 = 1582;
const METHOD_ISFUNCTIONORFUNCTIONTEMPLATE: u64 = 1583;
const METHOD_GETDESCRIBEDTEMPLATE: u64 = 1584;
const METHOD_GETDESCRIBEDTEMPLATEPARAMS: u64 = 1585;
const METHOD_GETASFUNCTION: u64 = 1586;
const METHOD_ISLOCALEXTERNDECL: u64 = 1587;
const METHOD_GETFRIENDOBJECTKIND: u64 = 1588;
const METHOD_GETID: u64 = 1589;
const METHOD_ISFUNCTIONPOINTERTYPE: u64 = 1590;
const CLASS_OBJCPROTOCOLDECL: u64 = 1591;
const CLASS_VALUEDECL: u64 = 1592;
const METHOD_GETTYPE: u64 = 1593;
const METHOD_ISWEAK: u64 = 1594;
const METHOD_ISINITCAPTURE: u64 = 1595;
const METHOD_GETPOTENTIALLYDECOMPOSEDVARDECL: u64 = 1596;
const CLASS_OMPDECLAREREDUCTIONDECL: u64 = 1597;
const CLASS_INDIRECTFIELDDECL: u64 = 1598;
const METHOD_CHAIN: u64 = 1599;
const METHOD_CHAIN_BEGIN: u64 = 1600;
const METHOD_CHAIN_END: u64 = 1601;
const METHOD_GETCHAININGSIZE: u64 = 1602;
const METHOD_GETANONFIELD: u64 = 1603;
const METHOD_GETVARDECL: u64 = 1604;
const METHOD_GETCANONICALDECL_13: u64 = 1605;
const CLASS_RETURNSTMT: u64 = 1606;
const METHOD_GETRETVALUE: u64 = 1607;
const METHOD_GETNRVOCANDIDATE: u64 = 1608;
const METHOD_GETRETURNLOC: u64 = 1609;
const METHOD_GETBEGINLOC_109: u64 = 1610;
const METHOD_GETENDLOC_108: u64 = 1611;
const METHOD_CHILDREN_96: u64 = 1612;
const CLASS_DECLARATORDECL: u64 = 1613;
const METHOD_GETTYPESOURCEINFO: u64 = 1614;
const METHOD_GETINNERLOCSTART: u64 = 1615;
const METHOD_GETOUTERLOCSTART: u64 = 1616;
const METHOD_GETSOURCERANGE_6: u64 = 1617;
const METHOD_GETBEGINLOC_1: u64 = 1618;
const METHOD_GETQUALIFIER_3: u64 = 1619;
const METHOD_GETQUALIFIERLOC: u64 = 1620;
const METHOD_GETTRAILINGREQUIRESCLAUSE: u64 = 1621;
const METHOD_GETNUMTEMPLATEPARAMETERLISTS: u64 = 1622;
const METHOD_GETTYPESPECSTARTLOC: u64 = 1623;
const METHOD_GETTYPESPECENDLOC: u64 = 1624;
const CLASS_NONTYPETEMPLATEPARMDECL: u64 = 1625;
const METHOD_GETSOURCERANGE_20: u64 = 1626;
const METHOD_GETDEFAULTARGSTORAGE: u64 = 1627;
const METHOD_HASDEFAULTARGUMENT: u64 = 1628;
const METHOD_GETDEFAULTARGUMENT: u64 = 1629;
const METHOD_GETDEFAULTARGUMENTLOC: u64 = 1630;
const METHOD_DEFAULTARGUMENTWASINHERITED: u64 = 1631;
const METHOD_ISPARAMETERPACK_2: u64 = 1632;
const METHOD_ISPACKEXPANSION: u64 = 1633;
const METHOD_ISEXPANDEDPARAMETERPACK: u64 = 1634;
const METHOD_GETNUMEXPANSIONTYPES: u64 = 1635;
const METHOD_GETPLACEHOLDERTYPECONSTRAINT: u64 = 1636;
const METHOD_HASPLACEHOLDERTYPECONSTRAINT: u64 = 1637;
const CLASS_OBJCATDEFSFIELDDECL: u64 = 1638;
const CLASS_CXXCONVERSIONDECL: u64 = 1639;
const METHOD_GETEXPLICITSPECIFIER_1: u64 = 1640;
const METHOD_ISEXPLICIT_1: u64 = 1641;
const METHOD_GETCONVERSIONTYPE: u64 = 1642;
const METHOD_ISLAMBDATOBLOCKPOINTERCONVERSION: u64 = 1643;
const METHOD_GETCANONICALDECL_1: u64 = 1644;
const CLASS_FLOATINGLITERAL: u64 = 1645;
const METHOD_GETVALUE_8: u64 = 1646;
const METHOD_GETRAWSEMANTICS: u64 = 1647;
const METHOD_GETSEMANTICS: u64 = 1648;
const METHOD_ISEXACT: u64 = 1649;
const METHOD_GETVALUEASAPPROXIMATEDOUBLE: u64 = 1650;
const METHOD_GETLOCATION_10: u64 = 1651;
const METHOD_GETBEGINLOC_75: u64 = 1652;
const METHOD_GETENDLOC_74: u64 = 1653;
const METHOD_CHILDREN_65: u64 = 1654;
const CLASS_CXXDESTRUCTORDECL: u64 = 1655;
const METHOD_GETOPERATORDELETE: u64 = 1656;
const METHOD_GETOPERATORDELETETHISARG: u64 = 1657;
const METHOD_GETCANONICALDECL_2: u64 = 1658;
const CLASS_CXXCONSTRUCTORDECL: u64 = 1659;
const METHOD_GETEXPLICITSPECIFIER: u64 = 1660;
const METHOD_ISEXPLICIT: u64 = 1661;
const METHOD_INITS: u64 = 1662;
const METHOD_INIT_BEGIN: u64 = 1663;
const METHOD_INIT_END: u64 = 1664;
const METHOD_INIT_RBEGIN: u64 = 1665;
const METHOD_INIT_REND: u64 = 1666;
const METHOD_GETNUMCTORINITIALIZERS: u64 = 1667;
const METHOD_ISDELEGATINGCONSTRUCTOR: u64 = 1668;
const METHOD_GETTARGETCONSTRUCTOR: u64 = 1669;
const METHOD_ISDEFAULTCONSTRUCTOR: u64 = 1670;
const METHOD_ISCOPYCONSTRUCTOR: u64 = 1671;
const METHOD_ISMOVECONSTRUCTOR: u64 = 1672;
const METHOD_ISCOPYORMOVECONSTRUCTOR: u64 = 1673;
const METHOD_ISSPECIALIZATIONCOPYINGOBJECT: u64 = 1674;
const METHOD_ISINHERITINGCONSTRUCTOR: u64 = 1675;
const METHOD_GETINHERITEDCONSTRUCTOR: u64 = 1676;
const METHOD_GETCANONICALDECL: u64 = 1677;
const CLASS_ABITAGATTR: u64 = 1678;
const CLASS_SPECULATIVELOADHARDENINGATTR: u64 = 1679;
const CLASS_CMSENSCALLATTR: u64 = 1680;
const CLASS_CONSUMABLEAUTOCASTATTR: u64 = 1681;
const CLASS_USEDATTR: u64 = 1682;
const CLASS_WORKGROUPSIZEHINTATTR: u64 = 1683;
const CLASS_OBJCNONRUNTIMEPROTOCOLATTR: u64 = 1684;
const CLASS_BUILTINTYPELOC: u64 = 1685;
const METHOD_GETBUILTINLOC_6: u64 = 1686;
const METHOD_GETNAMELOC_2: u64 = 1687;
const METHOD_GETWRITTENBUILTINSPECS: u64 = 1688;
const METHOD_NEEDSEXTRALOCALDATA: u64 = 1689;
const METHOD_GETEXTRALOCALDATASIZE: u64 = 1690;
const METHOD_GETEXTRALOCALDATAALIGNMENT: u64 = 1691;
const METHOD_GETLOCALSOURCERANGE: u64 = 1692;
const METHOD_GETWRITTENSIGNSPEC: u64 = 1693;
const METHOD_HASWRITTENSIGNSPEC: u64 = 1694;
const METHOD_GETWRITTENWIDTHSPEC: u64 = 1695;
const METHOD_HASWRITTENWIDTHSPEC: u64 = 1696;
const METHOD_GETWRITTENTYPESPEC: u64 = 1697;
const METHOD_HASWRITTENTYPESPEC: u64 = 1698;
const METHOD_HASMODEATTR: u64 = 1699;
const CLASS_ALIGNMAC68KATTR: u64 = 1700;
const CLASS_STRINGLITERAL: u64 = 1701;
const METHOD_GETSTRING: u64 = 1702;
const METHOD_GETBYTES: u64 = 1703;
const METHOD_GETBYTELENGTH: u64 = 1704;
const METHOD_GETLENGTH: u64 = 1705;
const METHOD_GETCHARBYTEWIDTH: u64 = 1706;
const METHOD_GETKIND_4: u64 = 1707;
const METHOD_ISORDINARY: u64 = 1708;
const METHOD_ISWIDE: u64 = 1709;
const METHOD_ISUTF8: u64 = 1710;
const METHOD_ISUTF16: u64 = 1711;
const METHOD_ISUTF32: u64 = 1712;
const METHOD_ISUNEVALUATED: u64 = 1713;
const METHOD_ISPASCAL: u64 = 1714;
const METHOD_CONTAINSNONASCII: u64 = 1715;
const METHOD_CONTAINSNONASCIIORNULL: u64 = 1716;
const METHOD_GETNUMCONCATENATED: u64 = 1717;
const METHOD_TOKLOC_BEGIN: u64 = 1718;
const METHOD_TOKLOC_END: u64 = 1719;
const METHOD_GETBEGINLOC_119: u64 = 1720;
const METHOD_GETENDLOC_118: u64 = 1721;
const METHOD_CHILDREN_107: u64 = 1722;
const CLASS_WARNUNUSEDRESULTATTR: u64 = 1723;
const CLASS_PTR64ATTR: u64 = 1724;
const CLASS_CORORETURNTYPEATTR: u64 = 1725;
const CLASS_MSCONSTEXPRATTR: u64 = 1726;
const CLASS_TRANSPARENTUNIONATTR: u64 = 1727;
const CLASS_DEPENDENTNAMETYPELOC: u64 = 1728;
const METHOD_GETELABORATEDKEYWORDLOC: u64 = 1729;
const METHOD_GETQUALIFIERLOC_16: u64 = 1730;
const METHOD_GETNAMELOC_3: u64 = 1731;
const METHOD_GETLOCALSOURCERANGE_1: u64 = 1732;
const CLASS_TYPEVISIBILITYATTR: u64 = 1733;
const CLASS_OBJCRUNTIMENAMEATTR: u64 = 1734;
const CLASS_ANNOTATEATTR: u64 = 1735;
const CLASS_TARGETVERSIONATTR: u64 = 1736;
const CLASS_CUDADEVICEBUILTINTEXTURETYPEATTR: u64 = 1737;
const CLASS_PACKEXPANSIONTYPE: u64 = 1738;
const METHOD_GETPATTERN: u64 = 1739;
const METHOD_GETNUMEXPANSIONS: u64 = 1740;
const METHOD_ISSUGARED_29: u64 = 1741;
const METHOD_DESUGAR_29: u64 = 1742;
const CLASS_OBJCDIRECTATTR: u64 = 1743;
const CLASS_REGCALLATTR: u64 = 1744;
const CLASS_IMPLICITCONCEPTSPECIALIZATIONDECL: u64 = 1745;
const METHOD_GETTEMPLATEARGUMENTS: u64 = 1746;
const CLASS_OSRETURNSRETAINEDONZEROATTR: u64 = 1747;
const CLASS_SWIFTPRIVATEATTR: u64 = 1748;
const CLASS_OBJCDIRECTMEMBERSATTR: u64 = 1749;
const CLASS_BUILTINBITCASTEXPR: u64 = 1750;
const METHOD_GETBEGINLOC_17: u64 = 1751;
const METHOD_GETENDLOC_16: u64 = 1752;
const CLASS_ADDRESSSPACEATTR: u64 = 1753;
const CLASS_USINGIFEXISTSATTR: u64 = 1754;
const CLASS_ARRAYINITLOOPEXPR: u64 = 1755;
const METHOD_GETCOMMONEXPR: u64 = 1756;
const METHOD_GETSUBEXPR: u64 = 1757;
const METHOD_GETARRAYSIZE: u64 = 1758;
const METHOD_GETBEGINLOC_6: u64 = 1759;
const METHOD_GETENDLOC_5: u64 = 1760;
const METHOD_CHILDREN_2: u64 = 1761;
const CLASS_PCSATTR: u64 = 1762;
const CLASS_NSRETURNSRETAINEDATTR: u64 = 1763;
const CLASS_CXXDEPENDENTSCOPEMEMBEREXPR: u64 = 1764;
const METHOD_ISIMPLICITACCESS: u64 = 1765;
const METHOD_GETBASE_7: u64 = 1766;
const METHOD_GETBASETYPE_1: u64 = 1767;
const METHOD_ISARROW: u64 = 1768;
const METHOD_GETOPERATORLOC_1: u64 = 1769;
const METHOD_GETQUALIFIER_11: u64 = 1770;
const METHOD_GETQUALIFIERLOC_8: u64 = 1771;
const METHOD_GETFIRSTQUALIFIERFOUNDINSCOPE: u64 = 1772;
const METHOD_GETMEMBERNAMEINFO: u64 = 1773;
const METHOD_GETMEMBER: u64 = 1774;
const METHOD_GETMEMBERLOC: u64 = 1775;
const METHOD_GETTEMPLATEKEYWORDLOC_2: u64 = 1776;
const METHOD_GETLANGLELOC: u64 = 1777;
const METHOD_GETRANGLELOC: u64 = 1778;
const METHOD_HASTEMPLATEKEYWORD: u64 = 1779;
const METHOD_HASEXPLICITTEMPLATEARGS: u64 = 1780;
const METHOD_GETTEMPLATEARGS_2: u64 = 1781;
const METHOD_GETNUMTEMPLATEARGS: u64 = 1782;
const METHOD_TEMPLATE_ARGUMENTS_2: u64 = 1783;
const METHOD_GETBEGINLOC_26: u64 = 1784;
const METHOD_GETENDLOC_25: u64 = 1785;
const METHOD_CHILDREN_20: u64 = 1786;
const CLASS_OBJCMETHODDECL: u64 = 1787;
const CLASS_LAYOUTVERSIONATTR: u64 = 1788;
const CLASS_FUNCTIONNOPROTOTYPELOC: u64 = 1789;
const CLASS_OPENCLKERNELATTR: u64 = 1790;
const CLASS_COYIELDEXPR: u64 = 1791;
const CLASS_RELEASEHANDLEATTR: u64 = 1792;
const CLASS_FIELDDECL: u64 = 1793;
const METHOD_GETFIELDINDEX: u64 = 1794;
const METHOD_ISMUTABLE: u64 = 1795;
const METHOD_ISBITFIELD: u64 = 1796;
const METHOD_ISUNNAMEDBITFIELD: u64 = 1797;
const METHOD_ISANONYMOUSSTRUCTORUNION: u64 = 1798;
const METHOD_GETBITWIDTH: u64 = 1799;
const METHOD_ISPOTENTIALLYOVERLAPPING: u64 = 1800;
const METHOD_GETINCLASSINITSTYLE: u64 = 1801;
const METHOD_HASINCLASSINITIALIZER_1: u64 = 1802;
const METHOD_HASNONNULLINCLASSINITIALIZER: u64 = 1803;
const METHOD_GETINCLASSINITIALIZER: u64 = 1804;
const METHOD_HASCAPTUREDVLATYPE: u64 = 1805;
const METHOD_GETCAPTUREDVLATYPE: u64 = 1806;
const METHOD_GETPARENT_2: u64 = 1807;
const METHOD_GETSOURCERANGE_10: u64 = 1808;
const METHOD_GETCANONICALDECL_10: u64 = 1809;
const CLASS_LOADERUNINITIALIZEDATTR: u64 = 1810;
const CLASS_OBJCATSYNCHRONIZEDSTMT: u64 = 1811;
const CLASS_ANYX86NOCFCHECKATTR: u64 = 1812;
const CLASS_NOSPLITSTACKATTR: u64 = 1813;
const CLASS_ANYX86INTERRUPTATTR: u64 = 1814;
const CLASS_NSRETURNSAUTORELEASEDATTR: u64 = 1815;
const CLASS_M68KRTDATTR: u64 = 1816;
const CLASS_RENDERSCRIPTKERNELATTR: u64 = 1817;
const CLASS_STANDALONEDEBUGATTR: u64 = 1818;
const CLASS_OBJCAUTORELEASEPOOLSTMT: u64 = 1819;
const CLASS_DESTRUCTORATTR: u64 = 1820;
const CLASS_MIPS16ATTR: u64 = 1821;
const CLASS_OBJCGCATTR: u64 = 1822;
const CLASS_PUREATTR: u64 = 1823;
const CLASS_TYPEOFEXPRTYPELOC: u64 = 1824;
const METHOD_GETUNDERLYINGEXPR_2: u64 = 1825;
const METHOD_GETLOCALSOURCERANGE_2: u64 = 1826;
const CLASS_OMPDECLAREVARIANTATTR: u64 = 1827;
const CLASS_BUILTINALIASATTR: u64 = 1828;
const CLASS_SWIFTVERSIONEDREMOVALATTR: u64 = 1829;
const CLASS_MSALLOCATORATTR: u64 = 1830;
const CLASS_FALLTHROUGHATTR: u64 = 1831;
const CLASS_BINARYOPERATOR: u64 = 1832;
const METHOD_GETEXPRLOC_1: u64 = 1833;
const METHOD_GETOPERATORLOC: u64 = 1834;
const METHOD_GETOPCODE: u64 = 1835;
const METHOD_GETLHS_1: u64 = 1836;
const METHOD_GETRHS_1: u64 = 1837;
const METHOD_GETBEGINLOC_14: u64 = 1838;
const METHOD_GETENDLOC_13: u64 = 1839;
const METHOD_GETOPCODESTR: u64 = 1840;
const METHOD_ISPTRMEMOP: u64 = 1841;
const METHOD_ISMULTIPLICATIVEOP: u64 = 1842;
const METHOD_ISADDITIVEOP: u64 = 1843;
const METHOD_ISSHIFTOP: u64 = 1844;
const METHOD_ISBITWISEOP: u64 = 1845;
const METHOD_ISRELATIONALOP: u64 = 1846;
const METHOD_ISEQUALITYOP: u64 = 1847;
const METHOD_ISCOMPARISONOP: u64 = 1848;
const METHOD_ISCOMMAOP: u64 = 1849;
const METHOD_ISLOGICALOP: u64 = 1850;
const METHOD_ISASSIGNMENTOP: u64 = 1851;
const METHOD_ISCOMPOUNDASSIGNMENTOP: u64 = 1852;
const METHOD_ISSHIFTASSIGNOP: u64 = 1853;
const METHOD_CHILDREN_10: u64 = 1854;
const METHOD_HASSTOREDFPFEATURES: u64 = 1855;
const METHOD_GETSTOREDFPFEATURES: u64 = 1856;
const METHOD_GETFPFEATURES: u64 = 1857;
const CLASS_CHARACTERLITERAL: u64 = 1858;
const METHOD_GETLOCATION_6: u64 = 1859;
const METHOD_GETKIND_3: u64 = 1860;
const METHOD_GETBEGINLOC_51: u64 = 1861;
const METHOD_GETENDLOC_50: u64 = 1862;
const METHOD_GETVALUE_6: u64 = 1863;
const METHOD_CHILDREN_41: u64 = 1864;
const CLASS_SWIFTASYNCERRORATTR: u64 = 1865;
const CLASS_XRAYLOGARGSATTR: u64 = 1866;
const CLASS_OMPCAPTUREKINDATTR: u64 = 1867;
const CLASS_INCOMPLETEARRAYTYPE: u64 = 1868;
const METHOD_ISSUGARED_23: u64 = 1869;
const METHOD_DESUGAR_23: u64 = 1870;
const CLASS_OSCONSUMESTHISATTR: u64 = 1871;
const CLASS_BITINTTYPE: u64 = 1872;
const METHOD_ISUNSIGNED: u64 = 1873;
const METHOD_ISSIGNED: u64 = 1874;
const METHOD_GETNUMBITS: u64 = 1875;
const METHOD_ISSUGARED_4: u64 = 1876;
const METHOD_DESUGAR_4: u64 = 1877;
const CLASS_VECTYPEHINTATTR: u64 = 1878;
const CLASS_CFUNKNOWNTRANSFERATTR: u64 = 1879;
const CLASS_ATTRIBUTEDSTMT: u64 = 1880;
const METHOD_GETATTRLOC: u64 = 1881;
const METHOD_GETATTRS_1: u64 = 1882;
const METHOD_GETSUBSTMT: u64 = 1883;
const METHOD_GETBEGINLOC_12: u64 = 1884;
const METHOD_GETENDLOC_11: u64 = 1885;
const METHOD_CHILDREN_8: u64 = 1886;
const CLASS_ELABORATEDTYPE: u64 = 1887;
const METHOD_GETQUALIFIER_2: u64 = 1888;
const METHOD_GETNAMEDTYPE: u64 = 1889;
const METHOD_DESUGAR_18: u64 = 1890;
const METHOD_ISSUGARED_18: u64 = 1891;
const METHOD_GETOWNEDTAGDECL: u64 = 1892;
const CLASS_PARENEXPR: u64 = 1893;
const METHOD_GETSUBEXPR_8: u64 = 1894;
const METHOD_GETBEGINLOC_103: u64 = 1895;
const METHOD_GETENDLOC_102: u64 = 1896;
const METHOD_GETLPAREN: u64 = 1897;
const METHOD_GETRPAREN: u64 = 1898;
const METHOD_CHILDREN_91: u64 = 1899;
const CLASS_SWIFTOBJCMEMBERSATTR: u64 = 1900;
const CLASS_OBJCBOXABLEATTR: u64 = 1901;
const CLASS_VARDECL: u64 = 1902;
const METHOD_GETSOURCERANGE_36: u64 = 1903;
const METHOD_GETSTORAGECLASS_1: u64 = 1904;
const METHOD_GETTSCSPEC: u64 = 1905;
const METHOD_GETTLSKIND: u64 = 1906;
const METHOD_HASLOCALSTORAGE: u64 = 1907;
const METHOD_ISSTATICLOCAL: u64 = 1908;
const METHOD_HASEXTERNALSTORAGE: u64 = 1909;
const METHOD_HASGLOBALSTORAGE: u64 = 1910;
const METHOD_GETSTORAGEDURATION_1: u64 = 1911;
const METHOD_GETLANGUAGELINKAGE_1: u64 = 1912;
const METHOD_ISEXTERNC_1: u64 = 1913;
const METHOD_ISINEXTERNCCONTEXT_1: u64 = 1914;
const METHOD_ISINEXTERNCXXCONTEXT_1: u64 = 1915;
const METHOD_ISLOCALVARDECL: u64 = 1916;
const METHOD_ISLOCALVARDECLORPARM: u64 = 1917;
const METHOD_ISFUNCTIONORMETHODVARDECL: u64 = 1918;
const METHOD_ISSTATICDATAMEMBER: u64 = 1919;
const METHOD_GETCANONICALDECL_27: u64 = 1920;
const METHOD_ISTHISDECLARATIONADEFINITION_4: u64 = 1921;
const METHOD_HASDEFINITION_1: u64 = 1922;
const METHOD_GETACTINGDEFINITION: u64 = 1923;
const METHOD_GETDEFINITION_5: u64 = 1924;
const METHOD_ISOUTOFLINE_2: u64 = 1925;
const METHOD_ISFILEVARDECL: u64 = 1926;
const METHOD_GETANYINITIALIZER: u64 = 1927;
const METHOD_HASINIT: u64 = 1928;
const METHOD_GETINIT: u64 = 1929;
const METHOD_GETINITIALIZINGDECLARATION: u64 = 1930;
const METHOD_ENSUREEVALUATEDSTMT: u64 = 1931;
const METHOD_GETEVALUATEDSTMT: u64 = 1932;
const METHOD_EVALUATEVALUE: u64 = 1933;
const METHOD_GETEVALUATEDVALUE: u64 = 1934;
const METHOD_HASCONSTANTINITIALIZATION: u64 = 1935;
const METHOD_GETINITSTYLE: u64 = 1936;
const METHOD_ISDIRECTINIT: u64 = 1937;
const METHOD_ISTHISDECLARATIONADEMOTEDDEFINITION_1: u64 = 1938;
const METHOD_ISEXCEPTIONVARIABLE: u64 = 1939;
const METHOD_ISNRVOVARIABLE: u64 = 1940;
const METHOD_ISCXXFORRANGEDECL: u64 = 1941;
const METHOD_ISOBJCFORDECL: u64 = 1942;
const METHOD_ISARCPSEUDOSTRONG: u64 = 1943;
const METHOD_ISINLINE_1: u64 = 1944;
const METHOD_ISINLINESPECIFIED_1: u64 = 1945;
const METHOD_ISCONSTEXPR_1: u64 = 1946;
const METHOD_ISINITCAPTURE_1: u64 = 1947;
const METHOD_ISPARAMETERPACK_5: u64 = 1948;
const METHOD_ISPREVIOUSDECLINSAMEBLOCKSCOPE: u64 = 1949;
const METHOD_ISESCAPINGBYREF: u64 = 1950;
const METHOD_ISNONESCAPINGBYREF: u64 = 1951;
const METHOD_HASDEPENDENTALIGNMENT: u64 = 1952;
const METHOD_GETTEMPLATEINSTANTIATIONPATTERN_2: u64 = 1953;
const METHOD_GETINSTANTIATEDFROMSTATICDATAMEMBER: u64 = 1954;
const METHOD_GETTEMPLATESPECIALIZATIONKIND_3: u64 = 1955;
const METHOD_GETTEMPLATESPECIALIZATIONKINDFORINSTANTIATION_1: u64 = 1956;
const METHOD_GETPOINTOFINSTANTIATION_2: u64 = 1957;
const METHOD_GETMEMBERSPECIALIZATIONINFO_3: u64 = 1958;
const METHOD_GETDESCRIBEDVARTEMPLATE: u64 = 1959;
const METHOD_ISKNOWNTOBEDEFINED: u64 = 1960;
const CLASS_EXCLUDEFROMEXPLICITINSTANTIATIONATTR: u64 = 1961;
const CLASS_X86FORCEALIGNARGPOINTERATTR: u64 = 1962;
const CLASS_UNLIKELYATTR: u64 = 1963;
const CLASS_OBJCATFINALLYSTMT: u64 = 1964;
const CLASS_OMPBARRIERDIRECTIVE: u64 = 1965;
const CLASS_OMPTASKDIRECTIVE: u64 = 1966;
const CLASS_DECLTYPETYPELOC: u64 = 1967;
const METHOD_GETUNDERLYINGEXPR_3: u64 = 1968;
const METHOD_GETDECLTYPELOC: u64 = 1969;
const METHOD_GETRPARENLOC_29: u64 = 1970;
const METHOD_GETLOCALSOURCERANGE_3: u64 = 1971;
const CLASS_TEMPLATETYPEPARMTYPELOC: u64 = 1972;
const METHOD_GETDECL_9: u64 = 1973;
const CLASS_OMPTARGETPARALLELFORDIRECTIVE: u64 = 1974;
const CLASS_WARNUNUSEDATTR: u64 = 1975;
const CLASS_TRYACQUIRECAPABILITYATTR: u64 = 1976;
const CLASS_ARMSTREAMINGCOMPATIBLEATTR: u64 = 1977;
const CLASS_NOTTAILCALLEDATTR: u64 = 1978;
const CLASS_REQUIRESCAPABILITYATTR: u64 = 1979;
const CLASS_CUDAHOSTATTR: u64 = 1980;
const CLASS_TESTTYPESTATEATTR: u64 = 1981;
const CLASS_UNARYEXPRORTYPETRAITEXPR: u64 = 1982;
const METHOD_GETKIND_5: u64 = 1983;
const METHOD_ISARGUMENTTYPE: u64 = 1984;
const METHOD_GETARGUMENTTYPE: u64 = 1985;
const METHOD_GETARGUMENTTYPEINFO: u64 = 1986;
const METHOD_GETARGUMENTEXPR: u64 = 1987;
const METHOD_GETTYPEOFARGUMENT: u64 = 1988;
const METHOD_GETOPERATORLOC_9: u64 = 1989;
const METHOD_GETRPARENLOC_26: u64 = 1990;
const METHOD_GETBEGINLOC_126: u64 = 1991;
const METHOD_GETENDLOC_125: u64 = 1992;
const METHOD_CHILDREN_113: u64 = 1993;
const CLASS_SYCLKERNELATTR: u64 = 1994;
const CLASS_OBJCISAEXPR: u64 = 1995;
const CLASS_SYSVABIATTR: u64 = 1996;
const CLASS_GNUNULLEXPR: u64 = 1997;
const METHOD_GETTOKENLOCATION: u64 = 1998;
const METHOD_GETBEGINLOC_79: u64 = 1999;
const METHOD_GETENDLOC_78: u64 = 2000;
const METHOD_CHILDREN_68: u64 = 2001;
const CLASS_ARGUMENTWITHTYPETAGATTR: u64 = 2002;
const CLASS_TARGETCLONESATTR: u64 = 2003;
const CLASS_CONSTRUCTORUSINGSHADOWDECL: u64 = 2004;
const METHOD_GETINTRODUCER: u64 = 2005;
const METHOD_GETPARENT_1: u64 = 2006;
const METHOD_GETNOMINATEDBASECLASSSHADOWDECL: u64 = 2007;
const METHOD_GETCONSTRUCTEDBASECLASSSHADOWDECL: u64 = 2008;
const METHOD_GETNOMINATEDBASECLASS: u64 = 2009;
const METHOD_GETCONSTRUCTEDBASECLASS: u64 = 2010;
const METHOD_CONSTRUCTSVIRTUALBASE: u64 = 2011;
const CLASS_SYCLSPECIALCLASSATTR: u64 = 2012;
const CLASS_SWIFTERRORATTR: u64 = 2013;
const CLASS_CONSTANTEXPR: u64 = 2014;
const METHOD_GETBEGINLOC_57: u64 = 2015;
const METHOD_GETENDLOC_56: u64 = 2016;
const METHOD_GETRESULTAPVALUEKIND: u64 = 2017;
const METHOD_GETRESULTSTORAGEKIND: u64 = 2018;
const METHOD_ISIMMEDIATEINVOCATION: u64 = 2019;
const METHOD_HASAPVALUERESULT: u64 = 2020;
const METHOD_GETAPVALUERESULT: u64 = 2021;
const METHOD_GETRESULTASAPSINT: u64 = 2022;
const METHOD_CHILDREN_47: u64 = 2023;
const CLASS_NODEREFATTR: u64 = 2024;
const CLASS_PRESERVEALLATTR: u64 = 2025;
const CLASS_CXXTEMPORARYOBJECTEXPR: u64 = 2026;
const METHOD_GETTYPESOURCEINFO_3: u64 = 2027;
const METHOD_GETBEGINLOC_41: u64 = 2028;
const METHOD_GETENDLOC_40: u64 = 2029;
const CLASS_CFRETURNSRETAINEDATTR: u64 = 2030;
const CLASS_OMPDECLARETARGETDECLATTR: u64 = 2031;
const CLASS_PRAGMACLANGRODATASECTIONATTR: u64 = 2032;
const CLASS_PRAGMADETECTMISMATCHDECL: u64 = 2033;
const METHOD_GETNAME: u64 = 2034;
const METHOD_GETVALUE_1: u64 = 2035;
const CLASS_COAWAITEXPR: u64 = 2036;
const METHOD_ISIMPLICIT_2: u64 = 2037;
const CLASS_ALIGNVALUEATTR: u64 = 2038;
const CLASS_NOBUILTINATTR: u64 = 2039;
const CLASS_REQDWORKGROUPSIZEATTR: u64 = 2040;
const CLASS_OPENCLUNROLLHINTATTR: u64 = 2041;
const CLASS_CXXCONSTCASTEXPR: u64 = 2042;
const CLASS_SWIFTBRIDGEATTR: u64 = 2043;
const CLASS_SWIFTASYNCATTR: u64 = 2044;
const CLASS_TYPETAGFORDATATYPEATTR: u64 = 2045;
const CLASS_ALWAYSDESTROYATTR: u64 = 2046;
const CLASS_ASSUMEALIGNEDATTR: u64 = 2047;
const CLASS_FILESCOPEASMDECL: u64 = 2048;
const METHOD_GETASMLOC: u64 = 2049;
const METHOD_GETRPARENLOC: u64 = 2050;
const METHOD_GETSOURCERANGE_11: u64 = 2051;
const METHOD_GETASMSTRING: u64 = 2052;
const CLASS_SPTRATTR: u64 = 2053;
const CLASS_RVALUEREFERENCETYPE: u64 = 2054;
const METHOD_ISSUGARED_33: u64 = 2055;
const METHOD_DESUGAR_33: u64 = 2056;
const CLASS_RETURNSNONNULLATTR: u64 = 2057;
const CLASS_ARMOUTATTR: u64 = 2058;
const CLASS_CUDAGLOBALATTR: u64 = 2059;
const CLASS_GCCASMSTMT: u64 = 2060;
const METHOD_GETRPARENLOC_16: u64 = 2061;
const METHOD_GETASMSTRING_1: u64 = 2062;
const METHOD_ISASMGOTO: u64 = 2063;
const METHOD_GETNUMLABELS: u64 = 2064;
const METHOD_BEGIN_LABELS: u64 = 2065;
const METHOD_END_LABELS: u64 = 2066;
const METHOD_LABELS: u64 = 2067;
const METHOD_GETBEGINLOC_78: u64 = 2068;
const METHOD_GETENDLOC_77: u64 = 2069;
const CLASS_ACQUIRECAPABILITYATTR: u64 = 2070;
const CLASS_AMDGPUKERNELCALLATTR: u64 = 2071;
const CLASS_AARCH64VECTORPCSATTR: u64 = 2072;
const CLASS_HLSLANNOTATIONATTR: u64 = 2073;
const CLASS_HLSLSV_DISPATCHTHREADIDATTR: u64 = 2074;
const CLASS_EMPTYDECL: u64 = 2075;
const CLASS_SHAREDTRYLOCKFUNCTIONATTR: u64 = 2076;
const CLASS_MIPSLONGCALLATTR: u64 = 2077;
const CLASS_ACQUIREHANDLEATTR: u64 = 2078;
const CLASS_TYPENULLUNSPECIFIEDATTR: u64 = 2079;
const CLASS_HLSLGROUPSHAREDADDRESSSPACEATTR: u64 = 2080;
const CLASS_DEPENDENTDECLTYPETYPE: u64 = 2081;
const CLASS_POINTERTYPELOC: u64 = 2082;
const METHOD_GETSTARLOC_1: u64 = 2083;
const CLASS_XRAYINSTRUMENTATTR: u64 = 2084;
const CLASS_WEAKATTR: u64 = 2085;
const CLASS_OBJCCATEGORYIMPLDECL: u64 = 2086;
const CLASS_OBJCKINDOFATTR: u64 = 2087;
const CLASS_SOURCELOCEXPR: u64 = 2088;
const METHOD_GETBUILTINSTR: u64 = 2089;
const METHOD_GETIDENTKIND_1: u64 = 2090;
const METHOD_ISINTTYPE: u64 = 2091;
const METHOD_GETPARENTCONTEXT: u64 = 2092;
const METHOD_GETLOCATION_15: u64 = 2093;
const METHOD_GETBEGINLOC_117: u64 = 2094;
const METHOD_GETENDLOC_116: u64 = 2095;
const METHOD_CHILDREN_104: u64 = 2096;
const CLASS_OBJCPROPERTYIMPLDECL: u64 = 2097;
const CLASS_THISCALLATTR: u64 = 2098;
const CLASS_USINGTYPE: u64 = 2099;
const METHOD_GETFOUNDDECL: u64 = 2100;
const METHOD_GETUNDERLYINGTYPE_3: u64 = 2101;
const METHOD_ISSUGARED_44: u64 = 2102;
const METHOD_DESUGAR_44: u64 = 2103;
const METHOD_TYPEMATCHESDECL_1: u64 = 2104;
const CLASS_INHERITABLEPARAMATTR: u64 = 2105;
const CLASS_CALLABLEWHENATTR: u64 = 2106;
const CLASS_ASMLABELATTR: u64 = 2107;
const CLASS_IMPLICITPARAMDECL: u64 = 2108;
const METHOD_GETPARAMETERKIND: u64 = 2109;
const CLASS_LOCKSEXCLUDEDATTR: u64 = 2110;
const CLASS_ALWAYSINLINEATTR: u64 = 2111;
const CLASS_DEPENDENTSIZEDARRAYTYPE: u64 = 2112;
const METHOD_GETSIZEEXPR_1: u64 = 2113;
const METHOD_GETBRACKETSRANGE: u64 = 2114;
const METHOD_GETLBRACKETLOC: u64 = 2115;
const METHOD_GETRBRACKETLOC: u64 = 2116;
const METHOD_ISSUGARED_14: u64 = 2117;
const METHOD_DESUGAR_14: u64 = 2118;
const CLASS_CODEALIGNATTR: u64 = 2119;
const CLASS_OBJCOBJECTTYPE: u64 = 2120;
const CLASS_OMPMASKEDTASKLOOPSIMDDIRECTIVE: u64 = 2121;
const CLASS_ARMSTREAMINGATTR: u64 = 2122;
const CLASS_MUSTTAILATTR: u64 = 2123;
const CLASS_OPENCLGLOBALDEVICEADDRESSSPACEATTR: u64 = 2124;
const CLASS_PATCHABLEFUNCTIONENTRYATTR: u64 = 2125;
const CLASS_OBJCAVAILABILITYCHECKEXPR: u64 = 2126;
const CLASS_ARRAYINITINDEXEXPR: u64 = 2127;
const METHOD_GETBEGINLOC_5: u64 = 2128;
const METHOD_GETENDLOC_4: u64 = 2129;
const METHOD_CHILDREN_1: u64 = 2130;
const CLASS_SETTYPESTATEATTR: u64 = 2131;
const CLASS_CUDASHAREDATTR: u64 = 2132;
const CLASS_MSGUIDDECL: u64 = 2133;
const METHOD_GETPARTS: u64 = 2134;
const METHOD_GETASAPVALUE: u64 = 2135;
const CLASS_TYPENONNULLATTR: u64 = 2136;
const CLASS_OPENCLPRIVATEADDRESSSPACEATTR: u64 = 2137;
const CLASS_CFCONSUMEDATTR: u64 = 2138;
const CLASS_TARGETATTR: u64 = 2139;
const CLASS_HLSLPARAMMODIFIERATTR: u64 = 2140;
const CLASS_COLDATTR: u64 = 2141;
const CLASS_AUTOTYPE: u64 = 2142;
const METHOD_GETTYPECONSTRAINTARGUMENTS: u64 = 2143;
const METHOD_GETTYPECONSTRAINTCONCEPT: u64 = 2144;
const METHOD_ISCONSTRAINED: u64 = 2145;
const METHOD_ISDECLTYPEAUTO: u64 = 2146;
const METHOD_ISGNUAUTOTYPE: u64 = 2147;
const METHOD_GETKEYWORD: u64 = 2148;
const CLASS_AVRINTERRUPTATTR: u64 = 2149;
const CLASS_CFRETURNSNOTRETAINEDATTR: u64 = 2150;
const CLASS_OMPTARGETPARALLELDIRECTIVE: u64 = 2151;
const CLASS_FUNCTIONDECL: u64 = 2152;
const METHOD_GETNAMEINFO: u64 = 2153;
const METHOD_GETELLIPSISLOC_1: u64 = 2154;
const METHOD_GETSOURCERANGE_13: u64 = 2155;
const METHOD_HASBODY_1: u64 = 2156;
const METHOD_HASTRIVIALBODY: u64 = 2157;
const METHOD_ISDEFINED: u64 = 2158;
const METHOD_GETDEFINITION_2: u64 = 2159;
const METHOD_GETBODY_3: u64 = 2160;
const METHOD_ISTHISDECLARATIONADEFINITION_1: u64 = 2161;
const METHOD_ISTHISDECLARATIONINSTANTIATEDFROMAFRIENDDEFINITION: u64 = 2162;
const METHOD_DOESTHISDECLARATIONHAVEABODY: u64 = 2163;
const METHOD_GETDEFAULTEDFUNCTIONINFO: u64 = 2164;
const METHOD_ISVARIADIC_2: u64 = 2165;
const METHOD_ISVIRTUALASWRITTEN: u64 = 2166;
const METHOD_ISPUREVIRTUAL: u64 = 2167;
const METHOD_ISLATETEMPLATEPARSED: u64 = 2168;
const METHOD_ISTRIVIAL_1: u64 = 2169;
const METHOD_ISTRIVIALFORCALL: u64 = 2170;
const METHOD_ISDEFAULTED: u64 = 2171;
const METHOD_ISEXPLICITLYDEFAULTED: u64 = 2172;
const METHOD_GETDEFAULTLOC: u64 = 2173;
const METHOD_ISUSERPROVIDED: u64 = 2174;
const METHOD_ISINELIGIBLEORNOTSELECTED: u64 = 2175;
const METHOD_HASIMPLICITRETURNZERO: u64 = 2176;
const METHOD_HASPROTOTYPE: u64 = 2177;
const METHOD_HASWRITTENPROTOTYPE: u64 = 2178;
const METHOD_HASINHERITEDPROTOTYPE: u64 = 2179;
const METHOD_ISCONSTEXPR: u64 = 2180;
const METHOD_GETCONSTEXPRKIND: u64 = 2181;
const METHOD_ISCONSTEXPRSPECIFIED: u64 = 2182;
const METHOD_ISCONSTEVAL: u64 = 2183;
const METHOD_BODYCONTAINSIMMEDIATEESCALATINGEXPRESSIONS: u64 = 2184;
const METHOD_ISIMMEDIATEESCALATING: u64 = 2185;
const METHOD_ISIMMEDIATEFUNCTION: u64 = 2186;
const METHOD_INSTANTIATIONISPENDING: u64 = 2187;
const METHOD_USESSEHTRY: u64 = 2188;
const METHOD_ISDELETED: u64 = 2189;
const METHOD_ISDELETEDASWRITTEN: u64 = 2190;
const METHOD_ISMAIN: u64 = 2191;
const METHOD_ISMSVCRTENTRYPOINT: u64 = 2192;
const METHOD_ISRESERVEDGLOBALPLACEMENTOPERATOR: u64 = 2193;
const METHOD_ISINLINEBUILTINDECLARATION: u64 = 2194;
const METHOD_ISDESTROYINGOPERATORDELETE: u64 = 2195;
const METHOD_GETLANGUAGELINKAGE: u64 = 2196;
const METHOD_ISEXTERNC: u64 = 2197;
const METHOD_ISINEXTERNCCONTEXT: u64 = 2198;
const METHOD_ISINEXTERNCXXCONTEXT: u64 = 2199;
const METHOD_ISGLOBAL: u64 = 2200;
const METHOD_ISNORETURN: u64 = 2201;
const METHOD_HASSKIPPEDBODY: u64 = 2202;
const METHOD_WILLHAVEBODY: u64 = 2203;
const METHOD_ISMULTIVERSION: u64 = 2204;
const METHOD_FRIENDCONSTRAINTREFERSTOENCLOSINGTEMPLATE: u64 = 2205;
const METHOD_ISMEMBERLIKECONSTRAINEDFRIEND: u64 = 2206;
const METHOD_GETMULTIVERSIONKIND: u64 = 2207;
const METHOD_ISCPUDISPATCHMULTIVERSION: u64 = 2208;
const METHOD_ISCPUSPECIFICMULTIVERSION: u64 = 2209;
const METHOD_ISTARGETMULTIVERSION: u64 = 2210;
const METHOD_ISTARGETCLONESMULTIVERSION: u64 = 2211;
const METHOD_GETCANONICALDECL_11: u64 = 2212;
const METHOD_PARAMETERS_2: u64 = 2213;
const METHOD_PARAM_EMPTY_1: u64 = 2214;
const METHOD_PARAM_BEGIN_2: u64 = 2215;
const METHOD_PARAM_END_2: u64 = 2216;
const METHOD_PARAM_SIZE_1: u64 = 2217;
const METHOD_GETNUMPARAMS_3: u64 = 2218;
const METHOD_GETMINREQUIREDARGUMENTS: u64 = 2219;
const METHOD_GETMINREQUIREDEXPLICITARGUMENTS: u64 = 2220;
const METHOD_HASCXXEXPLICITFUNCTIONOBJECTPARAMETER: u64 = 2221;
const METHOD_GETNUMNONOBJECTPARAMS: u64 = 2222;
const METHOD_HASONEPARAMORDEFAULTARGS: u64 = 2223;
const METHOD_GETFUNCTIONTYPELOC: u64 = 2224;
const METHOD_GETRETURNTYPE_1: u64 = 2225;
const METHOD_GETRETURNTYPESOURCERANGE: u64 = 2226;
const METHOD_GETPARAMETERSSOURCERANGE: u64 = 2227;
const METHOD_GETDECLAREDRETURNTYPE: u64 = 2228;
const METHOD_GETEXCEPTIONSPECTYPE_1: u64 = 2229;
const METHOD_GETEXCEPTIONSPECSOURCERANGE: u64 = 2230;
const METHOD_GETCALLRESULTTYPE: u64 = 2231;
const METHOD_GETSTORAGECLASS: u64 = 2232;
const METHOD_ISINLINESPECIFIED: u64 = 2233;
const METHOD_USESFPINTRIN: u64 = 2234;
const METHOD_ISINLINED: u64 = 2235;
const METHOD_ISINLINEDEFINITIONEXTERNALLYVISIBLE: u64 = 2236;
const METHOD_ISMSEXTERNINLINE: u64 = 2237;
const METHOD_DOESDECLARATIONFORCEEXTERNALLYVISIBLEDEFINITION: u64 = 2238;
const METHOD_ISSTATIC_1: u64 = 2239;
const METHOD_ISOVERLOADEDOPERATOR: u64 = 2240;
const METHOD_GETOVERLOADEDOPERATOR: u64 = 2241;
const METHOD_GETLITERALIDENTIFIER: u64 = 2242;
const METHOD_GETINSTANTIATEDFROMMEMBERFUNCTION: u64 = 2243;
const METHOD_GETTEMPLATEDKIND: u64 = 2244;
const METHOD_GETMEMBERSPECIALIZATIONINFO_2: u64 = 2245;
const METHOD_GETINSTANTIATEDFROMDECL: u64 = 2246;
const METHOD_GETDESCRIBEDFUNCTIONTEMPLATE: u64 = 2247;
const METHOD_ISFUNCTIONTEMPLATESPECIALIZATION: u64 = 2248;
const METHOD_GETTEMPLATESPECIALIZATIONINFO: u64 = 2249;
const METHOD_ISIMPLICITLYINSTANTIABLE: u64 = 2250;
const METHOD_ISTEMPLATEINSTANTIATION: u64 = 2251;
const METHOD_GETPRIMARYTEMPLATE: u64 = 2252;
const METHOD_GETTEMPLATESPECIALIZATIONARGS: u64 = 2253;
const METHOD_GETTEMPLATESPECIALIZATIONARGSASWRITTEN: u64 = 2254;
const METHOD_GETDEPENDENTSPECIALIZATIONINFO: u64 = 2255;
const METHOD_GETTEMPLATESPECIALIZATIONKIND_2: u64 = 2256;
const METHOD_GETTEMPLATESPECIALIZATIONKINDFORINSTANTIATION: u64 = 2257;
const METHOD_GETPOINTOFINSTANTIATION_1: u64 = 2258;
const METHOD_ISOUTOFLINE_1: u64 = 2259;
const METHOD_GETMEMORYFUNCTIONKIND: u64 = 2260;
const METHOD_GETODRHASH_1: u64 = 2261;
const CLASS_ANALYZERNORETURNATTR: u64 = 2262;
const CLASS_WEBASSEMBLYFUNCREFATTR: u64 = 2263;
const CLASS_IFUNCATTR: u64 = 2264;
const CLASS_HLSLSV_GROUPINDEXATTR: u64 = 2265;
const CLASS_OMPREQUIRESDECL: u64 = 2266;
const CLASS_AVAILABILITYATTR: u64 = 2267;
const CLASS_DEPENDENTNAMETYPE: u64 = 2268;
const METHOD_GETQUALIFIER: u64 = 2269;
const METHOD_GETIDENTIFIER: u64 = 2270;
const METHOD_ISSUGARED_13: u64 = 2271;
const METHOD_DESUGAR_13: u64 = 2272;
const CLASS_AMDGPUFLATWORKGROUPSIZEATTR: u64 = 2273;
const CLASS_ASSERTCAPABILITYATTR: u64 = 2274;
const CLASS_SEHLEAVESTMT: u64 = 2275;
const METHOD_GETLEAVELOC: u64 = 2276;
const METHOD_GETBEGINLOC_112: u64 = 2277;
const METHOD_GETENDLOC_111: u64 = 2278;
const METHOD_CHILDREN_99: u64 = 2279;
const CLASS_CONVERGENTATTR: u64 = 2280;
const CLASS_TYPENULLABLERESULTATTR: u64 = 2281;
const CLASS_OMPPARALLELMASKEDTASKLOOPSIMDDIRECTIVE: u64 = 2282;
const CLASS_OVERLOADABLEATTR: u64 = 2283;
const CLASS_DECLORSTMTATTR: u64 = 2284;
const CLASS_BUILTINATTR: u64 = 2285;
const CLASS_READONLYPLACEMENTATTR: u64 = 2286;
const CLASS_ALIGNNATURALATTR: u64 = 2287;
const CLASS_OMPPARALLELMASTERTASKLOOPDIRECTIVE: u64 = 2288;
const CLASS_AMDGPUWAVESPEREUATTR: u64 = 2289;
const CLASS_BTFDECLTAGATTR: u64 = 2290;
const CLASS_OBJCINERTUNSAFEUNRETAINEDATTR: u64 = 2291;
const CLASS_SUPPRESSATTR: u64 = 2292;
const CLASS_ASSUMPTIONATTR: u64 = 2293;
const CLASS_OMPTEAMSDISTRIBUTEDIRECTIVE: u64 = 2294;
const CLASS_USEHANDLEATTR: u64 = 2295;
const CLASS_CXXCONSTRUCTEXPR: u64 = 2296;
const METHOD_GETCONSTRUCTOR: u64 = 2297;
const METHOD_GETLOCATION_2: u64 = 2298;
const METHOD_ISELIDABLE: u64 = 2299;
const METHOD_HADMULTIPLECANDIDATES: u64 = 2300;
const METHOD_ISLISTINITIALIZATION: u64 = 2301;
const METHOD_ISSTDINITLISTINITIALIZATION: u64 = 2302;
const METHOD_REQUIRESZEROINITIALIZATION: u64 = 2303;
const METHOD_GETCONSTRUCTIONKIND: u64 = 2304;
const METHOD_ARGUMENTS: u64 = 2305;
const METHOD_ARG_BEGIN_1: u64 = 2306;
const METHOD_ARG_END_1: u64 = 2307;
const METHOD_GETARGS: u64 = 2308;
const METHOD_GETNUMARGS_1: u64 = 2309;
const METHOD_ISIMMEDIATEESCALATING_1: u64 = 2310;
const METHOD_GETBEGINLOC_22: u64 = 2311;
const METHOD_GETENDLOC_21: u64 = 2312;
const METHOD_GETPARENORBRACERANGE: u64 = 2313;
const METHOD_CHILDREN_16: u64 = 2314;
const CLASS_CARRIESDEPENDENCYATTR: u64 = 2315;
const CLASS_INHERITABLEATTR: u64 = 2316;
const CLASS_BPFPRESERVEACCESSINDEXATTR: u64 = 2317;
const CLASS_PARAMTYPESTATEATTR: u64 = 2318;
const CLASS_TYPEOFEXPRTYPE: u64 = 2319;
const METHOD_GETUNDERLYINGEXPR_1: u64 = 2320;
const METHOD_GETKIND_1: u64 = 2321;
const METHOD_DESUGAR_39: u64 = 2322;
const METHOD_ISSUGARED_39: u64 = 2323;
const CLASS_CONSTINITATTR: u64 = 2324;
const CLASS_SCOPEDLOCKABLEATTR: u64 = 2325;
const CLASS_AARCH64SVEPCSATTR: u64 = 2326;
const CLASS_PARAMETERABIATTR: u64 = 2327;
const CLASS_UNRESOLVEDUSINGTYPELOC: u64 = 2328;
const METHOD_GETDECL_10: u64 = 2329;
const CLASS_NONNULLATTR: u64 = 2330;
const CLASS_SUBSTTEMPLATETYPEPARMTYPE: u64 = 2331;
const METHOD_GETREPLACEMENTTYPE: u64 = 2332;
const METHOD_GETASSOCIATEDDECL_1: u64 = 2333;
const METHOD_GETREPLACEDPARAMETER_1: u64 = 2334;
const METHOD_GETINDEX_1: u64 = 2335;
const METHOD_GETPACKINDEX: u64 = 2336;
const METHOD_ISSUGARED_36: u64 = 2337;
const METHOD_DESUGAR_36: u64 = 2338;
const CLASS_STRICTGUARDSTACKCHECKATTR: u64 = 2339;
const CLASS_AVAILABLEONLYINDEFAULTEVALMETHODATTR: u64 = 2340;
const CLASS_BPFPRESERVESTATICOFFSETATTR: u64 = 2341;
const CLASS_OMPCANCELLATIONPOINTDIRECTIVE: u64 = 2342;
const CLASS_PRAGMACLANGTEXTSECTIONATTR: u64 = 2343;
const CLASS_REINITIALIZESATTR: u64 = 2344;
const CLASS_SHUFFLEVECTOREXPR: u64 = 2345;
const METHOD_GETBUILTINLOC_4: u64 = 2346;
const METHOD_GETRPARENLOC_22: u64 = 2347;
const METHOD_GETBEGINLOC_115: u64 = 2348;
const METHOD_GETENDLOC_114: u64 = 2349;
const METHOD_GETNUMSUBEXPRS_2: u64 = 2350;
const METHOD_CHILDREN_102: u64 = 2351;
const CLASS_ARMBUILTINALIASATTR: u64 = 2352;
const CLASS_CDECLATTR: u64 = 2353;
const CLASS_ENUMDECL: u64 = 2354;
const METHOD_GETCANONICALDECL_9: u64 = 2355;
const METHOD_GETPREVIOUSDECL_3: u64 = 2356;
const METHOD_GETMOSTRECENTDECL_4: u64 = 2357;
const METHOD_GETDEFINITION_1: u64 = 2358;
const METHOD_GETSOURCERANGE_8: u64 = 2359;
const METHOD_ENUMERATORS: u64 = 2360;
const METHOD_ENUMERATOR_BEGIN: u64 = 2361;
const METHOD_ENUMERATOR_END: u64 = 2362;
const METHOD_GETPROMOTIONTYPE: u64 = 2363;
const METHOD_GETINTEGERTYPE: u64 = 2364;
const METHOD_GETINTEGERTYPESOURCEINFO: u64 = 2365;
const METHOD_GETINTEGERTYPERANGE: u64 = 2366;
const METHOD_GETNUMPOSITIVEBITS: u64 = 2367;
const METHOD_GETNUMNEGATIVEBITS: u64 = 2368;
const METHOD_ISSCOPED: u64 = 2369;
const METHOD_ISSCOPEDUSINGCLASSTAG: u64 = 2370;
const METHOD_ISFIXED: u64 = 2371;
const METHOD_ISCOMPLETE: u64 = 2372;
const METHOD_ISCLOSED: u64 = 2373;
const METHOD_ISCLOSEDFLAG: u64 = 2374;
const METHOD_ISCLOSEDNONFLAG: u64 = 2375;
const METHOD_GETTEMPLATEINSTANTIATIONPATTERN_1: u64 = 2376;
const METHOD_GETINSTANTIATEDFROMMEMBERENUM: u64 = 2377;
const METHOD_GETTEMPLATESPECIALIZATIONKIND_1: u64 = 2378;
const METHOD_GETMEMBERSPECIALIZATIONINFO_1: u64 = 2379;
const CLASS_FUNCTIONTYPE: u64 = 2380;
const METHOD_GETRETURNTYPE: u64 = 2381;
const METHOD_GETHASREGPARM: u64 = 2382;
const METHOD_GETREGPARMTYPE: u64 = 2383;
const METHOD_GETNORETURNATTR: u64 = 2384;
const METHOD_GETCMSENSCALLATTR: u64 = 2385;
const METHOD_GETCALLCONV: u64 = 2386;
const METHOD_GETEXTINFO: u64 = 2387;
const METHOD_ISCONST: u64 = 2388;
const METHOD_ISVOLATILE: u64 = 2389;
const METHOD_ISRESTRICT: u64 = 2390;
const CLASS_CFGUARDATTR: u64 = 2391;
const CLASS_STMTATTR: u64 = 2392;
const CLASS_CUDADEVICEBUILTINSURFACETYPEATTR: u64 = 2393;
const CLASS_HOTATTR: u64 = 2394;
const CLASS_MATRIXSUBSCRIPTEXPR: u64 = 2395;
const METHOD_ISINCOMPLETE: u64 = 2396;
const METHOD_GETBASE_5: u64 = 2397;
const METHOD_GETROWIDX: u64 = 2398;
const METHOD_GETCOLUMNIDX: u64 = 2399;
const METHOD_GETBEGINLOC_96: u64 = 2400;
const METHOD_GETENDLOC_95: u64 = 2401;
const METHOD_GETEXPRLOC_8: u64 = 2402;
const METHOD_GETRBRACKETLOC_4: u64 = 2403;
const METHOD_CHILDREN_84: u64 = 2404;
const CLASS_ENFORCETCBATTR: u64 = 2405;
const CLASS_OSRETURNSRETAINEDONNONZEROATTR: u64 = 2406;
const CLASS_CXX11NORETURNATTR: u64 = 2407;
const CLASS_OBJCTYPEPARAMTYPE: u64 = 2408;
const CLASS_LOOPHINTATTR: u64 = 2409;
const CLASS_CUDALAUNCHBOUNDSATTR: u64 = 2410;
const CLASS_CALLBACKATTR: u64 = 2411;
const CLASS_FUNCTIONTYPELOC: u64 = 2412;
const METHOD_GETLOCALRANGEBEGIN: u64 = 2413;
const METHOD_GETLOCALRANGEEND: u64 = 2414;
const METHOD_GETLPARENLOC_12: u64 = 2415;
const METHOD_GETRPARENLOC_30: u64 = 2416;
const METHOD_GETPARENSRANGE: u64 = 2417;
const METHOD_GETEXCEPTIONSPECRANGE: u64 = 2418;
const METHOD_GETPARAMS: u64 = 2419;
const METHOD_GETPARMARRAY: u64 = 2420;
const METHOD_GETNUMPARAMS_4: u64 = 2421;
const METHOD_GETRETURNLOC_1: u64 = 2422;
const METHOD_GETLOCALSOURCERANGE_4: u64 = 2423;
const METHOD_GETEXTRALOCALDATASIZE_1: u64 = 2424;
const METHOD_GETEXTRALOCALDATAALIGNMENT_1: u64 = 2425;
const METHOD_GETINNERTYPE_1: u64 = 2426;
const CLASS_BLOCKSATTR: u64 = 2427;
const CLASS_SWIFTNAMEATTR: u64 = 2428;
const CLASS_DEPENDENTSCOPEDECLREFEXPR: u64 = 2429;
const METHOD_GETNAMEINFO_5: u64 = 2430;
const METHOD_GETDECLNAME_1: u64 = 2431;
const METHOD_GETLOCATION_8: u64 = 2432;
const METHOD_GETQUALIFIERLOC_11: u64 = 2433;
const METHOD_GETQUALIFIER_14: u64 = 2434;
const METHOD_GETTEMPLATEKEYWORDLOC_4: u64 = 2435;
const METHOD_GETLANGLELOC_2: u64 = 2436;
const METHOD_GETRANGLELOC_2: u64 = 2437;
const METHOD_HASTEMPLATEKEYWORD_2: u64 = 2438;
const METHOD_HASEXPLICITTEMPLATEARGS_3: u64 = 2439;
const METHOD_GETTEMPLATEARGS_4: u64 = 2440;
const METHOD_GETNUMTEMPLATEARGS_2: u64 = 2441;
const METHOD_TEMPLATE_ARGUMENTS_4: u64 = 2442;
const METHOD_GETBEGINLOC_67: u64 = 2443;
const METHOD_GETENDLOC_66: u64 = 2444;
const METHOD_CHILDREN_57: u64 = 2445;
const CLASS_SWIFTERRORRESULTATTR: u64 = 2446;
const CLASS_CAPTUREDRECORDATTR: u64 = 2447;
const CLASS_CALLEDONCEATTR: u64 = 2448;
const CLASS_INTELOCLBICCATTR: u64 = 2449;
const CLASS_REFERENCETYPE: u64 = 2450;
const METHOD_ISSPELLEDASLVALUE: u64 = 2451;
const METHOD_ISINNERREF: u64 = 2452;
const METHOD_GETPOINTEETYPEASWRITTEN: u64 = 2453;
const METHOD_GETPOINTEETYPE_5: u64 = 2454;
const CLASS_UNARYTRANSFORMTYPELOC: u64 = 2455;
const METHOD_GETKWLOC: u64 = 2456;
const METHOD_GETLPARENLOC_13: u64 = 2457;
const METHOD_GETRPARENLOC_31: u64 = 2458;
const METHOD_GETUNDERLYINGTINFO: u64 = 2459;
const METHOD_GETLOCALSOURCERANGE_5: u64 = 2460;
const METHOD_GETPARENSRANGE_1: u64 = 2461;
const CLASS_CAPABILITYATTR: u64 = 2462;
const CLASS_CLEANUPATTR: u64 = 2463;
const CLASS_OMPSCOPEDIRECTIVE: u64 = 2464;
const CLASS_CMSENSENTRYATTR: u64 = 2465;
const CLASS_CODESEGATTR: u64 = 2466;
const CLASS_OBJCCATEGORYDECL: u64 = 2467;
const CLASS_PASSOBJECTSIZEATTR: u64 = 2468;
const CLASS_COROONLYDESTROYWHENCOMPLETEATTR: u64 = 2469;
const CLASS_ASSERTSHAREDLOCKATTR: u64 = 2470;
const CLASS_BITINTTYPELOC: u64 = 2471;
const CLASS_HLSLRESOURCEATTR: u64 = 2472;
const CLASS_ARMLOCALLYSTREAMINGATTR: u64 = 2473;
const CLASS_DEPENDENTSIZEDARRAYTYPELOC: u64 = 2474;
const CLASS_COMMONATTR: u64 = 2475;
const CLASS_CONSUMABLESETONREADATTR: u64 = 2476;
const CLASS_CORODISABLELIFETIMEBOUNDATTR: u64 = 2477;
const CLASS_OBJCATCATCHSTMT: u64 = 2478;
const CLASS_ALLOCSIZEATTR: u64 = 2479;
const CLASS_FUNCTIONNOPROTOTYPE: u64 = 2480;
const METHOD_ISSUGARED_21: u64 = 2481;
const METHOD_DESUGAR_21: u64 = 2482;
const CLASS_COROLIFETIMEBOUNDATTR: u64 = 2483;
const CLASS_WEBASSEMBLYIMPORTMODULEATTR: u64 = 2484;
const CLASS_ASSERTEXCLUSIVELOCKATTR: u64 = 2485;
const CLASS_OMPFORDIRECTIVE: u64 = 2486;
const CLASS_PRAGMACLANGDATASECTIONATTR: u64 = 2487;
const CLASS_UNRESOLVEDUSINGVALUEDECL: u64 = 2488;
const METHOD_GETUSINGLOC_1: u64 = 2489;
const METHOD_ISACCESSDECLARATION: u64 = 2490;
const METHOD_GETQUALIFIERLOC_4: u64 = 2491;
const METHOD_GETQUALIFIER_7: u64 = 2492;
const METHOD_GETNAMEINFO_2: u64 = 2493;
const METHOD_ISPACKEXPANSION_4: u64 = 2494;
const METHOD_GETELLIPSISLOC_3: u64 = 2495;
const METHOD_GETSOURCERANGE_31: u64 = 2496;
const METHOD_GETCANONICALDECL_22: u64 = 2497;
const CLASS_TYPEDEFTYPE: u64 = 2498;
const METHOD_GETDECL_5: u64 = 2499;
const METHOD_ISSUGARED_41: u64 = 2500;
const METHOD_DESUGAR_41: u64 = 2501;
const METHOD_TYPEMATCHESDECL: u64 = 2502;
const CLASS_DEPENDENTBITINTTYPELOC: u64 = 2503;
const CLASS_OBJCNONLAZYCLASSATTR: u64 = 2504;
const CLASS_PRAGMACLANGRELROSECTIONATTR: u64 = 2505;
const CLASS_NORANDOMIZELAYOUTATTR: u64 = 2506;
const CLASS_CXXPARENLISTINITEXPR: u64 = 2507;
const METHOD_GETINITEXPRS: u64 = 2508;
const METHOD_GETUSERSPECIFIEDINITEXPRS: u64 = 2509;
const METHOD_GETBEGINLOC_36: u64 = 2510;
const METHOD_GETENDLOC_35: u64 = 2511;
const METHOD_GETINITLOC: u64 = 2512;
const METHOD_GETSOURCERANGE_42: u64 = 2513;
const METHOD_GETARRAYFILLER: u64 = 2514;
const METHOD_GETINITIALIZEDFIELDINUNION: u64 = 2515;
const METHOD_CHILDREN_27: u64 = 2516;
const CLASS_ANNOTATETYPEATTR: u64 = 2517;
const CLASS_OMPFORSIMDDIRECTIVE: u64 = 2518;
const CLASS_DEPENDENTADDRESSSPACETYPELOC: u64 = 2519;
const METHOD_GETATTRNAMELOC: u64 = 2520;
const METHOD_GETATTREXPROPERAND: u64 = 2521;
const METHOD_GETATTROPERANDPARENSRANGE: u64 = 2522;
const METHOD_GETLOCALSOURCERANGE_6: u64 = 2523;
const METHOD_GETINNERTYPE_2: u64 = 2524;
const METHOD_GETPOINTEETYPELOC: u64 = 2525;
const CLASS_OPENCLCONSTANTADDRESSSPACEATTR: u64 = 2526;
const CLASS_UUIDATTR: u64 = 2527;
const CLASS_OMPFLUSHDIRECTIVE: u64 = 2528;
const CLASS_COUNTEDBYATTR: u64 = 2529;
const CLASS_CONCEPTSPECIALIZATIONEXPR: u64 = 2530;
const METHOD_GETTEMPLATEARGUMENTS_1: u64 = 2531;
const METHOD_GETCONCEPTREFERENCE: u64 = 2532;
const METHOD_GETNAMEDCONCEPT: u64 = 2533;
const METHOD_HASEXPLICITTEMPLATEARGS_1: u64 = 2534;
const METHOD_GETCONCEPTNAMELOC: u64 = 2535;
const METHOD_GETTEMPLATEARGSASWRITTEN_2: u64 = 2536;
const METHOD_GETNESTEDNAMESPECIFIERLOC: u64 = 2537;
const METHOD_GETTEMPLATEKWLOC: u64 = 2538;
const METHOD_GETFOUNDDECL_1: u64 = 2539;
const METHOD_GETCONCEPTNAMEINFO: u64 = 2540;
const METHOD_GETSPECIALIZATIONDECL: u64 = 2541;
const METHOD_ISSATISFIED_1: u64 = 2542;
const METHOD_GETSATISFACTION: u64 = 2543;
const METHOD_GETBEGINLOC_55: u64 = 2544;
const METHOD_GETENDLOC_54: u64 = 2545;
const METHOD_GETEXPRLOC_6: u64 = 2546;
const METHOD_CHILDREN_45: u64 = 2547;
const CLASS_PREFERREDNAMEATTR: u64 = 2548;
const CLASS_RISCVINTERRUPTATTR: u64 = 2549;
const CLASS_DEDUCEDTEMPLATESPECIALIZATIONTYPELOC: u64 = 2550;
const METHOD_GETTEMPLATENAMELOC: u64 = 2551;
const CLASS_CFAUDITEDTRANSFERATTR: u64 = 2552;
const CLASS_LEAFATTR: u64 = 2553;
const CLASS_ARMINOUTATTR: u64 = 2554;
const CLASS_RESTRICTATTR: u64 = 2555;
const CLASS_INJECTEDCLASSNAMETYPE: u64 = 2556;
const METHOD_GETINJECTEDSPECIALIZATIONTYPE: u64 = 2557;
const METHOD_GETINJECTEDTST: u64 = 2558;
const METHOD_GETTEMPLATENAME_1: u64 = 2559;
const METHOD_GETDECL_1: u64 = 2560;
const METHOD_ISSUGARED_24: u64 = 2561;
const METHOD_DESUGAR_24: u64 = 2562;
const CLASS_EXTVECTORTYPELOC: u64 = 2563;
const CLASS_OMPCAPTURENOINITATTR: u64 = 2564;
const CLASS_OBJCBRIDGEMUTABLEATTR: u64 = 2565;
const CLASS_OPENCLGENERICADDRESSSPACEATTR: u64 = 2566;
const CLASS_OMPERRORDIRECTIVE: u64 = 2567;
const CLASS_TYPESPECTYPELOC: u64 = 2568;
const METHOD_GETNAMELOC_4: u64 = 2569;
const METHOD_GETLOCALSOURCERANGE_7: u64 = 2570;
const CLASS_CXXUUIDOFEXPR: u64 = 2571;
const METHOD_ISTYPEOPERAND_1: u64 = 2572;
const METHOD_GETTYPEOPERANDSOURCEINFO_1: u64 = 2573;
const METHOD_GETEXPROPERAND_1: u64 = 2574;
const METHOD_GETGUIDDECL: u64 = 2575;
const METHOD_GETBEGINLOC_47: u64 = 2576;
const METHOD_GETENDLOC_46: u64 = 2577;
const METHOD_GETSOURCERANGE_46: u64 = 2578;
const METHOD_CHILDREN_36: u64 = 2579;
const CLASS_SENTINELATTR: u64 = 2580;
const CLASS_NOUWTABLEATTR: u64 = 2581;
const CLASS_POINTERATTR: u64 = 2582;
const CLASS_BREAKSTMT: u64 = 2583;
const METHOD_GETBREAKLOC: u64 = 2584;
const METHOD_GETBEGINLOC_16: u64 = 2585;
const METHOD_GETENDLOC_15: u64 = 2586;
const METHOD_CHILDREN_12: u64 = 2587;
const CLASS_UNRESOLVEDMEMBEREXPR: u64 = 2588;
const METHOD_ISIMPLICITACCESS_3: u64 = 2589;
const METHOD_GETBASE_8: u64 = 2590;
const METHOD_GETBASETYPE_2: u64 = 2591;
const METHOD_HASUNRESOLVEDUSING: u64 = 2592;
const METHOD_ISARROW_5: u64 = 2593;
const METHOD_GETOPERATORLOC_11: u64 = 2594;
const METHOD_GETNAMINGCLASS_2: u64 = 2595;
const METHOD_GETMEMBERNAMEINFO_2: u64 = 2596;
const METHOD_GETMEMBERNAME: u64 = 2597;
const METHOD_GETMEMBERLOC_3: u64 = 2598;
const METHOD_GETEXPRLOC_13: u64 = 2599;
const METHOD_GETBEGINLOC_129: u64 = 2600;
const METHOD_GETENDLOC_128: u64 = 2601;
const METHOD_CHILDREN_116: u64 = 2602;
const CLASS_OBJCRUNTIMEVISIBLEATTR: u64 = 2603;
const CLASS_TLSMODELATTR: u64 = 2604;
const CLASS_ACQUIREDBEFOREATTR: u64 = 2605;
const CLASS_PASCALATTR: u64 = 2606;
const CLASS_MSPROPERTYREFEXPR: u64 = 2607;
const METHOD_GETSOURCERANGE_48: u64 = 2608;
const METHOD_ISIMPLICITACCESS_1: u64 = 2609;
const METHOD_GETBEGINLOC_93: u64 = 2610;
const METHOD_GETENDLOC_92: u64 = 2611;
const METHOD_CHILDREN_81: u64 = 2612;
const METHOD_GETBASEEXPR: u64 = 2613;
const METHOD_GETPROPERTYDECL: u64 = 2614;
const METHOD_ISARROW_3: u64 = 2615;
const METHOD_GETMEMBERLOC_1: u64 = 2616;
const METHOD_GETQUALIFIERLOC_13: u64 = 2617;
const CLASS_NOESCAPEATTR: u64 = 2618;
const CLASS_STRICTFPATTR: u64 = 2619;
const CLASS_ABSTRACTCONDITIONALOPERATOR: u64 = 2620;
const METHOD_GETCOND: u64 = 2621;
const METHOD_GETTRUEEXPR: u64 = 2622;
const METHOD_GETFALSEEXPR: u64 = 2623;
const METHOD_GETQUESTIONLOC: u64 = 2624;
const METHOD_GETCOLONLOC_1: u64 = 2625;
const CLASS_ATTR: u64 = 2626;
const CLASS_VISIBILITYATTR: u64 = 2627;
const CLASS_EMPTYBASESATTR: u64 = 2628;
const CLASS_OBJCREQUIRESPROPERTYDEFSATTR: u64 = 2629;
const CLASS_CLASSTEMPLATESPECIALIZATIONDECL: u64 = 2630;
const METHOD_GETSPECIALIZEDTEMPLATE: u64 = 2631;
const METHOD_GETTEMPLATEARGS: u64 = 2632;
const METHOD_GETSPECIALIZATIONKIND: u64 = 2633;
const METHOD_ISEXPLICITSPECIALIZATION: u64 = 2634;
const METHOD_ISCLASSSCOPEEXPLICITSPECIALIZATION: u64 = 2635;
const METHOD_ISEXPLICITINSTANTIATIONORSPECIALIZATION: u64 = 2636;
const METHOD_GETPOINTOFINSTANTIATION: u64 = 2637;
const METHOD_GETINSTANTIATEDFROM: u64 = 2638;
const METHOD_GETSPECIALIZEDTEMPLATEORPARTIAL: u64 = 2639;
const METHOD_GETTEMPLATEINSTANTIATIONARGS: u64 = 2640;
const METHOD_GETTYPEASWRITTEN: u64 = 2641;
const METHOD_GETEXTERNLOC: u64 = 2642;
const METHOD_GETTEMPLATEKEYWORDLOC: u64 = 2643;
const METHOD_GETSOURCERANGE_3: u64 = 2644;
const CLASS_SWIFTCONTEXTATTR: u64 = 2645;
const CLASS_NODEBUGATTR: u64 = 2646;
const CLASS_INITSEGATTR: u64 = 2647;
const CLASS_USINGPACKDECL: u64 = 2648;
const METHOD_GETINSTANTIATEDFROMUSINGDECL: u64 = 2649;
const METHOD_EXPANSIONS: u64 = 2650;
const METHOD_GETSOURCERANGE_35: u64 = 2651;
const METHOD_GETCANONICALDECL_25: u64 = 2652;
const CLASS_NOMIPS16ATTR: u64 = 2653;
const CLASS_CONTINUESTMT: u64 = 2654;
const METHOD_GETCONTINUELOC: u64 = 2655;
const METHOD_GETBEGINLOC_58: u64 = 2656;
const METHOD_GETENDLOC_57: u64 = 2657;
const METHOD_CHILDREN_48: u64 = 2658;
const CLASS_EXCLUSIVETRYLOCKFUNCTIONATTR: u64 = 2659;
const CLASS_RETURNTYPESTATEATTR: u64 = 2660;
const CLASS_WEAKREFATTR: u64 = 2661;
const CLASS_RETAINATTR: u64 = 2662;
const CLASS_WEAKIMPORTATTR: u64 = 2663;
const CLASS_MACROQUALIFIEDTYPELOC: u64 = 2664;
const METHOD_GETINNERLOC: u64 = 2665;
const METHOD_GETMACROIDENTIFIER_1: u64 = 2666;
const METHOD_GETEXPANSIONLOC: u64 = 2667;
const METHOD_GETINNERTYPE_3: u64 = 2668;
const METHOD_GETLOCALSOURCERANGE_8: u64 = 2669;
const CLASS_PRAGMACLANGBSSSECTIONATTR: u64 = 2670;
const CLASS_OMPTARGETTEAMSDISTRIBUTESIMDDIRECTIVE: u64 = 2671;
const CLASS_CUDADEVICEATTR: u64 = 2672;
const CLASS_DOSTMT: u64 = 2673;
const METHOD_GETCOND_5: u64 = 2674;
const METHOD_GETBODY_7: u64 = 2675;
const METHOD_GETDOLOC: u64 = 2676;
const METHOD_GETWHILELOC: u64 = 2677;
const METHOD_GETRPARENLOC_14: u64 = 2678;
const METHOD_GETBEGINLOC_70: u64 = 2679;
const METHOD_GETENDLOC_69: u64 = 2680;
const METHOD_CHILDREN_60: u64 = 2681;
const CLASS_PTR32ATTR: u64 = 2682;
const CLASS_VECRETURNATTR: u64 = 2683;
const CLASS_TRIVIALABIATTR: u64 = 2684;
const CLASS_SELECTANYATTR: u64 = 2685;
const CLASS_SWIFTASYNCCALLATTR: u64 = 2686;
const CLASS_PACKEDATTR: u64 = 2687;
const CLASS_ADJUSTEDTYPELOC: u64 = 2688;
const METHOD_GETORIGINALLOC: u64 = 2689;
const METHOD_GETINNERTYPE_4: u64 = 2690;
const METHOD_GETLOCALSOURCERANGE_9: u64 = 2691;
const METHOD_GETLOCALDATASIZE: u64 = 2692;
const CLASS_STDCALLATTR: u64 = 2693;
const CLASS_FORMATARGATTR: u64 = 2694;
const CLASS_OBJCTYPEPARAMTYPELOC: u64 = 2695;
const CLASS_OPENCLACCESSATTR: u64 = 2696;
const CLASS_CONSTRUCTORATTR: u64 = 2697;
const CLASS_SWIFTBRIDGEDTYPEDEFATTR: u64 = 2698;
const CLASS_OWNERSHIPATTR: u64 = 2699;
const CLASS_EXPLICITCASTEXPR: u64 = 2700;
const METHOD_GETTYPEINFOASWRITTEN: u64 = 2701;
const METHOD_GETTYPEASWRITTEN_3: u64 = 2702;
const CLASS_TYPEATTR: u64 = 2703;
const CLASS_PRESERVEMOSTATTR: u64 = 2704;
const CLASS_CLASSTEMPLATEPARTIALSPECIALIZATIONDECL: u64 = 2705;
const METHOD_GETTEMPLATEPARAMETERS: u64 = 2706;
const METHOD_HASASSOCIATEDCONSTRAINTS: u64 = 2707;
const METHOD_GETTEMPLATEARGSASWRITTEN: u64 = 2708;
const METHOD_GETINSTANTIATEDFROMMEMBER: u64 = 2709;
const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_1: u64 = 2710;
const METHOD_GETINJECTEDSPECIALIZATIONTYPE_1: u64 = 2711;
const CLASS_OWNERATTR: u64 = 2712;
const CLASS_OVERRIDEATTR: u64 = 2713;
const CLASS_TYPEOFTYPE: u64 = 2714;
const METHOD_GETUNMODIFIEDTYPE: u64 = 2715;
const METHOD_DESUGAR_40: u64 = 2716;
const METHOD_ISSUGARED_40: u64 = 2717;
const METHOD_GETKIND_2: u64 = 2718;
const CLASS_ANYX86NOCALLERSAVEDREGISTERSATTR: u64 = 2719;
const CLASS_OMPMASTERDIRECTIVE: u64 = 2720;
const CLASS_NSRETURNSNOTRETAINEDATTR: u64 = 2721;
const CLASS_ALIGNEDATTR: u64 = 2722;
const CLASS_MSNOVTABLEATTR: u64 = 2723;
const CLASS_OPTIMIZENONEATTR: u64 = 2724;
const CLASS_OBJCROOTCLASSATTR: u64 = 2725;
const CLASS_OBJCRETURNSINNERPOINTERATTR: u64 = 2726;
const CLASS_VARIABLEARRAYTYPE: u64 = 2727;
const METHOD_GETSIZEEXPR_4: u64 = 2728;
const METHOD_GETBRACKETSRANGE_1: u64 = 2729;
const METHOD_GETLBRACKETLOC_1: u64 = 2730;
const METHOD_GETRBRACKETLOC_1: u64 = 2731;
const METHOD_ISSUGARED_45: u64 = 2732;
const METHOD_DESUGAR_45: u64 = 2733;
const CLASS_ALIASATTR: u64 = 2734;
const CLASS_NODESTROYATTR: u64 = 2735;
const CLASS_OPENCLGLOBALADDRESSSPACEATTR: u64 = 2736;
const CLASS_WEBASSEMBLYIMPORTNAMEATTR: u64 = 2737;
const CLASS_OBJCREQUIRESSUPERATTR: u64 = 2738;
const CLASS_DISABLETAILCALLSATTR: u64 = 2739;
const CLASS_COMPOUNDASSIGNOPERATOR: u64 = 2740;
const METHOD_GETCOMPUTATIONLHSTYPE: u64 = 2741;
const METHOD_GETCOMPUTATIONRESULTTYPE: u64 = 2742;
const CLASS_FORMATATTR: u64 = 2743;
const CLASS_SWIFTCALLATTR: u64 = 2744;
const CLASS_OBJCOWNERSHIPATTR: u64 = 2745;
const CLASS_OMPPARALLELDIRECTIVE: u64 = 2746;
const CLASS_OMPMASKEDTASKLOOPDIRECTIVE: u64 = 2747;
const CLASS_AMDGPUNUMSGPRATTR: u64 = 2748;
const CLASS_SWIFTASYNCNAMEATTR: u64 = 2749;
const CLASS_OBJCINDEPENDENTCLASSATTR: u64 = 2750;
const CLASS_OBJCEXCEPTIONATTR: u64 = 2751;
const CLASS_BTFTYPETAGATTR: u64 = 2752;
const CLASS_OBJCBRIDGERELATEDATTR: u64 = 2753;
const CLASS_IBOUTLETCOLLECTIONATTR: u64 = 2754;
const CLASS_UNINITIALIZEDATTR: u64 = 2755;
const CLASS_UPTRATTR: u64 = 2756;
const CLASS_OSRETURNSRETAINEDATTR: u64 = 2757;
const CLASS_OSRETURNSNOTRETAINEDATTR: u64 = 2758;
const CLASS_OBJCSUBCLASSINGRESTRICTEDATTR: u64 = 2759;
const CLASS_OMPTHREADPRIVATEDECLATTR: u64 = 2760;
const CLASS_VARTEMPLATESPECIALIZATIONDECL: u64 = 2761;
const METHOD_GETSPECIALIZEDTEMPLATE_1: u64 = 2762;
const METHOD_GETTEMPLATEARGS_1: u64 = 2763;
const METHOD_GETTEMPLATEARGSINFO: u64 = 2764;
const METHOD_GETSPECIALIZATIONKIND_1: u64 = 2765;
const METHOD_ISEXPLICITSPECIALIZATION_1: u64 = 2766;
const METHOD_ISCLASSSCOPEEXPLICITSPECIALIZATION_1: u64 = 2767;
const METHOD_ISEXPLICITINSTANTIATIONORSPECIALIZATION_1: u64 = 2768;
const METHOD_GETPOINTOFINSTANTIATION_3: u64 = 2769;
const METHOD_GETINSTANTIATEDFROM_1: u64 = 2770;
const METHOD_GETSPECIALIZEDTEMPLATEORPARTIAL_1: u64 = 2771;
const METHOD_GETTEMPLATEINSTANTIATIONARGS_1: u64 = 2772;
const METHOD_GETTYPEASWRITTEN_1: u64 = 2773;
const METHOD_GETEXTERNLOC_2: u64 = 2774;
const METHOD_GETTEMPLATEKEYWORDLOC_1: u64 = 2775;
const METHOD_GETSOURCERANGE_38: u64 = 2776;
const CLASS_UNARYTRANSFORMTYPE: u64 = 2777;
const METHOD_ISSUGARED_42: u64 = 2778;
const METHOD_DESUGAR_42: u64 = 2779;
const METHOD_GETUNDERLYINGTYPE_2: u64 = 2780;
const METHOD_GETBASETYPE: u64 = 2781;
const METHOD_GETUTTKIND: u64 = 2782;
const CLASS_CONSTANTARRAYTYPE: u64 = 2783;
const METHOD_GETSIZE: u64 = 2784;
const METHOD_GETSIZEEXPR: u64 = 2785;
const METHOD_ISSUGARED_8: u64 = 2786;
const METHOD_DESUGAR_8: u64 = 2787;
const CLASS_OMPALLOCATEDECLATTR: u64 = 2788;
const CLASS_NOUNIQUEADDRESSATTR: u64 = 2789;
const CLASS_NOTHREADSAFETYANALYSISATTR: u64 = 2790;
const CLASS_SUBSTNONTYPETEMPLATEPARMEXPR: u64 = 2791;
const METHOD_GETNAMELOC_1: u64 = 2792;
const METHOD_GETBEGINLOC_120: u64 = 2793;
const METHOD_GETENDLOC_119: u64 = 2794;
const METHOD_GETREPLACEMENT: u64 = 2795;
const METHOD_GETASSOCIATEDDECL_2: u64 = 2796;
const METHOD_GETINDEX_4: u64 = 2797;
const METHOD_GETPACKINDEX_1: u64 = 2798;
const METHOD_GETPARAMETER: u64 = 2799;
const METHOD_ISREFERENCEPARAMETER: u64 = 2800;
const METHOD_CHILDREN_108: u64 = 2801;
const CLASS_RVALUEREFERENCETYPELOC: u64 = 2802;
const METHOD_GETAMPAMPLOC_1: u64 = 2803;
const CLASS_CXXDELETEEXPR: u64 = 2804;
const METHOD_ISGLOBALDELETE: u64 = 2805;
const METHOD_ISARRAYFORM: u64 = 2806;
const METHOD_ISARRAYFORMASWRITTEN: u64 = 2807;
const METHOD_DOESUSUALARRAYDELETEWANTSIZE: u64 = 2808;
const METHOD_GETOPERATORDELETE_1: u64 = 2809;
const METHOD_GETARGUMENT: u64 = 2810;
const METHOD_GETDESTROYEDTYPE: u64 = 2811;
const METHOD_GETBEGINLOC_25: u64 = 2812;
const METHOD_GETENDLOC_24: u64 = 2813;
const METHOD_CHILDREN_19: u64 = 2814;
const CLASS_PARMVARDECL: u64 = 2815;
const METHOD_GETSOURCERANGE_21: u64 = 2816;
const METHOD_ISOBJCMETHODPARAMETER: u64 = 2817;
const METHOD_ISDESTROYEDINCALLEE: u64 = 2818;
const METHOD_GETFUNCTIONSCOPEDEPTH: u64 = 2819;
const METHOD_GETFUNCTIONSCOPEINDEX: u64 = 2820;
const METHOD_GETOBJCDECLQUALIFIER: u64 = 2821;
const METHOD_ISKNRPROMOTED: u64 = 2822;
const METHOD_ISEXPLICITOBJECTPARAMETER: u64 = 2823;
const METHOD_GETEXPLICITOBJECTPARAMTHISLOC: u64 = 2824;
const METHOD_GETDEFAULTARG: u64 = 2825;
const METHOD_GETDEFAULTARGRANGE: u64 = 2826;
const METHOD_GETUNINSTANTIATEDDEFAULTARG: u64 = 2827;
const METHOD_HASDEFAULTARG: u64 = 2828;
const METHOD_HASUNPARSEDDEFAULTARG: u64 = 2829;
const METHOD_HASUNINSTANTIATEDDEFAULTARG: u64 = 2830;
const METHOD_HASINHERITEDDEFAULTARG: u64 = 2831;
const METHOD_GETORIGINALTYPE_1: u64 = 2832;
const CLASS_OBJCPRECISELIFETIMEATTR: u64 = 2833;
const CLASS_OMPCAPTUREDEXPRDECL: u64 = 2834;
const CLASS_ARMINTERRUPTATTR: u64 = 2835;
const CLASS_NOSPECULATIVELOADHARDENINGATTR: u64 = 2836;
const CLASS_LABELDECL: u64 = 2837;
const METHOD_GETSTMT: u64 = 2838;
const METHOD_ISGNULOCAL: u64 = 2839;
const METHOD_GETSOURCERANGE_16: u64 = 2840;
const METHOD_ISMSASMLABEL: u64 = 2841;
const METHOD_ISRESOLVEDMSASMLABEL: u64 = 2842;
const METHOD_GETMSASMLABEL: u64 = 2843;
const CLASS_NORETURNATTR: u64 = 2844;
const CLASS_REDECLARABLETEMPLATEDECL: u64 = 2845;
const METHOD_GETCANONICALDECL_16: u64 = 2846;
const METHOD_ISMEMBERSPECIALIZATION: u64 = 2847;
const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_3: u64 = 2848;
const CLASS_OPENCLLOCALADDRESSSPACEATTR: u64 = 2849;
const CLASS_UNNAMEDGLOBALCONSTANTDECL: u64 = 2850;
const METHOD_GETVALUE_3: u64 = 2851;
const CLASS_M68KINTERRUPTATTR: u64 = 2852;
const CLASS_ENABLEIFATTR: u64 = 2853;
const CLASS_NOMICROMIPSATTR: u64 = 2854;
const CLASS_ARMPRESERVESATTR: u64 = 2855;
const CLASS_OMPALLOCATEDECL: u64 = 2856;
const CLASS_NOCOMMONATTR: u64 = 2857;
const CLASS_CUDACONSTANTATTR: u64 = 2858;
const CLASS_TEMPLATEPARAMOBJECTDECL: u64 = 2859;
const METHOD_GETVALUE_2: u64 = 2860;
const METHOD_GETCANONICALDECL_18: u64 = 2861;
const CLASS_NOINSTRUMENTFUNCTIONATTR: u64 = 2862;
const CLASS_UNSAFEBUFFERUSAGEATTR: u64 = 2863;
const CLASS_MAYALIASATTR: u64 = 2864;
const CLASS_NODUPLICATEATTR: u64 = 2865;
const CLASS_OMPDISTRIBUTEPARALLELFORSIMDDIRECTIVE: u64 = 2866;
const CLASS_OBJCNSOBJECTATTR: u64 = 2867;
const CLASS_OBJCBRIDGEATTR: u64 = 2868;
const CLASS_ENUMEXTENSIBILITYATTR: u64 = 2869;
const CLASS_OBJCEXPLICITPROTOCOLIMPLATTR: u64 = 2870;
const CLASS_NOALIASATTR: u64 = 2871;
const CLASS_OMPTARGETTEAMSDISTRIBUTEDIRECTIVE: u64 = 2872;
const CLASS_DECAYEDTYPELOC: u64 = 2873;
const CLASS_ARTIFICIALATTR: u64 = 2874;
const CLASS_TYPEALIASDECL: u64 = 2875;
const METHOD_GETSOURCERANGE_28: u64 = 2876;
const METHOD_GETDESCRIBEDALIASTEMPLATE: u64 = 2877;
const CLASS_CODEMODELATTR: u64 = 2878;
const CLASS_PREFERREDTYPEATTR: u64 = 2879;
const CLASS_MIPSSHORTCALLATTR: u64 = 2880;
const CLASS_CONSTANTMATRIXTYPELOC: u64 = 2881;
const CLASS_MINVECTORWIDTHATTR: u64 = 2882;
const CLASS_CORETURNSTMT: u64 = 2883;
const METHOD_GETKEYWORDLOC: u64 = 2884;
const METHOD_GETOPERAND_1: u64 = 2885;
const METHOD_GETPROMISECALL: u64 = 2886;
const METHOD_ISIMPLICIT_3: u64 = 2887;
const METHOD_GETBEGINLOC_60: u64 = 2888;
const METHOD_GETENDLOC_59: u64 = 2889;
const METHOD_CHILDREN_50: u64 = 2890;
const CLASS_DEPENDENTSIZEDEXTVECTORTYPE: u64 = 2891;
const METHOD_GETSIZEEXPR_2: u64 = 2892;
const METHOD_GETELEMENTTYPE_2: u64 = 2893;
const METHOD_GETATTRIBUTELOC_1: u64 = 2894;
const METHOD_ISSUGARED_15: u64 = 2895;
const METHOD_DESUGAR_15: u64 = 2896;
const CLASS_OMPTEAMSDISTRIBUTESIMDDIRECTIVE: u64 = 2897;
const CLASS_NSERRORDOMAINATTR: u64 = 2898;
const CLASS_OMPARRAYSHAPINGEXPR: u64 = 2899;
const CLASS_MIPSINTERRUPTATTR: u64 = 2900;
const CLASS_OMPTARGETTEAMSDIRECTIVE: u64 = 2901;
const CLASS_UNRESOLVEDUSINGTYPE: u64 = 2902;
const METHOD_GETDECL_6: u64 = 2903;
const METHOD_ISSUGARED_43: u64 = 2904;
const METHOD_DESUGAR_43: u64 = 2905;
const CLASS_DEPENDENTSIZEDEXTVECTORTYPELOC: u64 = 2906;
const METHOD_GETNAMELOC_5: u64 = 2907;
const METHOD_GETLOCALSOURCERANGE_10: u64 = 2908;
const METHOD_GETELEMENTLOC: u64 = 2909;
const METHOD_GETINNERTYPE_5: u64 = 2910;
const CLASS_RANDOMIZELAYOUTATTR: u64 = 2911;
const CLASS_OMPDECLARESIMDDECLATTR: u64 = 2912;
const CLASS_CXXUNRESOLVEDCONSTRUCTEXPR: u64 = 2913;
const METHOD_GETTYPEASWRITTEN_2: u64 = 2914;
const METHOD_GETTYPESOURCEINFO_4: u64 = 2915;
const METHOD_GETLPARENLOC_3: u64 = 2916;
const METHOD_GETRPARENLOC_10: u64 = 2917;
const METHOD_ISLISTINITIALIZATION_2: u64 = 2918;
const METHOD_GETNUMARGS_2: u64 = 2919;
const METHOD_ARG_BEGIN_2: u64 = 2920;
const METHOD_ARG_END_2: u64 = 2921;
const METHOD_ARGUMENTS_1: u64 = 2922;
const METHOD_GETBEGINLOC_46: u64 = 2923;
const METHOD_GETENDLOC_45: u64 = 2924;
const METHOD_CHILDREN_35: u64 = 2925;
const CLASS_IMPORTDECL: u64 = 2926;
const METHOD_GETIMPORTEDMODULE: u64 = 2927;
const METHOD_GETIDENTIFIERLOCS: u64 = 2928;
const METHOD_GETSOURCERANGE_15: u64 = 2929;
const CLASS_MINSIZEATTR: u64 = 2930;
const CLASS_HLSLBUFFERDECL: u64 = 2931;
const METHOD_GETSOURCERANGE_14: u64 = 2932;
const METHOD_GETLOCSTART: u64 = 2933;
const METHOD_GETLBRACELOC: u64 = 2934;
const METHOD_GETRBRACELOC_1: u64 = 2935;
const METHOD_ISCBUFFER: u64 = 2936;
const CLASS_PIPETYPELOC: u64 = 2937;
const METHOD_GETVALUELOC: u64 = 2938;
const METHOD_GETLOCALSOURCERANGE_11: u64 = 2939;
const METHOD_GETKWLOC_1: u64 = 2940;
const METHOD_GETINNERTYPE_6: u64 = 2941;
const CLASS_UNAVAILABLEATTR: u64 = 2942;
const CLASS_MODEATTR: u64 = 2943;
const CLASS_OMPTARGETSIMDDIRECTIVE: u64 = 2944;
const CLASS_MICROMIPSATTR: u64 = 2945;
const CLASS_MSPROPERTYSUBSCRIPTEXPR: u64 = 2946;
const METHOD_GETBASE_4: u64 = 2947;
const METHOD_GETIDX_1: u64 = 2948;
const METHOD_GETBEGINLOC_94: u64 = 2949;
const METHOD_GETENDLOC_93: u64 = 2950;
const METHOD_GETRBRACKETLOC_3: u64 = 2951;
const METHOD_GETEXPRLOC_7: u64 = 2952;
const METHOD_CHILDREN_82: u64 = 2953;
const CLASS_OMPDEPOBJDIRECTIVE: u64 = 2954;
const CLASS_CPUSPECIFICATTR: u64 = 2955;
const CLASS_UNUSEDATTR: u64 = 2956;
const CLASS_SWIFTATTRATTR: u64 = 2957;
const CLASS_MAYBEUNDEFATTR: u64 = 2958;
const CLASS_OMPORDEREDDIRECTIVE: u64 = 2959;
const CLASS_QUALIFIEDTYPELOC: u64 = 2960;
const METHOD_GETLOCALSOURCERANGE_12: u64 = 2961;
const METHOD_GETUNQUALIFIEDLOC: u64 = 2962;
const METHOD_GETNEXTTYPELOC: u64 = 2963;
const METHOD_GETLOCALDATASIZE_1: u64 = 2964;
const METHOD_GETLOCALDATAALIGNMENT: u64 = 2965;
const CLASS_TYPE: u64 = 2966;
const METHOD_GETTYPECLASS: u64 = 2967;
const METHOD_ISFROMAST: u64 = 2968;
const METHOD_CONTAINSUNEXPANDEDPARAMETERPACK: u64 = 2969;
const METHOD_ISCANONICALUNQUALIFIED: u64 = 2970;
const METHOD_GETLOCALLYUNQUALIFIEDSINGLESTEPDESUGAREDTYPE: u64 = 2971;
const METHOD_ISSIZELESSTYPE: u64 = 2972;
const METHOD_ISSIZELESSBUILTINTYPE: u64 = 2973;
const METHOD_ISSIZELESSVECTORTYPE: u64 = 2974;
const METHOD_ISSVESIZELESSBUILTINTYPE: u64 = 2975;
const METHOD_ISRVVSIZELESSBUILTINTYPE: u64 = 2976;
const METHOD_ISWEBASSEMBLYEXTERNREFTYPE: u64 = 2977;
const METHOD_ISWEBASSEMBLYTABLETYPE: u64 = 2978;
const METHOD_ISSVEVLSBUILTINTYPE: u64 = 2979;
const METHOD_ISRVVVLSBUILTINTYPE: u64 = 2980;
const METHOD_ISINCOMPLETEOROBJECTTYPE: u64 = 2981;
const METHOD_ISOBJECTTYPE: u64 = 2982;
const METHOD_ISSTRUCTURALTYPE: u64 = 2983;
const METHOD_ISSTANDARDLAYOUTTYPE: u64 = 2984;
const METHOD_ISBUILTINTYPE: u64 = 2985;
const METHOD_ISPLACEHOLDERTYPE_1: u64 = 2986;
const METHOD_GETASPLACEHOLDERTYPE: u64 = 2987;
const METHOD_ISNONOVERLOADPLACEHOLDERTYPE_1: u64 = 2988;
const METHOD_ISINTEGERTYPE: u64 = 2989;
const METHOD_ISENUMERALTYPE: u64 = 2990;
const METHOD_ISSCOPEDENUMERALTYPE: u64 = 2991;
const METHOD_ISBOOLEANTYPE: u64 = 2992;
const METHOD_ISCHARTYPE: u64 = 2993;
const METHOD_ISWIDECHARTYPE: u64 = 2994;
const METHOD_ISCHAR8TYPE: u64 = 2995;
const METHOD_ISCHAR16TYPE: u64 = 2996;
const METHOD_ISCHAR32TYPE: u64 = 2997;
const METHOD_ISANYCHARACTERTYPE: u64 = 2998;
const METHOD_ISINTEGRALORENUMERATIONTYPE: u64 = 2999;
const METHOD_ISINTEGRALORUNSCOPEDENUMERATIONTYPE: u64 = 3000;
const METHOD_ISUNSCOPEDENUMERATIONTYPE: u64 = 3001;
const METHOD_ISREALFLOATINGTYPE: u64 = 3002;
const METHOD_ISCOMPLEXTYPE: u64 = 3003;
const METHOD_ISANYCOMPLEXTYPE: u64 = 3004;
const METHOD_ISFLOATINGTYPE: u64 = 3005;
const METHOD_ISHALFTYPE: u64 = 3006;
const METHOD_ISFLOAT16TYPE: u64 = 3007;
const METHOD_ISBFLOAT16TYPE: u64 = 3008;
const METHOD_ISFLOAT128TYPE: u64 = 3009;
const METHOD_ISIBM128TYPE: u64 = 3010;
const METHOD_ISREALTYPE: u64 = 3011;
const METHOD_ISARITHMETICTYPE: u64 = 3012;
const METHOD_ISVOIDTYPE: u64 = 3013;
const METHOD_ISSCALARTYPE: u64 = 3014;
const METHOD_ISAGGREGATETYPE: u64 = 3015;
const METHOD_ISFUNDAMENTALTYPE: u64 = 3016;
const METHOD_ISCOMPOUNDTYPE: u64 = 3017;
const METHOD_ISFUNCTIONTYPE: u64 = 3018;
const METHOD_ISFUNCTIONNOPROTOTYPE: u64 = 3019;
const METHOD_ISFUNCTIONPROTOTYPE: u64 = 3020;
const METHOD_ISPOINTERTYPE: u64 = 3021;
const METHOD_ISANYPOINTERTYPE: u64 = 3022;
const METHOD_ISBLOCKPOINTERTYPE: u64 = 3023;
const METHOD_ISVOIDPOINTERTYPE: u64 = 3024;
const METHOD_ISREFERENCETYPE: u64 = 3025;
const METHOD_ISLVALUEREFERENCETYPE: u64 = 3026;
const METHOD_ISRVALUEREFERENCETYPE: u64 = 3027;
const METHOD_ISOBJECTPOINTERTYPE: u64 = 3028;
const METHOD_ISFUNCTIONPOINTERTYPE_1: u64 = 3029;
const METHOD_ISFUNCTIONREFERENCETYPE: u64 = 3030;
const METHOD_ISMEMBERPOINTERTYPE: u64 = 3031;
const METHOD_ISMEMBERFUNCTIONPOINTERTYPE: u64 = 3032;
const METHOD_ISMEMBERDATAPOINTERTYPE: u64 = 3033;
const METHOD_ISARRAYTYPE: u64 = 3034;
const METHOD_ISCONSTANTARRAYTYPE: u64 = 3035;
const METHOD_ISINCOMPLETEARRAYTYPE: u64 = 3036;
const METHOD_ISVARIABLEARRAYTYPE: u64 = 3037;
const METHOD_ISDEPENDENTSIZEDARRAYTYPE: u64 = 3038;
const METHOD_ISRECORDTYPE: u64 = 3039;
const METHOD_ISCLASSTYPE: u64 = 3040;
const METHOD_ISSTRUCTURETYPE: u64 = 3041;
const METHOD_ISOBJCBOXABLERECORDTYPE: u64 = 3042;
const METHOD_ISINTERFACETYPE: u64 = 3043;
const METHOD_ISSTRUCTUREORCLASSTYPE: u64 = 3044;
const METHOD_ISUNIONTYPE: u64 = 3045;
const METHOD_ISCOMPLEXINTEGERTYPE: u64 = 3046;
const METHOD_ISVECTORTYPE: u64 = 3047;
const METHOD_ISEXTVECTORTYPE: u64 = 3048;
const METHOD_ISEXTVECTORBOOLTYPE: u64 = 3049;
const METHOD_ISMATRIXTYPE: u64 = 3050;
const METHOD_ISCONSTANTMATRIXTYPE: u64 = 3051;
const METHOD_ISDEPENDENTADDRESSSPACETYPE: u64 = 3052;
const METHOD_ISOBJCOBJECTPOINTERTYPE: u64 = 3053;
const METHOD_ISOBJCRETAINABLETYPE: u64 = 3054;
const METHOD_ISOBJCLIFETIMETYPE: u64 = 3055;
const METHOD_ISOBJCINDIRECTLIFETIMETYPE: u64 = 3056;
const METHOD_ISOBJCNSOBJECTTYPE: u64 = 3057;
const METHOD_ISOBJCINDEPENDENTCLASSTYPE: u64 = 3058;
const METHOD_ISOBJCOBJECTTYPE: u64 = 3059;
const METHOD_ISOBJCQUALIFIEDINTERFACETYPE: u64 = 3060;
const METHOD_ISOBJCQUALIFIEDIDTYPE: u64 = 3061;
const METHOD_ISOBJCQUALIFIEDCLASSTYPE: u64 = 3062;
const METHOD_ISOBJCOBJECTORINTERFACETYPE: u64 = 3063;
const METHOD_ISOBJCIDTYPE: u64 = 3064;
const METHOD_ISDECLTYPETYPE: u64 = 3065;
const METHOD_ISOBJCINERTUNSAFEUNRETAINEDTYPE: u64 = 3066;
const METHOD_ISOBJCCLASSTYPE: u64 = 3067;
const METHOD_ISOBJCCLASSORCLASSKINDOFTYPE: u64 = 3068;
const METHOD_ISOBJCSELTYPE: u64 = 3069;
const METHOD_ISOBJCBUILTINTYPE: u64 = 3070;
const METHOD_ISOBJCARCBRIDGABLETYPE: u64 = 3071;
const METHOD_ISCARCBRIDGABLETYPE: u64 = 3072;
const METHOD_ISTEMPLATETYPEPARMTYPE: u64 = 3073;
const METHOD_ISNULLPTRTYPE: u64 = 3074;
const METHOD_ISNOTHROWT: u64 = 3075;
const METHOD_ISALIGNVALT: u64 = 3076;
const METHOD_ISSTDBYTETYPE: u64 = 3077;
const METHOD_ISATOMICTYPE: u64 = 3078;
const METHOD_ISUNDEDUCEDAUTOTYPE: u64 = 3079;
const METHOD_ISTYPEDEFNAMETYPE: u64 = 3080;
const METHOD_ISOCLIMAGE1DROTYPE: u64 = 3081;
const METHOD_ISOCLIMAGE1DARRAYROTYPE: u64 = 3082;
const METHOD_ISOCLIMAGE1DBUFFERROTYPE: u64 = 3083;
const METHOD_ISOCLIMAGE2DROTYPE: u64 = 3084;
const METHOD_ISOCLIMAGE2DARRAYROTYPE: u64 = 3085;
const METHOD_ISOCLIMAGE2DDEPTHROTYPE: u64 = 3086;
const METHOD_ISOCLIMAGE2DARRAYDEPTHROTYPE: u64 = 3087;
const METHOD_ISOCLIMAGE2DMSAAROTYPE: u64 = 3088;
const METHOD_ISOCLIMAGE2DARRAYMSAAROTYPE: u64 = 3089;
const METHOD_ISOCLIMAGE2DMSAADEPTHROTYPE: u64 = 3090;
const METHOD_ISOCLIMAGE2DARRAYMSAADEPTHROTYPE: u64 = 3091;
const METHOD_ISOCLIMAGE3DROTYPE: u64 = 3092;
const METHOD_ISOCLIMAGE1DWOTYPE: u64 = 3093;
const METHOD_ISOCLIMAGE1DARRAYWOTYPE: u64 = 3094;
const METHOD_ISOCLIMAGE1DBUFFERWOTYPE: u64 = 3095;
const METHOD_ISOCLIMAGE2DWOTYPE: u64 = 3096;
const METHOD_ISOCLIMAGE2DARRAYWOTYPE: u64 = 3097;
const METHOD_ISOCLIMAGE2DDEPTHWOTYPE: u64 = 3098;
const METHOD_ISOCLIMAGE2DARRAYDEPTHWOTYPE: u64 = 3099;
const METHOD_ISOCLIMAGE2DMSAAWOTYPE: u64 = 3100;
const METHOD_ISOCLIMAGE2DARRAYMSAAWOTYPE: u64 = 3101;
const METHOD_ISOCLIMAGE2DMSAADEPTHWOTYPE: u64 = 3102;
const METHOD_ISOCLIMAGE2DARRAYMSAADEPTHWOTYPE: u64 = 3103;
const METHOD_ISOCLIMAGE3DWOTYPE: u64 = 3104;
const METHOD_ISOCLIMAGE1DRWTYPE: u64 = 3105;
const METHOD_ISOCLIMAGE1DARRAYRWTYPE: u64 = 3106;
const METHOD_ISOCLIMAGE1DBUFFERRWTYPE: u64 = 3107;
const METHOD_ISOCLIMAGE2DRWTYPE: u64 = 3108;
const METHOD_ISOCLIMAGE2DARRAYRWTYPE: u64 = 3109;
const METHOD_ISOCLIMAGE2DDEPTHRWTYPE: u64 = 3110;
const METHOD_ISOCLIMAGE2DARRAYDEPTHRWTYPE: u64 = 3111;
const METHOD_ISOCLIMAGE2DMSAARWTYPE: u64 = 3112;
const METHOD_ISOCLIMAGE2DARRAYMSAARWTYPE: u64 = 3113;
const METHOD_ISOCLIMAGE2DMSAADEPTHRWTYPE: u64 = 3114;
const METHOD_ISOCLIMAGE2DARRAYMSAADEPTHRWTYPE: u64 = 3115;
const METHOD_ISOCLIMAGE3DRWTYPE: u64 = 3116;
const METHOD_ISIMAGETYPE: u64 = 3117;
const METHOD_ISSAMPLERT: u64 = 3118;
const METHOD_ISEVENTT: u64 = 3119;
const METHOD_ISCLKEVENTT: u64 = 3120;
const METHOD_ISQUEUET: u64 = 3121;
const METHOD_ISRESERVEIDT: u64 = 3122;
const METHOD_ISOCLINTELSUBGROUPAVCMCEPAYLOADTYPE: u64 = 3123;
const METHOD_ISOCLINTELSUBGROUPAVCIMEPAYLOADTYPE: u64 = 3124;
const METHOD_ISOCLINTELSUBGROUPAVCREFPAYLOADTYPE: u64 = 3125;
const METHOD_ISOCLINTELSUBGROUPAVCSICPAYLOADTYPE: u64 = 3126;
const METHOD_ISOCLINTELSUBGROUPAVCMCERESULTTYPE: u64 = 3127;
const METHOD_ISOCLINTELSUBGROUPAVCIMERESULTTYPE: u64 = 3128;
const METHOD_ISOCLINTELSUBGROUPAVCREFRESULTTYPE: u64 = 3129;
const METHOD_ISOCLINTELSUBGROUPAVCSICRESULTTYPE: u64 = 3130;
const METHOD_ISOCLINTELSUBGROUPAVCIMERESULTSINGLEREFERENCESTREAMOUTTYPE: u64 = 3131;
const METHOD_ISOCLINTELSUBGROUPAVCIMERESULTDUALREFERENCESTREAMOUTTYPE: u64 = 3132;
const METHOD_ISOCLINTELSUBGROUPAVCIMESINGLEREFERENCESTREAMINTYPE: u64 = 3133;
const METHOD_ISOCLINTELSUBGROUPAVCIMEDUALREFERENCESTREAMINTYPE: u64 = 3134;
const METHOD_ISOCLINTELSUBGROUPAVCTYPE: u64 = 3135;
const METHOD_ISOCLEXTOPAQUETYPE: u64 = 3136;
const METHOD_ISPIPETYPE: u64 = 3137;
const METHOD_ISBITINTTYPE: u64 = 3138;
const METHOD_ISOPENCLSPECIFICTYPE: u64 = 3139;
const METHOD_ISOBJCARCIMPLICITLYUNRETAINEDTYPE: u64 = 3140;
const METHOD_ISCUDADEVICEBUILTINSURFACETYPE: u64 = 3141;
const METHOD_ISCUDADEVICEBUILTINTEXTURETYPE: u64 = 3142;
const METHOD_GETOBJCARCIMPLICITLIFETIME: u64 = 3143;
const METHOD_GETSCALARTYPEKIND: u64 = 3144;
const METHOD_GETDEPENDENCE: u64 = 3145;
const METHOD_CONTAINSERRORS: u64 = 3146;
const METHOD_ISDEPENDENTTYPE_1: u64 = 3147;
const METHOD_ISINSTANTIATIONDEPENDENTTYPE: u64 = 3148;
const METHOD_ISUNDEDUCEDTYPE: u64 = 3149;
const METHOD_ISVARIABLYMODIFIEDTYPE: u64 = 3150;
const METHOD_HASSIZEDVLATYPE: u64 = 3151;
const METHOD_HASUNNAMEDORLOCALTYPE: u64 = 3152;
const METHOD_ISOVERLOADABLETYPE: u64 = 3153;
const METHOD_ISELABORATEDTYPESPECIFIER: u64 = 3154;
const METHOD_CANDECAYTOPOINTERTYPE: u64 = 3155;
const METHOD_HASPOINTERREPRESENTATION: u64 = 3156;
const METHOD_HASOBJCPOINTERREPRESENTATION: u64 = 3157;
const METHOD_HASINTEGERREPRESENTATION: u64 = 3158;
const METHOD_HASSIGNEDINTEGERREPRESENTATION: u64 = 3159;
const METHOD_HASUNSIGNEDINTEGERREPRESENTATION: u64 = 3160;
const METHOD_HASFLOATINGREPRESENTATION: u64 = 3161;
const METHOD_GETASSTRUCTURETYPE: u64 = 3162;
const METHOD_GETASUNIONTYPE: u64 = 3163;
const METHOD_GETASCOMPLEXINTEGERTYPE: u64 = 3164;
const METHOD_GETASOBJCINTERFACETYPE: u64 = 3165;
const METHOD_GETASOBJCINTERFACEPOINTERTYPE: u64 = 3166;
const METHOD_GETASOBJCQUALIFIEDIDTYPE: u64 = 3167;
const METHOD_GETASOBJCQUALIFIEDCLASSTYPE: u64 = 3168;
const METHOD_GETASOBJCQUALIFIEDINTERFACETYPE: u64 = 3169;
const METHOD_GETASCXXRECORDDECL: u64 = 3170;
const METHOD_GETASRECORDDECL: u64 = 3171;
const METHOD_GETASTAGDECL: u64 = 3172;
const METHOD_GETPOINTEECXXRECORDDECL: u64 = 3173;
const METHOD_GETCONTAINEDDEDUCEDTYPE: u64 = 3174;
const METHOD_GETCONTAINEDAUTOTYPE: u64 = 3175;
const METHOD_HASAUTOFORTRAILINGRETURNTYPE: u64 = 3176;
const METHOD_GETASARRAYTYPEUNSAFE: u64 = 3177;
const METHOD_CASTASARRAYTYPEUNSAFE: u64 = 3178;
const METHOD_GETBASEELEMENTTYPEUNSAFE: u64 = 3179;
const METHOD_GETARRAYELEMENTTYPENOTYPEQUAL: u64 = 3180;
const METHOD_GETPOINTEEORARRAYELEMENTTYPE: u64 = 3181;
const METHOD_GETPOINTEETYPE_6: u64 = 3182;
const METHOD_GETUNQUALIFIEDDESUGAREDTYPE: u64 = 3183;
const METHOD_ISSIGNEDINTEGERTYPE: u64 = 3184;
const METHOD_ISUNSIGNEDINTEGERTYPE: u64 = 3185;
const METHOD_ISSIGNEDINTEGERORENUMERATIONTYPE: u64 = 3186;
const METHOD_ISUNSIGNEDINTEGERORENUMERATIONTYPE: u64 = 3187;
const METHOD_ISFIXEDPOINTTYPE: u64 = 3188;
const METHOD_ISFIXEDPOINTORINTEGERTYPE: u64 = 3189;
const METHOD_ISSATURATEDFIXEDPOINTTYPE: u64 = 3190;
const METHOD_ISUNSATURATEDFIXEDPOINTTYPE: u64 = 3191;
const METHOD_ISSIGNEDFIXEDPOINTTYPE: u64 = 3192;
const METHOD_ISUNSIGNEDFIXEDPOINTTYPE: u64 = 3193;
const METHOD_ISCONSTANTSIZETYPE: u64 = 3194;
const METHOD_ISSPECIFIERTYPE: u64 = 3195;
const METHOD_GETLINKAGE: u64 = 3196;
const METHOD_GETVISIBILITY: u64 = 3197;
const METHOD_ISVISIBILITYEXPLICIT: u64 = 3198;
const METHOD_GETLINKAGEANDVISIBILITY: u64 = 3199;
const METHOD_ISLINKAGEVALID_1: u64 = 3200;
const METHOD_GETNULLABILITY: u64 = 3201;
const METHOD_ACCEPTSOBJCTYPEPARAMS: u64 = 3202;
const METHOD_GETTYPECLASSNAME: u64 = 3203;
const METHOD_GETCANONICALTYPEINTERNAL: u64 = 3204;
const METHOD_GETCANONICALTYPEUNQUALIFIED: u64 = 3205;
const CLASS_HLSLSHADERATTR: u64 = 3206;
const CLASS_MSVTORDISPATTR: u64 = 3207;
const CLASS_CONSTANTARRAYTYPELOC: u64 = 3208;
const CLASS_TAGTYPE: u64 = 3209;
const METHOD_GETDECL_3: u64 = 3210;
const METHOD_ISBEINGDEFINED: u64 = 3211;
const CLASS_MSSTRUCTATTR: u64 = 3212;
const CLASS_TYPEDEFDECL: u64 = 3213;
const METHOD_GETSOURCERANGE_30: u64 = 3214;
const CLASS_TEMPLATESPECIALIZATIONTYPELOC: u64 = 3215;
const METHOD_GETTEMPLATEKEYWORDLOC_7: u64 = 3216;
const METHOD_GETLANGLELOC_5: u64 = 3217;
const METHOD_GETRANGLELOC_5: u64 = 3218;
const METHOD_GETNUMARGS_5: u64 = 3219;
const METHOD_GETTEMPLATENAMELOC_1: u64 = 3220;
const METHOD_GETLOCALSOURCERANGE_13: u64 = 3221;
const METHOD_GETEXTRALOCALDATASIZE_2: u64 = 3222;
const METHOD_GETEXTRALOCALDATAALIGNMENT_2: u64 = 3223;
const CLASS_ZEROCALLUSEDREGSATTR: u64 = 3224;
const CLASS_CFICANONICALJUMPTABLEATTR: u64 = 3225;
const CLASS_MAXFIELDALIGNMENTATTR: u64 = 3226;
const CLASS_NAMESPACEDECL: u64 = 3227;
const METHOD_ISANONYMOUSNAMESPACE: u64 = 3228;
const METHOD_ISINLINE: u64 = 3229;
const METHOD_ISNESTED: u64 = 3230;
const METHOD_GETORIGINALNAMESPACE: u64 = 3231;
const METHOD_ISORIGINALNAMESPACE: u64 = 3232;
const METHOD_GETANONYMOUSNAMESPACE: u64 = 3233;
const METHOD_GETCANONICALDECL_15: u64 = 3234;
const METHOD_GETSOURCERANGE_19: u64 = 3235;
const METHOD_GETBEGINLOC_2: u64 = 3236;
const METHOD_GETRBRACELOC_3: u64 = 3237;
const CLASS_MSP430INTERRUPTATTR: u64 = 3238;
const CLASS_NSCONSUMEDATTR: u64 = 3239;
const CLASS_OPENCLGLOBALHOSTADDRESSSPACEATTR: u64 = 3240;
const CLASS_TYPEDEFTYPELOC: u64 = 3241;
const METHOD_GETTYPEDEFNAMEDECL: u64 = 3242;
const CLASS_MSINHERITANCEATTR: u64 = 3243;
const CLASS_OMPDECLAREMAPPERDECL: u64 = 3244;
const CLASS_MATRIXTYPE: u64 = 3245;
const METHOD_GETELEMENTTYPE_4: u64 = 3246;
const METHOD_ISSUGARED_27: u64 = 3247;
const METHOD_DESUGAR_27: u64 = 3248;
const CLASS_SECTIONATTR: u64 = 3249;
const CLASS_MIGSERVERROUTINEATTR: u64 = 3250;
const CLASS_NOSANITIZEATTR: u64 = 3251;
const CLASS_ARCWEAKREFUNAVAILABLEATTR: u64 = 3252;
const CLASS_NOSTACKPROTECTORATTR: u64 = 3253;
const CLASS_RELEASECAPABILITYATTR: u64 = 3254;
const CLASS_LOCKRETURNEDATTR: u64 = 3255;
const CLASS_CONVERTVECTOREXPR: u64 = 3256;
const METHOD_GETSRCEXPR_1: u64 = 3257;
const METHOD_GETTYPESOURCEINFO_6: u64 = 3258;
const METHOD_GETBUILTINLOC_3: u64 = 3259;
const METHOD_GETRPARENLOC_13: u64 = 3260;
const METHOD_GETBEGINLOC_59: u64 = 3261;
const METHOD_GETENDLOC_58: u64 = 3262;
const METHOD_CHILDREN_49: u64 = 3263;
const CLASS_TRANSLATIONUNITDECL: u64 = 3264;
const METHOD_GETASTCONTEXT_1: u64 = 3265;
const METHOD_GETANONYMOUSNAMESPACE_1: u64 = 3266;
const CLASS_LIFETIMEBOUNDATTR: u64 = 3267;
const CLASS_CONSUMABLEATTR: u64 = 3268;
const CLASS_ADJUSTEDTYPE: u64 = 3269;
const METHOD_GETORIGINALTYPE: u64 = 3270;
const METHOD_GETADJUSTEDTYPE: u64 = 3271;
const METHOD_ISSUGARED: u64 = 3272;
const METHOD_DESUGAR: u64 = 3273;
const CLASS_OBJCIVARDECL: u64 = 3274;
const CLASS_LTOVISIBILITYPUBLICATTR: u64 = 3275;
const CLASS_HIPMANAGEDATTR: u64 = 3276;
const CLASS_INTERNALLINKAGEATTR: u64 = 3277;
const CLASS_INITPRIORITYATTR: u64 = 3278;
const CLASS_TYPENULLABLEATTR: u64 = 3279;
const CLASS_EXPORTDECL: u64 = 3280;
const METHOD_GETEXPORTLOC: u64 = 3281;
const METHOD_GETRBRACELOC: u64 = 3282;
const METHOD_HASBRACES: u64 = 3283;
const METHOD_GETENDLOC_1: u64 = 3284;
const METHOD_GETSOURCERANGE_9: u64 = 3285;
const CLASS_HLSLNUMTHREADSATTR: u64 = 3286;
const CLASS_MSABIATTR: u64 = 3287;
const CLASS_USINGENUMDECL: u64 = 3288;
const METHOD_GETUSINGLOC_4: u64 = 3289;
const METHOD_GETENUMLOC: u64 = 3290;
const METHOD_GETQUALIFIER_10: u64 = 3291;
const METHOD_GETQUALIFIERLOC_7: u64 = 3292;
const METHOD_GETENUMTYPELOC: u64 = 3293;
const METHOD_GETENUMTYPE: u64 = 3294;
const METHOD_GETENUMDECL: u64 = 3295;
const METHOD_GETSOURCERANGE_34: u64 = 3296;
const METHOD_GETCANONICALDECL_24: u64 = 3297;
const CLASS_DIAGNOSEASBUILTINATTR: u64 = 3298;
const CLASS_OMPPARALLELMASKEDDIRECTIVE: u64 = 3299;
const CLASS_CXXBINDTEMPORARYEXPR: u64 = 3300;
const METHOD_GETTEMPORARY: u64 = 3301;
const METHOD_GETSUBEXPR_1: u64 = 3302;
const METHOD_GETBEGINLOC_19: u64 = 3303;
const METHOD_GETENDLOC_18: u64 = 3304;
const METHOD_CHILDREN_13: u64 = 3305;
const CLASS_OBJCEXTERNALLYRETAINEDATTR: u64 = 3306;
const CLASS_ACQUIREDAFTERATTR: u64 = 3307;
const CLASS_OPAQUEVALUEEXPR: u64 = 3308;
const METHOD_GETLOCATION_12: u64 = 3309;
const METHOD_GETBEGINLOC_101: u64 = 3310;
const METHOD_GETENDLOC_100: u64 = 3311;
const METHOD_GETEXPRLOC_10: u64 = 3312;
const METHOD_CHILDREN_89: u64 = 3313;
const METHOD_GETSOURCEEXPR: u64 = 3314;
const METHOD_ISUNIQUE: u64 = 3315;
const CLASS_IBOUTLETATTR: u64 = 3316;
const CLASS_OBJCDESIGNATEDINITIALIZERATTR: u64 = 3317;
const CLASS_CUDAINVALIDTARGETATTR: u64 = 3318;
const CLASS_GUARDEDBYATTR: u64 = 3319;
const CLASS_OFFSETOFEXPR: u64 = 3320;
const METHOD_GETOPERATORLOC_7: u64 = 3321;
const METHOD_GETRPARENLOC_19: u64 = 3322;
const METHOD_GETTYPESOURCEINFO_7: u64 = 3323;
const METHOD_GETNUMCOMPONENTS: u64 = 3324;
const METHOD_GETNUMEXPRESSIONS: u64 = 3325;
const METHOD_GETBEGINLOC_100: u64 = 3326;
const METHOD_GETENDLOC_99: u64 = 3327;
const METHOD_CHILDREN_88: u64 = 3328;
const CLASS_CXXDEDUCTIONGUIDEDECL: u64 = 3329;
const METHOD_GETEXPLICITSPECIFIER_2: u64 = 3330;
const METHOD_ISEXPLICIT_2: u64 = 3331;
const METHOD_GETDEDUCEDTEMPLATE: u64 = 3332;
const METHOD_GETCORRESPONDINGCONSTRUCTOR: u64 = 3333;
const METHOD_GETDEDUCTIONCANDIDATEKIND: u64 = 3334;
const CLASS_IBACTIONATTR: u64 = 3335;
const CLASS_OBJCCLASSSTUBATTR: u64 = 3336;
const CLASS_GNUINLINEATTR: u64 = 3337;
const CLASS_NSCONSUMESSELFATTR: u64 = 3338;
const CLASS_OPENCLINTELREQDSUBGROUPSIZEATTR: u64 = 3339;
const CLASS_MSPROPERTYDECL: u64 = 3340;
const METHOD_HASGETTER: u64 = 3341;
const METHOD_GETGETTERID: u64 = 3342;
const METHOD_HASSETTER: u64 = 3343;
const METHOD_GETSETTERID: u64 = 3344;
const CLASS_SWIFTNEWTYPEATTR: u64 = 3345;
const CLASS_DLLIMPORTATTR: u64 = 3346;
const CLASS_ENUMTYPE: u64 = 3347;
const METHOD_GETDECL: u64 = 3348;
const METHOD_ISSUGARED_19: u64 = 3349;
const METHOD_DESUGAR_19: u64 = 3350;
const CLASS_SWIFTIMPORTPROPERTYASACCESSORSATTR: u64 = 3351;
const CLASS_OBJCBOOLLITERALEXPR: u64 = 3352;
const CLASS_FLATTENATTR: u64 = 3353;
const CLASS_FLAGENUMATTR: u64 = 3354;
const CLASS_CXXNOEXCEPTEXPR: u64 = 3355;
const METHOD_GETOPERAND: u64 = 3356;
const METHOD_GETBEGINLOC_33: u64 = 3357;
const METHOD_GETENDLOC_32: u64 = 3358;
const METHOD_GETSOURCERANGE_40: u64 = 3359;
const METHOD_GETVALUE_5: u64 = 3360;
const METHOD_CHILDREN_25: u64 = 3361;
const CLASS_FASTCALLATTR: u64 = 3362;
const CLASS_DESIGNATEDINITEXPR: u64 = 3363;
const METHOD_SIZE_1: u64 = 3364;
const METHOD_DESIGNATORS: u64 = 3365;
const METHOD_GETEQUALORCOLONLOC: u64 = 3366;
const METHOD_ISDIRECTINIT_1: u64 = 3367;
const METHOD_USESGNUSYNTAX: u64 = 3368;
const METHOD_GETINIT_3: u64 = 3369;
const METHOD_GETNUMSUBEXPRS_1: u64 = 3370;
const METHOD_GETDESIGNATORSSOURCERANGE: u64 = 3371;
const METHOD_GETBEGINLOC_68: u64 = 3372;
const METHOD_GETENDLOC_67: u64 = 3373;
const METHOD_CHILDREN_58: u64 = 3374;
const CLASS_EXTERNALSOURCESYMBOLATTR: u64 = 3375;
const CLASS_DECOMPOSITIONDECL: u64 = 3376;
const METHOD_BINDINGS: u64 = 3377;
const CLASS_ALLOCALIGNATTR: u64 = 3378;
const CLASS_OBJCMETHODFAMILYATTR: u64 = 3379;
const CLASS_ENFORCETCBLEAFATTR: u64 = 3380;
const CLASS_LIKELYATTR: u64 = 3381;
const CLASS_GOTOSTMT: u64 = 3382;
const METHOD_GETLABEL_1: u64 = 3383;
const METHOD_GETGOTOLOC: u64 = 3384;
const METHOD_GETLABELLOC_1: u64 = 3385;
const METHOD_GETBEGINLOC_81: u64 = 3386;
const METHOD_GETENDLOC_80: u64 = 3387;
const METHOD_CHILDREN_70: u64 = 3388;
const CLASS_C11NORETURNATTR: u64 = 3389;
const CLASS_OMPREFERENCEDVARATTR: u64 = 3390;
const CLASS_ERRORATTR: u64 = 3391;
const CLASS_NAKEDATTR: u64 = 3392;
const CLASS_ARMNEWATTR: u64 = 3393;
const CLASS_ENUMTYPELOC: u64 = 3394;
const METHOD_GETDECL_11: u64 = 3395;
const CLASS_DEPENDENTTEMPLATESPECIALIZATIONTYPE: u64 = 3396;
const METHOD_GETQUALIFIER_1: u64 = 3397;
const METHOD_GETIDENTIFIER_1: u64 = 3398;
const METHOD_TEMPLATE_ARGUMENTS: u64 = 3399;
const METHOD_ISSUGARED_16: u64 = 3400;
const METHOD_DESUGAR_16: u64 = 3401;
const CLASS_DEPRECATEDATTR: u64 = 3402;
const CLASS_DLLIMPORTSTATICLOCALATTR: u64 = 3403;
const CLASS_ENUMCONSTANTDECL: u64 = 3404;
const METHOD_GETINITEXPR: u64 = 3405;
const METHOD_GETINITVAL: u64 = 3406;
const METHOD_GETSOURCERANGE_7: u64 = 3407;
const METHOD_GETCANONICALDECL_8: u64 = 3408;
const CLASS_WEBASSEMBLYEXPORTNAMEATTR: u64 = 3409;
const CLASS_SWIFTIMPORTASNONGENERICATTR: u64 = 3410;
const CLASS_OSCONSUMEDATTR: u64 = 3411;
const CLASS_CPUDISPATCHATTR: u64 = 3412;
const CLASS_DLLEXPORTSTATICLOCALATTR: u64 = 3413;
const CLASS_CXXSTDINITIALIZERLISTEXPR: u64 = 3414;
const METHOD_GETSUBEXPR_2: u64 = 3415;
const METHOD_GETBEGINLOC_40: u64 = 3416;
const METHOD_GETENDLOC_39: u64 = 3417;
const METHOD_GETSOURCERANGE_44: u64 = 3418;
const METHOD_CHILDREN_30: u64 = 3419;
const CLASS_COROWRAPPERATTR: u64 = 3420;
const CLASS_PARENTYPE: u64 = 3421;
const METHOD_GETINNERTYPE: u64 = 3422;
const METHOD_ISSUGARED_30: u64 = 3423;
const METHOD_DESUGAR_30: u64 = 3424;
const CLASS_OBJCIMPLEMENTATIONDECL: u64 = 3425;
const CLASS_PRAGMACOMMENTDECL: u64 = 3426;
const METHOD_GETCOMMENTKIND: u64 = 3427;
const METHOD_GETARG: u64 = 3428;
const CLASS_CONSTANTMATRIXTYPE: u64 = 3429;
const METHOD_GETNUMROWS: u64 = 3430;
const METHOD_GETNUMCOLUMNS: u64 = 3431;
const METHOD_GETNUMELEMENTSFLATTENED: u64 = 3432;
const CLASS_OMPTASKWAITDIRECTIVE: u64 = 3433;
const CLASS_BUILTINTYPE: u64 = 3434;
const METHOD_GETKIND: u64 = 3435;
const METHOD_ISSUGARED_6: u64 = 3436;
const METHOD_DESUGAR_6: u64 = 3437;
const METHOD_ISINTEGER: u64 = 3438;
const METHOD_ISSIGNEDINTEGER: u64 = 3439;
const METHOD_ISUNSIGNEDINTEGER: u64 = 3440;
const METHOD_ISFLOATINGPOINT: u64 = 3441;
const METHOD_ISSVEBOOL: u64 = 3442;
const METHOD_ISSVECOUNT: u64 = 3443;
const METHOD_ISPLACEHOLDERTYPE: u64 = 3444;
const METHOD_ISNONOVERLOADPLACEHOLDERTYPE: u64 = 3445;
const CLASS_DECAYEDTYPE: u64 = 3446;
const METHOD_GETDECAYEDTYPE: u64 = 3447;
const METHOD_GETPOINTEETYPE_1: u64 = 3448;
const CLASS_OMPPARALLELMASTERDIRECTIVE: u64 = 3449;
const CLASS_MEMBERPOINTERTYPE: u64 = 3450;
const METHOD_GETPOINTEETYPE_3: u64 = 3451;
const METHOD_ISMEMBERFUNCTIONPOINTER: u64 = 3452;
const METHOD_ISMEMBERDATAPOINTER: u64 = 3453;
const METHOD_GETCLASS: u64 = 3454;
const METHOD_GETMOSTRECENTCXXRECORDDECL: u64 = 3455;
const METHOD_ISSUGARED_28: u64 = 3456;
const METHOD_DESUGAR_28: u64 = 3457;
const CLASS_ATTRIBUTEDTYPE: u64 = 3458;
const METHOD_GETATTRKIND: u64 = 3459;
const METHOD_GETMODIFIEDTYPE: u64 = 3460;
const METHOD_GETEQUIVALENTTYPE: u64 = 3461;
const METHOD_ISSUGARED_2: u64 = 3462;
const METHOD_DESUGAR_2: u64 = 3463;
const METHOD_ISQUALIFIER: u64 = 3464;
const METHOD_ISMSTYPESPEC: u64 = 3465;
const METHOD_ISWEBASSEMBLYFUNCREFSPEC: u64 = 3466;
const METHOD_ISCALLINGCONV: u64 = 3467;
const METHOD_GETIMMEDIATENULLABILITY: u64 = 3468;
const CLASS_SEHEXCEPTSTMT: u64 = 3469;
const METHOD_GETBEGINLOC_110: u64 = 3470;
const METHOD_GETEXCEPTLOC: u64 = 3471;
const METHOD_GETENDLOC_109: u64 = 3472;
const METHOD_GETFILTEREXPR: u64 = 3473;
const METHOD_GETBLOCK: u64 = 3474;
const METHOD_CHILDREN_97: u64 = 3475;
const CLASS_CONSTATTR: u64 = 3476;
const CLASS_MATRIXTYPELOC: u64 = 3477;
const METHOD_GETATTRNAMELOC_1: u64 = 3478;
const METHOD_GETATTRROWOPERAND: u64 = 3479;
const METHOD_GETATTRCOLUMNOPERAND: u64 = 3480;
const METHOD_GETATTROPERANDPARENSRANGE_1: u64 = 3481;
const METHOD_GETLOCALSOURCERANGE_14: u64 = 3482;
const CLASS_POINTERTYPE: u64 = 3483;
const METHOD_GETPOINTEETYPE_4: u64 = 3484;
const METHOD_ISSUGARED_32: u64 = 3485;
const METHOD_DESUGAR_32: u64 = 3486;
const CLASS_CXXFOLDEXPR: u64 = 3487;
const METHOD_GETCALLEE: u64 = 3488;
const METHOD_GETLHS_2: u64 = 3489;
const METHOD_GETRHS_2: u64 = 3490;
const METHOD_ISRIGHTFOLD: u64 = 3491;
const METHOD_ISLEFTFOLD: u64 = 3492;
const METHOD_GETPATTERN_1: u64 = 3493;
const METHOD_GETINIT_1: u64 = 3494;
const METHOD_GETLPARENLOC_1: u64 = 3495;
const METHOD_GETRPARENLOC_5: u64 = 3496;
const METHOD_GETELLIPSISLOC_4: u64 = 3497;
const METHOD_GETOPERATOR: u64 = 3498;
const METHOD_GETNUMEXPANSIONS_1: u64 = 3499;
const METHOD_GETBEGINLOC_27: u64 = 3500;
const METHOD_GETENDLOC_26: u64 = 3501;
const METHOD_CHILDREN_21: u64 = 3502;
const CLASS_STMT: u64 = 3503;
const METHOD_GETSTMTCLASS: u64 = 3504;
const METHOD_GETSTMTCLASSNAME: u64 = 3505;
const METHOD_GETSOURCERANGE_49: u64 = 3506;
const METHOD_GETBEGINLOC_133: u64 = 3507;
const METHOD_GETENDLOC_132: u64 = 3508;
const METHOD_STRIPLABELLIKESTATEMENTS: u64 = 3509;
const METHOD_CHILDREN_105: u64 = 3510;
const METHOD_CHILD_BEGIN: u64 = 3511;
const METHOD_CHILD_END: u64 = 3512;
const CLASS_RETURNSTWICEATTR: u64 = 3513;
const CLASS_DISABLESANITIZERINSTRUMENTATIONATTR: u64 = 3514;
const CLASS_GUARDEDVARATTR: u64 = 3515;
const CLASS_SUBSTTEMPLATETYPEPARMTYPELOC: u64 = 3516;
const CLASS_DEPENDENTCOAWAITEXPR: u64 = 3517;
const METHOD_GETOPERAND_3: u64 = 3518;
const METHOD_GETOPERATORCOAWAITLOOKUP: u64 = 3519;
const METHOD_GETKEYWORDLOC_2: u64 = 3520;
const METHOD_GETBEGINLOC_66: u64 = 3521;
const METHOD_GETENDLOC_65: u64 = 3522;
const METHOD_CHILDREN_56: u64 = 3523;
const CLASS_BTFTAGATTRIBUTEDTYPE: u64 = 3524;
const METHOD_GETWRAPPEDTYPE: u64 = 3525;
const METHOD_GETATTR: u64 = 3526;
const METHOD_ISSUGARED_3: u64 = 3527;
const METHOD_DESUGAR_3: u64 = 3528;
const CLASS_DEPENDENTBITINTTYPE: u64 = 3529;
const METHOD_ISUNSIGNED_1: u64 = 3530;
const METHOD_ISSIGNED_1: u64 = 3531;
const METHOD_GETNUMBITSEXPR: u64 = 3532;
const METHOD_ISSUGARED_12: u64 = 3533;
const METHOD_DESUGAR_12: u64 = 3534;
const CLASS_NOPROFILEFUNCTIONATTR: u64 = 3535;
const CLASS_VECTORTYPE: u64 = 3536;
const METHOD_GETELEMENTTYPE_6: u64 = 3537;
const METHOD_GETNUMELEMENTS: u64 = 3538;
const METHOD_ISSUGARED_46: u64 = 3539;
const METHOD_DESUGAR_46: u64 = 3540;
const METHOD_GETVECTORKIND_1: u64 = 3541;
const CLASS_ATOMICTYPE: u64 = 3542;
const METHOD_GETVALUETYPE: u64 = 3543;
const METHOD_ISSUGARED_1: u64 = 3544;
const METHOD_DESUGAR_1: u64 = 3545;
const CLASS_OBJCOBJECTTYPEIMPL: u64 = 3546;
const CLASS_DECLTYPETYPE: u64 = 3547;
const METHOD_GETUNDERLYINGEXPR: u64 = 3548;
const METHOD_GETUNDERLYINGTYPE: u64 = 3549;
const METHOD_DESUGAR_9: u64 = 3550;
const METHOD_ISSUGARED_9: u64 = 3551;
const CLASS_BLOCKEXPR: u64 = 3552;
const METHOD_GETBLOCKDECL: u64 = 3553;
const METHOD_GETCARETLOCATION_1: u64 = 3554;
const METHOD_GETBODY_4: u64 = 3555;
const METHOD_GETBEGINLOC_15: u64 = 3556;
const METHOD_GETENDLOC_14: u64 = 3557;
const METHOD_GETFUNCTIONTYPE: u64 = 3558;
const METHOD_CHILDREN_11: u64 = 3559;
const CLASS_ATTRIBUTEDTYPELOC: u64 = 3560;
const METHOD_GETATTRKIND_1: u64 = 3561;
const METHOD_ISQUALIFIER_1: u64 = 3562;
const METHOD_GETMODIFIEDLOC: u64 = 3563;
const METHOD_GETATTR_1: u64 = 3564;
const METHOD_GETLOCALSOURCERANGE_15: u64 = 3565;
const METHOD_GETINNERTYPE_7: u64 = 3566;
const CLASS_OMPTASKGROUPDIRECTIVE: u64 = 3567;
const CLASS_LVALUEREFERENCETYPE: u64 = 3568;
const METHOD_ISSUGARED_25: u64 = 3569;
const METHOD_DESUGAR_25: u64 = 3570;
const CLASS_OBJCMESSAGEEXPR: u64 = 3571;
const CLASS_VECTORCALLATTR: u64 = 3572;
const CLASS_COMPLEXTYPE: u64 = 3573;
const METHOD_GETELEMENTTYPE_1: u64 = 3574;
const METHOD_ISSUGARED_7: u64 = 3575;
const METHOD_DESUGAR_7: u64 = 3576;
const CLASS_RECORDTYPE: u64 = 3577;
const METHOD_GETDECL_2: u64 = 3578;
const METHOD_HASCONSTFIELDS: u64 = 3579;
const METHOD_ISSUGARED_34: u64 = 3580;
const METHOD_DESUGAR_34: u64 = 3581;
const CLASS_OBJCOBJECTPOINTERTYPE: u64 = 3582;
const CLASS_OBJCSELECTOREXPR: u64 = 3583;
const CLASS_THREADATTR: u64 = 3584;
const CLASS_OBJCINTERFACETYPE: u64 = 3585;
const CLASS_OBJCFORCOLLECTIONSTMT: u64 = 3586;
const CLASS_INJECTEDCLASSNAMETYPELOC: u64 = 3587;
const METHOD_GETDECL_12: u64 = 3588;
const CLASS_DEPENDENTSIZEDMATRIXTYPE: u64 = 3589;
const METHOD_GETROWEXPR: u64 = 3590;
const METHOD_GETCOLUMNEXPR: u64 = 3591;
const METHOD_GETATTRIBUTELOC_2: u64 = 3592;
const CLASS_MATERIALIZETEMPORARYEXPR: u64 = 3593;
const METHOD_GETSUBEXPR_7: u64 = 3594;
const METHOD_GETSTORAGEDURATION_2: u64 = 3595;
const METHOD_GETLIFETIMEEXTENDEDTEMPORARYDECL: u64 = 3596;
const METHOD_GETEXTENDINGDECL_1: u64 = 3597;
const METHOD_GETMANGLINGNUMBER_1: u64 = 3598;
const METHOD_ISBOUNDTOLVALUEREFERENCE: u64 = 3599;
const METHOD_GETBEGINLOC_95: u64 = 3600;
const METHOD_GETENDLOC_94: u64 = 3601;
const METHOD_CHILDREN_83: u64 = 3602;
const CLASS_DEDUCEDTEMPLATESPECIALIZATIONTYPE: u64 = 3603;
const METHOD_GETTEMPLATENAME: u64 = 3604;
const CLASS_MSDEPENDENTEXISTSSTMT: u64 = 3605;
const METHOD_GETKEYWORDLOC_3: u64 = 3606;
const METHOD_ISIFEXISTS: u64 = 3607;
const METHOD_ISIFNOTEXISTS: u64 = 3608;
const METHOD_GETQUALIFIERLOC_12: u64 = 3609;
const METHOD_GETNAMEINFO_6: u64 = 3610;
const METHOD_GETSUBSTMT_4: u64 = 3611;
const METHOD_GETBEGINLOC_92: u64 = 3612;
const METHOD_GETENDLOC_91: u64 = 3613;
const METHOD_CHILDREN_80: u64 = 3614;
const CLASS_TYPEWITHKEYWORD: u64 = 3615;
const METHOD_GETKEYWORD_1: u64 = 3616;
const CLASS_DEPENDENTUNARYTRANSFORMTYPE: u64 = 3617;
const CLASS_SUBSTTEMPLATETYPEPARMPACKTYPE: u64 = 3618;
const METHOD_GETIDENTIFIER_2: u64 = 3619;
const METHOD_GETASSOCIATEDDECL: u64 = 3620;
const METHOD_GETREPLACEDPARAMETER: u64 = 3621;
const METHOD_GETINDEX: u64 = 3622;
const METHOD_GETFINAL: u64 = 3623;
const METHOD_GETNUMARGS: u64 = 3624;
const METHOD_ISSUGARED_35: u64 = 3625;
const METHOD_DESUGAR_35: u64 = 3626;
const METHOD_GETARGUMENTPACK: u64 = 3627;
const CLASS_TYPEALIASTEMPLATEDECL: u64 = 3628;
const METHOD_GETTEMPLATEDDECL_3: u64 = 3629;
const METHOD_GETCANONICALDECL_19: u64 = 3630;
const METHOD_GETPREVIOUSDECL_6: u64 = 3631;
const METHOD_GETINSTANTIATEDFROMMEMBERTEMPLATE_4: u64 = 3632;
const CLASS_SWIFTINDIRECTRESULTATTR: u64 = 3633;
const CLASS_TEMPLATETYPEPARMTYPE: u64 = 3634;
const METHOD_GETDEPTH: u64 = 3635;
const METHOD_GETINDEX_2: u64 = 3636;
const METHOD_ISPARAMETERPACK: u64 = 3637;
const METHOD_GETDECL_4: u64 = 3638;
const METHOD_GETIDENTIFIER_3: u64 = 3639;
const METHOD_ISSUGARED_38: u64 = 3640;
const METHOD_DESUGAR_38: u64 = 3641;
const CLASS_SWIFTVERSIONEDADDITIONATTR: u64 = 3642;
const CLASS_PTGUARDEDBYATTR: u64 = 3643;
const CLASS_SUBSTTEMPLATETYPEPARMPACKTYPELOC: u64 = 3644;
const CLASS_TEMPLATESPECIALIZATIONTYPE: u64 = 3645;
const METHOD_ISCURRENTINSTANTIATION: u64 = 3646;
const METHOD_ISTYPEALIAS: u64 = 3647;
const METHOD_GETALIASEDTYPE: u64 = 3648;
const METHOD_GETTEMPLATENAME_2: u64 = 3649;
const METHOD_TEMPLATE_ARGUMENTS_1: u64 = 3650;
const METHOD_ISSUGARED_37: u64 = 3651;
const METHOD_DESUGAR_37: u64 = 3652;
const CLASS_DEPENDENTTYPEOFEXPRTYPE: u64 = 3653;
const CLASS_GENERICSELECTIONEXPR: u64 = 3654;
const METHOD_GETNUMASSOCS: u64 = 3655;
const METHOD_GETRESULTINDEX: u64 = 3656;
const METHOD_ISRESULTDEPENDENT: u64 = 3657;
const METHOD_ISEXPRPREDICATE: u64 = 3658;
const METHOD_ISTYPEPREDICATE: u64 = 3659;
const METHOD_GETCONTROLLINGEXPR: u64 = 3660;
const METHOD_GETCONTROLLINGTYPE: u64 = 3661;
const METHOD_GETRESULTEXPR: u64 = 3662;
const METHOD_GETASSOCEXPRS: u64 = 3663;
const METHOD_GETASSOCTYPESOURCEINFOS: u64 = 3664;
const METHOD_ASSOCIATIONS: u64 = 3665;
const METHOD_GETGENERICLOC: u64 = 3666;
const METHOD_GETDEFAULTLOC_2: u64 = 3667;
const METHOD_GETRPARENLOC_17: u64 = 3668;
const METHOD_GETBEGINLOC_80: u64 = 3669;
const METHOD_GETENDLOC_79: u64 = 3670;
const METHOD_CHILDREN_69: u64 = 3671;
const CLASS_ARMMVESTRICTPOLYMORPHISMATTR: u64 = 3672;
const CLASS_NVPTXKERNELATTR: u64 = 3673;
const CLASS_MACROQUALIFIEDTYPE: u64 = 3674;
const METHOD_GETMACROIDENTIFIER: u64 = 3675;
const METHOD_GETUNDERLYINGTYPE_1: u64 = 3676;
const METHOD_GETMODIFIEDTYPE_1: u64 = 3677;
const METHOD_ISSUGARED_26: u64 = 3678;
const METHOD_DESUGAR_26: u64 = 3679;
const CLASS_BLOCKPOINTERTYPE: u64 = 3680;
const METHOD_GETPOINTEETYPE: u64 = 3681;
const METHOD_ISSUGARED_5: u64 = 3682;
const METHOD_DESUGAR_5: u64 = 3683;
const CLASS_TEMPLATEDECL: u64 = 3684;
const METHOD_GETTEMPLATEPARAMETERS_1: u64 = 3685;
const METHOD_HASASSOCIATEDCONSTRAINTS_1: u64 = 3686;
const METHOD_GETTEMPLATEDDECL_2: u64 = 3687;
const METHOD_ISTYPEALIAS_1: u64 = 3688;
const METHOD_GETSOURCERANGE_24: u64 = 3689;
const CLASS_DEPENDENTVECTORTYPE: u64 = 3690;
const METHOD_GETSIZEEXPR_3: u64 = 3691;
const METHOD_GETELEMENTTYPE_3: u64 = 3692;
const METHOD_GETATTRIBUTELOC_3: u64 = 3693;
const METHOD_GETVECTORKIND: u64 = 3694;
const METHOD_ISSUGARED_17: u64 = 3695;
const METHOD_DESUGAR_17: u64 = 3696;
const CLASS_RECOVERYEXPR: u64 = 3697;
const METHOD_SUBEXPRESSIONS: u64 = 3698;
const METHOD_GETBEGINLOC_107: u64 = 3699;
const METHOD_GETENDLOC_106: u64 = 3700;
const CLASS_OBJCOBJECTTYPELOC: u64 = 3701;
const CLASS_FUNCTIONPROTOTYPE: u64 = 3702;
const METHOD_GETNUMPARAMS: u64 = 3703;
const METHOD_GETPARAMTYPES: u64 = 3704;
const METHOD_GETEXTPROTOINFO: u64 = 3705;
const METHOD_GETEXCEPTIONSPECTYPE: u64 = 3706;
const METHOD_HASEXCEPTIONSPEC: u64 = 3707;
const METHOD_HASDYNAMICEXCEPTIONSPEC: u64 = 3708;
const METHOD_HASNOEXCEPTEXCEPTIONSPEC: u64 = 3709;
const METHOD_HASDEPENDENTEXCEPTIONSPEC: u64 = 3710;
const METHOD_HASINSTANTIATIONDEPENDENTEXCEPTIONSPEC: u64 = 3711;
const METHOD_GETEXCEPTIONSPECINFO: u64 = 3712;
const METHOD_GETNUMEXCEPTIONS: u64 = 3713;
const METHOD_GETNOEXCEPTEXPR: u64 = 3714;
const METHOD_GETEXCEPTIONSPECDECL: u64 = 3715;
const METHOD_GETEXCEPTIONSPECTEMPLATE: u64 = 3716;
const METHOD_CANTHROW: u64 = 3717;
const METHOD_ISVARIADIC: u64 = 3718;
const METHOD_GETELLIPSISLOC: u64 = 3719;
const METHOD_ISTEMPLATEVARIADIC: u64 = 3720;
const METHOD_HASTRAILINGRETURN: u64 = 3721;
const METHOD_GETMETHODQUALS: u64 = 3722;
const METHOD_GETREFQUALIFIER: u64 = 3723;
const METHOD_PARAM_TYPES: u64 = 3724;
const METHOD_PARAM_TYPE_BEGIN: u64 = 3725;
const METHOD_PARAM_TYPE_END: u64 = 3726;
const METHOD_EXCEPTIONS: u64 = 3727;
const METHOD_EXCEPTION_BEGIN: u64 = 3728;
const METHOD_EXCEPTION_END: u64 = 3729;
const METHOD_HASEXTPARAMETERINFOS: u64 = 3730;
const METHOD_GETEXTPARAMETERINFOS: u64 = 3731;
const METHOD_GETEXTPARAMETERINFOSORNULL: u64 = 3732;
const METHOD_GETAARCH64SMEATTRIBUTES: u64 = 3733;
const METHOD_ISSUGARED_22: u64 = 3734;
const METHOD_DESUGAR_22: u64 = 3735;
const CLASS_PSEUDOOBJECTEXPR: u64 = 3736;
const METHOD_GETSYNTACTICFORM_1: u64 = 3737;
const METHOD_GETRESULTEXPRINDEX: u64 = 3738;
const METHOD_GETRESULTEXPR_1: u64 = 3739;
const METHOD_GETNUMSEMANTICEXPRS: u64 = 3740;
const METHOD_SEMANTICS_BEGIN: u64 = 3741;
const METHOD_SEMANTICS_END: u64 = 3742;
const METHOD_SEMANTICS: u64 = 3743;
const METHOD_GETEXPRLOC_11: u64 = 3744;
const METHOD_GETBEGINLOC_106: u64 = 3745;
const METHOD_GETENDLOC_105: u64 = 3746;
const METHOD_CHILDREN_94: u64 = 3747;
const CLASS_PTGUARDEDVARATTR: u64 = 3748;
const CLASS_EXTVECTORTYPE: u64 = 3749;
const METHOD_ISSUGARED_20: u64 = 3750;
const METHOD_DESUGAR_20: u64 = 3751;
const CLASS_AMDGPUNUMVGPRATTR: u64 = 3752;
const CLASS_DEPENDENTADDRESSSPACETYPE: u64 = 3753;
const METHOD_GETADDRSPACEEXPR: u64 = 3754;
const METHOD_GETPOINTEETYPE_2: u64 = 3755;
const METHOD_GETATTRIBUTELOC: u64 = 3756;
const METHOD_ISSUGARED_11: u64 = 3757;
const METHOD_DESUGAR_11: u64 = 3758;
const CLASS_ARMINATTR: u64 = 3759;
const CLASS_PIPETYPE: u64 = 3760;
const METHOD_GETELEMENTTYPE_5: u64 = 3761;
const METHOD_ISSUGARED_31: u64 = 3762;
const METHOD_DESUGAR_31: u64 = 3763;
const METHOD_ISREADONLY: u64 = 3764;
const CLASS_ARRAYTYPE: u64 = 3765;
const METHOD_GETELEMENTTYPE: u64 = 3766;
const METHOD_GETSIZEMODIFIER: u64 = 3767;
const METHOD_GETINDEXTYPEQUALIFIERS: u64 = 3768;
const METHOD_GETINDEXTYPECVRQUALIFIERS: u64 = 3769;
const CLASS_OMPCANCELDIRECTIVE: u64 = 3770;
const CLASS_TYPOEXPR: u64 = 3771;
const METHOD_CHILDREN_112: u64 = 3772;
const METHOD_GETBEGINLOC_125: u64 = 3773;
const METHOD_GETENDLOC_124: u64 = 3774;
const CLASS_FINALATTR: u64 = 3775;
const CLASS_VARIABLEARRAYTYPELOC: u64 = 3776;
const CLASS_WHILESTMT: u64 = 3777;
const METHOD_HASVARSTORAGE_2: u64 = 3778;
const METHOD_GETCOND_9: u64 = 3779;
const METHOD_GETBODY_12: u64 = 3780;
const METHOD_GETCONDITIONVARIABLE_3: u64 = 3781;
const METHOD_GETCONDITIONVARIABLEDECLSTMT_3: u64 = 3782;
const METHOD_GETWHILELOC_1: u64 = 3783;
const METHOD_GETLPARENLOC_11: u64 = 3784;
const METHOD_GETRPARENLOC_28: u64 = 3785;
const METHOD_GETBEGINLOC_132: u64 = 3786;
const METHOD_GETENDLOC_131: u64 = 3787;
const METHOD_CHILDREN_118: u64 = 3788;
const CLASS_UNRESOLVEDUSINGIFEXISTSDECL: u64 = 3789;
const CLASS_OBJCOBJECTPOINTERTYPELOC: u64 = 3790;
const CLASS_VECTORTYPELOC: u64 = 3791;
const METHOD_GETNAMELOC_6: u64 = 3792;
const METHOD_GETLOCALSOURCERANGE_16: u64 = 3793;
const METHOD_GETELEMENTLOC_1: u64 = 3794;
const METHOD_GETINNERTYPE_8: u64 = 3795;
const CLASS_TYPELOC: u64 = 3796;
const METHOD_GETTYPELOCCLASS: u64 = 3797;
const METHOD_ISNULL: u64 = 3798;
const METHOD_GETTYPE_2: u64 = 3799;
const METHOD_GETTYPEPTR: u64 = 3800;
const METHOD_GETOPAQUEDATA: u64 = 3801;
const METHOD_GETBEGINLOC_134: u64 = 3802;
const METHOD_GETENDLOC_133: u64 = 3803;
const METHOD_GETSOURCERANGE_50: u64 = 3804;
const METHOD_GETLOCALSOURCERANGE_17: u64 = 3805;
const METHOD_GETFULLDATASIZE: u64 = 3806;
const METHOD_GETNEXTTYPELOC_1: u64 = 3807;
const METHOD_GETUNQUALIFIEDLOC_1: u64 = 3808;
const METHOD_IGNOREPARENS_1: u64 = 3809;
const METHOD_FINDEXPLICITQUALIFIERLOC: u64 = 3810;
const METHOD_GETCONTAINEDAUTOTYPELOC: u64 = 3811;
const METHOD_FINDNULLABILITYLOC: u64 = 3812;
const CLASS_ATOMICTYPELOC: u64 = 3813;
const METHOD_GETVALUELOC_1: u64 = 3814;
const METHOD_GETLOCALSOURCERANGE_18: u64 = 3815;
const METHOD_GETKWLOC_2: u64 = 3816;
const METHOD_GETLPARENLOC_14: u64 = 3817;
const METHOD_GETRPARENLOC_32: u64 = 3818;
const METHOD_GETPARENSRANGE_2: u64 = 3819;
const METHOD_GETINNERTYPE_9: u64 = 3820;
const CLASS_DIAGNOSEIFATTR: u64 = 3821;
const CLASS_DEPENDENTVECTORTYPELOC: u64 = 3822;
const METHOD_GETNAMELOC_7: u64 = 3823;
const METHOD_GETLOCALSOURCERANGE_19: u64 = 3824;
const METHOD_GETELEMENTLOC_2: u64 = 3825;
const METHOD_GETINNERTYPE_10: u64 = 3826;
const CLASS_SWIFTASYNCCONTEXTATTR: u64 = 3827;
const CLASS_NOTHROWATTR: u64 = 3828;
const CLASS_ARRAYTYPELOC: u64 = 3829;
const METHOD_GETLBRACKETLOC_2: u64 = 3830;
const METHOD_GETRBRACKETLOC_5: u64 = 3831;
const METHOD_GETBRACKETSRANGE_2: u64 = 3832;
const METHOD_GETSIZEEXPR_5: u64 = 3833;
const METHOD_GETELEMENTLOC_3: u64 = 3834;
const METHOD_GETLOCALSOURCERANGE_20: u64 = 3835;
const METHOD_GETINNERTYPE_11: u64 = 3836;
const CLASS_OBJCINTERFACETYPELOC: u64 = 3837;
const CLASS_COMPLEXTYPELOC: u64 = 3838;
const CLASS_DEPENDENTTEMPLATESPECIALIZATIONTYPELOC: u64 = 3839;
const METHOD_GETELABORATEDKEYWORDLOC_1: u64 = 3840;
const METHOD_GETQUALIFIERLOC_17: u64 = 3841;
const METHOD_GETTEMPLATEKEYWORDLOC_8: u64 = 3842;
const METHOD_GETTEMPLATENAMELOC_2: u64 = 3843;
const METHOD_GETLANGLELOC_6: u64 = 3844;
const METHOD_GETRANGLELOC_6: u64 = 3845;
const METHOD_GETNUMARGS_6: u64 = 3846;
const METHOD_GETLOCALSOURCERANGE_21: u64 = 3847;
const METHOD_GETEXTRALOCALDATASIZE_3: u64 = 3848;
const METHOD_GETEXTRALOCALDATAALIGNMENT_3: u64 = 3849;
const CLASS_CSTYLECASTEXPR: u64 = 3850;
const METHOD_GETLPARENLOC: u64 = 3851;
const METHOD_GETRPARENLOC_4: u64 = 3852;
const METHOD_GETBEGINLOC_18: u64 = 3853;
const METHOD_GETENDLOC_17: u64 = 3854;
const CLASS_NOMERGEATTR: u64 = 3855;
const CLASS_UNQUALTYPELOC: u64 = 3856;
const METHOD_GETTYPEPTR_1: u64 = 3857;
const METHOD_GETTYPELOCCLASS_1: u64 = 3858;
const CLASS_BTFTAGATTRIBUTEDTYPELOC: u64 = 3859;
const METHOD_GETWRAPPEDLOC: u64 = 3860;
const METHOD_GETATTR_2: u64 = 3861;
const METHOD_GETLOCALSOURCERANGE_22: u64 = 3862;
const METHOD_GETINNERTYPE_12: u64 = 3863;
const CLASS_HLSLRESOURCEBINDINGATTR: u64 = 3864;
const CLASS_PACKEXPANSIONTYPELOC: u64 = 3865;
const METHOD_GETELLIPSISLOC_7: u64 = 3866;
const METHOD_GETLOCALSOURCERANGE_23: u64 = 3867;
const METHOD_GETPATTERNLOC: u64 = 3868;
const METHOD_GETINNERTYPE_13: u64 = 3869;
const CLASS_AVRSIGNALATTR: u64 = 3870;
const CLASS_FUNCTIONRETURNTHUNKSATTR: u64 = 3871;
const CLASS_RECORDTYPELOC: u64 = 3872;
const METHOD_GETDECL_13: u64 = 3873;
const CLASS_OBJCSTRINGLITERAL: u64 = 3874;
const CLASS_TYPEOFTYPELOC: u64 = 3875;
const METHOD_GETUNMODIFIEDTYPE_1: u64 = 3876;
const METHOD_GETUNMODIFIEDTINFO: u64 = 3877;
const CLASS_DEDUCEDTYPELOC: u64 = 3878;
const CLASS_OMPMASKEDDIRECTIVE: u64 = 3879;
const CLASS_USINGTYPELOC: u64 = 3880;
const METHOD_GETUNDERLYINGTYPE_5: u64 = 3881;
const METHOD_GETFOUNDDECL_4: u64 = 3882;
const CLASS_DEPENDENTSIZEDMATRIXTYPELOC: u64 = 3883;
const CLASS_ELABORATEDTYPELOC: u64 = 3884;
const METHOD_GETELABORATEDKEYWORDLOC_2: u64 = 3885;
const METHOD_GETQUALIFIERLOC_18: u64 = 3886;
const METHOD_GETLOCALSOURCERANGE_24: u64 = 3887;
const METHOD_GETNAMEDTYPELOC: u64 = 3888;
const METHOD_GETINNERTYPE_14: u64 = 3889;
const METHOD_ISEMPTY_1: u64 = 3890;
const METHOD_GETLOCALDATAALIGNMENT_1: u64 = 3891;
const METHOD_GETLOCALDATASIZE_2: u64 = 3892;
const CLASS_REFERENCETYPELOC: u64 = 3893;
const METHOD_GETINNERTYPE_15: u64 = 3894;
const CLASS_CXXCATCHSTMT: u64 = 3895;
const METHOD_GETBEGINLOC_21: u64 = 3896;
const METHOD_GETENDLOC_20: u64 = 3897;
const METHOD_GETCATCHLOC: u64 = 3898;
const METHOD_GETEXCEPTIONDECL: u64 = 3899;
const METHOD_GETCAUGHTTYPE: u64 = 3900;
const METHOD_GETHANDLERBLOCK: u64 = 3901;
const METHOD_CHILDREN_15: u64 = 3902;
const CLASS_OBJCTYPEPARAMDECL: u64 = 3903;
const CLASS_DLLEXPORTATTR: u64 = 3904;
const CLASS_INCOMPLETEARRAYTYPELOC: u64 = 3905;
const CLASS_BLOCKPOINTERTYPELOC: u64 = 3906;
const METHOD_GETCARETLOC: u64 = 3907;
const CLASS_FIXEDPOINTLITERAL: u64 = 3908;
const METHOD_GETBEGINLOC_74: u64 = 3909;
const METHOD_GETENDLOC_73: u64 = 3910;
const METHOD_GETLOCATION_9: u64 = 3911;
const METHOD_GETSCALE: u64 = 3912;
const METHOD_CHILDREN_64: u64 = 3913;
const CLASS_OBJCENCODEEXPR: u64 = 3914;
const CLASS_NOINLINEATTR: u64 = 3915;
const CLASS_AUTOTYPELOC: u64 = 3916;
const METHOD_GETAUTOKEYWORD: u64 = 3917;
const METHOD_ISDECLTYPEAUTO_1: u64 = 3918;
const METHOD_GETRPARENLOC_33: u64 = 3919;
const METHOD_ISCONSTRAINED_1: u64 = 3920;
const METHOD_GETCONCEPTREFERENCE_1: u64 = 3921;
const METHOD_GETNESTEDNAMESPECIFIERLOC_1: u64 = 3922;
const METHOD_GETTEMPLATEKWLOC_1: u64 = 3923;
const METHOD_GETCONCEPTNAMELOC_1: u64 = 3924;
const METHOD_GETFOUNDDECL_5: u64 = 3925;
const METHOD_GETNAMEDCONCEPT_1: u64 = 3926;
const METHOD_GETCONCEPTNAMEINFO_1: u64 = 3927;
const METHOD_HASEXPLICITTEMPLATEARGS_6: u64 = 3928;
const METHOD_GETLANGLELOC_7: u64 = 3929;
const METHOD_GETRANGLELOC_7: u64 = 3930;
const METHOD_GETNUMARGS_7: u64 = 3931;
const METHOD_GETLOCALSOURCERANGE_25: u64 = 3932;
const CLASS_VARTEMPLATEPARTIALSPECIALIZATIONDECL: u64 = 3933;
const METHOD_GETTEMPLATEPARAMETERS_2: u64 = 3934;
const METHOD_GETTEMPLATEARGSASWRITTEN_1: u64 = 3935;
const METHOD_HASASSOCIATEDCONSTRAINTS_2: u64 = 3936;
const METHOD_GETINSTANTIATEDFROMMEMBER_1: u64 = 3937;
const METHOD_GETSOURCERANGE_37: u64 = 3938;
const CLASS_MEMBERPOINTERTYPELOC: u64 = 3939;
const METHOD_GETSTARLOC_2: u64 = 3940;
const METHOD_GETCLASS_1: u64 = 3941;
const METHOD_GETCLASSTINFO: u64 = 3942;
const METHOD_GETLOCALSOURCERANGE_26: u64 = 3943;
const CLASS_CXXBOOLLITERALEXPR: u64 = 3944;
const METHOD_GETVALUE_4: u64 = 3945;
const METHOD_GETBEGINLOC_20: u64 = 3946;
const METHOD_GETENDLOC_19: u64 = 3947;
const METHOD_GETLOCATION_1: u64 = 3948;
const METHOD_CHILDREN_14: u64 = 3949;
const CLASS_PARENTYPELOC: u64 = 3950;
const METHOD_GETLPARENLOC_15: u64 = 3951;
const METHOD_GETRPARENLOC_34: u64 = 3952;
const METHOD_GETLOCALSOURCERANGE_27: u64 = 3953;
const METHOD_GETINNERLOC_1: u64 = 3954;
const METHOD_GETINNERTYPE_16: u64 = 3955;
const CLASS_LVALUEREFERENCETYPELOC: u64 = 3956;
const METHOD_GETAMPLOC: u64 = 3957;
const CLASS_FUNCTIONPROTOTYPELOC: u64 = 3958;
const CLASS_DEDUCEDTYPE: u64 = 3959;
const METHOD_ISSUGARED_10: u64 = 3960;
const METHOD_DESUGAR_10: u64 = 3961;
const METHOD_GETDEDUCEDTYPE: u64 = 3962;
const METHOD_ISDEDUCED: u64 = 3963;
const CLASS_TAGTYPELOC: u64 = 3964;
const METHOD_GETDECL_14: u64 = 3965;
const METHOD_ISDEFINITION: u64 = 3966;
const ENUM_VALUEKIND: u64 = 3967;
const ENUM_ACCESSSPECIFIER: u64 = 3982;
const ENUM_ARRAYSIZEMODIFIER: u64 = 3987;
const ENUM_ARRAYTYPETRAIT: u64 = 3991;
const ENUM_ATOMICOP: u64 = 3995;
const ENUM_AUTOTYPEKEYWORD: u64 = 4084;
const ENUM_BINARYOPERATORKIND: u64 = 4088;
const ENUM_BUILTINTEMPLATEKIND: u64 = 4122;
const ENUM_KIND: u64 = 4125;
const ENUM_KIND_1: u64 = 4626;
const ENUM_CXXCONSTRUCTIONKIND: u64 = 4631;
const ENUM_CXXNEWINITIALIZATIONSTYLE: u64 = 4636;
const ENUM_ADLCALLKIND: u64 = 4640;
const ENUM_CALLINGCONV: u64 = 4643;
const ENUM_CANTHROWRESULT: u64 = 4666;
const ENUM_CAPTUREDREGIONKIND: u64 = 4670;
const ENUM_CASTKIND: u64 = 4674;
const ENUM_CHARACTERLITERALKIND: u64 = 4740;
const ENUM_CONSTANTRESULTSTORAGEKIND: u64 = 4746;
const ENUM_CONSTEXPRSPECKIND: u64 = 4750;
const ENUM_FRIENDOBJECTKIND: u64 = 4755;
const ENUM_MODULEOWNERSHIPKIND: u64 = 4759;
const ENUM_OBJCDECLQUALIFIER: u64 = 4765;
const ENUM_DEDUCTIONCANDIDATE: u64 = 4774;
const ENUM_ELABORATEDTYPEKEYWORD: u64 = 4778;
const ENUM_EXCEPTIONSPECIFICATIONTYPE: u64 = 4786;
const ENUM_EXPRDEPENDENCE: u64 = 4799;
const ENUM_EXPROBJECTKIND: u64 = 4813;
const ENUM_EXPRVALUEKIND: u64 = 4820;
const ENUM_EXPRESSIONTRAIT: u64 = 4824;
const ENUM_TEMPLATEDKIND: u64 = 4828;
const ENUM_IFSTATEMENTKIND: u64 = 4835;
const ENUM_IMPLICITPARAMKIND: u64 = 4840;
const ENUM_INCLASSINITSTYLE: u64 = 4848;
const ENUM_LAMBDACAPTUREDEFAULT: u64 = 4852;
const ENUM_LANGUAGELINKAGE: u64 = 4856;
const ENUM_LINKAGE: u64 = 4860;
const ENUM_LINKAGESPECLANGUAGEIDS: u64 = 4868;
const ENUM_MSVTORDISPMODE: u64 = 4871;
const ENUM_MULTIVERSIONKIND: u64 = 4875;
const ENUM_NONODRUSEREASON: u64 = 4882;
const ENUM_OBJCSTRINGFORMATFAMILY: u64 = 4887;
const ENUM_OVERLOADEDOPERATORKIND: u64 = 4891;
const ENUM_PRAGMAMSCOMMENTKIND: u64 = 4939;
const ENUM_PREDEFINEDIDENTKIND: u64 = 4946;
const ENUM_OBJCLIFETIME: u64 = 4955;
const ENUM_RECORDARGPASSINGKIND: u64 = 4961;
const ENUM_REFQUALIFIERKIND: u64 = 4965;
const ENUM_SOURCELOCIDENTKIND: u64 = 4969;
const ENUM_STORAGECLASS: u64 = 4977;
const ENUM_STORAGEDURATION: u64 = 4984;
const ENUM_STRINGLITERALKIND: u64 = 4990;
const ENUM_TAGTYPEKIND: u64 = 4997;
const ENUM_TEMPLATESPECIALIZATIONKIND: u64 = 5003;
const ENUM_THREADSTORAGECLASSSPECIFIER: u64 = 5009;
const ENUM_TYPEDEPENDENCE: u64 = 5014;
const ENUM_TYPEOFKIND: u64 = 5024;
const ENUM_TYPETRAIT: u64 = 5027;
const ENUM_UNARYEXPRORTYPETRAIT: u64 = 5104;
const ENUM_UNARYOPERATORKIND: u64 = 5113;
const ENUM_UTTKIND: u64 = 5128;
const ENUM_LITERALOPERATORKIND: u64 = 5145;
const ENUM_DEFINITIONKIND: u64 = 5152;
const ENUM_INITIALIZATIONSTYLE: u64 = 5156;
const ENUM_TLSKIND: u64 = 5161;
const ENUM_VECTORKIND: u64 = 5165;
const ENUM_VISIBILITY: u64 = 5176;
const ENUM_KIND_2: u64 = 5180;
const ENUM_SEMANTICS: u64 = 5595;
