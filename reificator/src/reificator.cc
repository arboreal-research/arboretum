...
class ReificatorASTConsumer : public clang::ASTConsumer {
 ...
 public:
  ...
  std::unordered_map<std::string, bool> ReadPropertyTable() {
  ...
  void UpdatePropertyTable(
      std::unordered_map<std::string, bool>& original_property_table,
      Model& model) {
