...
void EmitReifyCpp(Model &model, std::map<std::string, bool> property_table,
  ...
  enums_to_emit.insert(std::make_pair(
  ...
  auto fqn_to_id_cpp = [&](const std::string &s) {
    ...
    return find_itr->second + (1UL << 32);
  };

  auto fqn_to_id_rs = [&](const std::string &s) {
    auto find_itr = id_by_name.find(s);
    if (find_itr == id_by_name.end()) {
      uint64_t id = next_id++;
      id_by_name[s] = id;
  ...
  meta_data_model.push_back(
      std::pair("meta_clang_ast_node", "/meta/clang_ast/node"));
  meta_data_model.push_back(
      std::pair("meta_clang_ast_method", "/meta/clang_ast/method"));
  meta_data_model.push_back(
      std::pair("meta_clang_ast_enum", "/meta/clang_ast/enum"));
  meta_data_model.push_back(std::pair("meta_clang_ast_enum_enumerators",
                                      "/meta/clang_ast/enum/enumerators"));
  meta_data_model.push_back(std::pair("meta_clang_ast_enum_constant",
                                      "/meta/clang_ast/enum_constant"));

  meta_data_model.push_back(
      std::pair("builtin_string_class", "/builtin/string"));
  ...
  meta_data_model.push_back(
      std::pair("builtin_list_size", "/builtin/list/size"));
  meta_data_model.push_back(
      std::pair("builtin_list_item_class", "/builtin/list/item_class"));
  ...
  meta_data_model.push_back(
      std::pair("builtin_set_item_class", "/builtin/set/item_class"));

  meta_data_model.push_back(std::pair("invalid_file", "/invalid/file"));
  meta_data_model.push_back(
      std::pair("invalid_source_location", "/invalid/clang/SourceLocation"));
  ...
  meta_data_model.push_back(
      std::pair("source_location_class", "/clang/SourceLocation"));
  meta_data_model.push_back(
      std::pair("source_location_is_file", "/clang/SourceLocation/is_file"));
  meta_data_model.push_back(
      std::pair("source_location_file", "/clang/SourceLocation/file"));
  meta_data_model.push_back(
      std::pair("source_location_line", "/clang/SourceLocation/line"));
  meta_data_model.push_back(
      std::pair("source_location_column", "/clang/SourceLocation/column"));
  meta_data_model.push_back(std::pair("source_location_expansion_loc",
                                      "/clang/SourceLocation/expansion_loc"));
  meta_data_model.push_back(std::pair("source_location_spelling_loc",
                                      "/clang/SourceLocation/spelling_loc"));

  meta_data_model.push_back(
      std::pair("source_range_class", "/clang/SourceRange"));
  meta_data_model.push_back(
      std::pair("source_range_begin", "/clang/SourceRange/begin"));
  meta_data_model.push_back(
      std::pair("source_range_end", "/clang/SourceLocation/end"));

  meta_data_model.push_back(std::pair("qualtype_class", "/clang/QualType"));
  meta_data_model.push_back(
      std::pair("qualtype_is_const", "/clang/QualType/is_const"));
  meta_data_model.push_back(
      std::pair("qualtype_is_volatile", "/clang/QualType/is_volatile"));
  meta_data_model.push_back(
      std::pair("qualtype_is_restrict", "/clang/QualType/is_restrict"));
  ...
  meta_data_model.push_back(
      std::pair("cfg_indirect_goto_block", "/clang/cfg/indirect_goto_block"));
  meta_data_model.push_back(
      std::pair("cfg_try_blocks", "/clang/cfg/try_blocks"));
  ...
  meta_data_model.push_back(
      std::pair("cfg_block_parent", "/clang/cfg_block/parents"));
  meta_data_model.push_back(
      std::pair("cfg_block_succs", "/clang/cfg_block/succs"));
  meta_data_model.push_back(
      std::pair("cfg_block_preds", "/clang/cfg_block/preds"));
  meta_data_model.push_back(
      std::pair("cfg_block_label", "/clang/cfg_block/label"));
  meta_data_model.push_back(std::pair("cfg_block_terminator_stmt",
                                      "/clang/cfg_block/terminator_stmt"));
  meta_data_model.push_back(std::pair("cfg_block_terminator_kind",
                                      "/clang/cfg_block/terminator_kind"));
  meta_data_model.push_back(std::pair("cfg_block_terminator_condition",
                                      "/clang/cfg_block/terminator_condition"));
  meta_data_model.push_back(
      std::pair("cfg_block_loop_target", "/clang/cfg_block/loop_target"));
  meta_data_model.push_back(
      std::pair("cfg_block_has_no_return_element",
                "/clang/cfg_block/has_no_return_element"));

  meta_data_model.push_back(std::pair("class_CFGElement", "clang::CFGElement"));
  meta_data_model.push_back(
      std::pair("class_CFGCleanupFunction", "clang::CFGCleanupFunction"));
  meta_data_model.push_back(
      std::pair("class_CFGImplicitDtor", "clang::CFGImplicitDtor"));
  meta_data_model.push_back(
      std::pair("class_CFGInitializer", "clang::CFGInitializer"));
  meta_data_model.push_back(
      std::pair("class_CFGLifetimeEnds", "clang::CFGLifetimeEnds"));
  meta_data_model.push_back(
      std::pair("class_CFGLoopExit", "clang::CFGLoopExit"));
  meta_data_model.push_back(
      std::pair("class_CFGNewAllocator", "clang::CFGNewAllocator"));
  meta_data_model.push_back(
      std::pair("class_CFGScopeBegin", "clang::CFGScopeBegin"));
  meta_data_model.push_back(
      std::pair("class_CFGScopeEnd", "clang::CFGScopeEnd"));
  meta_data_model.push_back(std::pair("class_CFGStmt", "clang::CFGStmt"));
  meta_data_model.push_back(
      std::pair("class_CFGAutomaticObjDtor", "clang::CFGAutomaticObjDtor"));
  meta_data_model.push_back(
      std::pair("class_CFGBaseDtor", "clang::CFGBaseDtor"));
  meta_data_model.push_back(
      std::pair("class_CFGDeleteDtor", "clang::CFGDeleteDtor"));
  meta_data_model.push_back(
      std::pair("class_CFGMemberDtor", "clang::CFGMemberDtor"));
  meta_data_model.push_back(
      std::pair("class_CFGTemporaryDtor", "clang::CFGTemporaryDtor"));
  meta_data_model.push_back(
      std::pair("class_CFGCXXRecordTypedCall", "clang::CFGCXXRecordTypedCall"));
  meta_data_model.push_back(
      std::pair("class_CFGConstructor", "clang::CFGConstructor"));

  meta_data_model.push_back(
      std::pair("cfg_element_trigger_stmt", "/clang/cfg_element/trigger_stmt"));
  meta_data_model.push_back(
      std::pair("cfg_element_var_decl", "/clang/cfg_element/var_decl"));
  meta_data_model.push_back(
      std::pair("cfg_element_alloc_expr", "/clang/cfg_element/alloc_expr"));
  meta_data_model.push_back(
      std::pair("cfg_element_loop_stmt", "/clang/cfg_element/loop_stmt"));
  meta_data_model.push_back(
      std::pair("cfg_element_stmt", "/clang/cfg_element/stmt"));
  meta_data_model.push_back(
      std::pair("cfg_element_ctor_context", "/clang/cfg_element/ctor_context"));
  meta_data_model.push_back(
      std::pair("cfg_element_dtor_decl", "/clang/cfg_element/dtor_decl"));
  meta_data_model.push_back(
      std::pair("cfg_element_is_no_return", "/clang/cfg_element/is_no_return"));
  meta_data_model.push_back(
      std::pair("cfg_element_init", "/clang/cfg_element/init"));
  meta_data_model.push_back(std::pair("cfg_element_cxx_record_decl",
                                      "/clang/cfg_element/cxx_record_decl"));
  meta_data_model.push_back(
      std::pair("cfg_element_delete_expr", "/clang/cfg_element/delete_expr"));
  meta_data_model.push_back(std::pair("cfg_element_base_specifier",
                                      "/clang/cfg_element/base_specifier"));
  meta_data_model.push_back(
      std::pair("cfg_element_field_decl", "/clang/cfg_element/field_decl"));
  meta_data_model.push_back(
      std::pair("cfg_element_bind_temporary_expr",
                "/clang/cfg_element/bind_temporary_expr"));
  meta_data_model.push_back(std::pair("cfg_element_function_decl",
                                      "/clang/cfg_element/function_decl"));
    ...
    auto emit_methods = [&](const clang::CXXRecordDecl *decl,
      ...
      for (const auto &method_decl : decl->methods()) {
        ...
        std::optional<HandlerFragment> handler_opt =
            handler_for(model, return_type, enums_to_emit);
  ...
  assert(data_model_cc.Write([&](std::ostream &out) -> bool {
    ...
    for (auto &decl_decl : model.index.clang.all_decls) {
      ...
      out << "  data_model." << decl_decl_Id
          ...
          << fqn_to_id_cpp(decl_decl->getQualifiedNameAsString()) << ");\n";
    ...
    for (auto &[enum_name, enum_decl] : enums_to_emit) {
      ...
      for (const auto &enum_value_decl : enum_decl->enumerators()) {
        ...
        out << "  data_model." << enum_value_decl_Id
            << "_ = arboretum_create_nameless_node_with_id("
            << fqn_to_id_cpp(enum_value_decl_fqn) << ");\n";
      }
    }
  ...
  assert(reify_rs.Write([&](std::ostream &out) -> bool {
    ...
    for (auto &[var_lower, name] : meta_data_model) {
      ...
      constants.push_back(std::make_pair(var, fqn_to_id_rs(name)));
    ...
    for (auto &decl_decl : model.index.clang.all_decls) {
      ...
      constants.push_back(
          std::make_pair(decl_decl_Id, fqn_to_id_rs(decl_decl_fqn)));
      ...
      for (auto method_decl : decl_decl->methods()) {
        ...
        std::string method_decl_fqn = method_decl->getQualifiedNameAsString();
        constants.push_back(
            std::make_pair(method_decl_Id, fqn_to_id_rs(method_decl_fqn)));
      }
    }
    ...
    for (auto &[enum_name, enum_decl] : enums_to_emit) {
      ...
      constants.push_back(
          std::make_pair(enum_decl_Id, fqn_to_id_rs(enum_decl_fqn)));
    }
    ...
    for (auto &decl_decl : model.index.clang.all_decls) {
      ...
      out << "  g.add_named_node(" << decl_decl_Id << ", \"" << decl_decl_fqn
          << "\");\n";
      out << "  g.add_edge((" << decl_decl_Id
          << ", META_CLASS, META_CLANG_AST_NODE));\n";
      ...
      for (auto super : model.index.inheritance.supers[decl_decl]) {
        ...
        out << "  g.add_edge((" << decl_decl_Id << ", META_SUBCLASS, "
            << super_Id << "));\n";
      }
      ...
      if (methods.size() > 0) {
        ...
        for (auto method_decl : methods) {
          ...
          out << "      add_named_node(&mut g, " << method_decl_Id << ", \""
              << method_decl_fqn << "\"),\n";
        }
        out << "    ]);\n";
    ...
    for (auto &[enum_name, enum_decl] : enums_to_emit) {
      ...
      for (const auto &enum_value_decl : enum_decl->enumerators()) {
        ...
        out << "      add_named_node(&mut g, "
            << fqn_to_id_rs(enum_value_decl_fqn) << ", \""
            << enum_value_decl_fqn << "\"),\n";
      }
      out << "    ]);\n";
      out << "    let enumerators = set_node(&mut g, "
             ...
             "enumerators);\n";
      out << "    g.add_edge((" << enum_decl_Id
          << ", META_CLANG_AST_ENUM_ENUMERATORS, enumerators));\n";
      out << "  }\n\n";
    }
    out << "  g\n";
    out << "}\n\n";
